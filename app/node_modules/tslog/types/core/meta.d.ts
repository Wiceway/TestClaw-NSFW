 ...
 */
export declare function defineLazyPath(meta: IMeta, error: Error, callerFrame: number, internalFramePatterns: RegExp[] | undefined, deps: MetaDeps): void;
/**
 ...
 */
export declare function buildMeta(staticMeta: RuntimeMetaStatic, logLevelId: number, logLevelName: string, callerFrame: number, hideLogPosition: boolean, name: string | undefined, parentNames: string[] | undefined, internalFramePatterns: RegExp[] | undefined, deps: MetaDeps): IMeta;
