 ...
 * }
 */
export declare class TslogConfigError extends Error {
 ...
 */
export declare function defineConfig<LogObj = unknown>(settings: ISettingsParam<LogObj>): ISettingsParam<LogObj>;
