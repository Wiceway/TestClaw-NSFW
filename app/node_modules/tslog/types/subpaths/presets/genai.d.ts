 ...
 */
export declare function genai(input?: GenAiInput): GenAiRecord;
/**
 ...
 */
export declare function genaiAttributes(input?: GenAiInput): GenAiAttributes;
/**
 * Return only the friendly {@link GenAiSummary} `{ model, tokens, costUsd, latencyMs }` for a {@link GenAiInput}.
 */
export declare function genaiSummary(input?: GenAiInput): GenAiSummary;
