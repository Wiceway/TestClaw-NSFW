...
const CONSOLE_TO_LEVEL = Object.freeze({
    log: "info",
    info: "info",
    debug: "debug",
    warn: "warn",
...
const WRAPPED_METHODS = ["log", "info", "debug", "warn", "error"];
 ...
 */
export function wrapConsole(logger) {
    if (originalMethods == null) {
        ...
        console[NATIVE_CONSOLE_KEY] = originalMethods;
    }
    for (const method of WRAPPED_METHODS) {
...
export function restoreConsole() {
    ...
    forwarding = false;
    delete console[NATIVE_CONSOLE_KEY];
}
