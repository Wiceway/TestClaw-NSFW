...
export const NATIVE_CONSOLE_KEY = Symbol.for("tslog.console.originals");
/**
 ...
 */
export function nativeConsoleMethod(method) {
    try {
        const published = console[NATIVE_CONSOLE_KEY];
