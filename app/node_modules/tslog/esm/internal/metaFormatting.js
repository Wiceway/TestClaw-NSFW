...
export function buildPrettyMeta(settings, meta) {
    ...
    const date = rawDate instanceof Date && !Number.isNaN(rawDate.getTime()) ? rawDate : undefined;
    let dateFallback;
    ...
    placeholderValues.rawIsoStr =
        dateInSettingsTimeZone == null ? (dateFallback ?? "") : isUtc ? dateInSettingsTimeZone.toISOString() : localIsoString(dateInSettingsTimeZone, date);
