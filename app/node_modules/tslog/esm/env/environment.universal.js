...
import { detectRuntimeInfo } from "./shared.js";
...
const SOURCE_MAP_CAPABLE_RUNTIMES = new Set(["node", "deno", "bun", "unknown"]);
export function createUniversalEnvironment() {
    ...
    return {
        ...base.methods,
        getMeta(logLevelId, logLevelName, callerFrame, hideLogPosition, name, parentNames, internalFramePatterns) {
