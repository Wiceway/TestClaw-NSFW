 ...
 */
export const DEFAULT_LOG_LEVEL_NAMES = Object.freeze({
    0: "SILLY",
    1: "TRACE",
    2: "DEBUG",
    3: "INFO",
...
const NAME_TO_ID = Object.freeze(Object.fromEntries(Object.entries(DEFAULT_LOG_LEVEL_NAMES).map(([id, name]) => [name, Number(id)])));
/**
 ...
 */
export function resolveLogLevelId(level, customLevels) {
    if (level == null) {
        return undefined;
    }
...
export function validateCustomLevel(name, id, existing) {
...
export function logLevelName(id) {
