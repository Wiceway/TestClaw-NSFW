...
Suspected security issues belong in private disclosure first. See [`SECURITY.md`](https://github.com/testclaw/fs-safe/blob/main/SECURITY.md) in the repo for the current contact path.
