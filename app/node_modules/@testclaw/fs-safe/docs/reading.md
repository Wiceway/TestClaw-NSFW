...
For tighter control over malformed-or-missing JSON, use the standalone helpers in [`@testclaw/fs-safe/json`](json.md): `tryReadJson` (returns `null` on missing/invalid) vs `readJson` (throws).
