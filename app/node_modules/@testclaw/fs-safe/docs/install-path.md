...
`"@testclaw/fs-safe:install-path:v2\0"`, followed by the UTF-16LE bytes of
...
```ts
import { resolveSafeInstallDir, assertCanonicalPathWithinBase, safePathSegmentHashedV2 } from "@testclaw/fs-safe/advanced";
