...
`@testclaw/fs-safe/test-hooks` exposes test-only injection points. Registration
...
} from "@testclaw/fs-safe/test-hooks";
```
...
import { __setFsSafeTestHooksForTest } from "@testclaw/fs-safe/test-hooks";
