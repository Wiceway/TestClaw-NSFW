...
`@testclaw/fs-safe/durability` provides the directory side of crash-safe file
...
import { syncDirectorySync, type DirectoryReceipt } from "@testclaw/fs-safe/durability";
...
import { publishFileExclusive } from "@testclaw/fs-safe/durability";
