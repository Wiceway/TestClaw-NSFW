...
```ts
import { statRegularFile } from "@testclaw/fs-safe/advanced";
...
```ts
import { readRegularFile } from "@testclaw/fs-safe/advanced";
...
```ts
import { appendRegularFile } from "@testclaw/fs-safe/advanced";
...
```ts
import { resolveRegularFileAppendFlags } from "@testclaw/fs-safe/advanced";
