import type { AssistantMessage, Context, Model } from "@testclaw/llm-core";
import { stableStringify } from "@testclaw/normalization-core";
...
function inputReplay(message: AssistantMessage) {
  const value =
    "testclawResponsesInputReplay" in message ? message.testclawResponsesInputReplay : undefined;
...
export function recordResponsesContextUsage(
  ...
  Object.assign(message, {
    testclawResponsesInputReplay: { ...inputReplay(message), contextUsage },
  });
}
