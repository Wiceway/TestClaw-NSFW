...
import type { Api, Model, StreamFn, StreamOptions } from "@testclaw/llm-core";
import type { ApiRegistry } from "../api-registry.js";
import { getAiTransportHost, resolveAiTransportHeaderSentinels } from "../host.js";
import {
  buildTransportAwareSimpleStreamFn,
  createTestclawTransportStreamFnForModel,
...
function resolveAnthropicVertexSimpleApi(baseUrl?: string): Api {
  ...
  return `testclaw-anthropic-vertex-simple:${suffix}`;
}
...
function prepareCodexSimpleTransportModel<TApi extends Api>(
  ...
  // completion path must use Testclaw's transport so resolved request auth is applied.
