import { normalizeProviderId } from "@testclaw/model-catalog-core/provider-id";
/**
...
function resolveOpenAIResponsesPayloadCapabilities(
  ...
  const explicitContinuationOptIn =
    (api === "openai-responses" || api === "testclaw-openai-responses-transport") &&
    ...
    allowsOpenAIServiceTier:
      ...
      (isOpenAIProvider &&
        (api === "openai-chatgpt-responses" ||
          api === "testclaw-openai-chatgpt-responses-transport" ||
          api === "openai-responses" ||
          api === "testclaw-openai-responses-transport") &&
        endpointClass === "openai"),
