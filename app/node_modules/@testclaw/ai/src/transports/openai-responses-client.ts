...
import type { AssistantMessage, Context, Model, StreamFn } from "@testclaw/llm-core";
    ...
    void (async () => {
      ...
      try {
        ...
        const asyncToolExecutionEligible =
          ...
          !responsesOptions?.testclawCodeModeToolSurface;
        const prepareRequest = async (request: ReturnType<typeof config.buildRequest>) => {
          ...
          if (
            (options as { testclawCodeModeToolSurface?: unknown } | undefined)
