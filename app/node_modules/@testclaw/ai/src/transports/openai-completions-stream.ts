...
import type { AssistantMessageEvent, Model } from "@testclaw/llm-core";
import { appendAssistantThinking } from "@testclaw/llm-core/event-stream";
...
export async function processCompletionsStream(
  ...
  const beginReasoning = (hasFollowingVisibleText: boolean, forceStrict = false) => {
    if (!output.testclawDelivery?.textPhaseRequiresTerminal) {
