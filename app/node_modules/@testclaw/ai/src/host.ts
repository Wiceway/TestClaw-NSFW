...
// the embedding application (Testclaw core installs its implementations via
...
import type { Api, Context, Model, StreamFn } from "@testclaw/llm-core";
...
/** Transport-safe provider policy input kept independent of Testclaw config types. */
