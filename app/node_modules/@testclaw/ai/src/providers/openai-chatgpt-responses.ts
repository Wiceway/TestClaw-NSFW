...
import {
  ...
  toErrorObject,
} from "@testclaw/normalization-core/error-coercion";
import { resolveTimerTimeoutMs } from "@testclaw/normalization-core/number-coercion";
import type {
  Tool as OpenAITool,
...
function buildBaseCodexHeaders(
  ...
  const userAgent = os
    ? `testclaw (${os.platform()} ${os.release()}; ${os.arch()})`
    : "testclaw (browser)";
