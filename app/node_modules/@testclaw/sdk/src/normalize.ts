import { asFiniteNumber } from "@testclaw/normalization-core/number-coercion";
...
import type { GatewayEvent, JsonObject, TestclawEvent, TestclawEventType } from "./types.js";

function normalizeAgentEventType(payload: JsonObject): TestclawEventType {
...
function normalizeNamedEventType(event: GatewayEvent): TestclawEventType {
...
export function normalizeGatewayEvent(event: GatewayEvent): TestclawEvent {
  const payload = asRecord(event.payload);
