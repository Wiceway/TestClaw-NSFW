...
import type { GatewayClientRequestOptions } from "@testclaw/gateway-client";
import type {
...
/** Minimal transport interface consumed by the Testclaw SDK client. */
export type TestclawTransport = {
  request<T = unknown>(
    method: string,
    params?: unknown,
...
export type ConnectableTestclawTransport = TestclawTransport & {
...
export type RuntimeSelection =
  | "auto"
  | { type: "embedded"; id: "testclaw" | "codex" | (string & {}) }
...
export type TestclawEvent<TData = unknown> = {
  version: 1;
  id: string;
  ts: number;
  type: TestclawEventType;
  runId?: string;
  sessionId?: string;
  sessionKey?: string;
  taskId?: string;
