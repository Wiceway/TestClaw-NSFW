...
export declare function readMetadataString(meta: Record<string, unknown> | null | undefined, keys: string[]): string | undefined;
...
export declare function readMetadataNumber(meta: Record<string, unknown> | null | undefined, keys: string[]): number | undefined;
