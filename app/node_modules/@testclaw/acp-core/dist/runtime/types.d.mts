...
export type AcpRuntimeHandle = {
  sessionKey: string;
  /** Testclaw session-store owner; independent of the external harness. */
  agentId?: string;
  backend: string;
...
export type AcpElicitationHandler = (request: AcpElicitationRequest, context: AcpElicitationContext) => Promise<AcpElicitationResponse>;
