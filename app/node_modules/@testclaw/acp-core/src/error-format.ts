...
// Minimal fallback for standalone or unwired ACP core. Testclaw injects canonical
...
const SECRET_PATTERNS: RegExp[] = [
  ...
  /(?:X-Testclaw-Token|x-pomerium-jwt-assertion|X-Api-Key|X-Auth-Token)\s*[:=]\s*([^\s"',;]+)/gi,
...
export { stringifyNonErrorCause } from "@testclaw/normalization-core/error-coercion";
