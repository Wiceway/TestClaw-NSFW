...
export declare function asPositiveFiniteNumber(value: unknown): number | undefined;
/** Returns a finite number only when it is zero or greater. */
export declare function asNonNegativeFiniteNumber(value: unknown): number | undefined;
...
export declare function parseDateStringTimestampMs(value: unknown): number | undefined;
/** Reads finite numbers as milliseconds and parses strings using date-string semantics. */
export declare function parseDateFirstTimestampMs(value: unknown): number | undefined;
