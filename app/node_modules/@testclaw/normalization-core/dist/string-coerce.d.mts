...
export declare function normalizeBoundedOptionalString(value: unknown, maxLength: number): string | undefined;
...
export declare function readNonEmptyStringPreservingWhitespace(value: unknown): string | undefined;
