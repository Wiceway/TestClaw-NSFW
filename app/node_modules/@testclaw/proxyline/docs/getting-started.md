...
Proxyline targets Node.js 22.19.0+. It is published as `@testclaw/proxyline` and ships ESM with TypeScript types.

## Install

```bash
pnpm add @testclaw/proxyline
# or
npm install @testclaw/proxyline
# or
yarn add @testclaw/proxyline
```
