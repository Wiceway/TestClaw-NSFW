...
[![CI](https://img.shields.io/github/actions/workflow/status/testclaw/proxyline/ci.yml?branch=main&style=flat-square&label=ci)](https://github.com/testclaw/proxyline/actions/workflows/ci.yml)
[![npm](https://img.shields.io/npm/v/%40testclaw%2Fproxyline?style=flat-square)](https://www.npmjs.com/package/@testclaw/proxyline)
[![Node.js](https://img.shields.io/node/v/%40testclaw%2Fproxyline?style=flat-square)](https://nodejs.org/)
[![License](https://img.shields.io/github/license/testclaw/proxyline?style=flat-square)](./LICENSE)
...
```sh
pnpm add @testclaw/proxyline undici@^8.5.0
```

Or with npm:

```sh
npm install @testclaw/proxyline undici@^8.5.0
```
