...
export * from "@testclaw/gateway-protocol/client-info";
export * from "@testclaw/gateway-protocol/connect-error-details";
export * from "@testclaw/gateway-protocol/gateway-error-details";
export * from "@testclaw/gateway-protocol/startup-unavailable";
export * from "@testclaw/gateway-protocol/version";
export { GATEWAY_SERVER_CAPS } from "@testclaw/gateway-protocol/frame-guards";
export type { ConnectParams, ErrorShape, EventFrame, HelloOk } from "@testclaw/gateway-protocol";
