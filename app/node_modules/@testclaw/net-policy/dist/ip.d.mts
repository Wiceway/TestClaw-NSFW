...
export declare function isUnspecifiedIpAddress(raw: string | undefined): boolean;
...
export declare function isRfc8215LocalUseNat64Ipv6Address(raw: string | undefined): boolean;
...
export declare function parseIpAddressOrCidr(raw: string | undefined): [ParsedIpAddress, number?] | undefined;
