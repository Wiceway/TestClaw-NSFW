// Collects configured model references from Testclaw config-shaped objects.
import { asNonArrayRecord, isRecord } from "@testclaw/normalization-core/record-coerce";
