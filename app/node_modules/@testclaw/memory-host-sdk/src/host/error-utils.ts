import { formatErrorMessage as formatSharedErrorMessage } from "@testclaw/normalization-core/error-coercion";
// Import the canonical redactor directly, not via testclaw-runtime-io: that
