...
import { normalizeAgentId } from "@testclaw/normalization-core/agent-id";
import {
  resolveDefaultAgentWorkspaceDir,
  resolveStateDir,
  resolveUserPath,
  tryResolveLegacyDataOwner,
} from "./testclaw-runtime-paths.js";
import type { MemoryExtraPath } from "./types.js";
export { normalizeAgentId };

// Shared Testclaw config helpers used by memory host and agent context code.
...
export function resolveRememberAcrossConversations(cfg: TestclawConfig, agentId: string): boolean {
...
function listAgentEntries(cfg: TestclawConfig): AgentConfig[] {
...
function resolveDefaultAgentId(cfg: TestclawConfig): string {
...
function resolveAgentConfig(cfg: TestclawConfig, agentId: string): AgentConfig | undefined {
