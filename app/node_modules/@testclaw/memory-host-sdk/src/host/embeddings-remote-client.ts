import { normalizeOptionalString } from "@testclaw/normalization-core/string-coerce";
import type { EmbeddingProviderOptions } from "./embeddings.types.js";
import { requireApiKey, resolveApiKeyForProvider } from "./testclaw-runtime-auth.js";
import type { SsrFPolicy } from "./testclaw-runtime-network.js";
...
function resolveTestclawAttributionHeaders(): Record<string, string> {
  const version = typeof process !== "undefined" ? process.env.TESTCLAW_VERSION?.trim() : undefined;
  return {
    originator: "testclaw",
    ...(version ? { version } : {}),
...
export async function resolveRemoteEmbeddingBearerClient(params: {
  ...
  if (isNativeOpenAIEmbeddingRoute(params.provider, baseUrl)) {
    entries.push(...Object.entries(resolveTestclawAttributionHeaders()));
  }
