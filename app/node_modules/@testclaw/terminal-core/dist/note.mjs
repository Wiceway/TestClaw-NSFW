import { c as visibleWidth, t as iterateGraphemes } from "./ansi-CYJ8PDsf.mjs";
import { n as normalizeLowercaseStringOrEmpty } from "./string-coerce-DWJQsxQV.mjs";
...
function noteToStream(message, title, output) {
	...
	note$1(wrappedMessage, stylePromptTitle(title), { output: createNoteOutput(output, resolveNoteOutputColumns(wrappedMessage, columns)) });
}
