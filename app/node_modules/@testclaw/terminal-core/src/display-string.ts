...
import { lowercasePreservingWhitespace } from "@testclaw/normalization-core";
import {
  normalizeHomeDirValue,
  resolveEffectiveHomeDir,
} from "@testclaw/normalization-core/home-dir";
...
function resolveHomeDisplayPrefix(): { home: string; prefix: string } | undefined {
  ...
  const explicitHome = normalizeHomeDirValue(process.env.TESTCLAW_HOME);
  return explicitHome ? { home, prefix: "$TESTCLAW_HOME" } : { home, prefix: "~" };
}
