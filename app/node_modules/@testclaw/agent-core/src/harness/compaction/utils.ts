import type { AssistantMessage, Message } from "@testclaw/llm-core";
import { asOptionalRecord as asRecord } from "@testclaw/normalization-core/record-coerce";
import { sliceUtf16Safe, truncateUtf16Safe } from "@testclaw/normalization-core/utf16-slice";
...
function readPersistedSender(message: PersistedSenderCarrier): PersistedSender | undefined {
  ...
  const metadata = asRecord(Reflect.get(message, "__testclaw"));
  if (!metadata) {
    return undefined;
  }
