...
/** Install Testclaw-owned loop control without adding a plugin-facing Agent option. */
...
/** Attach Testclaw-owned two-phase execution without changing the public AgentTool shape. */
