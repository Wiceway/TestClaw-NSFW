...
import { n as createStatusScanCoreBootstrap, t as buildColdStartStatusSummary } from "./status.scan.bootstrap-shared-DuUMdKHf.mjs";
...
const statusAgentLocalModuleLoader = createLazyImportLoader(() => import("./status.agent-local-BHk4AoVd.mjs"));
const statusUpdateModuleLoader = createLazyImportLoader(() => import("./status.update-DW2arJpt.mjs"));
...
const statusSummaryModuleLoader = createLazyImportLoader(() => import("./summary-Dj79dVyI.mjs"));
...
const controlUiLinksModuleLoader = createLazyImportLoader(() => import("./control-ui-links-CcbWBvPO.mjs"));
const commandConfigResolutionModuleLoader = createLazyImportLoader(() => import("./command-config-resolution-CeevFggk.mjs"));
const commandSecretTargetsModuleLoader = createLazyImportLoader(() => import("./command-secret-targets-CT-IPLu-.mjs"));
...
async function collectStatusScanOverview(params) {
	...
	const { snapshot } = await measureCliCommandStartup("status.config", async () => (await import("./command-config-snapshot-WrEQiiHL.mjs")).readCommandConfigSnapshot({
		observe: false,
