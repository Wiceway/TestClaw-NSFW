...
import { n as resolveSessionTarget, t as callSessionTargetGateway } from "./session-target-BgFLGp1H.mjs";
...
function writeClaudeMcpConfig(mcpConfig) {
	const dir = mkdtempSync(join(tmpdir(), "testclaw-attach-"));
