...
import { n as TESTCLAW_SOURCE_URL, r as resolveAssistantReferencePaths, t as TESTCLAW_DOCS_URL } from "./docs-path-l4C08Klu.mjs";
import { n as probeLocalCommand, t as probeGatewayUrl } from "./probes-Bp8t3rDt.mjs";
...
async function loadSystemAgentOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-BFsjnbnk.mjs")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
