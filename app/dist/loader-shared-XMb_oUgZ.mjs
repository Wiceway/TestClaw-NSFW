...
import { i as readErrorCause } from "./errors-DNLGIg8_.mjs";
import { t as VERSION } from "./version-BnaMeO13.mjs";
import { c as collectPluginManifestCompatCodes } from "./installed-plugin-index-Cd3PE_mG.mjs";
import { t as normalizePluginPolicyId } from "./plugin-policy-id-C9JZrwYv.mjs";
import { r as hasKind } from "./slots-D4OMSTbt.mjs";
import { d as resolveEffectivePluginActivationState, u as resolveEffectiveEnableState } from "./config-state-C1Oo_dIV.mjs";
import { T as recordPluginCandidateInstallOwner, a as isPluginLifecycleTraceEnabled, y as formatPluginVerificationDiagnostic } from "./discovery-Beqghw38.mjs";
...
import { o as shippedNativeSessionCatalogs } from "./native-session-catalog-config-CYC8tjEu.mjs";
import { C as rollbackStagedPluginRegistry, T as stageActivePluginRegistry, d as getActivePluginRegistryVersion, i as commitStagedPluginRegistry, l as getActivePluginRegistry, n as captureActivePluginRegistrySnapshot } from "./runtime-D1tHq7F4.mjs";
import { t as activateContextEngineRegistrations } from "./registry-BPMvk3sV.mjs";
import { C as resolveMemoryDreamingPluginConfig, S as resolveMemoryDreamingConfig, l as DEFAULT_MEMORY_DREAMING_PLUGIN_ID } from "./dreaming-DEVSpbop.mjs";
import { a as resetGlobalHookRunner, i as initializeGlobalHookRunner, n as getGlobalPluginRegistry } from "./hook-runner-global-eA1aRrLi.mjs";
import { t as isBundleCapabilitySupported } from "./bundle-capability-support-B86S0fqh.mjs";
import { t as recordPluginLoadDiagnostic } from "./load-diagnostics-Dim-V7oP.mjs";
