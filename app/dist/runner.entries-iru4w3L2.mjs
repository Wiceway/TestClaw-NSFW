...
import { o as normalizeLowercaseStringOrEmpty, s as normalizeNullableString } from "./string-coerce-CIXf7egm.mjs";
...
import { u as listOfficialExternalProviderCatalogEntries } from "./official-external-plugin-catalog-BxZhHmRY.mjs";
...
import { c as mergeModelProviderRequestOverrides, m as sanitizeConfiguredProviderRequest, p as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-B-Uo_fI2.mjs";
import { i as resolveOfficialExternalPluginRepairHint } from "./official-external-plugin-repair-hints-BeNc5xMr.mjs";
import { n as CUSTOM_LOCAL_AUTH_MARKER } from "./model-auth-markers-Bml4Y1AZ.mjs";
...
import { i as assertRuntimeMediaRequestSecretOwnerAvailable } from "./entry-capabilities-CZvlwvN6.mjs";
import { n as DEFAULT_MAX_BYTES, o as DEFAULT_VIDEO_MAX_BASE64_BYTES, s as MIN_AUDIO_FILE_BYTES, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-Cof2g8lZ.mjs";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-DSbuCFIb.mjs";
import { r as resolveEntryRunOptions, t as resolveCliModelEntry } from "./resolve-DyyZDR2o.mjs";
import { a as optimizeImageBufferForWebMedia, l as ImageOptimizationLimitError, t as effectiveImageBytesCap } from "./web-media-C_2-C1GR.mjs";
import { t as applyTemplate } from "./templating-DocmBuN3.mjs";
import { n as MediaUnderstandingSkipError } from "./attachments-DOhRHRtg.mjs";
import { r as providerOperationRetryConfig } from "./operation-retry-C8ZWJ_uo.mjs";
import { i as resolveRequestedLocalAudioBackend, r as recordLocalAudioBackendObservation } from "./local-audio-BTFl4nIm.mjs";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-CZK5TvIV.mjs";
import { r as getMediaUnderstandingProvider, t as resolveImageCompressionModelPolicy } from "./image-compression-policy-DogtvlAr.mjs";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-DoBLo6Xa.mjs";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-CnSUbkdi.mjs";
import { s as normalizeInputImageBuffer } from "./input-files-DZqbc4zm.mjs";
...
const loadModelAuth = createLazyRuntimeModule(async () => await import("./model-auth-CJ3sie7d.mjs"));
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-DhZzxrBs.mjs")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
...
//#endregion
export { runCliEntry as a, normalizeImageDescriptionInput as c, normalizeDecisionReason as i, optimizeImageDescriptionInput as l, findDecisionReason as n, runProviderEntry as o, formatDecisionSummary as r, summarizeDecisionReason as s, buildModelDecision as t };
