...
import { n as projectAgentActivityItem, t as isCompleteAgentPreamble } from "./agent-activity-presentation-D0NYxrK0.mjs";
import { A as resolveChannelStreamingSuppressDefaultToolProgressMessages, D as resolveChannelStreamingPreviewToolProgress, F as createProgressDraftDiffStatTracker, I as formatChannelProgressDraftDiffStat, N as isChannelProgressAttentionLine, O as resolveChannelStreamingProgressCommentary, P as removeChannelProgressDraftLine, a as createChannelProgressDraftGate, b as resolveChannelProgressDraftMaxLineChars, d as isChannelProgressDraftWorkToolName, f as isChannelProgressPriorityLine, g as normalizeChannelProgressDraftLineIdentity, i as copyProgressDraftLineMetadata, l as formatChannelProgressDraftTextForStreaming, m as mergeChannelProgressDraftLineForStreaming, n as buildChannelProgressDraftLineForEntry, v as resolveChannelProgressDraftConfig, x as resolveChannelProgressDraftMaxLines, y as resolveChannelProgressDraftLabel } from "./streaming-CDUnCr4v.mjs";
import { t as settleProgressVisibilityCallbackResult } from "./progress-visibility-DVUJibF4.mjs";
import { a as sanitizeProgressStatusText, i as resolveCommentaryLineId, n as formatReasoningProgressDisplayLine, r as normalizeCommentaryProgressText, t as createReasoningProgressAccumulator } from "./progress-draft-status-text-BUbtefrl.mjs";
...
function createChannelProgressWorkCounter(params) {
	...
	return {
		noteItem(item) {
			if (item.phase === "start" && item.kind !== "preamble" && !item.hideFromChannelProgress && !item.suppressChannelProgress) toolCalls += 1;
		},
