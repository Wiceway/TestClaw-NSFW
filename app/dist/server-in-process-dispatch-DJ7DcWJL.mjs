...
import { R as registerDiagnosticToolExecutionDeadline } from "./diagnostic-events-C4sEV9aC.mjs";
import { c as resolveSafeTimeoutDelayMs } from "./timeouts-Bm8XlcCK.mjs";
import { i as retainGatewayResponsePayload, n as GatewayProtocolRequestTimeoutError } from "./protocol-request-BMUN1re6.mjs";
import { t as GatewayClientRequestError } from "./request-error-Bu6YJefd.mjs";
import { t as bindCreatedInputMutationAuthority } from "./session-mutation-guards-CTsdHPbJ.mjs";
...
async function dispatchGatewayRequestInProcessRaw(method, params, options) {
	...
	try {
		const { handleGatewayRequest } = await import("./server-methods-B5_nUGdP.mjs");
		entry?.assertOpen();
