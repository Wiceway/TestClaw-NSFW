...
import { d as resolveUserTurnTranscriptAdmission, u as registerUserTurnTranscriptAdmissionOwner } from "./session-transcript-read-fence-BM_e7CiR.mjs";
...
import { Z as bindSessionPendingInputSources, h as persistSessionTranscriptTurn, it as withSessionPendingInputPersistence, k as rewriteTranscriptMessageAtAnchor, rt as stageSessionPendingInput } from "./session-accessor-CtBBLApI.mjs";
import { i as resolveSessionTranscriptRuntimeTarget } from "./session-accessor.transcript-target-I2MKxREg.mjs";
import { a as normalizePersistedSteerTargetRunId, c as rewritePersistedSteerTargetRunId, i as buildRunUserTurnIdempotencyKey, o as preparePersistedUserTurnMessageForTranscriptWrite } from "./user-turn-transcript.metadata-CRXr1P1Q.mjs";
import { a as isUserMessage, n as buildLateResolvedMediaMessage, s as resolvePersistedUserTurnMessage } from "./user-turn-transcript.message-DVnwpWW4.mjs";
...
function createUserTurnTranscriptRecorder(params) {
	...
	const handlePersistenceError = (error) => {
		...
		import("./globals-xLsebdpQ.mjs").then(({ logVerbose }) => {
