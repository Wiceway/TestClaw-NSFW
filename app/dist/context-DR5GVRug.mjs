...
import { f as isSameSsrFPolicy } from "./ssrf-CA4JQHU2.mjs";
import { a as DEFAULT_SOUL_FILENAME, n as DEFAULT_BOOTSTRAP_FILENAME, r as DEFAULT_IDENTITY_FILENAME, s as DEFAULT_USER_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-bootstrap-policy-DhM0WSIj.mjs";
...
import { t as ensureAgentWorkspace, u as publishBootstrapFile } from "./workspace-CQbT0L2J.mjs";
import { u as readAdmittedRunOperatorAuthority } from "./admitted-run-context-Dr03O97V.mjs";
import { C as SANDBOX_DOCKER_CREATE_ARGS_EPOCH, b as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, v as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-DLwYYb7M.mjs";
import { n as isToolAllowed } from "./tool-policy-CcGBeQQT.mjs";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-DBSLaQuW.mjs";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-B6-CxN9_.mjs";
import { r as toSandboxProvisioningError } from "./provisioning-error-rUAtr4Qd.mjs";
import { r as resolveSubagentSessionAttachmentRootDir, t as SANDBOX_SUBAGENT_ATTACHMENTS_MOUNT } from "./subagent-attachment-paths-BGHKYqZ0.mjs";
import { C as readDockerPort, S as readDockerContainerLabel, d as prepareSandboxMountPlan, i as execDocker, m as handleHotSandboxConfigMismatch, o as formatDockerDaemonUnavailableError, p as sandboxMountPlanMatchesContainer, s as isDockerDaemonUnavailable, t as buildSandboxCreateArgs, w as DOCKER_SANDBOX_ENGINE, x as readDockerContainerEnvVar, y as dockerContainerState } from "./docker-C4hnDi3L.mjs";
import { t as hashTextSha256 } from "./hash-DZK-8tRm.mjs";
import { a as computeSandboxBrowserConfigHash, t as resolveDockerEnvPolicyEpoch } from "./sanitize-env-vars-DTOHSTWf.mjs";
import "./workspace-mounts-Be-3VOYw.mjs";
import { i as slugifySessionKey, r as resolveSandboxWorkspaceLayoutPaths, t as buildSandboxContainerName } from "./shared-LriEBNe-.mjs";
import { a as readRegisteredSandboxRuntimeIds, i as readBrowserRegistry, p as updateBrowserRegistry } from "./registry-BWOS0ry_.mjs";
import { n as validateNetworkMode } from "./validate-sandbox-security-CK7xVx6D.mjs";
import { f as assertSshSandboxSecretOwnerAvailable } from "./ssh-backend-B6oWtOul.mjs";
import { a as getSandboxBackendWorkdirResolver, t as createSandboxBackend } from "./backend-Bn6ah0ml.mjs";
import { n as prepareRemoteSkillConnections } from "./remote-skills-19JJuvQV.mjs";
import { a as DEFAULT_TESTCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_TESTCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-D-ihLV5t.mjs";
import { i as startBrowserBridgeServer, n as stopCachedBrowserBridge, r as stopCachedBrowserBridgesForContainer, t as BROWSER_BRIDGES } from "./browser-bridges-CDm9-EDD.mjs";
...
async function syncSandboxSkillsToWorkspace(params) {
	try {
		const [syncWorkspaceSkills, { getRemoteSkillEligibility }, { resolveNodeExecEligibility }] = await Promise.all([
			...
			import("./remote-BAD5gByO.mjs"),
			import("./exec-defaults-CJY8jZZt.mjs")
		]);
...
async function prepareSandboxWorkspaceSelection(params, resolved) {
	...
	const localWorkspace = params.config ? await (await import("./local-workspace-ChFhJSU8.mjs")).prepareLocalSandboxWorkspace({
		cfg: params.config,
		agentId: runtime.agentId,
		sessionKey: rawSessionKey,
		workspaceDir: params.workspaceDir,
...
async function resolveProvisionedSandboxContext(params, resolved) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-CxvoyEf1.mjs")).maybePruneSandboxes();
	...
	if (localWorkspace) {
		localWorkspace.assertCurrent();
		(await import("./local-workspace-ChFhJSU8.mjs")).bindLocalSandboxWorkspace(sandboxContext, localWorkspace);
	}
