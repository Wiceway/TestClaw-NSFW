...
import { E as string, _ as literal, b as number, f as boolean, l as _enum, x as object } from "./schemas-qz0osXyE.mjs";
import { d as readPersistedMediaFacts, s as isMeaningfulMediaFact } from "./media-facts-DBEv8hMW.mjs";
import { i as extractFirstTextBlock } from "./chat-message-content-D14VlZZc.mjs";
...
var AssistantChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_CAPS, GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			...
			import("./client-Dv7kbB56.mjs"),
			import("./readiness-CauHmF42.mjs"),
			import("./method-scopes-DvsiuZve.mjs"),
			import("./client-info-e4r6yJba.mjs")
		]);
