...
import { c as shouldSkipRootMemoryAuxiliaryPath, i as resolveCanonicalRootMemoryFile } from "./root-memory-files-CXdmSxyG.mjs";
...
import { o as estimateStructuredEmbeddingInputBytes } from "./markdown-chunks-KGMZtt6f.mjs";
import { a as readRegularFile, c as walkDirectory, n as isFileMissingError, r as isPathInside, s as statRegularFile } from "./fs-utils-CcpRbLb1.mjs";
...
function shouldDescendMemoryEntry(entry, shouldSkipPath) {
	...
	return entry.kind === "directory" && entry.name !== ".testclaw-repair";
}
