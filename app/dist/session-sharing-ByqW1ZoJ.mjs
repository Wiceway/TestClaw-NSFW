...
import { m as resolveConfiguredAgentId, p as resolveAmbientOwnerAgentId, t as AgentSelectionRequiredError } from "./agent-scope-config-Dm8T0OhW.mjs";
...
import { a as sessionMutationTargetFields, i as isSessionProfileDependentMethod, n as isApprovalSessionTargetMethod, r as isRequiredSessionTargetMethod, t as isAgentRunStartMethod } from "./session-method-policy-Bf4wvoIc.mjs";
...
import { f as resolveOperatorRolePolicyForAssignment, n as authorizeGatewaySessionCreation, o as operatorSessionCap, u as resolveGatewayOperatorRoleActor } from "./operator-role-policy-BqKjnbl9.mjs";
import { g as toDatabaseOptions, u as resolveSqliteScope } from "./session-accessor.sqlite-scope-kTo4D2H6.mjs";
import { i as publishSessionEntryCacheCategoryUpdate } from "./session-accessor.sqlite-entry-cache-DuDIqgIP.mjs";
import { r as prepareSessionGroupCategoryMutation, t as applySessionGroupCategoryMutation } from "./session-group-categories.kernel-C7VSsbIj.mjs";
import { q as runSessionCollaborationWrite } from "./session-accessor-CtBBLApI.mjs";
import { n as resolveRequestedSessionAgentId, r as resolveRequestedSessionAgentInput } from "./session-request-agent-CmhrS9-1.mjs";
import { r as resolveSessionStoreIdentity, t as canonicalizeSessionKeyForAgent } from "./session-store-key-GnE6aqPA.mjs";
...
import { s as resolveAuthorizedBoardViewTicketClaims } from "./board-view-ticket-BbZpS9TM.mjs";
import { i as readSessionGroupMembershipInWorker, n as mutateSessionGroupCatalog, r as readSessionGroupCatalog, t as ensureSessionGroupCatalog } from "./session-group-catalog-izaA8_R0.mjs";
