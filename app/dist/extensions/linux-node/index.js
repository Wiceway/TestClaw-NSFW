...
import { T as strictObject, f as boolean } from "../../schemas-qz0osXyE.mjs";
...
import { n as buildPluginConfigSchema } from "../../config-schema-4Av7y654.mjs";
		...
		handle: async (paramsJSON) => {
			...
			const result = await deps.runCommand([
				...
				onOutputChunk: (chunk, stream) => {
					...
					streamedOutput = `${streamedOutput}${chunk.toString("utf8")}`.slice(-65536);
...
const MAX_BASE64_BYTES = 26148864;
