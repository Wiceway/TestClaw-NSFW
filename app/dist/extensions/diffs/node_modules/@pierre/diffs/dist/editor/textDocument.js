...
import { setTextDocumentChangeTransaction } from "./textDocumentChangeTransaction.js";
...
var TextDocument = class TextDocument {
	...
	#editStack;
	#eol;
	constructor(uri, text, languageId = "text", version = 0, editStack = new EditStack(), eol) {
