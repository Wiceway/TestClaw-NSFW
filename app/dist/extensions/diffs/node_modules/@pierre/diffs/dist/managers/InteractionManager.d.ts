...
declare class InteractionManager<TMode extends InteractionManagerMode> {
  ...
  private selectedRangeHighlightSide;
  private selectedRangeLineNumberOnly;
  private editorActiveLine;
  private editorActiveLineSide;
  private editorLineNumberOnly;
  private proposedSelectedRange;
  private renderedSelectedLinesState;
  private renderedEditorActiveLineState;
  ...
  setEditorActiveLine(lineNumber: number | null, { lineNumberOnly, side }?: EditorActiveLineWriteOptions): void;
  ...
  private getSelectionRenderState;
