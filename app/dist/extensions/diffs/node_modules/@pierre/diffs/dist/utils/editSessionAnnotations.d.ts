import { LineAnnotationPosition } from "./lineAnnotationIdentity.js";
//#region src/utils/editSessionAnnotations.d.ts
/**
 ...
 */
interface EditSessionAnnotations<TAnnotation> {
 ...
 * simply dropped.
 */
declare function adoptEditSessionAnnotations<TAnnotation extends LineAnnotationPosition>(annotations: TAnnotation[], getName: (annotation: TAnnotation) => string, previousSession?: EditSessionAnnotations<TAnnotation>): EditSessionAnnotations<TAnnotation>;
/**
 ...
 * they landed.
 */
declare function writeEditSessionAnnotations<TAnnotation extends LineAnnotationPosition>(session: EditSessionAnnotations<TAnnotation>, annotations: TAnnotation[], getName: (annotation: TAnnotation) => string): void;
/**
 ...
 */
declare function resolveEditSessionSlotName<TAnnotation extends LineAnnotationPosition>(session: EditSessionAnnotations<TAnnotation> | undefined, annotation: TAnnotation, getName: (annotation: TAnnotation) => string): string;
//#endregion
export { EditSessionAnnotations, adoptEditSessionAnnotations, resolveEditSessionSlotName, writeEditSessionAnnotations };
//# sourceMappingURL=editSessionAnnotations.d.ts.map