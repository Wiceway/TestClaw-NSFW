import { ChangeTypes, DiffLineAnnotation, FileContents, FileDiffMetadata, Hunk, LineAnnotation, SelectionSide } from "../types.js";
...
interface CapturedDiffSessionState {
 ...
 */
type EditCompletionDecision = 'accept' | 'reject';
interface EditorActiveLineOptions {
  lineNumberOnly?: boolean;
  side?: SelectionSide;
}
type EditorType = 'file' | 'file-diff';
/** Creates an editor whose editor type matches the supplied options. */
type EditorFactory<LAnnotation, Caret> = <EType extends EditorType>(editorType: EType, options: EditorOptions<EType, LAnnotation, Caret>, editStateKey?: string) => Editor<EType, LAnnotation, Caret>;
/**
...
type EditorLineAnnotation<EType extends EditorType = EditorType, LAnnotation = unknown> = EType extends 'file' ? LineAnnotation<LAnnotation> & {
  side?: never;
} : DiffLineAnnotation<LAnnotation>;
/** The document and normalized edits reported after an editor change. */
type EditorChangeEvent<EType extends EditorType, LAnnotation, Caret> = EType extends EditorType ? {
 ...
 */
interface FileEditCompleteEvent<LAnnotation, Caret> {
  file: FileContents;
 ...
 * externally, which a revert keeps.
 */
interface FileDiffEditCompleteEvent<LAnnotation, Caret> {
 ...
 */
type EditorEditCompleteEvent<EType extends EditorType, LAnnotation, Caret> = EType extends 'file' ? FileEditCompleteEvent<LAnnotation, Caret> : FileDiffEditCompleteEvent<LAnnotation, Caret>;
type EditHistoryCoalescingMode = 'insert' | 'backspace' | 'delete';
/** One reversible document transaction. */
interface EditHistoryEntry<EType extends EditorType, LAnnotation = unknown> {
...
interface EditHistoryState<EType extends EditorType, LAnnotation = unknown> {
...
interface FileEditState<LAnnotation = unknown> extends EditStateBase<'file', LAnnotation> {
  type: 'file';
  diffSession?: never;
}
interface FileDiffEditState<LAnnotation = unknown> extends EditStateBase<'file-diff', LAnnotation> {
  type: 'file-diff';
  diffSession: RetainedDiffSessionSnapshot;
}
/**
 ...
 */
type EditState<EType extends EditorType = EditorType, LAnnotation = unknown> = EType extends 'file' ? FileEditState<LAnnotation> : FileDiffEditState<LAnnotation>;
/** State supplied to a new editor, completed from the attached component. */
type EditorInitialState<EType extends EditorType = EditorType, LAnnotation = unknown> = EType extends 'file' ? {
  type: 'file';
} & Partial<Omit<FileEditState<LAnnotation>, 'type'>> : {
  type: 'file-diff';
} & Partial<Omit<FileDiffEditState<LAnnotation>, 'type'>>;
//#endregion
export { CapturedDiffSessionState, CaretMetadata, EditCompletionDecision, EditHistoryCoalescingMode, EditHistoryEntry, EditHistoryState, EditState, EditorActiveLineOptions, EditorCaret, EditorChange, EditorChangeEvent, EditorEditCompleteEvent, EditorFactory, EditorInitialState, EditorLineAnnotation, EditorSelection, EditorType, EditorViewState, EditorViewportState, FileDiffEditCompleteEvent, FileDiffEditState, FileEditCompleteEvent, FileEditState, Position, Range, ResolvedTextEdit, RetainedDiffSessionSnapshot, SelectionDirection, TextEdit };
