...
function getDefaultLineAnnotationName(annotation) {
...
function applyDocumentChangeToLineAnnotations(change, lineAnnotations) {
	...
	for (const annotation of lineAnnotations) {
		if ("side" in annotation && annotation.side === "deletions" || annotation.lineNumber <= 0) {
		...
		if (annotationChanged) {
			if (lineNumber === annotation.lineNumber) nextLineAnnotations.push(annotation);
			else {
				const moved = {
					...annotation,
					lineNumber
...
function renderLineAnnotations(lineAnnotations, contentEl, gutterEl, getName = getDefaultLineAnnotationName) {
	...
	for (const annotation of lineAnnotations) {
		...
		("side" in annotation && annotation.side === "deletions" ? deletionAnnotations : additionAnnotations).get(lineNumber).push(getName(annotation));
	}
		...
		if (lineNumber !== void 0) {
			...
			if (annotations !== void 0) {
				...
				const annotationElement = h("div", {
					dataset: { lineAnnotation: "0," + lineIndex },
					children: [h("div", {
