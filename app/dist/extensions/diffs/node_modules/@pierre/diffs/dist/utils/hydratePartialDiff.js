...
function getLoadedFileCacheKey(oldFile, newFile) {
	if (oldFile != null && newFile != null) return oldFile.cacheKey != null && newFile.cacheKey != null ? composeCacheKey("hydrated-files", oldFile.cacheKey, newFile.cacheKey) : void 0;
