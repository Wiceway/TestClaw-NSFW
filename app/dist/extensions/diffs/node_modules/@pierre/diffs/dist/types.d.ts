 ...
 */
type LineAnnotation<LAnnotation = undefined> = {
  lineNumber: number;
 ...
 */
type DiffLineAnnotation<LAnnotation = undefined> = {
  side: AnnotationSide;
  lineNumber: number;
} & OptionalMetadata<LAnnotation>;
type CodeViewFileItem<LAnnotation = undefined> = {
  id: string;
  type: 'file';
  file: FileContents;
...
type CodeViewDiffItem<LAnnotation = undefined> = {
  id: string;
  type: 'diff';
...
type CodeViewItem<LAnnotation> = CodeViewFileItem<LAnnotation> | CodeViewDiffItem<LAnnotation>;
