...
declare function resolveLineCommentEdits(textDocument: TextDocument, selections: readonly EditorSelection[], token: string): TextEdit[];
...
declare function resolveBlockCommentEdits(textDocument: TextDocument, selections: readonly EditorSelection[], [open, close]: readonly [string, string], linewise?: boolean): BlockCommentEditResult | undefined;
//#endregion
