...
import { readPositiveIntegerParam, readStringParam } from "testclaw/plugin-sdk/param-readers";
import { createWebSearchProviderContractFields } from "testclaw/plugin-sdk/provider-web-search-contract";
...
const loadSearxngClientModule = createLazyRuntimeModule(() => import("./searxng-client-BpbEkR-m.mjs"));
