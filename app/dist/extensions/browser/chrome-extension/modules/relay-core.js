// Pure helpers for the Assistant extension: pairing-string parsing, reconnect
...
export const TESTCLAW_TAB_GROUP_TITLE = "Assistant";
export const ACCESS_MODE_ALL = "all";
export const ACCESS_MODE_SELECTED = "selected";
const EXTENSION_RELAY_PROTOCOL = "testclaw-extension-relay.v2";
...
const UNSUPPORTED_PROXY_PREFIX_HINT =
  "Stored proxy-prefixed browser relay pairing is no longer supported. Re-run `testclaw browser extension pair` with a Gateway URL that has no path prefix.";
...
/**
 * Parse a pairing string printed by `testclaw browser extension pair`.
