...
import { a as getGatewayContextResolver, n as clearGatewayContextResolver, t as bindGatewayContextResolver } from "./gateway-context-binding-VqB7gkMe.mjs";
import { l as withPluginRuntimeRegistryScope } from "./gateway-request-scope-Cys5l4an.mjs";
import { r as createLazyPromiseLoader, t as createLazyImportLoader } from "./lazy-promise-DGqyc4Y4.mjs";
...
import { _t as normalizeAgentRunTerminalReplySnapshot, gt as mergeAgentRunTerminalReplySnapshot } from "./testclaw-state-db-read-connection-BvrNnfuu.mjs";
...
import { C as runWithGatewayIndependentRootWorkContinuation, S as runWithGatewayIndependentRootWorkAdmission, b as runWithGatewayDetachedWorkAdmission, l as isGatewayRestartDrainError, s as getGatewayRestartDrainSignal, t as GatewayDrainingError, u as isGatewayRestartDraining, x as runWithGatewayDetachedWorkContinuation } from "./gateway-work-admission-DeFm4gyw.mjs";
import { f as retireSessionMcpRuntimeForSessionKey } from "./agent-bundle-mcp-manager-api-BNGMxdv8.mjs";
import { c as getAgentRunContext } from "./agent-run-registry-DmVqATcC.mjs";
import { f as onAgentEvent, l as getAgentEventLifecycleGeneration, u as isAgentEventLifecycleGenerationCurrent } from "./agent-events-WwqMA2rD.mjs";
import { c as getPluginRecordRegistry, i as capturePluginLifecycleAuthority } from "./registry-lifecycle-7UsSBpcC.mjs";
...
import { a as registerSystemEventStoreOwner, i as recordSystemEventStoreReplaced, n as isSystemEventStoreCurrent } from "./system-event-ownership-CyDeneYw.mjs";
...
import { g as runExclusiveSessionLifecycleMutation, m as isSessionLifecycleMutationActive } from "./session-lifecycle-admission-8OlXMJli.mjs";
import { w as resolvePhysicalSessionStorePath } from "./session-accessor.sqlite-entry-BgjD5zI-.mjs";
import { p as registerSessionMaintenancePreserveKeysProvider } from "./disk-budget-t8-7rutO.mjs";
import { h as recordSubagentTerminalState } from "./session-state-events-DiPU1ldX.mjs";
import { E as readTaskBackingInstance, N as cloneTaskRecord, S as createSubagentTaskBackingDetail, _t as upsertTaskFlowRowInDatabase, d as readTaskRecord, dt as readTaskFlowRecord, jt as SUBAGENT_KILL_TASK_ERROR, st as bindTaskFlowRecord, t as bindTaskRecord, v as upsertTaskRunRowInDatabase } from "./task-registry.store.kernel-CTpG8C0S.mjs";
import { A as getTaskFlowRegistryStore, _ as prepareTaskMirroredFlowSync, d as getTaskFlowById, v as publishTaskFlowAfterAtomicStore } from "./task-flow-runtime-internal-BwKluq5j.mjs";
import { a as buildAgentRunTerminalOutcomeFromWaitResult, i as buildAgentRunTerminalOutcomeFromLifecycleEvent, t as AGENT_RUN_TERMINAL_RETRY_GRACE_MS } from "./agent-run-terminal-outcome-CoX7DFOi.mjs";
...
import { a as SUBAGENT_ENDED_REASON_ERROR, i as SUBAGENT_ENDED_REASON_COMPLETE, n as SUBAGENT_ENDED_OUTCOME_KILLED, o as SUBAGENT_ENDED_REASON_KILLED } from "./subagent-lifecycle-events-CDQCTuLB.mjs";
import { C as releaseSwarmRun, O as getSubagentRunsForChildSession, S as ownsSwarmRunReservation, b as isSwarmRunActive, c as getSubagentSessionRuntimeMs, f as resolveSubagentRunDeadlineMs, g as bindSwarmRunReservation, i as isStaleUnendedSubagentRun, j as subagentRuns, k as getSubagentRunsForCollectorGroup, l as getSubagentSessionStartedAt, n as hasSubagentRunEnded, p as resolveSubagentRunEffectiveEndedAt, r as isRetainedUnendedSubagentRun, v as enqueueSwarmRun, w as removeQueuedSwarmRun } from "./subagent-run-liveness-BX0M8mQR.mjs";
import { S as normalizeSubagentRunState, _ as getDeliveryAttemptCount, b as isCompletedRequesterDeliveryBlocked, g as ensureDeliveryState, h as ensureCompletionState, m as clearDeliveryState, p as bindSubagentRunRecord, s as readSubagentRun, v as getDeliveryLastError, x as isDeliverySuspended } from "./subagent-registry.store.sqlite-CqHNBudF.mjs";
import { A as persistSubagentRunsToDiskAsyncOrThrow, C as clearSubagentRunsReadCacheForTest, F as publishSubagentRunsAfterAtomicStore, I as restoreSubagentRunsFromDisk, N as prepareSubagentRunsSnapshotForRunIds, O as onSubagentRegistryPersisted, R as SubagentRegistryWriteError, T as getSubagentRunsSnapshotForRead, a as getLatestLiveSubagentRunByChildSessionKey, b as getLatestSubagentRunByChildSessionKeyFromRuns, i as countPendingDescendantRuns, j as persistSubagentRunsToDiskOrThrow, k as persistSubagentRunsToDisk, w as getSubagentMaintenanceRunsSnapshotForRead, x as listSwarmRunsForGroupFromRuns, y as countActiveRunsForSessionFromRuns } from "./subagent-registry-read-PBgGP-fW.mjs";
import { r as upsertSubagentRunRowInDatabase, t as deleteSubagentRunRowInDatabase } from "./subagent-registry.store.kernel-Cs5Cnv2d.mjs";
import { t as isProvisionalSubagentKillTask } from "./task-cancellation-state-phnfX7Hr.mjs";
import "./task-backing-authority-3puosIoc.mjs";
import { t as publishTaskRecordAfterAtomicStore } from "./task-registry-CM3JdjEZ.mjs";
import { n as nextSubagentRunGeneration, r as recordLatestSubagentRun, t as compareSubagentRunGeneration } from "./subagent-run-generation-BpwN1g73.mjs";
import { s as scheduleYieldedSubagentRunProgress } from "./task-registry-progress-BvGy2sM8.mjs";
import "./runtime-internal-CxjcW5l2.mjs";
import { a as finalizeTaskRunByRunId, d as startTaskRunByRunId, m as createQueuedTaskRunCoreWithReceiptAsync, n as createQueuedTaskRun, o as findDetachedTaskRun, r as createRunningTaskRun, s as getDetachedTaskLifecycleRuntime } from "./detached-task-runtime-BbgsXm9e.mjs";
...
import { i as shouldSuppressSubagentRecoverySessionEffects } from "./subagent-recovery-state-QSAu697-.mjs";
...
import { n as resolveSubagentRequesterAgentId, t as backfillSubagentRequesterAgentIds } from "./subagent-requester-owner-C9qFGVs7.mjs";
import { t as captureOperatorToolGatewayContinuationContext } from "./server-plugin-in-process-dispatch-DLEJEMN0.mjs";
import { A as safeRemoveAttachmentsDir, B as emitSubagentProgressEndedHook, C as ANNOUNCE_COMPLETION_HARD_EXPIRY_MS, D as logAnnounceGiveUp, H as resolveKilledSubagentTaskEndedAt, O as persistSubagentSessionTiming, S as safeSetSubagentTaskDeliveryStatus, T as MIN_ANNOUNCE_RETRY_DELAY_MS, U as resolveLifecycleOutcomeFromRunOutcome, _ as markRequesterSettleWakePending, a as reconcileRetiredSubagentCancellation, b as refreshFrozenResultFromSession$1, c as buildSafeLifecycleErrorMeta, d as finalizeSubagentTaskRun, f as formatAnnounceDeliveryError, g as markPendingFinalDelivery, h as loadPendingFinalDeliveryPayload, j as updateSubagentArchiveAtMs, k as resolveAnnounceRetryDelayMs, l as clearSubagentPendingDelivery, m as hasPriorRequesterDeliveryMirror, o as settleRequesterCompletionBatch, p as freezeRunResultAtCompletion, r as blockSubagentCompletionDelivery, u as emitCompletionEndedHookIfNeeded, v as maskLifecycleIdentifier, w as ANNOUNCE_EXPIRY_MS, x as refreshPendingFinalDeliveryPayload, y as recordAnnounceDeliveryResult, z as emitSubagentEndedHookOnce } from "./subagent-completion-admission.store-JZXyb7da.mjs";
import { n as sanitizeForPromptLiteral, r as wrapPromptDataBlock } from "./sanitize-for-prompt-bzCyHFCH.mjs";
import { a as resolveSubagentSessionCompletion, i as resolveSubagentRunOrphanReason, n as loadSubagentSessionEntry, o as resolveSubagentSessionStartedAt, r as resolveCompletionFromSessionEntry } from "./subagent-session-reconciliation-C2qpA4o0.mjs";
import { a as terminateAcceptedCollectorRun, c as readGatewayRunId, f as applySubagentLaunchAuthorization, h as deleteSubagentSessionForCleanup, i as retrySubagentCleanup } from "./subagent-spawn-cleanup-BxKO7XTM.mjs";
import { r as removeInternalSessionEffectsSession } from "./internal-session-effects-D9jqbAWF.mjs";
import { c as promoteRequesterCronAuthority, d as revokeRequesterCronAuthorityBatch, i as revokeRequesterFinalAttachment, l as replaceRequesterCronAuthorityEntry, n as promoteRequesterFinalAttachment, o as captureRequesterCronAuthority } from "./requester-final-attachment-BCiO2yoi.mjs";
import { f as withSubagentOutcomeTiming, p as classifySubagentTerminalOutcome } from "./subagent-announce-output-CuAFUNfG.mjs";
import { t as captureTaskProgressContinuationForRequesterTurn } from "./task-progress-requester-EbUzNq5h.mjs";
import { r as waitForAgentRun } from "./run-wait-65OZ7ug0.mjs";
import { t as resolveSwarmConfig } from "./swarm-config-CB3czZI3.mjs";
import { i as isRetiredSubagentSessionOwner } from "./subagent-registry-restart-recovery-helpers-BuUOxVy-.mjs";
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-BlrpG6DO.mjs"));
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-B-U3tMWA.mjs"));
...
const subagentRegistryPluginRuntimeLoader = createLazyPromiseLoader(() => import("./runtime-plugins-D5F_Pnik.mjs"));
...
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-B-U3tMWA.mjs"));
	...
	async function leasePendingAgentSteeringItems(params) {
		...
		const leased = await leasePendingAgentSteeringItemsFromSubagentRuns({
			...
			readResult: async (entry) => {
				const { readSubagentRunAnnounceResult } = await import("./subagent-announce-output-CSdrmrMg.mjs");
...
const restartRecoveryLoader = createLazyImportLoader(() => import("./subagent-registry-restart-recovery-bhr3rmIJ.mjs"));
...
const subagentLifecycleController = new SubagentLifecycleController({
	...
	maybeWakeRequesterAfterAllChildrenSettled: async (args) => subagentRestorer.canResumeWakes() ? (await import("./subagent-announce.requester-settle-wake-CREvtVc1.mjs")).maybeWakeRequesterAfterAllChildrenSettled(args) : false,
	warn: (message, meta) => log.warn(message, meta)
});
