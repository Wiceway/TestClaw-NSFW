...
import { a as isLoopbackAddress, n as hasForwardedRequestHeaders, x as resolveRequestClientIpFromHeaders } from "./net-D6MXMoHn.mjs";
import { f as buildRateLimitIdentityKey, l as AUTH_RATE_LIMIT_SCOPE_WATCH_CHALLENGE, o as AUTH_RATE_LIMIT_SCOPE_NODE_PAIRING } from "./auth-rate-limit-Dk5g5GeL.mjs";
...
import { _h as formatValidationErrors, ot as validateConnectParams } from "./src-BNV0SJoP.mjs";
import "./method-scopes-Cn-bBRCy.mjs";
import { d as isVoiceNodePairingSetupBootstrapProfile, u as isNodePairingSetupBootstrapProfile } from "./device-bootstrap-profile-CLBYuPAv.mjs";
import { o as resolveNodePairingState } from "./device-pairing-identity-CHXMzbKB.mjs";
import { t as getPairedDevice, u as requestDevicePairing } from "./device-pairing-_TqsO6HW.mjs";
import { f as requestNodePairing, n as beginNodePairingConnect, o as recordPairedNodeConnection, r as finalizeNodePairingCleanupClaim, s as recordPairedNodeDisconnection, t as approveNodePairing, u as releaseNodePairingCleanupClaim } from "./device-pairing-node-B8qqDaPQ.mjs";
import { t as resolveEffectiveComputerUseDescriptor } from "./node-computer-use-descriptor-D_tS4bop.mjs";
import { t as approveBootstrapDevicePairing } from "./device-pairing-approval-DOeuWLWv.mjs";
import { d as redeemDeviceBootstrapTokenProfile, f as restoreGenericDeviceBootstrapToken, m as verifyDeviceBootstrapToken, o as getBoundDeviceBootstrapProfile } from "./device-bootstrap-CiR_v_ui.mjs";
import { i as verifyDeviceToken } from "./device-pairing-tokens-DOl0ZhuD.mjs";
import { a as readJsonBodyOrError, c as sendJson, d as sendRateLimited, f as sendUnauthorized, l as sendMethodNotAllowed, s as sendInvalidRequest } from "./http-common-BRkymMwR.mjs";
import { t as captureAuthenticatedNodePairingState } from "./device-pairing-node-state-DKmocNzo.mjs";
import { a as consumeSetupHandoff, i as confirmSetupHandoffDelivery, l as resolveDeviceSignaturePayloadVersion, n as broadcastSetupHandoffCompletion, o as resolveConnectAuthDecision, r as broadcastSetupHandoffDeliveryUncertain, t as reconcileNodePairingOnConnect } from "./node-connect-reconcile-Ctrzxz0E.mjs";
