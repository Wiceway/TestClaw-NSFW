...
import { o as isDefaultInstallIdentity, v as resolveGatewayPort, x as resolveIsNixMode } from "./paths-DvpAEtA8.mjs";
...
import { n as NON_DEFAULT_INSTALL_SERVICE_SKIP_REASON, r as assertGatewayServiceMutationAllowed } from "./gateway-supervision-C0zD4p1G.mjs";
...
import { b as isSystemdUnitActive } from "./systemd-service-files-DD3GZ5qW.mjs";
...
import { b as isLaunchctlNotLoaded, v as execLaunchctl } from "./launchd-service-files-l5nKWe5c.mjs";
import { a as hasGatewayServiceLauncherOverride, i as hasGatewayServiceEnvironmentOverride, o as resolveManagedGatewayServiceCommand, t as assertServiceDefinitionWritable } from "./service-types-D9NIqD52.mjs";
import { n as inspectGatewayServiceInstallationDrift, s as summarizeGatewayServiceLayout } from "./service-layout-Vt9OJt8Q.mjs";
import { n as inspectGatewayHeapLimit, t as formatGatewayHeapLimitReport } from "./gateway-heap-CvYpsifa.mjs";
import { t as TESTCLAW_WRAPPER_ENV_KEY } from "./program-args-BDOZSKCy.mjs";
import { c as normalizeServiceEnvKey, d as readManagedServiceEnvKeysFromEnvironment } from "./service-managed-env-5yO_H6vS.mjs";
import { t as buildGatewayInstallPlan } from "./daemon-install-helpers-BAlp8qLD.mjs";
import { t as SERVICE_PROXY_ENV_KEYS } from "./service-env-Bks-WiHT.mjs";
import { a as resolveNodeRuntimeInfo, l as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-JnRsn5WM.mjs";
import { i as resolveGatewayDaemonRuntime } from "./daemon-runtime-D15REPfs.mjs";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-WgoSnoBo.mjs";
import { a as readDaemonRuntimePin } from "./runtime-pin-state-DHDrmeuf.mjs";
import { a as readEmbeddedGatewayToken, i as needsNodeRuntimeMigration, n as auditGatewayServiceConfig, t as SERVICE_AUDIT_CODES } from "./service-audit-c2T0LJAF.mjs";
...
import { i as findSystemdGatewayInstallation, o as isSystemUnitActiveAndEnabled } from "./systemd-scope-DJVah67a.mjs";
import { c as uninstallLegacySystemdUnits, l as uninstallUserSystemdGatewayUnit } from "./systemd-C14FU_go.mjs";
import { a as formatGatewayServiceInstallationDrift } from "./shared-C9jIJw7D.mjs";
import { i as renderGatewayServiceCleanupHints, n as findExtraGatewayServices } from "./inspect-D_yWG_q0.mjs";
import { t as note } from "./note-BvG46svB.mjs";
import { a as isServiceRepairDeferred, i as formatServiceRepairDeferredNote, l as shouldManageGatewayService, r as confirmDoctorServiceRepair, s as resolveServiceRepairPolicy } from "./doctor-service-repair-policy-BIWEOO8f.mjs";
	...
	try {
		const install = async (assertCurrent = params.maintenance?.assertCurrent) => {
			...
			if (params.repair.kind === "definition") {
				const { reconcileGatewayServiceDefinition } = await import("./service-reconciliation-DblTXnSD.mjs");
...
async function assertGatewayServiceInstallationRepairAllowed(params) {
	const { inspectManagedGatewayServiceBeforeUpdate, GATEWAY_SERVICE_INSPECTION_WARNING } = await import("./update-command-service-plan-DtIHd7Kk.mjs");
