...
import { A as parseAgentSessionKey, S as isSubagentSessionKey, x as isCronSessionKey } from "./session-key-C_bfgyCp.mjs";
...
import { v as onTrustedToolExecutionEvent } from "./diagnostic-events-C4sEV9aC.mjs";
...
import { T as runWithRetainedGatewayRootWork, m as onGatewaySuspendAdmissionChange } from "./gateway-work-admission-DeFm4gyw.mjs";
import { a as clearAgentRunContext, c as getAgentRunContext, l as getAgentRunContextOwnerStatus, u as getAgentRunContextOwnership } from "./agent-run-registry-DmVqATcC.mjs";
import { b as createAgentRunStaleLifecycleError, d as onAgentAuditEvent, m as onAgentRuntimeEvent } from "./agent-events-WwqMA2rD.mjs";
...
import { u as onHeartbeatEvent } from "./system-event-ownership-CyDeneYw.mjs";
import { o as createChannelAdmissionAudit } from "./admission-evidence-D42R2X7S.mjs";
import { _ as bumpGatewayAccessRevision } from "./operator-role-policy-BqKjnbl9.mjs";
import { n as findErrorProperty } from "./error-ON38hPhx.mjs";
import { o as waitForSessionTranscriptProjection } from "./session-transcript-reconcile-DCABr_1E.mjs";
import { i as onSessionLifecycleEvent, r as onSessionIdentityMutation } from "./session-lifecycle-events-BReqLf0S.mjs";
import { m as isSessionLifecycleMutationActive } from "./session-lifecycle-admission-8OlXMJli.mjs";
...
import { n as extractAssistantTextForPhase, t as extractAssistantPhaseText } from "./chat-message-content-D14VlZZc.mjs";
...
import { a as tryResolveSessionCompatibilityOwnerAgentId, i as resolveSessionEventAgentScope, o as resolveSessionSubscriptionKey, s as resolveSessionSubscriptionKeys } from "./session-request-agent-CmhrS9-1.mjs";
import { a as resolveStoredSessionKeyForAgentStore, i as resolveSessionStoreKey } from "./session-store-key-GnE6aqPA.mjs";
import { a as readSessionTranscriptActivePathEntryRelation, s as readSessionTranscriptBoundedMessageTailPage } from "./session-accessor.sqlite-active-events-CM5yNO6K.mjs";
import { n as isExecutionIdentityCollectionEnabled, r as resolveAuditMessageMode, t as isAuditLedgerEnabled } from "./audit-config-BXFCjLO0.mjs";
import { t as configureExecutionIdentityAdmissionSink } from "./execution-identity-admission-BmYUbdZ8.mjs";
import { P as cloneTaskRecordForObserver } from "./task-registry.store.kernel-CTpG8C0S.mjs";
import { r as isTerminalTaskStatus } from "./task-registry.types-CkM1jc3D.mjs";
import { t as AGENT_RUN_TERMINAL_RETRY_GRACE_MS } from "./agent-run-terminal-outcome-CoX7DFOi.mjs";
...
import { m as resolveModelFallbackError } from "./failover-error-CLjp2PNc.mjs";
import { i as resolveRetryAfterMs, r as hasLongWindowRateLimitEvidence } from "./retry-evidence-DWhfdHWB.mjs";
import { r as onTrustedMessageAuditEvent } from "./message-audit-events-r-sGQykK.mjs";
import { t as configureExecutionDecisionWorkSink } from "./execution-decision-work-5_EchQMd.mjs";
import { c as removeChatAbortControllerEntry, m as markChatAbortTerminalPersistenceError, p as bindChatAbortTerminalDispatch } from "./chat-abort-CNLBLnF-.mjs";
...
import { F as projectSessionActivitySummary, I as sessionActivitySummaryOwnerIsCurrent, L as setSessionActivitySummaryState, P as activitySummaryScope } from "./session-row-prepared-read-B632AuGn.mjs";
...
import { t as configureMessageActionDecisionSink } from "./message-action-decision-wVLVKnHm.mjs";
import { i as terminalHealthFor, n as flushSessionActivityAssistantNote, r as noteSessionActivityEvent, t as createSessionActivityNoteState } from "./session-activity-notes-RzXpuDEd.mjs";
import { a as sanitizeProgressStatusText } from "./progress-draft-status-text-BUbtefrl.mjs";
import { n as captureAgentRunTerminalWriteContext } from "./agent-run-terminal-writes-VoDFnMIA.mjs";
import { n as onGatewaySessionReset } from "./session-reset-notifications-CCxqHwFT.mjs";
import { t as createAuditEventRecorder } from "./audit-recorder-DAzFW-Ni.mjs";
import { i as persistGatewaySessionLifecycleEvent, t as buildGatewaySessionSnapshot } from "./session-event-payload-C6MsfOsM.mjs";
import { a as defaultPersistDigest, c as isSameSessionObserverLifecycle, d as rememberSessionObserverDisabledRun, f as rememberSessionObserverDormantRun, g as synthesizeSessionObserverTerminalDigest, h as sessionObserverScopeKey, i as defaultCompleteModel, l as markSessionObserverRunSuperseded, m as resolveSessionObserverDigestForLifecycle, n as buildSessionObserverPrompt, o as defaultPrepareModel, p as rememberSessionObserverRevisionFloor, r as createDormantSessionObserverRun, s as defaultReadSession, t as SESSION_OBSERVER_SYSTEM_PROMPT, u as normalizeSessionObserverModelOutput } from "./session-observer-model-XuqiMPWH.mjs";
import { o as resolveTaskRequesterSessionTarget, t as mapTaskSummary } from "./task-summary-CXJRX-6I.mjs";
import { n as createSessionCompanionAskRuntime } from "./session-companion-ask-BQyKudu-.mjs";
...
function startGatewayTaskSubscriptions(params) {
	...
	let pendingClose;
	const registered = Promise.all([import("./task-registry.store-BJVIZPJc.mjs"), import("./task-backing-authority-C9aXiTGO.mjs")]).then(([runtime, { readTaskBackingInstance }]) => {
...
async function broadcastSessionActivitySummary(target, params) {
	...
	if (projection) {
		const { withReadySessionRows } = await import("./session-row-prepared-read-BzHaZieB.mjs");
...
function startGatewayEventSubscriptions(params) {
	...
	const getSessionKeyModule = createLazyPromise(() => import("./server-session-key-B33v38vM.mjs"), { cacheRejections: true });
	const agentEventHandlerLoader = createLazyPromiseLoader(() => {
		return Promise.all([import("./server-chat-DxoG8LU4.mjs"), getSessionKeyModule()]).then(([{ createAgentEventHandler }, { resolveSessionKeyForRun }]) => createAgentEventHandler({
	...
	const getSessionEventsModule = createLazyPromise(() => import("./server-session-events-D5Q3xRJ-.mjs"), { cacheRejections: true });
