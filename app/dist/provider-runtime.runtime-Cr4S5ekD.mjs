...
import { n as createLazyRuntimeMethodBinder } from "./lazy-runtime-BPNHa36e.mjs";
...
const providerRuntimeLoader = createLazyImportLoader(() => import("./provider-runtime-CHNSC8WG.mjs"));
