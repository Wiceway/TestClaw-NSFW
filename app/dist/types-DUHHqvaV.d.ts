import { c as ModelProviderConfig, r as TestclawConfig } from "./types.testclaw-C-wX50Nb.js";
import { f as SecretRef } from "./types.secrets-BR-Cncxg.js";
...
declare const LEGACY_OAUTH_REF_SOURCE = "testclaw-credentials";
...
/** Static token credential that Testclaw does not refresh. */
type TokenCredential = {
  /**
   * Static bearer-style token (often OAuth access token / PAT).
   * Not refreshable by Testclaw (unlike `type: "oauth"`).
   */
  type: "token";
  provider: string;
  token?: string;
