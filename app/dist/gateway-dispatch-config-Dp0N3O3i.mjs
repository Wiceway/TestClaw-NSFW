...
import { l as resolveConfigIncludes, s as readConfigIncludeFileWithGuards } from "./includes-BmaVsPnI.mjs";
...
import { t as applyConfigEnvVars } from "./config-env-vars-DSeyJ5Sb.mjs";
...
async function readGatewayDispatchConfigWithShellEnvFallback(options = {}) {
	...
	const { loadShellEnvFallback, resolveShellEnvFallbackTimeoutMs, shouldDeferShellEnvFallback, shouldEnableShellEnvFallback } = await import("./shell-env-4Bp3Z0MM.mjs");
