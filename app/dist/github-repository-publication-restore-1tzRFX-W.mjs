...
import { f as retryableGitNetworkOperation, p as withGitNetworkRetry, s as gitNullConfigPath } from "./git-exec-0cc0Upnj.mjs";
import { c as splitNullBuffer } from "./git-path-inventory-sE4y6-Mm.mjs";
import { a as GitHubPublicationWorkflowChangesError, n as GitHubPublicationKnownFailure } from "./github-publication-failure-B1jd4XaP.mjs";
import { n as NODE_WORKER_WORKSPACE_STDIN_MAX_BYTES } from "./node-workspace-protocol-Npg4AxJH.mjs";
import { c as githubPublicationUnsafeConfigArgs, i as GITHUB_PUBLICATION_CONFIG_GUARD_JS, r as readGitHubRepositoryPublicationMetadata } from "./github-repository-publication-snapshot-DtG9fxxv.mjs";
...
async function captureGitHubPublicationWorkspaceSnapshot(params) {
	...
	return await withSettledLocalWorkspacePath(params, async (custody) => {
		...
		const [{ findLiveRegistryWorktreeByPath }, { withManagedWorktreeGit }, { getRuntimeConfig }] = await Promise.all([
			import("./registry-BJcSYYUU.mjs"),
			import("./checkout-policy-DPx6r_Y_.mjs"),
