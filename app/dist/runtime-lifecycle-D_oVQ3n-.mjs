...
import { c as registerUnhandledRejectionHandler } from "./unhandled-rejections-C1I3eiY5.mjs";
...
import { d as markBrowserRuntimeStopping, r as beginProfileTransition } from "./server-context.lifecycle-DB6cINxT.mjs";
import "./config-D1wodu3O.mjs";
import { r as sweepTrackedBrowserTabs } from "./session-tab-registry-CGBqDqyq.mjs";
...
async function stopKnownBrowserProfiles(params) {
	...
	if (failed?.status === "rejected") {
		params.onWarn(`testclaw browser stop failed: ${String(failed.reason)}`);
		throw failed.reason;
	}
}
//#endregion
...
/**
* Periodic cleanup for browser tabs tracked to primary Assistant sessions.
*/
