...
import { i as isGatewayRpcUnavailableError } from "./transport-error-BJi8D8Qw.mjs";
import { s as getActiveAgentRunDelegatedAuthority } from "./agent-run-registry-DmVqATcC.mjs";
...
import "./session-lifecycle-events-BReqLf0S.mjs";
import "./session-accessor-CtBBLApI.mjs";
import { m as resolveSubagentRunTimerDelayMs } from "./subagent-run-liveness-BX0M8mQR.mjs";
import "./session-binding-service-Bi4qYPkN.mjs";
import { i as getGatewayToolCallerIdentity } from "./gateway-caller-context-CxCRBFJ-.mjs";
import "./lifecycle-DX3moz6p.mjs";
import "./session-fork-BNbaLDv1.mjs";
import { i as resolveSandboxConfigForAgent } from "./config-DBSLaQuW.mjs";
import "./runtime-status-B6-CxN9_.mjs";
import { l as withAgentRuntimeExecutionLineage } from "./agent-runtime-identity-token-Be6SZrKX.mjs";
import { c as runWithGatewaySessionSpawnContext, s as runWithGatewaySessionSpawnParentExecutionIdentity, t as callGatewayTool } from "./gateway-DOSiCmYl.mjs";
import { t as bindGatewayLifecycleRequest } from "./server-recovery-runtime-context-DoAnlrSa.mjs";
import "./init-C-zIFIaU.mjs";
import { l as withInProcessAgentRuntimeIdentity, n as dispatchGatewayMethodInProcess } from "./server-plugin-in-process-dispatch-DLEJEMN0.mjs";
import "./sessions-helpers-CfUZs9xt.mjs";
import { M as cleanupMaterializedSubagentAttachments, N as removeSubagentAttachmentTree } from "./subagent-completion-admission.store-JZXyb7da.mjs";
import { i as wrapUntrustedPromptDataBlock, t as hasPromptUnsafeControlCharacter } from "./sanitize-for-prompt-bzCyHFCH.mjs";
import { n as resolveSubagentAttachmentDir, r as resolveSubagentSessionAttachmentRootDir, t as SANDBOX_SUBAGENT_ATTACHMENTS_MOUNT } from "./subagent-attachment-paths-BGHKYqZ0.mjs";
import { n as getSandboxBackendCapabilities } from "./backend-Bn6ah0ml.mjs";
...
import "./model-runtime-choice-CkEzKuMa.mjs";
