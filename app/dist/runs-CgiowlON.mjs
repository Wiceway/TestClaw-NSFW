...
import { c as getAgentRunContext, s as getActiveAgentRunDelegatedAuthority } from "./agent-run-registry-DmVqATcC.mjs";
...
import { d as getAttachedBackend, f as hasCommittedReplyOperationOutcome, p as hasReplyOperationExecutionStarted, u as forceClearReplyOperation } from "./reply-run-registry.state-0DtmpREE.mjs";
...
import { a as ACTIVE_EMBEDDED_RUNS_BY_RUN_ID, c as ACTIVE_EMBEDDED_RUN_SESSION_IDS_BY_KEY, d as EMBEDDED_RUN_FORCED_TERMINAL_SETTLEMENTS, f as EMBEDDED_RUN_WAITERS, g as setActiveEmbeddedRunLifecycleGeneration, h as resolveActiveEmbeddedRunRecoveryBlocker, i as ACTIVE_EMBEDDED_RUNS, l as ACTIVE_EMBEDDED_RUN_SNAPSHOTS, n as ABANDONED_EMBEDDED_RUN_SESSION_IDS_BY_FILE, o as ACTIVE_EMBEDDED_RUN_REGISTRATIONS, p as RETAINED_EMBEDDED_RUN_ABORTABILITY_RUN_IDS, r as ABANDONED_EMBEDDED_RUN_SESSION_IDS_BY_KEY, s as ACTIVE_EMBEDDED_RUN_SESSION_IDS_BY_FILE, t as ABANDONED_EMBEDDED_RUNS_BY_SESSION_ID, u as EMBEDDED_RUN_COMPLETION_CLAIMS } from "./run-state-0_sahEHT.mjs";
import { a as getDiagnosticSessionActivitySnapshot, c as markDiagnosticEmbeddedRunEnded, d as markDiagnosticRunProgress, l as markDiagnosticEmbeddedRunStarted, o as isDiagnosticEmbeddedRunOwnerClosed, y as resolveRunStaleThresholdMs } from "./diagnostic-run-activity-CdSzto1l.mjs";
import { D as resolveReplyBackendQueueMessageMismatch, _ as resolveActiveReplyRunSessionId, a as expireStaleReplyRunBySessionId, b as waitForReplyOperationOwnerSettlement, d as isReplyRunEvidenceStaleBySessionId, f as listActiveReplyRunSessionIds, g as resolveActiveReplyOperationForSessionId, l as isReplyRunAbortableForCompaction, n as abortReplyRunBySessionId, t as abortActiveReplyRuns, u as isReplyRunActiveForSessionId, x as waitForReplyRunEndBySessionId, y as supersedeReplyRunByRunId } from "./reply-run-registry.registry-CVdu99y8.mjs";
import { a as logMessageQueuedWithBacklogPolicy, t as diagnosticLogger } from "./diagnostic-runtime-3y1N7Ewl.mjs";
import "./reply-run-registry-C6CtjXiK.mjs";
import { o as logSessionStateChange } from "./diagnostic-CjDzLGgv.mjs";
import { t as resolveSessionPlacementForcedTerminalSettlement } from "./session-placement-forced-terminal-settlement-5I2_k7jG.mjs";
