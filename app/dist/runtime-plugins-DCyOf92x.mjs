...
import { i as projectRuntimeChangesOntoSource, n as projectConfigOntoRuntimeSourceSnapshot } from "./runtime-source-projection-0J6vD_nm.mjs";
import { d as isPluginRecordActive, h as isPluginRegistryRetired, i as capturePluginLifecycleAuthority, r as bindPluginRegistryResourceOwner, u as getPluginRegistryResourceOwner } from "./registry-lifecycle-7UsSBpcC.mjs";
import { f as getActivePluginRegistryWorkspaceDir, l as getActivePluginRegistry } from "./runtime-D1tHq7F4.mjs";
...
import { a as listRuntimePluginIdsFromRegistry, i as listLoadedRuntimePluginIds, o as registryContainsRuntimePluginIds, t as createRuntimePluginManifestLookup } from "./active-runtime-registry-CFUp_yLA.mjs";
import { f as getPluginRegistryInspectionResources, g as adoptRuntimeContextEngineRegistrations, m as collectRegistryInvocationInstances, p as PluginInvocationScope } from "./registry-BPMvk3sV.mjs";
import { r as getPluginRuntimeLoadContext } from "./load-context-CEKyQMyt.mjs";
import { a as resolveAgentRuntimePluginSelections, i as resolveAgentRuntimePluginLoadPlan } from "./runtime-plugin-load-plan-VA_wFpYQ.mjs";
import { n as loadPluginRegistryHandle } from "./loader-Dvu_qkfz.mjs";
import { t as adoptRuntimeMemoryRegistrations } from "./memory-state-CqnusXLv.mjs";
...
async function withAgentPluginRegistry(params) {
	...
	const [{ setPluginRuntimeLoadContext }, { resolvePluginRuntimeLoadContext }] = await Promise.all([import("./load-context-CudHorL2.mjs"), import("./load-context.resolve-CZZxgTHg.mjs")]);
