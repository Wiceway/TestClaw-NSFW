...
import { r as getSelfAndAncestorPidsSync, t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-CLokJIf8.mjs";
import { l as readLockPayloadSync, u as resolveGatewayLockPaths } from "./gateway-lock-CMKMxZa9.mjs";
import { n as resolveLaunchAgentLabel, t as assertValidLaunchAgentLabel } from "./launchd-label-DPsML32p.mjs";
...
import { c as withGatewayServiceInstallationRecovery, i as assertGatewayServiceUpdateCurrent, o as isUpdateOwnedGatewayServiceCommand } from "./service-update-authority-p1W3yDaI.mjs";
...
import { a as prepareGatewayRestartIntentLegacyProcess, c as GatewayRestartPreparationError, s as writeGatewayServiceRestartIntentSync } from "./restart-intent-DaD-IiMo.mjs";
import { n as scheduleDetachedLaunchdRestartHandoff, t as scheduleDetachedLaunchdMaintenancePark } from "./launchd-restart-handoff-CKfIfSke.mjs";
...
async function stopLaunchAgent({ stdout, env, disable: persistDisable, onMutation, assertCurrent, updateHandoff }) {
	...
	const assertStopCurrent = async () => {
		...
		if (insideService || transferred || updateOwned && intentEnv.TESTCLAW_UPDATE_RUN_HANDOFF === "1") {
			if (!(updateOwned && updateHandoff && await (await import("./update-managed-service-handoff-CcGc5GeR.mjs")).isCurrentManagedServiceUpdateHandoffProcess({
				...updateHandoff,
				env: intentEnv
...
//#endregion
export { startLaunchAgent as a, uninstallLaunchAgent as c, restartLaunchAgent as i, parkCurrentLaunchAgentForMaintenance as l, findStaleAssistantUpdateLaunchdJobs as n, installLaunchAgent as o, repairLaunchAgentBootstrap as r, stageLaunchAgent as s, disableCurrentAssistantUpdateLaunchdJob as t, stopLaunchAgent as u };
