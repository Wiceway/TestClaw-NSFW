...
import { C as tryResolveAmbientOwnerAgentId, a as resolveAgentDir, d as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-Dm8T0OhW.mjs";
import { A as parseAgentSessionKey, x as isCronSessionKey } from "./session-key-C_bfgyCp.mjs";
...
import { _t as normalizeAgentRunTerminalReplySnapshot, ht as buildAgentRunTerminalReplySnapshot } from "./testclaw-state-db-read-connection-BvrNnfuu.mjs";
import { i as isSilentReplyPayloadText, n as SILENT_REPLY_TOKEN } from "./tokens-BaiqOb60.mjs";
...
import { _ as resolveHooksGmailModel, h as resolveConfiguredModelRef, m as resolveConfiguredModelPolicyAllow, s as getModelRefStatus } from "./model-selection-shared-DIVgwazZ.mjs";
import { x as resolveSubagentModelConfigSelectionResult } from "./agent-scope-_30Scclc.mjs";
...
import { b as releaseAgentRunContext, o as consumeCronNextCheckProposal, r as claimAgentRunContext } from "./agent-run-registry-DmVqATcC.mjs";
import { l as getAgentEventLifecycleGeneration, t as assertAgentRunLifecycleGenerationCurrent, y as withAgentRunLifecycleGeneration } from "./agent-events-WwqMA2rD.mjs";
...
import { l as resolveCreatorSandbox } from "./operator-role-policy-BqKjnbl9.mjs";
...
import { a as isAgentHarnessSessionKey, n as AGENT_HARNESS_SESSION_ID_LOCKED_MESSAGE, r as AGENT_HARNESS_SESSION_KEY_RESERVED_MESSAGE } from "./agent-harness-session-key-J-d5OkuD.mjs";
import { i as resolveSessionRuntimeOverrideForProvider } from "./session-runtime-compat-D2C-wPbw.mjs";
import { i as normalizeThinkingCatalogProviders, o as resolveEffectiveAgentRuntime, r as needsThinkHydration } from "./thinking-runtime-CNDwCWtd.mjs";
...
import { l as loadResolvedPublishedModelCatalogOwner, o as loadProviderScopedThinkingCatalog } from "./prepared-model-catalog-iMxpdaVw.mjs";
...
import { a as hasBillableUsage, i as deriveSessionTotalTokens, n as deriveContextPromptTokens, o as hasNonzeroUsage } from "./usage-DsWbmzqR.mjs";
import { m as resolveAgentRunErrorLifecycleFields, o as createAgentRunRestartAbortError } from "./run-termination-Cf8kcgMU.mjs";
...
import { i as normalizeCronRunErrorText, o as resolveCronAbortReasonText } from "./execution-errors-DEOtK1PO.mjs";
...
import { t as hasAcceptedSessionSpawn } from "./accepted-session-spawn-CRPngSCf.mjs";
...
import { n as resolveSourceDeliveryOutcome } from "./source-delivery-plan-SGz_ftxr.mjs";
import { t as createAgentLifecycleTerminalBackstop } from "./agent-lifecycle-terminal-218cTt0y.mjs";
...
import { i as mergeCronRunDiagnostics, n as createCronRunDiagnosticsFromError, t as createCronRunDiagnosticsFromAgentResult } from "./run-diagnostics-C81CKkyf.mjs";
...
import { t as cleanupCronRunSessionAfterRun } from "./session-cleanup-B8otXCxD.mjs";
import { t as classifyCronAgentTurnShellPrompt } from "./agent-turn-command-prompt-BL5zsw0r.mjs";
import { t as CronExecutionRootRuntimeError } from "./execution-root-runtime-DSaHRVG3.mjs";
import { c as createCronToolsAllowPreflightDiagnostics, d as resolveCronChannelOutputPolicy, l as loadCronDeliveryRuntime, n as resolveCronPreflight, s as buildCronDeliveryTrace, u as resolveCronDeliveryContext } from "./run-fallback-policy-45oOsY2P.mjs";
import { a as markCronSessionPreRun, c as resolveCronLifecycleRevisionIdentity, i as createPersistCronSessionEntry, l as setCronSessionAgentHarnessId, m as resolveCronPayloadOutcome, n as adoptCronRunSessionMetadata, o as persistCronSkillsSnapshotIfChanged, r as createCronRunContinuationSession, s as projectCronOwnershipFields, t as CronSessionLifecycleClaimError, u as setCronSessionRuntimeModel } from "./run-session-state-BRJNYW1D.mjs";
import { n as resolveCronAgentConfig, t as resolveCronActiveRuntimeConfig } from "./run-config-wCDg5a6u.mjs";
import { n as prepareCronSession, t as loadCronSessionEntryLatest } from "./session-CRuWLLO0.mjs";
...
async function recordCronRunUsage(params) {
	...
	const { estimateAggregateUsageCost, resolveModelCostConfig } = await import("./usage-format-DXByGGpm.mjs");
...
const sessionAccessorRuntimeLoader = createLazyImportLoader(() => import("./session-accessor-BamJc7_g.mjs"));
...
async function prepareCronRunContext(params) {
	...
	const workspaceDir = (await ensureAgentWorkspace({
		...
		provisioning: await (await import("./acp-workspace-provisioning-D3uDffXu.mjs")).resolveAcpAgentWorkspaceProvisioningForTurn({
			cfg: runtimeCfg,
			agentId
		})
	})).dir;
