...
import { o as loadOriginDeviceToken } from "./device-auth-store-CpeaaLlm.mjs";
...
import { n as isListedTuiSession } from "./tui-session-list-policy-IAjHU3PR.mjs";
...
var GatewayChatClient = class GatewayChatClient {
	...
	async loadImage(opts) {
		const { loadGatewayImage } = await import("./gateway-image-loader-DcE8F_7p.mjs");
