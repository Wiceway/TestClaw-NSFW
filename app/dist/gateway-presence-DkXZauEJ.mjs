...
import { t as inspectBestEffortPrimaryTailnetIPv4 } from "./network-discovery-display-DDi0cfKB.mjs";
...
/** Extracts the config fields displayed by `testclaw gateway status --deep`. */
