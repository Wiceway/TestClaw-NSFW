...
//#endregion
//#region src/infra/sqlite-reader-lifecycle.d.ts
type SqliteReaderOwner = {
  operation: string;
  ownerKind: "main" | "worker";
  actorId?: number;
};
type SqliteReaderDiagnostic = SqliteReaderOwner & {
  kind: "iterator";
  connectionId: number;
  threadId: number;
  ageMs: number;
...
type SqliteReaderDiagnostics = {
  ...
  readerCount: number;
  connections: Array<SqliteReaderOwner & {
    connectionId: number;
    threadId: number;
    ageMs: number;
...
//#endregion
//#region src/infra/sqlite-wal-checkpoint.d.ts
...
type MessagePresentationAction = {
  ...
  url: string;
  /** Testclaw hosted-widget ID whose launch mechanics are owned by the channel. */
  widgetId?: string;
} | {
  /** Launch a channel-native web app. */
  type: "web-app";
...
declare function getReplyFromConfig$2(ctx: RuntimeMsgContext, options?: GetReplyOptions, configOverride?: TestclawConfig): Promise<ReplyPayload | ReplyPayload[] | undefined>;
//#endregion
...
//#endregion
//#region src/config/sessions/disk-budget.types.d.ts
