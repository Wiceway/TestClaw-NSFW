...
import { d as isTrustedSecretSurfaceUnavailableError, f as listActiveCredentialDegradedOwners } from "./runtime-degraded-state-C2v6LD8h.mjs";
import { t as formatFencedCodeBlock } from "./markdown-code-Buzx6wvi.mjs";
import { l as getActiveSecretsRuntimeSnapshotRevisionState, s as getActiveSecretsRuntimeEnvState, u as getActiveSecretsRuntimeSnapshotState } from "./runtime-state-p_Glf0Cm.mjs";
...
import { i as sanitizeExecApprovalWarningText } from "./exec-approval-text-sanitize-C4VbUkOU.mjs";
import { c as buildPluginApprovalExpiredMessage, l as buildPluginApprovalRequestMessage, s as approvalDecisionLabel } from "./plugin-approvals-CbE1CTiQ.mjs";
...
import { t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-D3Wf4LmX.mjs";
...
import { f as formatExecApprovalExpiresIn } from "./exec-approval-reply-NU4MEJdw.mjs";
import { a as buildTypedApprovalPendingReplyPayload, i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, o as buildTypedPluginApprovalPendingReplyPayload } from "./approval-renderers-B8nwQEhK.mjs";
...
import { g as resolveApnsRelayConfigFromEnv, n as clearApnsRegistrationIfCurrent, s as loadApnsRegistrations } from "./push-apns-store--yWyvNXI.mjs";
...
import { a as pruneTerminalOperatorApprovals, t as closeOrphanedOperatorApprovals } from "./operator-approval-store.transitions-DwqBBQ67.mjs";
import { i as getOperatorApprovalDetailed } from "./operator-approval-store-Bru3sIMf.mjs";
import { t as resolveApprovalSessionAudienceWithFallback } from "./approval-session-audience-DmcgsiGg.mjs";
import { t as canAccessOperatorApproval } from "./operator-approval-authorization-CRqUaNvq.mjs";
import { c as listBoundWebPushSubscriptions, d as prepareWebPushApprovalDeliveries, l as listTerminalWebPushApprovalDeliveryIds, o as deleteWebPushApprovalDeliveryTargets, r as prepareWebPushNotificationSender, s as hasBoundWebPushSubscriptions, u as listWebPushApprovalDeliveryTargets } from "./push-web-C2JwKwo_.mjs";
import { n as getUserPreferences } from "./user-preferences-D56zhlv2.mjs";
import { n as isApprovalRecordVisibleToClient, t as canAccessApprovalSession } from "./approval-record-lookup-BL6mBsV5.mjs";
...
import { a as sendApnsPluginApprovalAlert, c as resolveApnsAuthConfigFromEnv, i as sendApnsExecApprovalResolvedWake, o as sendApnsPluginApprovalResolvedWake, r as sendApnsExecApprovalAlert, s as shouldClearStoredApnsRegistration } from "./push-apns-C1cVdBh0.mjs";
import { t as ExecApprovalManager } from "./exec-approval-manager-BJZmCvF4.mjs";
import { t as QuestionManager } from "./question-manager-Ctksrh_P.mjs";
import { t as publishAppliedApprovalResolution } from "./approval-publication-BKGHswXy.mjs";
import { t as refreshModelRuntimeAfterHotReload } from "./server-reload-model-runtime-scope-B4lkpCSw.mjs";
...
async function restoreSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, onActivated, runtimeSourceConfig) {
	if ((await import("./runtime-xnvnIymm.mjs")).restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, { runtimeSourceConfig })) onActivated();
}
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = createLazyPromise(() => import("./exec-approval-BYVd2a8n.mjs").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: execApprovalIosPushDelivery
	})), { cacheRejections: true });
	const reloadSecrets = createGatewaySecretsReloader(params);
	const loadSecretsModule = createLazyPromise(() => import("./secrets-DlE0iSBB.mjs"), { cacheRejections: true });
	...
	const loadQuestionHandlers = createLazyPromise(async () => {
		const [{ createQuestionHandlers }, storeWriteService] = await Promise.all([import("./question-Ct7TYD0O.mjs"), loadSecretStoreWriteService()]);
	...
	const loadPluginApprovalHandlers = createLazyPromise(() => import("./plugin-approval-Day7m8jd.mjs").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: pluginApprovalIosPushDelivery
	})), { cacheRejections: true });
	const loadApprovalHandlers = createLazyPromise(() => import("./approval-CFFV1yC-.mjs").then(({ createApprovalHandlers }) => createApprovalHandlers({
		execApprovalManager,
		pluginApprovalManager,
		systemAgentApprovalManager,
		forwarder: execApprovalForwarder,
