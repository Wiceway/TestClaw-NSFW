import { D as resolveExpiresAtMsFromDurationMs, R as timestampMsToIsoString } from "./number-coercion-CLj0HTDM.mjs";
import { C as retirePluginCache, D as withPluginCache, a as createPluginCache, o as getPluginCache, w as retirePluginCacheInstance, y as releasePluginCacheInstance } from "./plugin-cache-CTGtP6hf.mjs";
import { c as isRecord } from "./record-coerce-DItp3I4t.mjs";
import { l as normalizeOptionalString, o as normalizeLowercaseStringOrEmpty, p as normalizeStringifiedOptionalString, t as hasNonEmptyString } from "./string-coerce-CIXf7egm.mjs";
import { _ as normalizeUniqueTrimmedStringList, b as uniqueValues, d as normalizeStringEntries, h as normalizeUniqueStringEntries, p as normalizeTrimmedStringList, v as sortUniqueStrings } from "./string-normalization-_gRhJUDw.mjs";
...
import { a as getGatewayContextResolver, r as getCanonicalGatewayContextResolver, t as bindGatewayContextResolver } from "./gateway-context-binding-VqB7gkMe.mjs";
import { c as withPluginRuntimePluginScope, i as getPluginRuntimeGatewayRequestScope, s as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-Cys5l4an.mjs";
import { a as createLazyRuntimeSurface, r as createLazyRuntimeModule, t as createLazyRuntimeMethod } from "./lazy-runtime-BPNHa36e.mjs";
...
import { n as describeRootFileOpenFailure } from "./boundary-file-read-u2SCs3-A.mjs";
import { o as safeRealpathSync, s as safeStatSync } from "./path-safety-D-qXHKZj.mjs";
...
import { c as isSecretRef, p as isValidSecretRef, s as isBuiltInDefaultSecretProviderRef } from "./ref-contract-BVi3ykLT.mjs";
import { p as resolveSecretInputRef } from "./types.secrets-B5xWSzLp.mjs";
import { u as tryNativeRequireModule } from "./native-module-require-ZurZy0Ov.mjs";
import { i as preparePluginModule, o as installAssistantPluginSdkNativeResolver, s as toSafeImportPath, t as getCachedPluginModuleLoader } from "./plugin-module-loader-cache-DHy9worZ.mjs";
import { n as openPluginRootFileSync, t as isPathInside } from "./path-safety-BMyr873a.mjs";
import { c as runPluginCleanup, i as getPluginValueInstance, t as getPluginInstance, u as wrapCurrentPluginInstance } from "./plugin-instance-scope-6R-akBzy.mjs";
import { _ as redactSensitiveText } from "./redact-Db5P6nQB.mjs";
import { t as formatErrorMessage } from "./errors-DNLGIg8_.mjs";
import { m as resolvePluginRuntimeExecutionArtifact, u as prefersBuiltPluginArtifacts } from "./bundled-dir-Bmn6z9c1.mjs";
import { c as resolvePluginRuntimeModulePathWithDiagnostics, o as preparePluginLoaderAliases } from "./sdk-alias-D0VX5QZ1.mjs";
...
import { i as kindsEqual, n as defaultSlotIdForKey, r as hasKind } from "./slots-D4OMSTbt.mjs";
import { d as resolveEffectivePluginActivationState, l as normalizePluginsConfig, p as resolveMemorySlotDecision } from "./config-state-C1Oo_dIV.mjs";
import { E as resolvePluginCandidateInstallOwner, g as degradedPluginMatchesRoot, h as clearActiveDegradedPlugin, n as discoverAssistantPlugins, v as findActiveDegradedPlugin } from "./discovery-Beqghw38.mjs";
import { l as normalizeCommandDescriptorName, u as sanitizeCommandDescriptorDescription } from "./manifest-CIpOoIMT.mjs";
...
import { s as listOfficialExternalChannelCatalogEntries } from "./official-external-plugin-catalog-BxZhHmRY.mjs";
...
import { d as hasExplicitPluginIdScope, i as getCurrentPluginMetadataSnapshot, p as normalizePluginIdScope, u as createPluginIdScopeSet } from "./current-plugin-metadata-snapshot-CuzkxMsN.mjs";
import { u as resolvePluginMetadataSnapshot } from "./plugin-metadata-snapshot-BdghSFzd.mjs";
import { n as matchesDeclaredProviderOwner, t as buildDeclaredProviderOwnerIndex } from "./provider-owner-index-eVSJvcfU.mjs";
import { c as normalizeChannelMeta } from "./bundled-C1mcBugY.mjs";
import { n as unwrapDefaultModuleExport, t as resolvePluginModuleExport } from "./module-export-BbYMQUy2.mjs";
import { a as resolveManifestOwnerBasePolicyBlock, t as hasExplicitManifestOwnerTrust } from "./manifest-owner-policy-Dwt1BYod.mjs";
...
import { n as PluginInstance, r as bindPluginInstanceModuleLoader, t as getPluginSetupModuleLoader } from "./plugin-setup-module-07LQkKXt.mjs";
import { n as pluginArrays, r as pluginMaps, t as createEmptyPluginRegistry } from "./registry-empty--vb91VWS.mjs";
import { t as getPluginRuntimeGenerationRegistry } from "./generation-state-DLEV_th_.mjs";
import { d as invalidateProviderRegistryIndex, u as findProviderRuntimeRegistrationInRegistry } from "./model-ref-shared-BJVdLDpP.mjs";
import { E as selectApplicableRuntimeConfig, r as createRuntimeConfigReader, s as getRuntimeConfigSnapshot, u as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-Dti8jFIP.mjs";
...
import { l as reserveSqliteWorkerInputPreparation } from "./sqlite-worker-store-arRyGxwp.mjs";
...
import { i as resolveProviderConfigApiOwnerHint, r as resolveModelCatalogScope } from "./provider-config-owner-C-dKiqUZ.mjs";
import { t as resolvePluginActivationSourceConfig } from "./activation-source-config-BdcJztaZ.mjs";
import { r as listChatChannels } from "./chat-meta-CaiDRnrz.mjs";
import { a as readNativeSessionCatalogPreference, n as hasLegacyNativeSessionCatalogDefault } from "./native-session-catalog-config-CYC8tjEu.mjs";
...
import { C as NODE_WORKER_PRIVATE_COMMANDS, N as isPrivateNodeInvokeCommand, a as NODE_EXEC_APPROVALS_COMMANDS, m as NODE_SYSTEM_RUN_COMMANDS, p as NODE_SYSTEM_NOTIFY_COMMAND } from "./node-commands-BLhGKTZa.mjs";
import { i as normalizePluginGatewayMethodScope, r as createPluginGatewayMethodDescriptor } from "./descriptor-ByqpE-ah.mjs";
import { s as warn } from "./globals-CUJhO5PM.mjs";
import { h as readProviderTextResponse, m as readProviderJsonResponse, o as createProviderHttpError } from "./provider-http-errors-BdTzR7WL.mjs";
import { n as inspectBundleMcpRuntimeSupport } from "./bundle-mcp-r1yEgTVd.mjs";
import { S as hasInvalidLifecycleStartTimestamp, i as emitAgentEvent } from "./agent-events-WwqMA2rD.mjs";
import { S as withPluginRegistryPreparationScope, c as getPluginRecordRegistry, d as isPluginRecordActive, f as isPluginRegistryActivated, h as isPluginRegistryRetired, i as capturePluginLifecycleAuthority, m as isPluginRegistryPreparing, s as getPluginLoaderCacheState, u as getPluginRegistryResourceOwner, x as revokePluginRecord } from "./registry-lifecycle-7UsSBpcC.mjs";
import { D as withPluginRegistrationContext, I as publishPluginSessionSchedulerJobs, L as registerPluginSessionSchedulerJob, M as deletePluginSessionSchedulerJob, N as getPluginRunContext, R as setPluginRunContext, _ as recordImportedPluginId, f as getActivePluginRegistryWorkspaceDir, j as clearPluginRunContext, l as getActivePluginRegistry } from "./runtime-D1tHq7F4.mjs";
import { a as normalizePluginHostHookId, i as normalizeOptionalHostHookString, n as normalizeHostHookString, r as normalizeHostHookStringList } from "./host-hooks-D9_pJ8kZ.mjs";
...
import { a as resolveTokenExpiryState, l as isOAuthRefreshFence, r as hasUsableOAuthCredential } from "./credential-state-B72qRadL.mjs";
import { S as createExternalAuthRuntime, i as createAuthProfileStoreRuntime } from "./store-_Ypv0hYn.mjs";
...
import { t as bindPluginRegistryRuntime } from "./registry-runtime-binding-CfPMzNoS.mjs";
import { c as bindPluginRuntimeArtifactSelection, d as hasCompletedPluginRuntimeRegistration, f as resolvePluginLoadCacheContext, o as registryContainsRuntimePluginIds, p as resolveRuntimeSubagentMode, r as getLoadedRuntimePluginRegistry, s as resolveCompatibleRuntimePluginRegistry, t as createRuntimePluginManifestLookup, u as getPluginRuntimeEntrySource } from "./active-runtime-registry-CFUp_yLA.mjs";
import { n as resolvePluginRuntimeArtifact, t as clearPluginRuntimeArtifactResolutionMemo } from "./plugin-runtime-artifact-resolution-dvxiteiB.mjs";
import { a as isConversationHookName, c as isPluginHookReplyDispatchKind, k as normalizePluginToolMatcher, l as isPromptInjectionHookName, o as isPluginHookAgentTrigger, s as isPluginHookName } from "./hooks-D28cLPAG.mjs";
import { a as normalizeAgentToolResultMiddlewareRuntimeIds, n as appendAgentToolResultMiddlewareScope, o as normalizeAgentToolResultMiddlewareRuntimes, t as agentToolResultMiddlewareRegistrationCoversTool } from "./agent-tool-result-middleware-C0Ff74jB.mjs";
import { c as createUnavailableRuntime, l as instrumentPluginInstanceApi, o as runPluginRegistration, s as buildPluginApi } from "./setup-registry-DVb_VIRo.mjs";
import { d as PluginRegistryInspectionResources, f as getPluginRegistryInspectionResources, o as registerContextEngineInRegistry } from "./registry-BPMvk3sV.mjs";
import { C as validatePluginStoreNamespace, S as validatePluginStoreKey, b as serializePluginStoreJson, w as validatePluginStorePositiveInteger, x as validateOptionalPluginStoreTtlMs, y as createPluginStoreOptionPolicy } from "./plugin-state-worker-errors-IBw3goOX.mjs";
import { i as createPluginStateSyncKeyedStore, r as createPluginStateKeyedStore } from "./plugin-state-store-CMkSV5C5.mjs";
import { a as matchesScopedPluginOrDreamingSidecar, c as resolveAuthorizedDreamingSidecar, d as formatPluginFailureSummary, f as markPluginActivationDisabled, h as recordPluginError, i as detailPluginStartupTrace, l as validatePluginConfig, m as recordPluginConfiguredUnavailable, n as activatePluginRegistry, o as maybeThrowOnPluginLoadError, p as recordBundleDiagnostics, r as createPluginCandidatesFromManifestRegistry, s as preparePluginLoadRecord, u as formatMissingPluginRegisterError } from "./loader-shared-XMb_oUgZ.mjs";
...
import { o as enqueueSystemEventFromSdk } from "./system-events-DczSbqkY.mjs";
import { c as registerPluginDashboardCapabilities, o as PluginDashboardDeclarationError, t as createPluginBoardWidgetContentKindRegistrar } from "./board-widget-content-kinds-D6jQaAxg.mjs";
import { a as resolveSetupChannelRegistration, i as resolveBundledRuntimeChannelRegistration, n as loadBundledRuntimeChannelPlugin, o as shouldLoadChannelPluginInSetupRuntime, r as mergeSetupRuntimeChannelPlugin, t as channelPluginIdBelongsToManifest } from "./loader-channel-setup-b2yFhHDE.mjs";
import { O as getCoreEmbeddingProvider } from "./gateway-startup-plugin-config-CMh9tu9P.mjs";
import { n as resolveDecisionModelSetting, t as getConfiguredDecisionProviderIds } from "./decision-model-setting-C99EmsdI.mjs";
import { a as resolveProviderRuntimeWorkspaceDir, r as matchesProviderPluginRef } from "./provider-registry-shared-CGngP_UC.mjs";
import { t as resolveExternalPluginRuntimeDependencyRepairHint } from "./official-external-plugin-repair-hints-BeNc5xMr.mjs";
import { i as replacePluginHttpRoutes, r as projectPluginHttpRoutes, t as getPluginHttpRouteViews } from "./http-route-owner-CM8sIN3n.mjs";
import { n as resolveCronListPageNextOffset, t as readCanonicalCronListPage } from "./list-page-validation-myXdxCmr.mjs";
import { l as getActiveSecretsRuntimeSnapshotRevisionState } from "./runtime-state-p_Glf0Cm.mjs";
import { r as validateDecisionResult, t as DecisionContractError } from "./validation-DRK4SBoT.mjs";
import { r as registerPluginInteractiveHandlerInRegistry } from "./interactive-registry-3EvNuEWP.mjs";
import { i as classifyGatewayProbePath } from "./gateway-http-route-contracts-ZNLfhchO.mjs";
...
import { r as registerPluginCommandInRegistry, t as isReservedCommandName } from "./command-registration-C6onWC-R.mjs";
import { n as validateWorkerProviderContract } from "./worker-provider-registry-DRB5p70d.mjs";
import "./with-timeout-CEnLHVHe.mjs";
import { n as resolvePromptInjectionAllowed, t as resolveConversationAccessAllowed } from "./hook-policy-decisions-DL3kOjGW.mjs";
import { t as createHostChannelInboundEventContextBuilder } from "./host-context-builder-BkWvew0V.mjs";
import { n as createHostChannelIngressRuntime } from "./runtime-BJmsKdOg.mjs";
import { n as createChannelIngressDrain } from "./ingress-drain-IRH2TmLw.mjs";
import { t as createChannelIngressQueue } from "./ingress-queue-CLtOX3CO.mjs";
import { a as MAX_PLUGIN_BLOB_ENTRIES_PER_PLUGIN, f as wrapPluginBlobError, i as MAX_PLUGIN_BLOB_BYTES_PER_PLUGIN, n as pluginBlobWorkerOperations, r as MAX_PLUGIN_BLOB_BYTES_PER_ENTRY } from "./plugin-blob-worker-contract-lHArRrtD.mjs";
import { t as PluginTrustRefusalError } from "./plugin-trust-BZaMrZlB.mjs";
import { a as setPluginRuntimeLoadContext, n as createPluginRuntimeLoaderLogger, r as getPluginRuntimeLoadContext, t as buildPluginRuntimeLoadOptions } from "./load-context-CEKyQMyt.mjs";
...
import { o as isKnownEnvApiKeyMarker, s as isNonSecretApiKeyMarker } from "./model-auth-markers-Bml4Y1AZ.mjs";
import { t as resolveEnvApiKey } from "./model-auth-env-8aEZOe8n.mjs";
import { N as resolveDirectProviderCredentialMode, S as resolveUsableCustomProviderApiKey, _ as resolveProviderConfig, b as resolveProviderEntryApiKeyProfileReference, d as providerConfigMatchesRuntimeSnapshot, i as hasSecretRefProviderApiKey, l as profileTypeToAuthMode, x as resolveRuntimeProviderConfigApiKeyAuth } from "./model-auth-provider-config-BtBizCzx.mjs";
import { a as resolveDiscoverableProviderOwnerPluginIds, c as resolveExternalAuthProfileProviderPluginIds, f as resolveOwningPluginIdsForProviderRef, n as resolveActivatableProviderOwnerPluginIds, o as resolveDiscoveredProviderPluginIds, r as resolveBundledProviderCompatPluginIds, s as resolveEnabledProviderPluginIds, u as resolveOwningPluginIdsForModelRefs } from "./providers-DCFiJBbN.mjs";
import { t as attachModelProviderLocalServiceReconciler } from "./provider-local-service-reconcile-CjW67P5z.mjs";
import { n as withActivatedPluginIds, t as resolveBundledCompatActivationInputs } from "./activation-context-BetIEEPx.mjs";
...
function createPluginCapabilityCatalogContext(availability) {
	...
	return Object.freeze({
		...
		resolveApiKeyForProvider: async (params) => (await import("./runtime-model-auth.runtime.js")).resolveProviderRuntimeApiKey(params),
		captureWsEvent,
...
function createRuntimeConfig() {
	return {
		...
		mutateConfigFile: async (params) => {
			const { mutateConfigFile } = await import("./mutate-ByqAykWB.mjs");
			return await mutateConfigFile(params);
		},
		replaceConfigFile: async (params) => {
			const { replaceConfigFile } = await import("./mutate-ByqAykWB.mjs");
...
const loadHeartbeatRunnerRuntime = createLazyRuntimeModule(() => import("./heartbeat-runner-DaiEISD0.mjs"));
...
const loadAttachments = createLazyRuntimeModule(() => import("./host-hook-attachments-D1VfA5Wu.mjs"));
const loadHookState = createLazyRuntimeModule(() => import("./host-hook-state-_VHcC8aV.mjs"));
...
function createPluginRuntimeResolver(state) {
	...
	const resolvePluginRuntime = (record) => {
		...
		const loadSessionOwnership = createLazyRuntimeSurface(() => import("./registry-runtime-session-ownership-DFPSbpua.mjs"), (module) => module.createPluginSessionOwnership(state, pluginId, currentRegistry));
		...
		const runtime = new Proxy(registryParams.runtime, { get(target, prop, receiver) {
			...
			if (prop === "decisions") return { evaluate: async (batch, options) => {
				assertRuntimeCurrent();
				const { evaluateDecisionInRegistry } = await import("./runtime-C9Ns85-5.mjs");
				assertRuntimeCurrent();
...
//#endregion
export { createRuntimeBase as _, nativePluginBindings as a, resolvePluginRegistryLoadCacheKey as b, resolvePluginCapabilityCatalogContext as c, resolveManagedSecretRefRuntimeProviderAuth as d, hasMalformedSecretInputSyntax as f, findUndeclaredPluginToolNames as g, listCodexAppServerExtensionFactories as h, loadAssistantPluginsWithInternalOverrides as i, resolveRuntimePluginRegistry as l, resolveStoredCredentialReadOnlyAvailability as m, acquirePluginRegistryWithInternalOverrides as n, resolveNativePluginModelAuth as o, resolveSecretRefReadOnlyAvailability as p, loadAssistantPlugins as r, resolveNativePluginModelConfig as s, acquirePluginRegistryForInspection as t, assertRuntimeProviderSecretOwnerAvailable as u, clearPluginRegistryLoadCache as v, isPluginRegistryLoadInFlight as y };
