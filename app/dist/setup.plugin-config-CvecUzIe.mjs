...
import { n as getPath, r as setPathCreateStrict } from "./path-utils-C3EgzLrx.mjs";
import { n as t } from "./i18n-DrbABx94.mjs";
//#region src/wizard/setup.plugin-config.ts
const loadPluginMetadataSnapshotModule = createLazyRuntimeModule(() => import("./plugin-metadata-snapshot-BWOEJ_To.mjs"));
