import { n as writeStableStringify } from "./stable-stringify-CkQ0IEj1.mjs";
...
function sha256StableValue(value) {
	let digest;
	let chunks = [];
...
//#endregion
export { sha256StableValue as i, sha256Hex as n, sha256HexPrefixCore as r, redactIdentifier as t };
