...
declare function hasControlCommand(text?: string, cfg?: TestclawConfig, options?: CommandNormalizeOptions): boolean;
/** Returns true for exact control commands or abort triggers after metadata stripping. */
declare function isControlCommandMessage(text?: string, cfg?: TestclawConfig, options?: CommandNormalizeOptions): boolean;
/**
...
declare function shouldComputeCommandAuthorized(text?: string, cfg?: TestclawConfig, options?: CommandNormalizeOptions): boolean;
//#endregion
