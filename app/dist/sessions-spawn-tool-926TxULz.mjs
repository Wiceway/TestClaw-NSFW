...
import { n as normalizeAgentId, r as normalizeAgentIdStrict, t as isValidAgentId } from "./agent-id-fXQBq5ZF.mjs";
import { T as tryResolveLegacyCompatibilityAgentId, a as resolveAgentDir, r as resolveAgentConfig } from "./agent-scope-config-Dm8T0OhW.mjs";
import { n as buildAgentMainSessionKey, r as isIncognitoSessionKey } from "./session-key-B8Cn8Xls.mjs";
import { A as parseAgentSessionKey, E as parseThreadSessionSuffix, T as parseSessionDeliveryRoute, _ as toAgentStoreSessionKey, b as isCronRunSessionKey, o as classifySessionKeyShape, s as isUnscopedSessionKeySentinel, x as isCronSessionKey } from "./session-key-C_bfgyCp.mjs";
...
import { i as isNonDeliverableSessionsReply, n as REPLY_SKIP_TOKEN, t as ANNOUNCE_SKIP_TOKEN } from "./sessions-send-tokens-GWcKOtO3.mjs";
...
import { a as mergeDeliveryContext, r as hasDeliveryTargetFields, s as normalizeDeliveryContext } from "./delivery-context.shared-C0r2NKUR.mjs";
...
import { C as runWithGatewayIndependentRootWorkContinuation, t as GatewayDrainingError, x as runWithGatewayDetachedWorkContinuation } from "./gateway-work-admission-DeFm4gyw.mjs";
...
import { a as enqueueSystemEventEntry } from "./system-events-a6gEP3M4.mjs";
import { i as listRegisteredPluginAgentPromptGuidance } from "./command-registry-state-DUpVKTvF.mjs";
import { i as resolvePersistedSelectedModelRef, l as normalizeStoredOverrideModel } from "./model-selection-7SY54ACM.mjs";
...
import { b as upsertSessionEntryCore, l as loadSessionEntryReadOnly, s as loadSessionEntry } from "./session-accessor.sqlite-entry-BgjD5zI-.mjs";
import "./session-accessor-CtBBLApI.mjs";
import { n as isExecutionIdentityCollectionEnabled } from "./audit-config-BXFCjLO0.mjs";
import { _ as registerSessionStateWatch, m as recordSubagentSpawned } from "./session-state-events-DiPU1ldX.mjs";
import { T as reserveSwarmRun, h as activateSwarmRun, y as holdQueuedSwarmRun } from "./subagent-run-liveness-BX0M8mQR.mjs";
...
import { b as queueEmbeddedAgentMessageWithOutcomeAsync, o as formatEmbeddedAgentQueueFailureSummary } from "./runs-CgiowlON.mjs";
...
import { t as forkSessionEntryFromParent } from "./session-fork-BNbaLDv1.mjs";
...
import { m as withToolEffectBoundary } from "./tool-result-error-Ce9ky0UT.mjs";
import { n as resolveSnakeCaseParamKey } from "./param-key-J0cnwxlA.mjs";
import { t as jsonResult } from "./tool-results-BCM3fdVS.mjs";
import { a as normalizeToolModelOverride, d as readPositiveIntegerParam, h as readToolStringParam, l as readNonNegativeIntegerParam } from "./common-C3p8rD5A.mjs";
...
import { d as logSessionOwnershipLookupFailure, f as lookupFailedDenialMessage, g as sessionOwnershipLookupFailure, i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, p as lookupFailedOperationMessage } from "./session-visibility-WXo_iVWW.mjs";
import { i as bindInProcessSubagentResume } from "./server-plugin-runtime-client-CxKOo1Bw.mjs";
import { c as runWithGatewayToolCleanupContext, i as callInProcessGatewayToolWithCreation, l as runWithGatewayToolContinuationContext, n as callAgentToolGatewayRequest, r as callInProcessGatewayTool, s as hasInProcessGatewayToolContext } from "./in-process-gateway-DYoA0sVl.mjs";
import { _ as resolveVisibleSessionReference, a as resolveSessionToolContext, c as resolveSandboxedSessionToolContext, d as isExpectedSessionLookupMiss, g as resolveSessionReference, h as resolveMainSessionAlias, l as resolveSessionToolAccess, m as resolveInternalSessionKey, o as formatSessionToolAccessDenial, p as resolveDisplaySessionKey, s as recordSessionToolActionFact } from "./sessions-helpers-CfUZs9xt.mjs";
import { d as resolveSubagentController, i as ensureSubagentControllerOwnsRun } from "./subagent-control-scope-DxTe-y0O.mjs";
import { M as cleanupMaterializedSubagentAttachments } from "./subagent-completion-admission.store-JZXyb7da.mjs";
import { D as settleFailedQueuedSubagentLaunch, c as countActiveRunsForSession, k as startQueuedSubagentRun, m as listSwarmRunsForGroup, s as completeCollectorLaunchCleanup, x as registerSubagentRun } from "./subagent-registry-C2Nqhwx2.mjs";
import { a as terminateAcceptedCollectorRun, c as readGatewayRunId, d as withSubagentGatewayExecutionIdentity, h as deleteSubagentSessionForCleanup, i as retrySubagentCleanup, l as resolveSubagentAgentGatewayTimeoutMs, m as resolveAcpSessionsSpawnImageAttachments, n as cleanupFailedSpawnBeforeAgentStart, o as callNativeSubagentGateway, p as materializeSubagentAttachments, r as cleanupProvisionalSession, t as bindSubagentSpawnCleanup, u as buildSubagentExecutionSessionSpawnContext } from "./subagent-spawn-cleanup-BxKO7XTM.mjs";
...
import { i as waitForAgentRunReply, t as isTerminalAgentWaitTimeout } from "./run-wait-65OZ7ug0.mjs";
import { t as resolveSwarmConfig } from "./swarm-config-CB3czZI3.mjs";
import { r as captureCollectorSpawnGuard, t as bindCollectorSpawnTool } from "./swarm-collector-capability-C21oM8a6.mjs";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-Dt2c3YNS.mjs";
import { i as normalizeAcceptedSessionSpawnResult, r as mergeAcceptedSessionSpawnsForRun } from "./accepted-session-spawn-CRPngSCf.mjs";
...
import { o as SUBAGENT_COMPLETION_OUTCOME_INSTRUCTION } from "./subagent-completion-delivery-DfVNOj8t.mjs";
import { o as loadSessionEntryByKey } from "./subagent-announce-delivery-B0-7Sv1G.mjs";
...
import { n as PortalOutputSchema, r as PortalToolSchema, t as PORTAL_TOOL_DESCRIPTION } from "./portal-tool-contract-CGrmNgOa.mjs";
import { t as recordSessionParticipantBestEffort } from "./session-participant-recording-BXhaYJvJ.mjs";
import { a as resolveThreadBindingIdleTimeoutMsForChannel, c as resolveThreadBindingSpawnPolicy, s as resolveThreadBindingMaxAgeMsForChannel } from "./thread-bindings-policy-toE2K7ZV.mjs";
import { t as recordSessionCreated } from "./session-created-bkFI0o6W.mjs";
import { i as resolveSpawnedWorkspaceInheritance, n as normalizeSpawnedRunMetadata, t as mapToolContextToSpawnedRunMetadata } from "./spawned-context-Bx2tMYZh.mjs";
...
async function prepareParentSubagentResume(params) {
	const runtime = await import("./subagent-registry-BuC6YZFG.mjs");
	return () => {
...
async function runAgentStep(params) {
	...
	if (params.transcriptMessage !== void 0) {
		...
		const { agentCommandFromIngress } = await import("./agent-zmLuKkLm.mjs");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-Bs63egJV.mjs"));
