...
import { _ as normalizeIpAddress, f as isLoopbackIpAddress, h as isRfc8215LocalUseNat64Ipv6Address, i as isCanonicalDottedDecimalIPv4, p as isPrivateOrLoopbackIpAddress, s as isIpInCidr } from "./ip-3mD58gHN.mjs";
import { t as isContainerEnvironment } from "./container-environment-CNsJSTpY.mjs";
import { i as safeNetworkInterfaces, n as pickMatchingExternalInterfaceAddress, r as readNetworkInterfaces } from "./network-interfaces-S5y8vKUw.mjs";
...
function resolveRequestClientIpFromHeaders(req, trustedProxies, allowRealIpFallback = false) {
	if (!req) return;
...
async function canBindToHost(host) {
	return new Promise((resolve) => {
		...
		const timeout = setTimeout(() => finish(false), 3e3);
		const finish = (canBind) => {
