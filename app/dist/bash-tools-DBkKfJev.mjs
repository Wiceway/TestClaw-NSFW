...
import { n as TESTCLAW_CLI_ENV_VAR, t as SUBAGENT_EXEC_ENV_VAR } from "./testclaw-exec-env-O_MEx5Tv.mjs";
import { o as safeRealpathSync } from "./boundary-path-DdYnCwCA.mjs";
import { r as isPathInside, s as safeStatSync } from "./path-guards-0NKGHIHl.mjs";
import { t as createAbortError$1 } from "./abort-signal-Z3A36sLL.mjs";
...
import { c as sanitizeHostExecEnvWithDiagnostics, n as isDangerousHostEnvOverrideVarName, o as normalizeHostOverrideEnvVarKey, r as isDangerousHostEnvVarName } from "./host-env-security-zCuqI0tD.mjs";
import { i as normalizeChatChannelId } from "./ids-CiKpeSuq.mjs";
import { a as EXEC_TOOL_DISPLAY_SUMMARY, o as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-description-presets-CT4WhVkI.mjs";
import { c as requireValidExecTarget, d as resolveExecModePolicy, r as normalizeExecAsk } from "./exec-approvals-core-BZ3ECkXD.mjs";
import { o as resolveShellEnvFallbackTimeoutMs, r as getShellPathFromLoginShell } from "./shell-env-etbD1Y0U.mjs";
import { b as resolveExecWrapperTrustPlan, h as resolveExecutionTargetTrustPath, l as resolveApprovalAuditTrustPath } from "./exec-command-resolution-Ca5iRhk7.mjs";
import { n as splitCommandArgs, r as splitShellArgs } from "./shell-argv-DE1kujuY.mjs";
import { c as hasPosixShellStartupBeforeInlineCommand, l as isBlockedShellWrapperCommand } from "./shell-wrapper-resolution-CPhcV89l.mjs";
...
import { n as getInstallationTarget, r as installationTargetEnv, t as LOCAL_INSTALLATION_TARGET_UNSUPPORTED } from "./installation-target-context-ybuwJO_0.mjs";
import { i as logWarn, r as logInfo } from "./logger-Bmf0V5tr.mjs";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-CRp372y2.mjs";
import { S as runWithGatewayIndependentRootWorkAdmission, t as GatewayDrainingError } from "./gateway-work-admission-DeFm4gyw.mjs";
...
import { d as resolveExecApprovalsTranscriptPath } from "./exec-approvals-config-BRtA2IE3.mjs";
import { C as minSecurity, E as resolveExecApprovalAllowedDecisions, O as resolveExecApprovalUnavailableDecisions, S as maxAsk, T as requiresExecApproval, b as commandRequiresSecurityAuditSuppressionApproval, c as hasDurableExecApproval, g as resolveDurableExecApprovalRequirement, h as resolveAllowAlwaysPersistenceDecision, l as hasExactCommandDurableExecApproval, m as resolveAllowAlwaysPatternCoverage, s as createExecApprovalPolicySnapshot, u as hasNodeCommandAllowAlwaysMarker } from "./exec-approvals-authorization.kernel-DwCnJmG2.mjs";
import { i as loadExecApprovals } from "./exec-approvals-store-BO70FhRz.mjs";
import { t as buildEnforcedShellCommand } from "./exec-approvals-analysis-BULxro3E.mjs";
import "./exec-wrapper-resolution-ChbEn7AS.mjs";
import { l as describeInterpreterInlineEval } from "./risks-HzTsadnl.mjs";
import { i as evaluateShellAllowlistWithAuthorization } from "./exec-approvals-allowlist-e0iaS2Bs.mjs";
import { t as countObsoleteGeneratedExecApprovals } from "./exec-approvals-generated-migration-C9NP5rOs.mjs";
import { a as resolveExecApprovalsLocked, c as commitExecAuthorizationLocked, i as resolveExecApprovalsFromFile } from "./exec-approvals-BBEWVrGM.mjs";
...
import { a as invalidateTaskActivity } from "./task-registry-activity-CD1JyNcp.mjs";
import { E as isExecDeniedResultText } from "./user-copy-COjqIhB4.mjs";
import { a as renderExecOutputText, i as renderExecExitLabel, n as EXEC_RETENTION_CAP_NOTE, o as renderExecUpdateText, r as appendExecTimeoutRetryGuidance } from "./bash-tools.exec-output-Cei3R_ZV.mjs";
import { t as BACKGROUND_EXEC_TASK_KIND } from "./background-exec-task-contract-DDYMoYd-.mjs";
import { a as finalizeTaskRunByRunId, r as createRunningTaskRun } from "./detached-task-runtime-BbgsXm9e.mjs";
import { n as getDiagnosticSessionState } from "./diagnostic-session-state-DpvjzgzY.mjs";
import { o as attachInternalToolResultAcknowledgement } from "./internal-hooks-A8m3oGkR.mjs";
import { s as withoutGatewayToolCallerIdentity } from "./gateway-caller-context-CxCRBFJ-.mjs";
import { A as sliceLogLines, C as buildSandboxEnv, D as deriveSessionName, E as coerceEnv, O as padProcessStatus, T as clampWithDefault, a as compareProcessSessionStartOrder, f as hasPendingPollDelivery, g as markBackgrounded, h as listRunningSessions, j as truncateMiddle, k as readEnvInt, l as getFinishedSession, m as listFinishedSessions, o as deleteSession, t as acknowledgeNotifyOnExit, u as getSession, v as prepareSessionPoll, x as tail } from "./bash-process-registry-H3slo6SX.mjs";
...
import { c as stripMalformedXmlArgValueSuffixFromKeys } from "./agent-tools.before-tool-call.decision-BLWhmguO.mjs";
import { a as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-FKkZmrLs.mjs";
import { n as textResult } from "./tool-results-BCM3fdVS.mjs";
import { r as failedTextResult } from "./common-C3p8rD5A.mjs";
...
import { n as describeExecTool, r as describeProcessTool } from "./bash-tools.descriptions-CdVoGX1S.mjs";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-i4_5kmZr.mjs";
import { n as resolveExecDefaultTimeoutSec, r as resolveNodeExecTimeouts, t as createExecToolExecutionTimeoutResolver } from "./exec-tool-timeout-L5Tfgb3S.mjs";
import { l as prepareGitHubToolEnvironment } from "./github-tool-identity-CY0H5w86.mjs";
import { a as resolveRegisteredExecApprovalDecision, i as registerExecApprovalRequestForHostOrThrow, n as buildExecApprovalTurnSourceContext, r as isExecApprovalRunAbortedError, t as buildExecApprovalRequesterContext } from "./bash-tools.exec-approval-request-D5xvY6Rv.mjs";
import { c as prepareSystemRunMutableFileBinding, g as extractShellCommandFromArgv, u as revalidateSystemRunMutableFileBinding, v as resolveSystemRunCommandRequest } from "./system-run-approval-binding-C4sb8YTM.mjs";
import { n as detectPolicyInlineEval } from "./policy-rcE8M9fa.mjs";
import { a as defaultExecAutoReviewer, c as resolveExecAutoReviewDecision, n as EXEC_AUTO_REVIEW_DISPATCH_IDENTITY_WARNING, o as formatExecAutoReviewAssessment, r as EXEC_AUTO_REVIEW_SHELL_STARTUP_WARNING } from "./exec-auto-review-BSwWXYeA.mjs";
import { a as formatExecApprovalContinuationSourceOutput, i as buildExecAutoReviewDeniedToolResult } from "./bash-tools.exec-approval-output-tiUpJJqT.mjs";
...
import { n as buildReviewedShellCommandFromPlan, t as buildAuthorizedShellCommandFromPlan } from "./exec-authorization-render-q7Fz4p6u.mjs";
import { s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-NU4MEJdw.mjs";
import { o as registerExecApprovalFollowupRuntimeHandoff } from "./bash-tools.exec-approval-followup-state-HII0ITe7.mjs";
import { n as rejectUnsafeExecControlShellCommand, r as rejectUnsafeExecLiveStateSqliteShellCommand } from "./exec-control-command-guard-CwlUNACJ.mjs";
import { n as consumeCronStandingGrant, s as validateCronStandingGrant, t as buildCronExecOperationBinding } from "./operator-approval-standing-grants-DJLv5NuE.mjs";
import { t as lookupCronRunExecSource } from "./cron-run-exec-source-BYare2tS.mjs";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-B1DEwd6s.mjs";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-DeKW-baq.mjs";
...
async function sendExecApprovalFollowupResult(target, resultText, deps = {}) {
	const send = deps.sendExecApprovalFollowup ?? (async (params) => {
		const { sendExecApprovalFollowup } = await import("./bash-tools.exec-approval-followup-eDCkCFSJ.mjs");
...
const fsSafeModuleLoader = createLazyImportLoader(() => import("./fs-safe-AWhjgyiF.mjs"));
...
async function readLiteralTildePreflightScript(params) {
	...
	try {
		...
		const { readFileHandleBounded } = await import("./fs-safe-advanced-BNVMxrzb.mjs");
...
function createExecTool(defaults) {
	...
	let storeEnvPromise;
	const resolveStoreEnv = () => storeEnvPromise ??= import("./secret-store-B8Q8hsMv.mjs").then((store) => store.readSecretStoreExecEnvironment({
