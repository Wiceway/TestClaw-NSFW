...
import { f as CLAW_OUTPUT_STABILITY } from "./reader-BU9kgCOF.mjs";
import { t as listConfiguredMcpServers } from "./mcp-config-Dxi66ATE.mjs";
import { a as withClawMcpLifecycleLease, n as unsetConfiguredMcpServer } from "./mcp-config-mutation-DYQXtZJF.mjs";
import { a as readAgentDeleteDatabaseRegistry, n as assertAgentSessionStoreDeletionSafe, o as resolveSurvivingDatabaseFilePaths, r as isPathOwnedBySurvivingAgent, t as AgentSharedStoreOwnerError } from "./agent-delete-databases-D0eCIrd2.mjs";
import { S as deleteClawCronRef, a as ClawRemoveError, b as clawCronGatewayJobMatchesRef, c as deletionEffects, f as readClawRemoveCronInventory, g as workspaceContainsUntrackedEntries, i as clawMonitorSnapshotSchema, m as removeClawWorkspaceFile, o as clawRemoveQuietRuntime, p as releaseClawRemoveRows, s as cleanupClawAgentFilesystem, w as markClawCronRefRemoved } from "./monitor-cleanup-contract-CbhVewFQ.mjs";
import { a as readClawInstallRecord } from "./provenance-ksQfwli9.mjs";
import { S as withClawAgentConfigRemoval, _ as applyClawPackageRemovals, a as normalizeClawPackageCleanup, c as readClawStatus, i as filterReferencedCleanup, n as digestClawRemovalInstall, o as orderClawPackageRemovals, r as digestClawRemovalState, s as projectClawPackageRemovePlan, t as digestClawPackageRemovalPlan, v as planClawPackageRemovals, x as digestClawAgentRemovalSurface } from "./package-remove-plan-D2-7iWG1.mjs";
import { a as digestClawMcpServer, i as deleteClawMcpServerRef, l as readClawMcpServerRefsByName, r as clawMcpRemovalSelector, s as planClawMcpServerRemoval } from "./mcp-CwJWD5at.mjs";
...
async function applyClawRemovePlan(plan, options = {}) {
	...
	return await withClawAgentConfigRemoval({
		...
		const purgeFailed = await (options.purgeSessions ?? (await import("./cleanup-service-B7f0vO8o.mjs")).purgeAgentSessionStoreEntries)(configBeforeDelete, agentId, {
			env: options.env,
