...
import { f as isVerifiedUpdateRollback, i as UPDATE_FOREIGN_DESTINATION_REASON, l as formatUpdateActivationTimeoutGuidance, o as UPDATE_INSTALL_SKIP_GUIDANCE, r as UPDATE_ENVIRONMENT_FAILURE_REASONS } from "./update-outcome-Dj5_EBo1.mjs";
import "./capability-consent-error-details-CF5XfV3G.mjs";
import { n as createUpdateFailureFact, t as createUpdateErrorFact } from "./update-failure-facts-CQQBnbzM.mjs";
...
import { l as writeControlPlaneUpdateRestartSentinel, o as markControlPlaneUpdateRestartSentinelFailure } from "./update-control-plane-sentinel-D9E1Aa9B.mjs";
import { a as recordUpdateRunDiagnostics } from "./update-run-write-DLKbiRhE.mjs";
import { i as updateRunStepsFromResultStep, n as isFailedUpdateStep, r as isUpdateGatewayReadinessPending } from "./update-run-step-ClarIGqJ.mjs";
import { f as recordUpdateRunPhase, h as recordUpdateRunStep, x as UpdateRunAdmissionBusyError } from "./update-run-ledger-CWjgjkCi.mjs";
import { r as getUpdateRun } from "./update-run-reader-DcJAE2Qr.mjs";
import { d as resolveDaemonServiceInstallGuidance, i as formatDaemonServiceInstallCommand } from "./shared-C9jIJw7D.mjs";
import { t as UpdateRequesterRevokedError } from "./update-requester-authority-BqQG6ZV5.mjs";
import { k as FreeBsdPkgOwnershipError } from "./update-runner-command-Dn-V6rM4.mjs";
...
import { s as updateRunReportInputFromResult } from "./update-run-report-BB6X6q4R.mjs";
...
import { r as loadUpdateRecovery } from "./update-run-recovery-admission-BgCTLAZE.mjs";
import { r as formatErrorMessageForDisplay, t as attachErrorDiagnostic } from "./error-diagnostics-LIeQ0S8g.mjs";
...
function formatUpdateFinalizationError(error) {
	const contention = collectNestedErrorCandidates(error).find(isSqliteLockError);
	if (error && typeof error === "object" && contention instanceof Error) attachErrorDiagnostic(error, `SQLite contention call site:\n${formatUncaughtError(contention)}`);
...
//#endregion
export { resolveMutableUpdateFailure as _, collectServiceInspectionFailureFacts as a, formatUpdateFinalizationError as c, prepareUpdateServiceResult as d, recordServiceReconciliationWarning as f, resolveAutomaticUpdateTriage as g, reportUpdateCommandPendingRecovery as h, UpdateCommandPendingRecoveryFailure as i, markControlPlaneUpdateRestartSentinelFailureBestEffort as l, recordUpdateResultNextAction as m, UpdateCommandFailure as n, createUpdateCommandFailureResult as o, recordServiceReconciliationWarnings as p, UpdateCommandFinalizedRecoveryFailure as r, failUpdateCommandRun as s, UnreportedUpdateAdmissionOutcome as t, mergeWindowsTaskRecoveryFailure as u, withUpdateAdmissionReporting as v, writeControlPlaneUpdateRestartSentinelBestEffort as y };
