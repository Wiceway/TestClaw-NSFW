...
import { a as getPreparedModelRuntimeAuthMaterializations, c as loadPreparedModelRuntimeAuth, d as setPreparedModelRuntimeAuthLoader, f as setPreparedModelRuntimeAuthMaterializations, p as setPreparedModelRuntimeAuthStore, r as getPreparedModelFullCatalogAuth, u as setPreparedModelRuntimeAuthLabels } from "./prepared-model-runtime-auth-Cnc45sWs.mjs";
...
import { i as normalizeThinkingCatalogProviders } from "./thinking-runtime-CNDwCWtd.mjs";
...
import { a as acquireReadOnlyPreparedModelRuntime, c as getPreparedModelRuntimeSnapshot, f as prepareModelRuntimeSnapshot, h as refreshPreparedModelRuntimeCatalog, o as activateStandalonePreparedModelRuntime, r as acquirePreparedModelRuntimeSnapshot, t as acquireAgentRunPreparedModelRuntime, v as preparedModelRuntimeConfigsMatch } from "./prepared-model-runtime-DkA7Mb_L.mjs";
import { n as prepareScopedReadOnlyLiveModelCatalog, r as prepareScopedReadOnlyModelCatalog } from "./prepared-model-runtime.scoped-catalog-iqsLjqoY.mjs";
...
async function loadProviderScopedThinkingCatalog(params) {
	...
	if (owner?.loadNativeModelCatalog && params.agentRuntime && params.agentRuntime !== "testclaw") snapshot = await owner.loadNativeModelCatalog({
		...
		const { augmentModelCatalogWithAgentHarness } = await import("./model-catalog-Bi_2qliI.mjs");
	...
	if (params.agentRuntime) {
		...
		if (entry) {
			const { selectModelCatalogRuntimeEntry } = await import("./model-catalog-view-DkkHAUus.mjs");
