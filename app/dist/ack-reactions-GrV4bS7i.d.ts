...
import { v as HumanDelayConfig, y as IdentityConfig } from "./types.base-CA0_JvyZ.js";
//#region src/agents/identity.d.ts
/** Resolve the configured identity block for one agent. */
declare function resolveAgentIdentity(cfg: TestclawConfig, agentId: string): IdentityConfig | undefined;
/** Resolve the acknowledgement reaction using account, channel, global, then identity fallback. */
declare function resolveAckReaction(cfg: TestclawConfig, agentId: string, opts?: {
  channel?: string;
  accountId?: string;
}): string;
/** Build the automatic `[name]` prefix for an agent identity. */
declare function resolveIdentityNamePrefix(cfg: TestclawConfig, agentId: string): string | undefined;
/** Resolve message and response prefix values together for channel delivery. */
declare function resolveEffectiveMessagesConfig(cfg: TestclawConfig, agentId: string, opts?: {
...
declare function resolveHumanDelayConfig(cfg: TestclawConfig, agentId: string): HumanDelayConfig | undefined;
//#endregion
