...
import { a as resolveOAuthRefreshLockPath, c as resolveSharedAuthStorePath, l as resolveSharedMainAuthAgentDir } from "./path-resolve-DhOkmnkh.mjs";
...
import { _ as runAuthProfileWriteTransaction, a as inspectPersistedAuthProfileStoreRaw, h as resolveAuthProfileDatabasePath, i as inspectPersistedAuthProfileStateRaw, n as deletePersistedAuthProfileStoreRaw, y as writePersistedAuthProfileStateRaw } from "./sqlite-BFln1N56.mjs";
...
import { E as OAUTH_REFRESH_LOCK_OPTIONS, _ as getRuntimeExternalCliProfileIds, a as loadPersistedAuthProfileStore, b as removeRuntimeExternalProfileReferences, o as loadPersistedAuthProfileStoreAtDatabasePath, p as buildPersistedAuthProfileState, s as loadPersistedSharedAuthProfileStore } from "./persisted-MKrH3nfz.mjs";
import { d as isSameOAuthRefreshGeneration, l as isOAuthRefreshFence, r as hasUsableOAuthCredential, s as createFailedOAuthRefreshFence } from "./credential-state-B72qRadL.mjs";
import { n as hasMatchingOAuthIdentity, r as hasOAuthIdentity } from "./oauth-shared-DqUUZy55.mjs";
import { a as findPersistedAuthProfileCredential, d as resolvePersistedAuthProfileOwnerAgentDir, f as resolveRuntimeAuthProfileAgentDir, u as isSharedMainAuthProfileAgentDir, w as isPersistedExternalCliAuthProfile } from "./store-_Ypv0hYn.mjs";
import { B as isExactOAuthCredential } from "./runtime-snapshots-BVrxpeKm.mjs";
import { f as dedupeProfileIds, p as listProfilesForProvider } from "./order-BnTFWeei.mjs";
import { u as resetAuthProfileFailureState } from "./usage-state-Bm5iXGhR.mjs";
import { f as saveAuthProfileStoreWithPreparedOwner, l as loadAuthProfileStoreWithoutExternalProfiles, p as updateAuthProfileStoreWithLock, r as ensureAuthProfileStoreForLocalUpdate, u as saveAuthProfileStore } from "./store-runtime-CZ_l0ERR.mjs";
...
//#endregion
export { loadCandidateAuthProfileStore as _, removeProviderAuthProfilesWithLock as a, resolveAuthStorePathForDisplay as b, persistAuthProfileBatch as c, OAuthRefreshPeerFenceError as d, failOAuthRefreshPeerClaims as f, listCandidateAuthProfileStores as g, settleOAuthRefreshPeerClaims as h, removeAuthProfilesAcrossOwnerStores as i, upsertAuthProfileWithLock as l, rollbackOAuthRefreshPeerClaims as m, markAuthProfileSuccess as n, setAuthProfileOrder as o, fenceOAuthRefreshPeers as p, promoteAuthProfileInOrder as r, upsertAuthProfile as s, clearLastGoodProfileWithLock as t, upsertAuthProfileWithLockOrThrow as u, withOAuthProfileLock as v, resolveAuthStatePathForDisplay as y };
