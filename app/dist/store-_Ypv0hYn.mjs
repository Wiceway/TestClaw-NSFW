...
import { a as resolveRequiredOsHomeDir, o as resolveUserPath } from "./home-dir-BPqVt7Ps.mjs";
...
import { C as withStateDatabaseCoordinatorRuntimeDirectory, g as prepareStateDatabaseSourceExclusion } from "./sqlite-source-handle-CDYF24uv.mjs";
import { n as inspectDatabasePathIdentitySync } from "./sqlite-worker-identity-CR_ZuhW6.mjs";
import { l as runSqliteReadOnlyWorker } from "./sqlite-readonly-worker-6W33iy-a.mjs";
...
import { r as MINIMAX_CLI_PROFILE_ID } from "./profile-ids-B9fFWPvP.mjs";
import { c as resolveSharedAuthStorePath, l as resolveSharedMainAuthAgentDir, o as resolveSharedAuthStoreOwnership, s as resolveSharedAuthStoreOwnershipAsync, t as captureAuthProfileOwnerScope } from "./path-resolve-DhOkmnkh.mjs";
...
import { O as listLegacyAuthProfileSources, _ as runAuthProfileWriteTransaction, a as inspectPersistedAuthProfileStoreRaw, b as writePersistedAuthProfileStoreRaw, g as resolveAuthProfileStoreOwner, h as resolveAuthProfileDatabasePath, k as resolveLegacyAuthProfileSourceCandidates, l as readPersistedAuthProfileStateRaw, m as resolveAuthProfileDatabaseOwnerId, n as deletePersistedAuthProfileStoreRaw, s as inspectPersistedSharedAuthProfileStoreRaw, u as readPersistedAuthProfileStoreRaw, v as runAuthProfileWriteTransactionAsync, y as writePersistedAuthProfileStateRaw } from "./sqlite-BFln1N56.mjs";
import { i as isUserModelAuthProfileId } from "./profile-usage-stats-DRJ9TkmC.mjs";
import { D as authProfilesLog, _ as getRuntimeExternalCliProfileIds, a as loadPersistedAuthProfileStore, b as removeRuntimeExternalProfileReferences, c as mergeAuthProfileStores, f as AuthProfileStoreUnreadableError, h as loadPersistedAuthProfileState, l as mergePersistedAuthProfileState, n as buildPersistedAuthProfileSecretsStore, o as loadPersistedAuthProfileStoreAtDatabasePath, s as loadPersistedSharedAuthProfileStore, v as mergeRuntimeExternalProfileReferences, w as EXTERNAL_CLI_SYNC_TTL_MS, x as setRuntimeExternalCliProfileIds, y as removePersonalAuthProfileReferences } from "./persisted-MKrH3nfz.mjs";
import { f as readOAuthRefreshGenerationDigest, l as isOAuthRefreshFence, o as captureOAuthRefreshClaimPublication, r as hasUsableOAuthCredential } from "./credential-state-B72qRadL.mjs";
import { i as readMiniMaxCliCredentialsCached } from "./cli-credentials-CyjDKMBN.mjs";
import { c as overlayRuntimeExternalOAuthProfiles, d as cloneAuthProfileStore, f as isSafeToCopyOAuthIdentity, l as shouldBootstrapFromExternalCliCredential, o as isSafeToAdoptBootstrapOAuthIdentity, t as areOAuthCredentialsEquivalent, u as shouldPersistRuntimeExternalOAuthProfile } from "./oauth-shared-DqUUZy55.mjs";
import { D as setRuntimeAuthProfileStoreSnapshotAtDatabasePath, E as setRuntimeAuthProfileStoreSnapshot, O as updateRuntimeAuthProfileStoreSnapshot, P as getRuntimeAuthProfileStoreCredentialMutationToken, T as runtimeAuthProfileRowsCache, b as noteRuntimeAuthProfileStorePersistedMutation, d as getRuntimeAuthProfileStoreSnapshotCore, n as clearRuntimeAuthProfileStoreSnapshotAtDatabasePath, o as getOwnedRuntimeAuthProfileStoreSnapshotAtDatabasePath, p as getRuntimeAuthProfileStoreSnapshotRevisionAtDatabasePath, r as clearRuntimeAuthProfileStoreSnapshotCore, s as getPreparedRuntimeAuthProfileStoreSnapshotCore, t as captureRuntimeAuthProfileLocalPin, u as getRuntimeAuthProfileStoreSnapshotAtDatabasePath, v as listOwnedRuntimeAuthProfileStoreSnapshots, w as restoreOwnedRuntimeAuthProfileStoreSnapshot, y as listRuntimeAuthProfileStoreSnapshotsForSharedOwner, z as captureOAuthRefreshSettlement } from "./runtime-snapshots-BVrxpeKm.mjs";
import { c as readUserModelAuthProfile, l as registerUserModelAuthProfileSecrets, p as updateUserModelAuthProfile } from "./user-model-accounts-D4lUc8aG.mjs";
import { a as assertAuthProfileMigrationStateAtDatabasePath, d as warnLegacyAuthProfileSourcesIgnored, i as assertAuthProfileMigrationReady, n as assertAuthProfileCredentialMigrationStateAtDatabasePath, r as assertAuthProfileMigrationCandidates, t as AuthProfileMigrationRequiredError } from "./legacy-source-diagnostic-C3oR-sYo.mjs";
import { S as shouldUseMainOwnerForLocalOAuthCredential, a as createEmptyAuthProfileStore, b as stripRuntimeExternalProfileMetadata, c as markRuntimePersistedProfiles, d as preserveResolvedSecretBackedCredentials, f as pruneAuthProfileStoreReferences, g as runtimeAuthProfileSnapshotSharesOwner, l as mergeLocalAuthProfileStoreWithInheritedStore, o as listRuntimeLocalProfileIds, s as loadRuntimeAuthProfileOwnerSnapshot, t as captureRuntimeAuthProfileLegacyCandidates, v as runtimeStoreInheritsMainState, x as isInheritedMainOAuthCredentialFromStores, y as setRuntimeLocalProfileMetadata } from "./runtime-snapshot-owner-BRsxcyEE.mjs";
import { n as prepareAuthProfileStoreMutation } from "./store-mutation-DesbRlRu.mjs";
import "./source-check-CB_N3ikB.mjs";
...
//#endregion
export { isAmbientCredentialAllowedByProviderAuthPin as C, resolveExternalCliAuthProfiles as D, readExternalCliBootstrapCredential as E, createExternalAuthRuntime as S, listExternalCliSyncProviderIds as T, publishPreparedRuntimeAuthProfileStoreSnapshot as _, findPersistedAuthProfileCredential as a, readSharedAuthProfileRows as b, getScopedAuthProfileEnv as c, resolvePersistedAuthProfileOwnerAgentDir as d, resolveRuntimeAuthProfileAgentDir as f, buildPortableAuthProfileStoreForAgentCopy as g, withEnvOnlyAuthProfileStore as h, createAuthProfileStoreRuntime as i, getScopedSharedAuthStore as l, withAuthProfileStoreAgentDir as m, captureAuthProfileStorePersistenceSnapshot as n, getPreparedRuntimeAuthProfileStoreSnapshot as o, restoreAuthProfileStorePersistenceSnapshot as p, clearRuntimeAuthProfileStoreSnapshot as r, getRuntimeAuthProfileStoreSnapshot as s, applyScopedAuthReadThrough as t, isSharedMainAuthProfileAgentDir as u, loadPersistedAuthProfileStoreFromRows as v, isPersistedExternalCliAuthProfile as w, materializePersonalAuthProfile as x, prepareAgentAuthProfileRowsRead as y };
