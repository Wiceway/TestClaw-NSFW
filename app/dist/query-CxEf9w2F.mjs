...
import { B as RECALLED_CONTEXT_LINE_PATTERNS, a as ACTIVE_MEMORY_OPEN_TAG, n as ACTIVE_MEMORY_CLOSE_TAG } from "./types-DgEaE0BK.mjs";
...
function findActiveMemoryCloseLine(lines, startIndex) {
	for (let index = startIndex; index < lines.length; index += 1) if ((lines[index]?.trim() ?? "") === ACTIVE_MEMORY_CLOSE_TAG) return index;
	return -1;
}
