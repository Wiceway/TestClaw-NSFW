...
import { l as resolveMediaReferenceSandboxPath } from "./media-reference-CjtkPle6.mjs";
import { n as normalizeContainerPathCore, t as isPathInsideContainerRoot } from "./path-utils-Drbu0ZHc.mjs";
