...
import { _ as describePluginAvailabilityFailure } from "./discovery-Beqghw38.mjs";
import { n as loadBundledPluginManifestRegistry } from "./manifest-registry-build-B06dCtmr.mjs";
import { n as loadBundledPluginPublicArtifactModuleSync, r as loadPluginPublicArtifactModuleSync, t as loadBundledPluginPublicArtifactModuleFromCandidatesSync } from "./public-surface-loader-CmdxTEvc.mjs";
...
import { o as registerHealthCheck, r as getHealthCheck } from "./health-check-registry-AvzmSJIz.mjs";
...
function registerBundledWorkerProviderHealthChecks(params, registerCheck) {
	...
	for (const pluginId of pluginIds) loadBundledPluginPublicArtifactModuleFromCandidatesSync({
		...
		async listPluginStateEntries(options) {
			const { createPluginStateKeyedStore } = await import("./plugin-state-store-B1-J6SV7.mjs");
