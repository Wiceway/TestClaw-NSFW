...
import { i as sha256StableValue } from "./node-crypto-B8Y3L7k8.mjs";
...
function normalizeBootstrapReceipt(value) {
	...
	return {
		bundleHash,
		testclawVersion: requireWorkerEnvironmentString(value.testclawVersion, "bootstrap Assistant version"),
