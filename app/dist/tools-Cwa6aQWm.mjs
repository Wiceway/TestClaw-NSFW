import { c as inspectProviderToolSchemasWithPlugin, p as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-v9pi62W8.mjs";
import { r as copyAgentToolMetadata } from "./agent-tool-metadata-CyFqBZ5V.mjs";
import { t as filterProviderNormalizableTools } from "./tool-schema-projection-CtKpYJEt.mjs";
...
function copyRuntimeToolMetadata(source, target) {
	...
	const { catalogMode, outputSchema, hideFromChannelProgress } = source;
...
function normalizeAgentRuntimeTools(params) {
	...
	return preserveRuntimeToolMetadata(normalizableTools, Array.isArray(normalized) ? Array.from(normalized) : normalizableTools);
}
