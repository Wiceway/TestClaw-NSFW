...
import { f as isBundledProviderCompatContract, m as withBundledPluginEnablementCompat, t as createInstalledPluginEnabledPredicate } from "./installed-plugin-index-Cd3PE_mG.mjs";
...
import { n as isManifestPluginAvailableForControlPlane, o as loadManifestContractSnapshot, r as isManifestPluginOwnerAllowedByControlPlanePolicy, t as hasManifestContractValue } from "./manifest-contract-eligibility-Cir-JbRF.mjs";
import { a as resolveConfiguredTalkRealtimeProviderId, o as resolveConfiguredTalkSpeechProviderId } from "./talk-CV-gw2AL.mjs";
import { c as resolvePluginCapabilityCatalogContext, i as loadAssistantPluginsWithInternalOverrides, l as resolveRuntimePluginRegistry, n as acquirePluginRegistryWithInternalOverrides } from "./loader-runtime-load-nvWKqtze.mjs";
import { o as registryContainsRuntimePluginIds, r as getLoadedRuntimePluginRegistry } from "./active-runtime-registry-CFUp_yLA.mjs";
import { n as findCapabilityProviderEntry } from "./provider-registry-shared-CGngP_UC.mjs";
import { r as getPluginRuntimeLoadContext, t as buildPluginRuntimeLoadOptions } from "./load-context-CEKyQMyt.mjs";
