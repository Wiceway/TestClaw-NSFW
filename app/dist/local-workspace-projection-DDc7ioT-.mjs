...
import { c as serializeWorkerWorkspaceManifest, l as serializeWorkerWorkspaceReconciliationPlan, o as parseWorkerWorkspaceManifest, s as parseWorkerWorkspaceReconciliationPlan } from "./workspace-manifest-Ify_1Ssa.mjs";
import { r as manifestNodes } from "./workspace-manifest-comparison-DoEdN3VL.mjs";
import { c as requireGit, l as requireGitBuffer } from "./git-C-rUSsb0.mjs";
import { u as captureWorkspaceSnapshot } from "./workspace-reconcile-fs-BNf4p_qM.mjs";
import { a as recoverWorkerWorkspaceReconciliation, n as AcceptedWorkspacePublicationIndeterminateError, t as applyStagedWorkerWorkspace } from "./workspace-reconcile-BBxtIEQ4.mjs";
import { t as withWorktreeGitConfig } from "./checkout-git-config-BtAsPcLl.mjs";
import { d as getRegistryWorktree, u as findLiveRegistryWorktreeByPath } from "./registry-BYEaQrMy.mjs";
import { c as splitNullBuffer } from "./git-path-inventory-sE4y6-Mm.mjs";
import { a as hasWorkerWorkspaceResultRef, d as withStagedWorkerWorkspaceResult, f as workerWorkspaceResultRef, l as readStagedWorkerWorkspaceResult, p as workerWorkspaceResultStaging, r as deleteStagedWorkerWorkspaceResult } from "./workspace-result-staging-jA6R4hR_.mjs";
import { t as localWorkspaceStore } from "./local-workspace-store-CoTKPswN.mjs";
import { a as runWorkspaceInventoryCommandToFile } from "./workspace-sync-inventory-BnNfakeh.mjs";
...
function localWorkspaceArchiveOperations(params) {
	...
	return {
		...
		expire: async (retireSnapshot) => {
			...
			const { readLocalWorkspaceRuntimes } = await import("./local-workspace-quiescence-NSI0QVAE.mjs");
...
async function withLocalWorkspaceProjection(owner, run, options = {}) {
	return await withAssistantStateLease({
		...
		const { quiesceLocalWorkspace, parseLocalWorkspacePausedRuntimes } = await import("./local-workspace-quiescence-NSI0QVAE.mjs");
