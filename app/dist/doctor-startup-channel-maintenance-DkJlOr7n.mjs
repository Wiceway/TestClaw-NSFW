import { t as runChannelPluginStartupMaintenance } from "./lifecycle-startup-DWG1X0-y.mjs";
import { n as resolveDoctorChannelPreviewConfig } from "./preview-warnings-BAhZfcO2.mjs";
...
async function collectChannelPreviewWarningHealthFindings(params) {
	const { collectChannelDoctorPreviewWarnings } = await import("./channel-doctor-ByO2bSww.mjs");
	const doctorFixCommand = params.doctorFixCommand ?? "testclaw doctor --fix";
