import { a as WINDOWS_TASK_SUPERVISOR_RESTART_EXIT_CODE_MAX, c as isWindowsTaskSupervisorChildArgument, n as WINDOWS_TASK_LAUNCHER_ENV, o as WINDOWS_TASK_SUPERVISOR_RESTART_EXIT_CODE_MIN, s as formatWindowsTaskSupervisorChildArgument } from "./windows-task-supervisor-contract-BzWmAmHJ.mjs";
...
async function runWindowsGatewayTaskSupervisor() {
	...
	try {
		...
		if (launcher === "wscript") {
			const [{ default: koffi }, { bindWindowsTaskLauncher }] = await Promise.all([import("koffi"), import("./service-child-windows-task-launcher-Ct9X7k6N.mjs")]);
