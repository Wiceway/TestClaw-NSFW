...
declare function createAccountListHelpers<TConfig extends Record<string, unknown> = Record<string, unknown>>(channelKey: string, options?: {
  ...
  additionalAccountIds?: (cfg: TestclawConfig) => Iterable<string>;
  fallbackAccountIdWhenEmpty?: string | false;
  implicitDefaultAccount?: {
    channelKeys?: readonly string[];
    envVars?: readonly string[];
  };
  hasImplicitDefaultAccount?: (cfg: TestclawConfig) => boolean;
  resolveImplicitAccountId?: (cfg: TestclawConfig) => string | undefined;
}): {
  listConfiguredAccountIds: (cfg: TestclawConfig) => string[];
  listAccountIds: (cfg: TestclawConfig) => string[];
  resolveDefaultAccountId: (cfg: TestclawConfig) => string;
  resolveAccountConfig: (cfg: TestclawConfig, accountId: string) => TConfig;
};
/**
