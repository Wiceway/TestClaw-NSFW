...
import { r as listKnownProviderAuthEnvVarNamesCore, s as resolveProviderAuthLookupMaps } from "./provider-env-vars-DBxaTVGF.mjs";
...
function listKnownNonSecretApiKeyMarkers() {
	knownNonSecretApiKeyMarkersCache ??= uniqueStrings([...CORE_NON_SECRET_API_KEY_MARKERS, ...listAssistantPluginManifestMetadata().flatMap((plugin) => plugin.origin === "bundled" ? normalizeTrimmedStringList(plugin.manifest.nonSecretAuthMarkers) : [])]);
...
//#endregion
export { SECRETREF_ENV_HEADER_MARKER_PREFIX as a, isOAuthApiKeyMarker as c, resolveNonEnvSecretRefHeaderValueMarker as d, resolveOAuthApiKeyMarker as f, MINIMAX_OAUTH_MARKER as i, isSecretRefHeaderValueMarker as l, resolveProviderEnvAuthLookupMaps as m, CUSTOM_LOCAL_AUTH_MARKER as n, isKnownEnvApiKeyMarker as o, listProviderEnvAuthLookupKeys as p, GCP_VERTEX_CREDENTIALS_MARKER as r, isNonSecretApiKeyMarker as s, CODEX_APP_SERVER_AUTH_MARKER as t, resolveEnvSecretRefHeaderValueMarker as u };
