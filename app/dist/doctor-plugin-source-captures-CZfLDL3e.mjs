...
import { D as walkDirectory } from "./fs-safe-B1VkXzpu.mjs";
import { t as hasErrnoCode } from "./errno-CkbDOfLk.mjs";
import { n as resolveNewStateDir, r as resolveStateDir } from "./state-dir-Bicqquql.mjs";
import { n as isLegacyPluginSourceCaptureName } from "./plugin-source-capture-path-W2y4l3k-.mjs";
...
import { n as isAssistantArgv } from "./gateway-process-argv-ChHzlSxd.mjs";
...
import { r as readProcessGroupMembers } from "./service-child-group-ownership-DXvcRCQv.mjs";
import { t as note } from "./note-BvG46svB.mjs";
import { n as formatBytes } from "./doctor-disk-space-Bv_jb-ps.mjs";
...
async function noteLegacyPluginSourceCaptures(env, shouldRepair = false) {
	...
	const warnings = [];
	try {
		const { resolveGatewayService } = await import("./service-DPsoBeZn.mjs");
