...
import { o as getCanonicalSqliteNamedIndexContracts } from "./sqlite-schema-contract-BhQmGuZB.mjs";
...
import { s as readDeferredPluginMigrations, t as DeferredPluginMigrationConflictError, u as withDeferredPluginMigrationsCurrent } from "./deferred-plugin-migrations-4hDLWarS.mjs";
import { r as getRuntimeConfig } from "./io.runtime-DIHH_X2V.mjs";
import "./config-DqAgdhnz.mjs";
import { v as inspectSqliteRecoveryFiles, y as moveSqliteFilesAside } from "./agent-database-admission-CyLpJ2LV.mjs";
import { m as ensureAssistantAgentDatabasePermissions, r as migrateAssistantAgentDatabaseForMaintenance, t as assertAssistantAgentDatabaseForMaintenance } from "./testclaw-agent-db-maintenance-50rOkGc_.mjs";
import { u as invalidateAssistantAgentDatabaseIntegrityBeforeMutation } from "./testclaw-agent-db-lease-gzW677CG.mjs";
import { a as closeAssistantAgentDatabaseByPath } from "./testclaw-agent-db-lifecycle-BQsqjh85.mjs";
import { c as isAssistantAgentDatabaseOpen, f as runAssistantAgentWriteTransaction, h as withAgentDatabaseMaintenanceLease, n as clearAssistantAgentDatabaseOpenFailure } from "./testclaw-agent-db-DAdiee0a.mjs";
import { a as normalizeStoreSessionKey } from "./store-entry-FtNy8CfS.mjs";
import { a as getSessionKysely, g as toDatabaseOptions, h as runExclusiveSqliteSessionWrite, i as formatSqliteSessionReferenceForScope, u as resolveSqliteScope } from "./session-accessor.sqlite-scope-kTo4D2H6.mjs";
import { u as reconcileSessionTranscriptIndexInTransaction } from "./session-transcript-index-S3XK2B3D.mjs";
...
import { a as resolveAllAgentSessionStoreTargetsSync, i as resolveAllAgentSessionStoreCandidateTargetsSync, l as resolveSessionStoreTargets, r as resolveAgentSessionStoreTargetsSync, s as resolveConfiguredAgentDatabaseTargets } from "./targets-DS0OmfJW.mjs";
import { f as writeSessionEntry, ft as recordLegacyAcpMigrationSources, gt as prepareLegacyAcpMigrationSource, z as invalidateSessionEntryMaintenanceAgeFact } from "./session-accessor.sqlite-entry-store-Ct1v5fIu.mjs";
import { n as assertSessionTranscriptHot } from "./session-cold-storage-state-lHKSo6QB.mjs";
import { t as advanceTranscriptMutationAtInTransaction, u as touchTranscriptMutationInTransaction } from "./session-accessor.sqlite-transcript-state-DELnx7YZ.mjs";
import { n as createRetainedAgentDatabaseMatcher } from "./agent-deletion-discovery-D-s4cGnL.mjs";
import { n as appendTranscriptEventsInTransaction } from "./session-accessor.sqlite-transcript-store-oZ7bC7_7.mjs";
