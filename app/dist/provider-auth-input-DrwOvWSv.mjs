...
import { i as isMalformedApiKeyInput } from "./credential-state-B72qRadL.mjs";
...
const loadModelAuthEnv = createLazyRuntimeModule(() => import("./model-auth-env-B9jD9f9w.mjs"));
const loadProviderAuthRef = createLazyRuntimeModule(() => import("./provider-auth-ref-xFQIBmo7.mjs"));
...
const validateApiKeyInput = (value) => {
	...
	if (isMalformedApiKeyInput(normalized)) return "Paste the API key value, not an Assistant onboarding command.";
};
