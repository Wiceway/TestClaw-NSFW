...
import { C as summarizeRestartSentinel, h as readRestartSentinel, i as clearRestartSentinelIfRevision, l as formatRestartSentinelMessage, s as finalizeUpdateRestartSentinelRunningVersion } from "./restart-sentinel-Csb-WRIg.mjs";
...
import { a as isPendingControlPlaneUpdateRestartSentinel } from "./update-control-plane-sentinel-D9E1Aa9B.mjs";
import { t as finishUpdateRun } from "./update-run-write-DLKbiRhE.mjs";
import { f as recordUpdateRunPhase, g as recordUpdateRunVerification } from "./update-run-ledger-CWjgjkCi.mjs";
...
import { d as resolveDurableCompletionDeliveryMode } from "./task-notification-routing-QKMzdln2.mjs";
...
import { n as dispatchGatewayLifecycleMethod } from "./server-recovery-runtime-context-DoAnlrSa.mjs";
import { t as dispatchReplyWithBufferedBlockDispatcherCore } from "./provider-dispatcher-BeGlRQ51.mjs";
import { L as drainPendingSessionDelivery, R as recoverPendingSessionDeliveries } from "./subagent-completion-admission.store-JZXyb7da.mjs";
import { a as SessionDeliveryDeferredError, i as SessionDeliveryDeadLetteredError, o as SessionDeliveryRetryChargedError, s as SessionDeliverySafeRetryError } from "./session-delivery-queue.records-BjWLZoS3.mjs";
import { a as enqueueSessionDelivery, d as mergeSessionDeliveryPreparedMediaBlocks, l as markSessionDeliveryAttemptStarted, o as failSessionDelivery, r as deferSessionDelivery, t as advanceSessionDeliveryAgentRun, u as markSessionDeliverySettlement } from "./session-delivery-queue-storage-loIz0kog.mjs";
import { r as hasExplicitlyVisibleAgentPayload } from "./message-visibility-bcJD66YP.mjs";
...
import { i as attachManagedOutgoingMediaToMessage, s as createManagedOutgoingMediaBlocks } from "./managed-image-attachments-BRMIS9SL.mjs";
import { a as enqueueRestartSentinelNotice, i as deliverRestartSentinelNotice, n as recordUpdateRunNoticeSkipped, r as resolveUpdateRunNoticeTarget } from "./update-run-notice-target-CowZZhgA.mjs";
...
async function deliverQueuedGeneratedMediaAgentTurn(params) {
	...
	const persistInternalMedia = route.channel === "webchat" && (entry.expectedMediaUrls?.length ?? 0) > 0 ? async (mediaUrls, transcriptRunId) => {
		...
		const { enrichAssistantTranscriptMediaForRun, publishAssistantTranscriptRewrite } = await import("./chat-transcript-persistence-B79aalZC.mjs");
		params.queueContext.admission.assertCurrent();
		let enriched = null;
