...
function createChannelProgressUiHints(params) {
	...
	return {
		...
		"streaming.progress.labels": {
			...
			help: params.labels === "testclaw" ? "Candidate labels for streaming.progress.label=\"auto\". Leave unset to use Assistant built-in progress labels." : "Candidate labels for streaming.progress.label=\"auto\". Leave unset to use the built-in \"Working\" label."
		},
