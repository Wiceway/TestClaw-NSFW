...
import { h as resolveNodeLaunchAgentLabel } from "./constants-DJMIH2n2.mjs";
import { r as signalProcessTree } from "./kill-tree-BGQdx374.mjs";
import { k as withTimeout, t as FsSafeError, w as root } from "./fs-safe-B1VkXzpu.mjs";
...
import { o as redactRegisteredSecretValues, s as registerSecretValueForRedaction } from "./secret-redaction-registry-DWRK6iJC.mjs";
import { t as formatErrorMessage } from "./errors-DNLGIg8_.mjs";
import { n as resolvePreferredAssistantTmpDir } from "./tmp-testclaw-dir-DCm0nmdl.mjs";
import { t as createSubsystemLogger } from "./subsystem-Bmu9GF-b.mjs";
import { l as sanitizeSystemRunEnvOverrides, s as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-zCuqI0tD.mjs";
import { t as VERSION } from "./version-BnaMeO13.mjs";
import { t as copyFileHandle } from "./file-descriptor--ToewmB_.mjs";
import { E as string, b as number, f as boolean, x as object } from "./schemas-qz0osXyE.mjs";
...
import { a as resolveExecutableFromPathEnv, o as resolveExecutablePath } from "./executable-path-DWJhQog7.mjs";
import { t as initializeNativeAssistantStateDatabase } from "./testclaw-state-db-BXFT1fUC.mjs";
...
import { r as withTempWorkspace, t as tempWorkspace } from "./private-temp-workspace-zG5_UiR7.mjs";
import { d as resolveCommandResolutionFromArgv, l as resolveApprovalAuditTrustPath } from "./exec-command-resolution-Ca5iRhk7.mjs";
import { P as normalizeExecutableToken, S as resolveInlineCommandMatch, a as extractShellWrapperCommand, c as hasPosixShellStartupBeforeInlineCommand, d as isShellWrapperInvocation, f as resolveShellWrapperTransportArgv, h as POSIX_INLINE_COMMAND_FLAGS, l as isBlockedShellWrapperCommand, n as POSIX_SHELL_WRAPPERS, t as POSIX_PARSEABLE_SHELL_WRAPPERS, w as extractEnvAssignmentKeysFromDispatchWrappers } from "./shell-wrapper-resolution-CPhcV89l.mjs";
import "./worker-admission-D3KU1TOA.mjs";
import { c as WORKER_PUBLIC_INGRESS_PATH } from "./worker-protocol-primitives-SWHIccOn.mjs";
import { i as NODE_WORKER_SUPERVISOR_PROTOCOL_FEATURE, r as NODE_WORKER_CAPACITY_MAX, t as NODE_RUNNER_INVENTORY_UPDATE_METHOD } from "./node-runner-inventory-BHZC33E8.mjs";
import { r as getRuntimeConfig } from "./io.runtime-DIHH_X2V.mjs";
import "./config-DqAgdhnz.mjs";
import { c as createCapturedOutputBuffers, i as runCommandWithTimeout, l as finalizeCapturedOutput, n as runExec, s as appendCapturedOutput, t as runCommandBuffered } from "./exec-BddaUUYf.mjs";
...
import { Bg as GATEWAY_SERVER_CAPS, ec as validateWorkerAdmissionHandshake } from "./src-BNV0SJoP.mjs";
import { t as GatewayClientRequestError } from "./request-error-Bu6YJefd.mjs";
import { i as isGatewayLoopbackHost, r as applyGatewayWebSocketTlsPin } from "./websocket-transport-DrOMT165.mjs";
import { O as buildCloudflareAccessHeaders, i as parseWorkerProcessResult, o as serializeWorkerProcessInput, t as buildWorkerProcessTurn, w as parseWorkerConnectionEndpoint, y as completeWorkerLaunchDescriptor } from "./worker-process-protocol-DAgOy1yj.mjs";
import { i as logWarn, t as logDebug } from "./logger-Bmf0V5tr.mjs";
import { _ as NODE_WORKER_CAPACITY_EXHAUSTED_ERROR_CODE, a as NODE_EXEC_APPROVALS_COMMANDS, c as NODE_MCP_TOOLS_CALL_COMMAND, h as NODE_TERMINAL_UPLOAD_COMMAND, i as NODE_DUPLEX_INVOKE_IDLE_TIMEOUT_MS, m as NODE_SYSTEM_RUN_COMMANDS, r as NODE_DEVICE_APPS_COMMAND, s as NODE_FS_LIST_DIR_COMMAND, t as NODE_AGENT_CLI_CLAUDE_RUN_COMMAND, u as NODE_MCP_TOOL_CALL_TIMEOUT_MS } from "./node-commands-BLhGKTZa.mjs";
import { o as readJsonBodyWithLimit } from "./http-body-CLbsEXM2.mjs";
import { t as resolveMcpRequestTimeoutMs } from "./mcp-transport-config-DNz9iwKg.mjs";
import { i as isMcpHttpSessionExpired, l as redactMcpDiagnosticError, n as connectMcpClient, r as disposeMcpClient } from "./mcp-client-lifecycle-Di1oO2De.mjs";
import { n as createServiceChildRelayAdapter, t as createChildAdapter } from "./child-BKtK19VC.mjs";
import { n as supportsNodeWorkerProcessOwner } from "./service-child-protocol-BASUIVtb.mjs";
import { c as createMcpJsonSchemaValidator, n as normalizeMcpToolCatalog, o as sanitizeMcpMetadataText, r as collectMcpPaginatedItems, t as resolveMcpTransport } from "./mcp-transport-BqWBB8LV.mjs";
import { i as jsonUtf8BytesOrInfinity, t as boundedJsonUtf8Bytes } from "./json-utf8-bytes-fm9i4b7G.mjs";
import { t as isMcpToolAllowed } from "./mcp-tool-filter-BFjsm6Nl.mjs";
import { n as tightenPrivateDirRootSync, t as tightenPrivateDirChain } from "./private-dir-mode-CfIQtph_.mjs";
import { g as parseScreenSnapshotResult, n as COMPUTER_CONTRACT_MISMATCH, p as parseComputerActResult } from "./computer-use-contract-DhRDTcIL.mjs";
import { a as mergeExecApprovalsSocketDefaults, n as DEFAULT_SECURITY } from "./exec-approvals-config-BRtA2IE3.mjs";
import { C as minSecurity, S as maxAsk, b as commandRequiresSecurityAuditSuppressionApproval, c as hasDurableExecApproval, d as isExecApprovalPolicySnapshotCurrent, g as resolveDurableExecApprovalRequirement, h as resolveAllowAlwaysPersistenceDecision, m as resolveAllowAlwaysPatternCoverage, s as createExecApprovalPolicySnapshot } from "./exec-approvals-authorization.kernel-DwCnJmG2.mjs";
...
import { n as resolvePlannedSegmentArgv, r as analyzeArgvCommand } from "./exec-approvals-analysis-BULxro3E.mjs";
import "./exec-wrapper-resolution-ChbEn7AS.mjs";
import { l as describeInterpreterInlineEval } from "./risks-HzTsadnl.mjs";
import { _ as planShellAuthorization, g as planExecAuthorization, i as evaluateShellAllowlistWithAuthorization, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-e0iaS2Bs.mjs";
import { a as resolveExecApprovalsLocked, c as commitExecAuthorizationLocked, i as resolveExecApprovalsFromFile, n as redactExecApprovals, s as requestJsonlSocket, t as normalizeExecApprovals } from "./exec-approvals-BBEWVrGM.mjs";
import { a as listRegisteredNodeHostCapsAndCommands, c as evaluateSystemRunPolicy, i as isRegisteredNodeHostCommandDuplex, l as resolveExecApprovalDecision, n as hasRegisteredNodeHostCommandActiveWork, o as notifyRegisteredNodeHostCommandDisconnect, r as invokeRegisteredNodeHostCommand, s as watchRegisteredNodeHostCommandAvailability, t as ensureNodeHostPluginRegistry, u as resolveNodeExecConfigPolicy } from "./plugin-node-host-CjFLjEf1.mjs";
import { s as gitNullConfigPath } from "./git-exec-0cc0Upnj.mjs";
import { r as tryReadDiskSpace } from "./disk-space-CtKhSv74.mjs";
import { t as getProcessSupervisor } from "./supervisor-DBtmUeXo.mjs";
import { a as ensureStagedInputDirectory, c as stagedInputDirectoriesFromEntries, o as isStagedInputPath } from "./staged-inputs-BLLLz0d5.mjs";
import { a as MAX_WORKSPACE_MANIFEST_BYTES, i as MAX_WORKSPACE_INVENTORY_TOTAL_BYTES } from "./workspace-inventory-limits-DfDQlGHa.mjs";
import { _ as workspaceStatIdentity, d as serializeRemoteWorkspaceHashMemo, f as takeWorkspaceHashMemo, p as withWorkerWorkspaceHashMemo, s as parseRemoteWorkspaceManifestEnvelope, t as MAX_WORKSPACE_HASH_MEMO_BYTES, u as replaceWorkerWorkspaceHashMemoEntries } from "./workspace-hash-memo-tBbmQxde.mjs";
import { t as changedPaths } from "./workspace-manifest-comparison-DoEdN3VL.mjs";
import { h as parseWorkspaceManifest, m as overlayWorkspaceManifest, t as absoluteEntryMatches } from "./workspace-reconcile-fs-BNf4p_qM.mjs";
import { t as applyStagedWorkerWorkspace } from "./workspace-reconcile-BBxtIEQ4.mjs";
import { n as boundedWorkerErrorWithCode, t as boundedWorkerError } from "./worker-error-ylcLWUlF.mjs";
import { n as WORKER_BUNDLE_ENTRY_PATH, o as hashWorkerBundleManifest, s as workerBundleArchiveRelativePath } from "./worker-bundle-hash-BnRiAYh0.mjs";
import { t as DEFAULT_WORKER_BUNDLE_ARCHIVE_LIMITS } from "./worker-bundle-limits-CF239rpc.mjs";
import { r as readWorkerBundleDirectoryManifest, t as extractWorkerBundleArchive } from "./worker-bundle-archive-Du1f7cno.mjs";
import { t as createNodeDuplexEndpoint } from "./node-duplex-framing-A5ewuqpE.mjs";
import { n as NODE_DESKTOP_STREAM_COMMAND, r as NODE_PORTAL_ATTACH_PATH, t as NODE_DESKTOP_ATTACH_PATH } from "./node-desktop-stream-BZM2AiRA.mjs";
import { t as loadSingleSkillDirectory, u as tryRealpath } from "./local-loader-CT9lL3Xc.mjs";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-i4_5kmZr.mjs";
import { _ as formatExecCommand, h as revalidateApprovedMutableFileOperand, l as resolveMutableFileOperandSnapshotSync, o as prepareSystemRunExecutableIdentityBinding, t as APPROVAL_SCRIPT_OPERAND_DRIFT_DENIED_MESSAGE, u as revalidateSystemRunMutableFileBinding, v as resolveSystemRunCommandRequest } from "./system-run-approval-binding-C4sb8YTM.mjs";
import { n as detectPolicyInlineEval } from "./policy-rcE8M9fa.mjs";
import { n as NODE_HOST_STATS_INTERVAL_MS, t as NODE_HOST_STATS_EVENT } from "./node-host-stats-I3w3IYYG.mjs";
import { c as resolveExecAutoReviewDecision, o as formatExecAutoReviewAssessment, r as EXEC_AUTO_REVIEW_SHELL_STARTUP_WARNING, t as EXEC_AUTO_REVIEW_DENIAL_GUIDANCE } from "./exec-auto-review-BSwWXYeA.mjs";
import { a as NodeClaudeSkillResultSchema, c as encodeNodeClaudeSkillMessage, n as NODE_CLAUDE_SKILLS_MESSAGE_BYTES, r as NODE_CLAUDE_WORKSHOP_CALL_BYTES, s as decodeNodeClaudeSkillInit, t as NODE_CLAUDE_SKILLS_CAPABILITY } from "./node-claude-skill-protocol-vz147HUx.mjs";
import { t as ensureAssistantCliOnPath } from "./path-env-D0-aNIo4.mjs";
import { n as stageTerminalUpload, t as ensureTerminalUploadCleanup } from "./terminal-file-upload-ykumt-2H.mjs";
import { t as BoundedBuffer } from "./bounded-buffer-R7mwXp10.mjs";
import { n as connectRfbServer, t as classifyRfbSecurity } from "./rfb-probe-8CgUWhMx.mjs";
import { i as isWorkerDesktopUsername, n as isWorkerDesktopArgs, r as isWorkerDesktopString, t as isWorkerDesktopArdPassword } from "./worker-desktop-descriptor-DZyj9bOd.mjs";
...
import { n as requestsClaudeNodeSkillRuntime, t as decodeClaudeCliNodeRunParams } from "./invoke-agent-cli-claude-params-Bi-USBdQ.mjs";
import { n as parseNodeWorkerComputerInput } from "./node-computer-protocol-BYljeQQi.mjs";
import { t as materializeSkillResources } from "./resources-DFNI-ARk.mjs";
import { i as resolveUnpinnedAutoApprovalEligibility, n as captureApprovedCwdSnapshotSync, r as revalidateApprovedCwdSnapshot, t as APPROVAL_CWD_DRIFT_DENIED_MESSAGE } from "./system-run-cwd-binding-C-vynT2i.mjs";
import { t as normalizeSystemRunApprovalPlan } from "./system-run-approval-plan-BKH1tdNX.mjs";
import { t as buildAuthorizedShellCommandFromPlan } from "./exec-authorization-render-q7Fz4p6u.mjs";
import { t as scanInstalledApps } from "./installed-apps-Dhe8aPRY.mjs";
import { t as listHostDirectories } from "./host-directory-listing-Cr8UEgwk.mjs";
import { a as parseNodeWorkerBundleInstallInput, i as nodeWorkerBundleTransferPath, r as NodeWorkerBundleInstallError, t as NODE_WORKER_BUNDLE_INSTALL_ERROR_CODE } from "./node-bundle-install-protocol-B1zSrPHg.mjs";
import { t as parseNodeWorkerPreparedWorkspaceInput } from "./node-workspace-prepared-protocol-CeNMrk4X.mjs";
import { a as NodeWorkerWorkspaceTransferError, c as nodeWorkspaceTransferBlobPath, d as nodeWorkspaceTransferReconcilePath, l as nodeWorkspaceTransferManifestPath, n as NODE_WORKSPACE_EMPTY_MANIFEST_REF, r as NODE_WORKSPACE_TRANSFER_ERROR_CODE, s as isNodeWorkspaceTransferInvalidReason, t as NODE_WORKSPACE_EMPTY_MANIFEST, u as nodeWorkspaceTransferPackPath } from "./node-workspace-transfer-protocol-BZtjkTnv.mjs";
import { i as parseWorkspaceInspectionInput, r as isWorkspaceInspectionCommand } from "./workspace-inspection-protocol-DEK8M15S.mjs";
import { a as parseNodeWorkerWorkspaceExecInput, r as NODE_WORKER_WORKSPACE_STDOUT_MAX_BYTES, s as projectNodeWorkerWorkspaceExecResult, t as NODE_WORKER_WORKSPACE_STDERR_MAX_BYTES } from "./node-workspace-protocol-Npg4AxJH.mjs";
import { r as parseNodeWorkerWorkspaceRetainInput } from "./node-workspace-retain-protocol-M8KqdE0o.mjs";
...
import { a as setSessionWorkspaceFile, n as listSessionWorkspaceFiles, t as getSessionWorkspaceFile } from "./workspace-files-Bsva_xCo.mjs";
...
import { n as readWorkspaceTransferBody, t as boundedWorkspaceTransferChunks } from "./node-workspace-transfer-body-CE3uVhq8.mjs";
import { t as REMOTE_GITHUB_PUBLICATION_SNAPSHOT_JS } from "./github-repository-publication-snapshot-DtG9fxxv.mjs";
import { r as selectWorkspaceSeedsToPrune, t as WORKSPACE_SEED_RETENTION } from "./workspace-seed-retention-CLuCf_ZX.mjs";
