...
import { i as normalizeTlsFingerprint, n as isGatewayClientStoppedError, r as normalizeGatewayErrorText, t as formatGatewayClientErrorForLog } from "./client-address-utils-CbFoLQ4k.mjs";
import { d as readConnectErrorRecoveryAdvice, p as readPairingConnectErrorDetails, t as ConnectErrorDetailCodes, u as readConnectErrorDetailCode } from "./connect-error-details-BvebFtE_.mjs";
import { t as normalizeDeviceAuthRole } from "./device-auth-C-STNejO.mjs";
import { c as prepareDeviceAuthStore, d as storeOriginDeviceToken, i as loadDeviceAuthTokenReadOnly, n as clearOriginDeviceToken, o as loadOriginDeviceToken, r as loadDeviceAuthToken, s as loadOriginDeviceTokenReadOnly, t as clearDeviceAuthToken, u as storeDeviceAuthToken } from "./device-auth-store-CpeaaLlm.mjs";
import { c as signDevicePayload, i as loadOrCreateDeviceIdentity, r as loadDeviceIdentityIfPresent, s as publicKeyRawBase64UrlFromPem } from "./device-identity-DxW0pian.mjs";
import { a as resolveConnectChallengeTimeoutMs, c as resolveSafeTimeoutDelayMs, i as clearGatewayConnectTimeout, l as startGatewayConnectTimeout, s as resolvePreauthHandshakeTimeoutMs, t as DEFAULT_GATEWAY_REQUEST_TIMEOUT_MS } from "./timeouts-Bm8XlcCK.mjs";
import "./version-CwNT1gaY.mjs";
import { o as resolveGatewayStartupRetryAfterMs } from "./startup-unavailable-D0-EeFjq.mjs";
import { n as buildDeviceAuthPayloadV3 } from "./device-auth-na9vtJo1.mjs";
import { i as retainGatewayResponsePayload, n as GatewayProtocolRequestTimeoutError, t as GatewayProtocolRequestError } from "./protocol-request-BMUN1re6.mjs";
import { r as markGatewayConnectAssemblyError, t as GatewayClientRequestError } from "./request-error-Bu6YJefd.mjs";
import { t as rawDataToString } from "./websocket-data-2vBvd4uX.mjs";
import { a as resolveGatewayWebSocketTransport, i as isGatewayLoopbackHost, n as GatewayWebSocketTransportConfigurationError } from "./websocket-transport-DrOMT165.mjs";
import { t as WebSocket } from "./websocket-CGHaToS5.mjs";
import { n as logError, t as logDebug } from "./logger-Bmf0V5tr.mjs";
import { r as registerManagedProxyGatewayLoopbackBypass, t as ensureInheritedManagedProxyRoutingActive } from "./proxy-lifecycle-DqKgDURL.mjs";
