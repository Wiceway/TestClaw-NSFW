...
import { i as removeRemoteNodeSkills, o as setRemoteSkillConnectionReconciler, r as recordRemoteSkillNodeInfo } from "./remote-skills-19JJuvQV.mjs";
import { n as executeDevicePairingMutation, t as DevicePairingAuthorityRefusedError } from "./device-pairing-worker-DlAH0QLC.mjs";
...
async function refreshRemoteNodeBinsUncoalesced(params) {
	...
	if (!remoteRegistry) return;
	const { loadWorkspaceSkills } = await import("./workspace-skill-loader-D0P85O4S.mjs");
