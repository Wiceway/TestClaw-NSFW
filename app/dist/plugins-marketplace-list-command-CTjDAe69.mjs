...
async function runPluginMarketplaceListCommand(source, opts) {
	const { listMarketplacePlugins } = await import("./marketplace-h4SM8Icc.mjs");
	const { createPluginInstallLogger, quietPluginJsonLogger } = await import("./plugins-command-helpers-y3BicmF-.mjs");
