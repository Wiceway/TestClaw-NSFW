...
import { A as unknown, C as preprocess, E as string, T as strictObject, _ as literal, b as number, d as array, f as boolean, g as lazy, j as url, k as union, l as _enum, m as discriminatedUnion, w as record, x as object } from "./schemas-qz0osXyE.mjs";
import { B as createAllowDenyChannelRulesSchema, D as TypingModeSchema, H as ZodIssueCode, L as MessagesSchema, N as BroadcastSchema, R as NativeCommandsSettingSchema, a as ContextVisibilityModeSchema, c as GroupPolicySchema, j as SecretInputSchema, l as HexColorSchema, m as ModelsConfigSchema, n as BlockStreamingCoalesceSchema, t as BlockStreamingChunkSchema, u as HumanDelaySchema, v as SecretsConfigSchema, w as TtsConfigSchema, y as SsrFPolicyConfigSchema } from "./zod-schema.core-v-bbtNf8.mjs";
import { t as parseDurationMs } from "./parse-duration-DBWI377R.mjs";
import { n as sensitive, t as configUiMetadata } from "./zod-schema.sensitive-XQpE2bSk.mjs";
import { t as parseByteSize } from "./parse-bytes-DCAjQ31S.mjs";
import { a as HeartbeatSchema, c as MemorySearchSchema, d as AgentModelSchema, f as AgentToolModelSchema, i as ElevatedAllowFromSchema, l as AgentModelMapSchema, n as AgentEntrySchema, p as DecisionModelSchema, r as AgentSandboxSchema, s as ToolsSchema, t as AgentContextLimitsSchema, u as AgentModelPolicySchema } from "./zod-schema.agent-runtime-BA4DC7-J.mjs";
import { a as ApprovalsSchema, i as ChannelBotLoopProtectionSchema, r as ChannelHeartbeatVisibilitySchema, t as ChannelImplicitMentionsSchema } from "./zod-schema.implicit-mentions-DZDZ5whr.mjs";
import { a as projectConfigFieldMetadata, r as CloudWorkersConfigSchema } from "./zod-schema.cloud-workers-DA4Q6Zx6.mjs";
import { a as READ_SCOPE, c as TALK_SCOPE, i as QUESTIONS_SCOPE, l as TALK_SECRETS_SCOPE, n as APPROVALS_SCOPE, o as SESSION_READ_SCOPE, r as PAIRING_SCOPE, s as SESSION_WRITE_SCOPE, t as ADMIN_SCOPE, u as WRITE_SCOPE } from "./operator-scopes-D-CL26h0.mjs";
import { t as findEdgeAuthIssue } from "./gateway-edge-auth-headers-DIemWTJm.mjs";
import { n as isHttpUrl, r as isHttpsUrl } from "./url-protocol-OU3K-ySz.mjs";
import { r as NODE_WORKER_CAPACITY_MAX } from "./node-runner-inventory-BHZC33E8.mjs";
