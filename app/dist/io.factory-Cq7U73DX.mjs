...
import { O as DuplicateAgentDirError, k as findDuplicateAgentDirs, p as materializeRuntimeConfig } from "./validation-core-tZ7JDiKd.mjs";
import { n as loadDotEnvAsync } from "./dotenv-ZFs38mnU.mjs";
import { a as hashConfigRaw, c as parseConfigJson5, d as resolveConfigIncludesForRead, n as containsConfigIncludeDirective, o as maybeLoadDotEnvForConfig, t as coerceConfig, u as resolveConfigForRead } from "./io.read-helpers-CchQKD1x.mjs";
import { f as migrateLegacyContextBudgetConfig, o as validateConfigObjectWithPlugins, s as validateConfigObjectWithPluginsAsync } from "./io.snapshot-preparation-CMr7aQeD.mjs";
...
function createConfigIO(options = {}) {
	...
	return {
		...
		writeConfigFile: async (config, writeOptions = {}) => {
			...
			const { writeConfigFileFromContext } = await import("./io.write-Ctu6yKV-.mjs");
			writeOptions.assertConfigPathForWrite?.();
