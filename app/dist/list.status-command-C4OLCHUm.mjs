...
import { P as parseModelPolicyWildcardRef, c as resolveAgentNativeModelPrimary, d as resolveAgentWorkspaceDir } from "./agent-scope-config-Dm8T0OhW.mjs";
import { t as resolveDefaultAgentWorkspaceDir } from "./workspace-default-path-xAxuUQuv.mjs";
import { s as stripSelfProviderModelPrefix } from "./provider-model-id-normalization-DG4lTdzR.mjs";
...
import { h as resolveConfiguredModelRef, i as buildModelAliasIndex, m as resolveConfiguredModelPolicyAllow, v as resolveModelRefFromString, y as readUtilityModelSetting } from "./model-selection-shared-DIVgwazZ.mjs";
...
import { n as OPENAI_PROVIDER_ID } from "./openai-routing-BjbLRc1p.mjs";
import { c as shouldEnableShellEnvFallback, n as getShellEnvAppliedKeys } from "./shell-env-etbD1Y0U.mjs";
...
import { s as getRuntimeAuthProfileStoreSnapshot } from "./store-_Ypv0hYn.mjs";
...
import { d as resolveManagedSecretRefRuntimeProviderAuth } from "./loader-runtime-load-nvWKqtze.mjs";
...
import { c as isOAuthApiKeyMarker, m as resolveProviderEnvAuthLookupMaps, p as listProviderEnvAuthLookupKeys, s as isNonSecretApiKeyMarker } from "./model-auth-markers-Bml4Y1AZ.mjs";
import { t as resolveEnvApiKey } from "./model-auth-env-8aEZOe8n.mjs";
import { S as resolveUsableCustomProviderApiKey, r as getCustomProviderApiKey, v as resolveProviderConfigSecretInput } from "./model-auth-provider-config-BtBizCzx.mjs";
...
import { v as prepareProviderSyntheticAuthWithPlugin } from "./provider-runtime-v9pi62W8.mjs";
import { i as resolveRuntimeSyntheticAuthProviderRefs } from "./synthetic-auth.runtime.js";
import { r as maskApiKey } from "./model-catalog-auth-labels-BEoDV8nv.mjs";
...
import { a as loadPreparedModelCatalogSnapshot } from "./prepared-model-catalog-iMxpdaVw.mjs";
...
import { n as resolveAgentHarnessRuntimeAvailability } from "./runtime-plugin-BoB34352.mjs";
import { h as isRich, l as resolveModelsTargetAgent, n as ensureFlagCompatibility } from "./shared-DVPg8fou.mjs";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-Re63_Qq-.mjs"));
...
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-xt2OnbH1.mjs"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	const resolveCodexRuntimeAvailability = (provider) => {
		...
		const pending = (async () => {
			const { runPluginPayloadSmokeCheckForManifestRecords } = await import("./payload-verification-BOCL-fKH.mjs");
	...
	return withPluginMetadataSnapshotScope(metadataSnapshot, async () => {
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-recovery-hint-D9j3IzGO.mjs");
			runtime.log("");
