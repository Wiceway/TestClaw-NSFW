//#region src/shared/control-ui-link-reader.d.ts
/** Passive link-reader models shared by plugins and the Control UI. */
type ControlUiLinkReaderMetadata = {
...
type ControlUiLinkReaderDescriptor = {
  pluginId: string;
  id: string;
  label: string;
...
type ControlUiLinkReaderPreviewParams = {
  url: string;
  /** Selected agent hint; the receiving owner still authorizes identity selection. */
  agentId?: string;
};
type ControlUiLinkReaderDetailParams = ControlUiLinkReaderPreviewParams & {
  refresh?: boolean;
};
type ControlUiLinkReaderPreview = {
...
type ControlUiLinkReaderDocument = ControlUiLinkReaderPreview & {
...
//#endregion
export { ControlUiLinkReaderPreview as a, ControlUiLinkReaderMetadata as i, ControlUiLinkReaderDetailParams as n, ControlUiLinkReaderPreviewParams as o, ControlUiLinkReaderDocument as r, ControlUiLinkReaderDescriptor as t };