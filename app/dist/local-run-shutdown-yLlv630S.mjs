import { C as parseStrictNonNegativeInteger, n as MAX_TIMER_TIMEOUT_MS } from "./number-coercion-CLj0HTDM.mjs";
...
function resolveLocalRunShutdownGraceMs() {
	const raw = process.env.TESTCLAW_TUI_LOCAL_RUN_SHUTDOWN_GRACE_MS?.trim();
