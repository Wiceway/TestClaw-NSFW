...
import { C as tryResolveAmbientOwnerAgentId, T as tryResolveLegacyCompatibilityAgentId, v as resolveMutableAgentEntry } from "./agent-scope-config-Dm8T0OhW.mjs";
...
import { c as isSecretRef, h as resolveDefaultSecretProviderAlias, l as isValidEnvSecretRefId } from "./ref-contract-BVi3ykLT.mjs";
...
import { y as parseIpAddressOrCidr } from "./ip-3mD58gHN.mjs";
...
import { a as isLoopbackAddress, d as isTrustedProxyAddress } from "./net-D6MXMoHn.mjs";
import { r as findTailscaleBinary } from "./tailscale-DhbWzWKD.mjs";
...
import { a as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-BWH3Jzzo.mjs";
import "./systemd-C14FU_go.mjs";
import { o as formatPortRangeHint } from "./error-format-Puu-o0M-.mjs";
...
import { a as guardCancel, d as summarizeExistingConfig, f as validateGatewayPasswordInput, n as applyWizardMetadata, p as waitForGatewayReachable, s as normalizeGatewayTokenInput, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-BRZVRRpx.mjs";
import { a as ensureOnboardingAgentWorkspace, c as resolveOnboardingAgentTarget, i as applyOnboardingWorkspace, n as applyOnboardingPrimaryModel, r as applyOnboardingUtilityModel, t as applyAgentModelDefaults } from "./onboard-agent-target--U5T7XvY.mjs";
import { l as writeWizardConfigFile } from "./setup.shared-D_zf99RC.mjs";
...
import { a as outro, c as select, i as intro, l as text, n as CONFIGURE_WIZARD_SECTIONS, o as parseConfigureWizardSections, r as confirm, s as password, t as CONFIGURE_SECTION_OPTIONS } from "./configure.shared-DOWYdaU1.mjs";
import { i as setupChannels, n as createChannelSetupHooks } from "./onboard-channels-CtrtX6hJ.mjs";
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt-uIw2f8np.mjs";
import { i as applyAuthChoice } from "./auth-choice-BFAd8NXq.mjs";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BoevoZZ7.mjs";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-MN6qqJCE.mjs";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-B8IPVu63.mjs";
import { t as promptCustomApiConfig } from "./onboard-custom-DVyN_GYS.mjs";
import { t as validateDottedDecimalIPv4Input } from "./ipv4-8qOF3FFq.mjs";
import { i as maybeAddTailnetOriginToControlUiAllowedOrigins, n as TAILSCALE_EXPOSURE_OPTIONS, r as TAILSCALE_MISSING_BIN_NOTE_LINES, t as TAILSCALE_DOCS_LINES } from "./gateway-config-prompts.shared-DR3JR1Xs.mjs";
...
import { t as promptRemoteGatewayConfig } from "./onboard-remote-DclSREaS.mjs";
import { t as setupSkills } from "./onboard-skills-Cc1L4Whi.mjs";
...
const loadSetupPluginConfigModule = createLazyPromise(() => import("./setup.plugin-config-CvecUzIe.mjs"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-Bwa1vp3R.mjs");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, runSearchSetupFlow } = await import("./search-setup-H_s5ZbyK.mjs");
