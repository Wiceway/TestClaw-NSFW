import { a as HeartbeatSchema, c as ChannelConfigRuntimeSchema, d as JsonSchemaObject, f as ConfigUiGroup, i as AgentSandboxSchema, n as AgentContextLimitsSchema, o as ToolPolicySchema, p as ConfigUiPresentation, r as AgentEntrySchema, s as ToolsSchema, t as ChannelImplicitMentionsSchema } from "./zod-schema.implicit-mentions-Du1YLL_X.js";
import { f as ChannelBotLoopProtectionSchema, o as CommonChannelAccountSchema } from "./zod-schema.channel-messaging-common-DVuikTk7.js";
import { C as BroadcastSchema, D as MessagesSchema, E as MentionPatternsPolicySchema, O as ProviderCommandsSchema, T as GroupChatSchema, _ as SsrFPolicyConfigSchema, f as ModelsConfigSchema, w as DmConfigSchema, y as TtsConfigSchema } from "./zod-schema.core-CFOD6InI.js";
import { C as ReplyToMode, O as SessionThreadBindingsConfig, a as ChannelDeliveryStreamingConfig, b as LoggingConfig, d as ChannelStreamingProgressConfig, f as ContextVisibilityMode, g as GroupPolicy, i as BlockStreamingCoalesceConfig, j as TypingMode, l as ChannelStreamingConfig, m as DmPolicy, n as AuditConfig, o as ChannelPreviewStreamingConfig, p as DiagnosticsConfig, r as BlockStreamingChunkConfig, t as AgentElevatedAllowFromConfig, u as ChannelStreamingPreviewConfig, v as HumanDelayConfig, w as SessionConfig, y as IdentityConfig } from "./types.base-CA0_JvyZ.js";
import { a as SecretsConfig, d as SecretInput } from "./types.secrets-BR-Cncxg.js";
...
type ModelCatalog = {
  /** Publication-time opt-in: owned Testclaw provider id -> models.dev provider id. */
...
type PluginFormat = "testclaw" | "bundle";
...
type PluginDiagnostic = {
  ...
  sdkCompatibility?: {
    seam: string;
    coreVersion: string;
    builtWithTestclawVersion?: string;
    nestedSdk: boolean;
  };
};
...
type PluginManifestDoctorContract = {
   ...
   * Removal plan: remove the module fallback in Testclaw 2027.1 after external plugins migrate.
   */
...
type PluginManifestQaRunner = {
  /** Subcommand mounted beneath `testclaw qa`, for example `matrix`. */
  commandName: string;
...
type PluginManifestDecisionModel = {
  provider: string;
  id: string;
  name: string;
...
type AccessGroupConfig = AccessGroupsConfig[string];
//#endregion
...
type ExecApprovalForwardingConfig = NonNullable<ApprovalsConfig["exec"]>;
type ExecApprovalForwardingMode = NonNullable<ExecApprovalForwardingConfig["mode"]>;
type ExecApprovalForwardTarget = NonNullable<ExecApprovalForwardingConfig["targets"]>[number];
//#endregion
...
type SubagentDelegationMode = NonNullable<NonNullable<SchemaAgentDefaultsConfig["subagents"]>["delegationMode"]>;
...
/** Provider API families with first-class request/stream adapters in Testclaw. */
...
interface Model<TApi extends Api = Api> {
  ...
  reasoning: boolean;
  /**
   * Maps Testclaw thinking levels to provider/model-specific values.
...
declare const testClawConfigStateBrand: unique symbol;
type BrandedConfigState<TState extends string> = TestclawConfig & {
  readonly [testClawConfigStateBrand]?: TState;
};
...
//#endregion
export { TelegramGroupConfig as $, SilentReplyConversationType as $t, McpServerToolFilterConfig as A, TtsPersonaConfig as At, BrowserConfig as B, SafeBinProfile as Bt, ThinkingBudgets as C, ModelCatalogContextWindowOption as Cn, DiscordIntentsConfig as Ct, Transport as D, UnifiedModelCatalogSource as Dn, TtsConfig as Dt, ToolResultMessage as E, UnifiedModelCatalogKind as En, TtsAutoMode as Et, GatewayTailscaleMode as F, ToolLoopDetectionConfig as Ft, AgentDefaultsConfig as G, MentionPatternsPolicyConfig as Gt, AuthConfig as H, BroadcastStrategy as Ht, GatewayTrustedProxyConfig as I, ToolProfileId as It, AgentRuntimePolicyConfig as J, ExecApprovalForwardingMode as Jt, AgentModelEntryConfig as K, NativeCommandsSetting as Kt, ResolvedTalkConfig as L, ToolsConfig as Lt, GatewayAuthConfig as M, TtsProvider as Mt, GatewayAuthRateLimitConfig as N, GroupToolPolicyBySenderConfig as Nt, Usage as O, TtsMode as Ot, GatewayTailscaleConfig as P, GroupToolPolicyConfig as Pt, TelegramExecApprovalConfig as Q, AccessGroupsConfig as Qt, TalkConfig as R, MemoryCitationsMode as Rt, TextContent as S, resolveNormalizedAccountEntry as Sn, DiscordGuildEntry as St, Tool as T, UnifiedModelCatalogEntry as Tn, ResolvedTtsPersona as Tt, AgentBinding as U, DmConfig as Ut, BrowserProfileConfig as V, SafeBinProfileFixture as Vt, AgentContextLimitsConfig as W, MentionPatternsMode as Wt, TelegramActionConfig as X, AcpRuntimeSessionMode as Xt, TelegramAccountConfig as Y, ChannelBotLoopProtectionConfig as Yt, TelegramDirectConfig as Z, AccessGroupConfig as Zt, MaybePromise as _, PluginManifestSetupProvider as _n, DiscordActionConfig as _t, ModelDefinitionConfig as a, PluginManifestActivation as an, SlackReactionNotificationMode as at, SimpleStreamOptions as b, resolveAccountEntry as bn, DiscordExecApprovalConfig as bt, ModelProviderConfig as c, PluginManifestControlUi as cn, MSTeamsChannelConfig as ct, AssistantMessage as d, PluginManifestDashboardDataBinding as dn, MSTeamsReplyStyle as dt, PluginBundleFormat as en, TelegramInlineButtonsScope as et, AssistantMessageEvent as f, PluginManifestMcpServer as fn, MSTeamsTeamConfig as ft, ImageContent as g, PluginManifestProviderRequestProvider as gn, DiscordAccountConfig as gt, Context as h, PluginManifestProviderEndpoint as hn, GoogleChatConfig as ht, ModelCompatConfig as i, PluginManifest as in, SlackChannelConfig as it, PluginInstallRecord as j, TtsPersonaFallbackPolicy as jt, McpCodexToolApprovalMode as k, TtsModelOverrideConfig as kt, ModelApi as l, PluginManifestDashboard as ln, MSTeamsCloudName as lt, CompleteSimpleFn as m, PluginManifestNativeSessionCatalogSetup as mn, GoogleChatAccountConfig as mt, ConfigValidationIssue as n, PluginDiagnostic as nn, TelegramTopicConfig as nt, ModelMediaInputConfig as o, PluginManifestChannelCommandDefaults as on, SlackSlashCommandConfig as ot, AssistantMessageEventStreamContract as p, PluginManifestModelIdNormalizationProvider as pn, ChannelImplicitMentionsConfig as pt, SubagentDelegationMode as q, ExecApprovalForwardTarget as qt, TestclawConfig as r, PluginFormat as rn, SlackAccountConfig as rt, ModelProviderAuthMode as s, PluginManifestContracts as sn, SignalReactionNotificationMode as st, ConfigFileSnapshot as t, PluginConfigUiHint as tn, TelegramNetworkConfig as tt, Api as u, PluginManifestDashboardActionVerb as un, MSTeamsConfig as ut, Message as v, PluginKind as vn, DiscordAutoPresenceConfig as vt, ThinkingLevelMap as w, ModelCatalogStatus as wn, DiscordSlashCommandConfig as wt, StreamFn as x, resolveAccountKey as xn, DiscordGuildChannelConfig as xt, Model as y, ChannelAccountKeyPolicy as yn, DiscordConfig as yt, TalkProviderConfig as z, MemorySearchConfig as zt };