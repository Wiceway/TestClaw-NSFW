...
function formatInvalidConfigRecoveryHint() {
	return [`Run "${formatCliCommand("testclaw doctor --fix")}" to repair, then retry.`, "If startup is still blocked, inspect the adjacent .bak backup before restoring it manually."].join("\n");
}
