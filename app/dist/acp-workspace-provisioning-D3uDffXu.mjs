import { f as resolveAgentWorkspaceProvisioning, n as isImplicitAcpWorkspaceCandidate } from "./agent-scope-config-Dm8T0OhW.mjs";
...
async function resolveAcpAgentWorkspaceProvisioningForTurn(params) {
	...
	if (params.sessionKey) {
		const { resolveConfiguredAcpBindingSpecBySessionKey } = await import("./persistent-bindings.resolve-1WZL0O8N.mjs");
