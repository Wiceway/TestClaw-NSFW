...
import { n as resolveRuntimeWorkerThreadExecArgv } from "./runtime-worker-url-DEzGnZz9.mjs";
import { t as createCpuTrackedWorker } from "./worker-cpu-CKY5rkaq.mjs";
import { a as releaseWorkerNativeSectionsOnExit, n as createWorkerNativeSectionState, s as waitForWorkerNativeSections, t as cancelWorkerNativeSections } from "./worker-task-native-sections-DJJPCbWU.mjs";
		...
		const worker = runInWorkerPoolContext(() => {
			...
			if (temporaryDirectory) {
				...
				slot.releaseResources = async () => {
					try {
						const { removeTemporaryArtifacts } = await import("./temp-artifact-cleanup-DXAZenSv.mjs");
