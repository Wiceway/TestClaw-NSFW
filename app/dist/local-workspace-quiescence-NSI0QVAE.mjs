...
import { E as execContainer, c as bindPodmanSandboxEngine, u as validateSandboxContainerEngineTarget, w as DOCKER_SANDBOX_ENGINE } from "./docker-C4hnDi3L.mjs";
import { i as readBrowserRegistry, n as assertSandboxRegistryEntryCurrent, o as readRegistry, t as assertSandboxBrowserRegistryEntryCurrent } from "./registry-BWOS0ry_.mjs";
import { t as BROWSER_BRIDGES } from "./browser-bridges-CDm9-EDD.mjs";
...
async function quiesceLocalWorkspace(params) {
	...
	for (const { runtime, bridges } of selected) {
		...
		const captureRetirement = (id) => retirements.push(async () => {
			const { removeSandboxRuntimeGeneration } = await import("./manage-B-0Cn-zy.mjs");
