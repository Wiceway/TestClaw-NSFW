...
import "./startup-migration-checkpoint-BP_pKeOq.mjs";
...
import { r as hasCommandProcessCleanupError, t as CommandProcessCleanupError } from "./exec-result-DDSLXVaJ.mjs";
...
import { t as GatewayServiceDefinitionBackupReceiptSchema } from "./service-stage-DQv3shua.mjs";
...
import { n as hasGatewayServiceDefinitionOverrides, o as resolveManagedGatewayServiceCommand } from "./service-types-D9NIqD52.mjs";
import { a as resolveServiceEntrypoint, i as resolveManagedServiceNodeRunner } from "./service-layout-Vt9OJt8Q.mjs";
import { a as readDaemonRuntimePin, o as readDaemonRuntimePinForInstall } from "./runtime-pin-state-DHDrmeuf.mjs";
...
import { g as recordUpdateRunVerification, h as recordUpdateRunStep, p as recordUpdateRunRepairAttempt } from "./update-run-ledger-CWjgjkCi.mjs";
...
import { r as fingerprintGatewayServiceDefinition } from "./service-rebind-BUgKGjWl.mjs";
import { t as recoverInstalledLaunchAgent } from "./launchd-recovery-DGp-t6HN.mjs";
import { a as waitForGatewayHttpReadiness, i as resolveGatewayRestartProbeContext } from "./restart-health-probe-BWQHWIfG.mjs";
import { n as waitForGatewayHealthyRestart, o as renderRestartDiagnostics, s as inspectGatewayRestart, t as isSameGatewayRestartGeneration } from "./restart-health-DODQwMtT.mjs";
...
import { o as resolveUpdatedInstallCommandEnv, s as stripGatewayServiceMarkerEnv } from "./update-command-service-env-DbNjnRg7.mjs";
...
import { a as requiresRetainedUpdateCommandOwner, c as withUpdateCommandExecutorChild, d as UpdateCommandRecoveryPendingError, r as captureUpdateCommandExecutorAuthority, t as assertRetainedUpdateCommandRoot } from "./update-command-executor-C_9Me3Ow.mjs";
import { n as UpdatePreMutationError } from "./shared-hPUQ-y6A.mjs";
import { o as createPluginUpdateWarning } from "./update-command-plugins-internals-T3SfWaVR.mjs";
import { t as prepareUpdateCommandNativeGate } from "./update-command-native-gate-CQdMGbmx.mjs";
import { n as PackageIntegrityTimeoutError, r as createPackageIntegrityReader, t as PackageIntegrityLimitError } from "./package-update-integrity-Cx1-iR_m.mjs";
import { a as gatewayServiceCommandUsesRoot, i as assertGatewayServiceManagementAllowedForUpdate, p as resolveUpdatedGatewayRestartPort } from "./update-command-service-plan-BvweOT5A.mjs";
...
import { i as hasSchemaRefusal, n as checkTargetDatabaseSchemasForContexts, t as captureTargetDatabaseSchemaContext } from "./schema-preflight-BSE2UQ3z.mjs";
...
async function verifyPreviousManagedGatewayForUpdate(params) {
	...
	const identity = installationDrift ? await (await import("./update-command-package-Bu0x4U-U.mjs")).readPackageUpdateIdentity(params.root) : void 0;
	params.assertCurrent?.();
	let verified = false;
