...
import { $i as validateSessionsResolveParams, bi as validateSessionsDescribeParams, ia as validateSessionsStorageParams, pi as validateSessionsCleanupParams, qi as validateSessionsPreviewParams, ta as validateSessionsSearchParams, zi as validateSessionsListParams } from "./src-BNV0SJoP.mjs";
...
import { c as resolveExistingAgentSessionStoreTargetsSync, d as isConfiguredSessionStoreAgentId } from "./targets-DS0OmfJW.mjs";
import { t as SessionTranscriptColdError } from "./session-cold-storage-state-lHKSo6QB.mjs";
import { x as withSessionEntryReadOnlyScope } from "./session-accessor.sqlite-entry-BgjD5zI-.mjs";
import "./session-accessor-CtBBLApI.mjs";
import { n as resolveRequestedSessionAgentId } from "./session-request-agent-CmhrS9-1.mjs";
import { a as resolveStoredSessionKeyForAgentStore, i as resolveSessionStoreKey, n as resolveSessionStoreAgentId } from "./session-store-key-GnE6aqPA.mjs";
import "./sessions-QjbxjKuh.mjs";
import { n as runSessionsCleanup, o as serializeSessionCleanupResult } from "./cleanup-service-DEQ-rtBk.mjs";
...
import { E as gatewayClientSessionCreator, _ as resolveSessionSharingTarget, c as canAccessIncognitoSession, f as isGatewayAdmin, h as prepareSessionSharingTargets, n as authorizeIncognitoSessionTarget } from "./session-sharing-policy-gt4OMoUR.mjs";
import { a as filterSessionEntries, n as listProjectedSessions, r as prepareProjectedSessionList } from "./session-utils-list-C8xRKZPC.mjs";
...
import { t as readRecentSessionMessagesWithStatsAsync } from "./session-transcript-readers-DgYp6UTC.mjs";
...
import { t as getSessionColdStorageStatus } from "./session-cold-storage-D-khWbpj.mjs";
import { r as emitSessionsChanged } from "./session-change-event-DJR94g0D.mjs";
import { t as assertValidParams } from "./validation-uy_XyLdJ.mjs";
import { n as requestGatewaySessionColdStorageMaintenance, t as getSessionColdStorageMaintenanceStatus } from "./session-cold-storage-maintenance-C5TddxXT.mjs";
import { t as readSessionPreviewItemsFromTranscriptAsync } from "./session-transcript-preview-BTLBVjiA.mjs";
import { d as sessionLog, s as requireSessionKey } from "./sessions-shared-BEFWecy7.mjs";
...
const sessionByKeyReadHandlers = {
	...
	"sessions.get": async ({ params, respond, context, client, signal }) => {
		...
		const messages = selected.entry.incognito || isIncognitoSessionKey(selected.key) ? (await readRecentSessionMessagesWithStatsAsync(target, limits)).messages : await (await import("./session-history-worker-runtime-Nv1a0-vL.mjs")).readSessionHistoryPageInWorker({
			kind: "recent",
			params: {
				target,
				...limits
