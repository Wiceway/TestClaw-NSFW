...
import { i as watchCliExitAfterOutput, o as getPendingCliDisposers, t as exitCliAfterOutput } from "./one-shot-exit-lcRdrcHV.mjs";
import { n as hasCliProcessScope, r as retainCliProcessJobUntilExit } from "./runtime-cleanup-scope-CM7nGuUs.mjs";
...
import { c as normalizeUpdateChannel, i as UPDATE_EFFECTIVE_CHANNEL_ENV } from "./update-channels-D-eqC5La.mjs";
import { a as redactSupportDiagnosticLine } from "./diagnostic-support-redaction-B1vQapv6.mjs";
import { n as createUpdateFailureFact } from "./update-failure-facts-CQQBnbzM.mjs";
import { f as normalizeUpdatePostInstallDoctorWarnings, i as UpdateDoctorError, t as DoctorMaintenanceRefusalError } from "./update-doctor-result-Dn-wRvxN.mjs";
...
import { c as reconcileAbandonedUpdateRuns, d as recordUpdateRunDiagnostic, f as recordUpdateRunPhase, h as recordUpdateRunStep, m as recordUpdateRunRepairContinuation, n as adoptUpdateRun, r as createUpdateRun, s as heartbeatUpdateRun, t as acknowledgeAbandonedUpdateRun } from "./update-run-ledger-CWjgjkCi.mjs";
...
import { l as createUpdateOperationDeadline } from "./update-command-executor-C_9Me3Ow.mjs";
import { S as suppressDeprecations, o as reportPreMutationUpdateResult } from "./update-command-terminal-BZCyq7aD.mjs";
...
import { _ as tryWriteCompletionCache, c as parseTimeoutMsOrExit, g as tryResolveInvocationCwd, l as parseUpdateTimeoutMs, m as resolveUpdateRoot } from "./shared-hPUQ-y6A.mjs";
import { a as preparePostCorePluginConfig, i as persistValidatedDowngradeConfig, o as readPostCorePreUpdateSourceConfig, r as persistRequestedUpdateChannel } from "./update-command-config-CgomrYKI.mjs";
...
import { a as withPrePluginUpdateDoctorEnv, i as runUpdateFinalizationDoctorInFreshProcess, n as updatePluginsAfterCoreUpdate, o as UpdateFinalizationOutput, r as completePostCorePluginUpdate, t as completeSourceUpdateRuntime } from "./update-command-runtime-49WRijCo.mjs";
import { a as collectPostCorePluginFailureFacts, i as collectPostCorePluginAdvisories } from "./update-command-plugins-internals-T3SfWaVR.mjs";
import { t as assertUpdateRecoveryAdmission } from "./update-run-recovery-admission-BgCTLAZE.mjs";
import { n as UpdateCommandFailure, r as UpdateCommandFinalizedRecoveryFailure, v as withUpdateAdmissionReporting } from "./update-command-result-C1yfMxMf.mjs";
...
var UpdateFinalizationLifecycle = class {
	...
	async observeFailure(error) {
		...
		const { verifyUpdateFailureRecovery } = await import("./update-command-failure-recovery-Chhr7kC9.mjs");
