...
import { n as bindLegacyPluginSdkResourceHost, t as LegacyPluginSdkResourceHost } from "./legacy-sdk-resource-host-Bylva0Uj.mjs";
...
import { n as isTruthyEnvValue, r as logAcceptedEnvOption } from "./env-DiCPcdkM.mjs";
import { x as captureConfigOverrideApplier } from "./io.snapshot-B8cv2I8b.mjs";
...
import { b as resolveIsConfigReadOnly, l as isNixMode, u as normalizeStateDirEnv } from "./paths-DvpAEtA8.mjs";
import { r as isIncognitoSessionKey } from "./session-key-B8Cn8Xls.mjs";
import { a as isControlUiApprovalDocumentPath, i as classifyControlUiRequest, n as resolveControlUiShareOrigin, o as isControlUiFocusDocumentPath, s as isControlUiPluginManagerRequest, t as isControlUiSharePath } from "./control-ui-share-DG74x2IZ.mjs";
...
import { K as hasInternalDiagnosticEventInterest, P as runWithDiagnosticTraceContext, T as createDiagnosticTraceContext, b as setDiagnosticsEnabledForProcess, o as emitInternalDiagnosticEvent, p as isDiagnosticsEnabled, t as areDiagnosticsEnabledForProcess } from "./diagnostic-events-C4sEV9aC.mjs";
import { t as applyLoggingConfig } from "./logger-Cnti88IN.mjs";
...
import { d as prepareConfigRuntimeEnv, l as initializePublishedConfigRuntimeEnv, r as collectConfigRuntimeEnvOwnership } from "./config-env-vars-DSeyJ5Sb.mjs";
...
import { E as string, O as tuple, b as number, d as array, x as object } from "./schemas-qz0osXyE.mjs";
...
import { a as withArtifactPreservingStateReads, u as withExistingAssistantStateDatabaseReadOnly } from "./testclaw-state-db-readonly-L2ePyI_M.mjs";
import { n as getTrackedWorkerCpuSources } from "./worker-cpu-CKY5rkaq.mjs";
import { i as getGatewayPluginMetadataSnapshot, s as selectCurrentPluginMetadataCache } from "./current-plugin-metadata-state-CEUlVPFu.mjs";
import { n as registerPluginMetadataProcessMemoLifecycleClear, r as retainGatewayPluginMetadata } from "./plugin-metadata-lifecycle-C3T8T9Jz.mjs";
import { c as setGatewayPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CuzkxMsN.mjs";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-DiitF2V3.mjs";
import { D as setAppliedRuntimeConfigSnapshot, s as getRuntimeConfigSnapshot, u as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-Dti8jFIP.mjs";
...
import { a as hashConfigRaw, v as assertGatewayConfigEnvSelectionUnchanged } from "./io.read-helpers-CchQKD1x.mjs";
import { t as KeyedAsyncQueue } from "./keyed-async-queue-CTreGrmR.mjs";
import { t as _usingCtx } from "./usingCtx-E-VWE-jt.mjs";
import { c as portalIngressConflictsWithOrigin, s as isValidPortalIngressDomain } from "./zod-schema-D5oceVYH.mjs";
...
import { n as captureRemoteModelCatalogStartupSnapshot } from "./model-catalog-h3BsH2qo.mjs";
import { a as promoteConfigSnapshotToLastKnownGood, d as readConfigFileSnapshotWithPluginMetadata, l as readConfigFileSnapshotForRuntimeTransaction, r as getRuntimeConfig, y as registerConfigWriteListener } from "./io.runtime-DIHH_X2V.mjs";
import "./io-B_AwfUDz.mjs";
import "./config-DqAgdhnz.mjs";
import { n as GatewayLockError } from "./gateway-lock-CMKMxZa9.mjs";
import { o as purgeExpiredSecretStoreEntries } from "./secret-store-DwtizB8r.mjs";
import { t as isContainerEnvironment } from "./container-environment-CNsJSTpY.mjs";
import { _ as resolveGatewayListenHosts, r as isLocalDirectRequest, s as isLoopbackHost, y as resolveHostName } from "./net-D6MXMoHn.mjs";
import { f as buildRateLimitIdentityKey, p as createAuthRateLimiter, s as AUTH_RATE_LIMIT_SCOPE_NODE_REAPPROVAL, u as AUTH_RATE_LIMIT_SCOPE_WORKER_ADMISSION } from "./auth-rate-limit-Dk5g5GeL.mjs";
import { n as claimTailscaleServePort, s as readTailscaleWhoisIdentity } from "./tailscale-DhbWzWKD.mjs";
import { a as prepareGatewayIngressAttribution, i as markGatewayIngressTransport, n as PROXY_ATTRIBUTION_REQUIRED_REASON, o as readPreparedGatewayIngressAttribution, r as createGatewayUnattributableProxyReporter, t as PROXY_ATTRIBUTION_GUIDANCE } from "./ingress-attribution-DuobesAh.mjs";
...
import { t as isBrowserCopilotClient } from "./message-channel-C5zrzt0f.mjs";
...
import { n as loadGatewayTlsServerRuntime } from "./gateway-X9acZIDG.mjs";
import { n as WebSocketServer } from "./websocket-CGHaToS5.mjs";
import { d as createCoreGatewayMethodDescriptors, f as isCoreGatewayMethodClassified, h as listCoreGatewayMethodNames, u as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./method-scopes-Cn-bBRCy.mjs";
import { f as errorShape } from "./error-codes-WUvUxA6s.mjs";
import "./sessions-D-UIbeC_.mjs";
...
import { a as getActiveGatewayRootWorkCount, c as getGatewaySuspendAdmissionPhase, f as isGatewayWorkAdmissionClosed, s as getGatewayRestartDrainSignal, u as isGatewayRestartDraining, y as runOutsideGatewayRootWorkAdmission } from "./gateway-work-admission-DeFm4gyw.mjs";
import { a as isPackageProvenControlUiRootSync, c as resolveControlUiRootOverrideSync, i as inspectControlUiRootAssets, l as resolveControlUiRootSync, n as ensureControlUiAssetsBuilt } from "./control-ui-assets-BfKJRzJM.mjs";
...
import { a as createPluginRegistryOwner } from "./runtime-D1tHq7F4.mjs";
import { a as listLoadedChannelPluginsForRegistry } from "./registry-loaded-U-7eR7Vu.mjs";
import { a as runWithProcessCleanupBudget, i as getProcessCleanupBudget } from "./child-BKtK19VC.mjs";
import { i as tryLoadActivatedBundledPluginPublicSurfaceModule } from "./facade-runtime-BU46mtcN.mjs";
import { l as listAgentDatabaseAdmissionRefusals, p as withAgentDatabasePreparationGuard, r as canIsolateAgentDatabase } from "./agent-database-admission-CyLpJ2LV.mjs";
...
import { B as readUserProfileVersion, N as onUserProfilesChanged } from "./user-profiles-internal-BfnkNaNn.mjs";
...
import { i as clearSecretsRuntimeSnapshotState, o as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-p_Glf0Cm.mjs";
import { i as decodeSandboxHostCsp, n as buildSandboxHostDocument, o as resolveSandboxHostPort } from "./sandbox-host-CKiwbduk.mjs";
import { a as classifyMcpAppStandalonePath, c as classifyWorkerBootstrapArtifactTransferPath, i as classifyGatewayProbePath, l as classifyWorkerGatewayPath, o as classifyNodeWorkerBundleTransferPath, s as classifyNodeWorkspaceTransferPath } from "./gateway-http-route-contracts-ZNLfhchO.mjs";
import { m as readUserProfileDirectory, s as resolveUserProfileId } from "./user-profiles-_UmAgioR.mjs";
import { g as resolveOperatorSessionCreation, n as authorizeGatewaySessionCreation, p as resolveOperatorRolePolicyForProfile } from "./operator-role-policy-BqKjnbl9.mjs";
import { r as GatewayOperatorAccessUnavailableError } from "./operator-access-policy-FuVg7FFf.mjs";
...
import { s as resolveConfiguredAgentDatabaseTargets } from "./targets-DS0OmfJW.mjs";
...
import { C as publishSystemEventStoreConfig } from "./session-accessor.sqlite-entry-BgjD5zI-.mjs";
...
import { i as resolveSessionEventAgentScope, n as resolveRequestedSessionAgentId } from "./session-request-agent-CmhrS9-1.mjs";
import { o as createAgentRunRestartAbortError } from "./run-termination-Cf8kcgMU.mjs";
import { f as startDiagnosticHeartbeat, p as stopDiagnosticHeartbeat } from "./diagnostic-CjDzLGgv.mjs";
import { n as resolveCronJobsStorePathFromConfig } from "./paths-DhhZyQfL.mjs";
import "./store-DySaWHFF.mjs";
import { i as resolveActiveEmbeddedRunSessionId, t as getActiveEmbeddedRunCount } from "./active-run-projections-BihqvttO.mjs";
import { d as setGatewayRestartPolicy, f as setPreRestartDeferralCheck } from "./restart-BLOXglMD.mjs";
...
import { s as getTotalQueueSize, u as isGatewayDraining } from "./command-queue-8llssnSl.mjs";
...
import { t as createAgentRuntimeApprovalAuthorityValidator } from "./agent-runtime-identity-token-Be6SZrKX.mjs";
import { i as retireQuestionChannelGateway } from "./question-channel-runtime-DdOqbB9-.mjs";
import { i as withCoreCanvasNodeCapability, n as isCanvasDocumentHttpPath, r as resolveCanvasNodeCapability } from "./constants-TbtN10EL.mjs";
import { d as resumeGatewayRestartTraceFromHandoff, i as finishGatewayRestartTrace, n as collectGatewayProcessMemoryUsageMb, u as resumeGatewayRestartTraceFromEnv } from "./restart-trace-eKYE6PYh.mjs";
import { r as waitForMediaCleanupDrains, t as MEDIA_CLEANUP_STOP_TIMEOUT_MS } from "./server-media-cleanup-lifecycle-CDoi9fu0.mjs";
import { i as upsertPresence } from "./system-presence-CqJqlpE_.mjs";
import { a as createSessionMessageSubscriberRegistry, i as createSessionEventSubscriberRegistry, r as createChatRunState } from "./server-chat-state-s6eZWEwx.mjs";
import { a as rethrowGatewayStartupError, i as resolveGatewayShutdownNotice, o as runGatewayCloseSteps } from "./server-shutdown-CN_Up_Fm.mjs";
...
import { a as resolveAssistantAgentId } from "./assistant-avatar-BlC0Axxe.mjs";
import { a as parseControlUiUserAvatarPath, i as parseControlUiResourcePath, o as resolveAssistantMediaRoutePath } from "./control-ui-resource-routes-BkNuf_B2.mjs";
...
import { C as authenticatedProfileUnavailableError, _ as resolveSessionSharingTarget, m as isSessionVisibilityAllowed, y as resolveSessionVisibility } from "./session-sharing-policy-gt4OMoUR.mjs";
import { i as resolveVisibleActiveSessionRunState } from "./session-active-runs-B7nF2tZH.mjs";
import { D as prepareProjectedSessionSharing, O as prepareSessionSharing, T as createProfileSessionEntryFilter, w as canReceiveSessionEvent } from "./session-sharing-ByqW1ZoJ.mjs";
...
import { r as prepareGatewayAgentCliShim, t as clearGatewayAgentCliShim } from "./testclaw-cli-shim-DmdbtxmJ.mjs";
import { t as isCoreCanvasHostEnabled } from "./config-Cu5_58br.mjs";
import { n as installActiveGitHubOAuthLifecycle, t as createGitHubOAuthLifecycle } from "./github-oauth-lifecycle-btUO6zoO.mjs";
import { c as removeRemoteNodeInfoForConnection, i as recordRemoteNodeInfo, s as removeRemoteNodeInfo } from "./remote-75hX6LX9.mjs";
import { f as requestNodePairing, p as reusePendingNodePairingForReconnect, r as finalizeNodePairingCleanupClaim } from "./device-pairing-node-B8qqDaPQ.mjs";
...
import { f as waitForNodeWorkerSupervisor } from "./node-registry-private-F9l3rgde.mjs";
...
import { c as normalizePluginNodeCapabilityScopedUrl, d as reconcileClientPluginNodeCapabilities, o as indexPluginNodeCapabilitySurfaces } from "./plugin-node-capability-CGbSnr30.mjs";
import { n as mergeGatewayAuthConfig } from "./startup-auth-BRavxagO.mjs";
...
import { i as handleProviderOAuthCallback, t as PROVIDER_OAUTH_CALLBACK_PATH } from "./provider-browser-auth-CdiGcTzL.mjs";
import { t as adoptPluginHttpRouteHandoffs } from "./http-registry-BRDVY7GD.mjs";
import { u as revokeAttachGrantsForSession } from "./mcp-grant-store-D1Y-PT7h.mjs";
import { n as controlUiPluginAssetRoot } from "./control-ui-plugin-assets-contract-BqcSiyjv.mjs";
...
import { n as logWs, r as summarizeAgentEventForWsLog } from "./ws-log-t4EJEA4q.mjs";
import { b as respondPlainText, n as finishFailedGatewayHttpResponse, o as sendGatewayAuthFailure, p as setDefaultSecurityHeaders, r as isWebSocketUpgradeRequest, y as respondNotFound } from "./http-common-BRkymMwR.mjs";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-BvPWrEnf.mjs";
import { r as listConfigReloadRefinementPrefixes, s as diffGatewayReloadPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-WY_GBKpc.mjs";
import { n as parseDevicePairingJoinRequestPath } from "./join-code-B_OfdZ-j.mjs";
import { t as assertGatewayRuntimeSecurityConfig } from "./server-runtime-config-Dpqt0PnW.mjs";
import { _ as resolveEffectiveWebPushPreferences, f as WEB_PUSH_USER_PREFERENCES_KEY, h as normalizeWebPushDisplayLabel, p as isWebPushQuietHours, v as webPushAgentAllowed, y as webPushCategoryEnabled } from "./push-web-store.records-BIcpv8Gu.mjs";
...
import { r as queuePluginSessionsChanged } from "./gateway-events-D--gK1yU.mjs";
import { t as buildGatewaySessionSnapshot } from "./session-event-payload-C6MsfOsM.mjs";
import { t as attachSessionChangeEventLifetime } from "./session-change-event-DJR94g0D.mjs";
...
import { n as buildControlUiPublicSessionSharePath, r as parseControlUiPublicSessionShareUrl } from "./public-share-BPBXLwSy.mjs";
import { t as isTerminalConfigEnabled } from "./enabled-BSjeiWpO.mjs";
import { n as resolveGatewayReloadPluginActivationCandidate, t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-YUrLVbiP.mjs";
import { r as prepareWebPushNotificationSender, s as hasBoundWebPushSubscriptions } from "./push-web-C2JwKwo_.mjs";
import { n as getUserPreferences } from "./user-preferences-D56zhlv2.mjs";
import { n as webPushTargetClient, r as withCurrentWebPushAuthority, t as listCurrentWebPushTargets } from "./web-push-authority-BIG39pBz.mjs";
import { i as GATEWAY_EVENT_UPDATE_RUN_CHANGED, n as GATEWAY_EVENT_NODE_RUNNER_INVENTORY_CHANGED, t as GATEWAY_EVENT_DEVICE_PAIR_CHANGED } from "./events-CzKbLwW2.mjs";
import { t as createPresenceRecipientProjection } from "./presence-projection-h8V0vY-h.mjs";
import { a as incrementPresenceVersion, i as getPresenceVersion, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-DPk6C9K0.mjs";
import { t as collectGatewayWorkerPoolMetrics } from "./process-vitals-CMA6MgO_.mjs";
import { r as createModelAccountConnectService } from "./model-account-connect-DXLmfAVp.mjs";
import { i as prepareControlUiSessionPrRead, t as createControlUiSessionPullRequestSubscriptions } from "./control-ui-session-pr-subscriptions-tKRw7Hpe.mjs";
...
import { n as refreshConnectedNodeSurfaceCaches } from "./nodes.read-Do_9EPGq.mjs";
import { t as broadcastPresenceSnapshot } from "./presence-events-C3NKybuY.mjs";
import { n as createGatewayChatMetadataLifecycle, t as broadcastChatMetadataChanged } from "./server-chat-metadata-lifecycle-D6a3QGO2.mjs";
import { n as listPluginNodeCapabilities, t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-CuLTAIQQ.mjs";
import { n as applyGatewayLaneConcurrency, r as resolveGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-CogPb_Is.mjs";
...
import { t as recordClientPresenceActivity } from "./client-presence-CFh7CjYg.mjs";
import { i as disposeNodeConnectionNotifications, n as disconnectDisallowedGatewayPolicyClients, o as retireDeviceTokenClients } from "./ws-origin-policy-BeP4t5Ty.mjs";
import { r as createDesktopSessionRegistry } from "./session-registry-UGzd_Atk.mjs";
import { t as createGatewayStartupTrace } from "./server-startup-trace-CD8BamQh.mjs";
import { a as runWithGatewayHttpWorkAdmission, i as rejectGatewayUpgradeServiceUnavailable, r as shouldEnforceGatewayAuthForPluginPath, t as isPluginAuthenticatedRoutePath } from "./route-auth-6FXPp-2-.mjs";
import { n as handleNodeWorkerBundleTransferHttpRequest } from "./node-worker-bundle-transfer-http-faxshkcS.mjs";
import { n as handleNodeWorkspaceTransferHttpRequest } from "./node-workspace-transfer-http-A8F51lLG.mjs";
import { n as handleWorkerBootstrapArtifactTransferHttpRequest } from "./worker-bootstrap-artifact-transfer-http-CUDa-mjm.mjs";
import { i as markPublicWorkerIngress, t as GATEWAY_WS_CONNECTION_KIND_PROPERTY } from "./ws-types-CovtUmQe.mjs";
import { t as GATEWAY_EVENTS } from "./server-methods-list-DpzMmJ1l.mjs";
import { n as logGatewayReady, t as beginMacOSSystemCaWarmupOnce } from "./system-ca-warmup-Dx8aa5Rp.mjs";
...
async function startGatewayCoreRuntime(input) {
	...
	const secretEgressProxy = cfgAtStart.secrets?.egressProxy?.enabled === true ? await import("./runtime-DSKZ47O7.mjs").then((egressRuntime) => egressRuntime.startGatewaySecretEgressProxy({
	...
	const [{ startGatewayEventSubscriptions }, { startGatewayChannelHealthMonitor }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-ukO2SSLW.mjs"), import("./server-runtime-startup-services-B93e6BMg.mjs")]));
	...
	const { createOperatorApprovalSessionEventRuntime } = await import("./operator-approval-session-events-D3jrQ91K.mjs");
	...
	const { execApprovalManager, questionManager, cancelRunBoundApprovals, forwardPluginApprovalRequest, forwardExecApprovalRequest, execApprovalIosPushDelivery, approvalWebPushDelivery, pluginApprovalIosPushDelivery, pluginApprovalManager, placementStandingGrants, systemAgentApprovalManager, bindApprovalPublicationContext, beginCloseApprovalObservers, stopOperatorInteractions, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
		const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-CzEYb-VI.mjs"), import("./server-methods-B5_nUGdP.mjs")]);
		return {
	...
	const prepareAttachedPluginRuntime = async (loaded) => {
		const { activatePluginRegistry } = await import("./loader-shared-CZGhKjL-.mjs");
	...
	const reloadAttachedGatewayPlugins = async (params) => {
		const { reloadGatewayPlugins } = await import("./server-plugin-reload-BD-K4mCE.mjs");
...
async function prepareGatewayKernelRequestRuntime(params) {
	...
	const configRevisionProjector = await startupTrace.measure("gateway.config-revision-key", async () => {
		const { loadGatewayConfigRevisionProjector } = await import("./config-revision-token-C802NllC.mjs");
	...
	const gatewayRequestContext = await startupTrace.measure("gateway.request-context", async () => {
		const { createGatewayRequestContext } = await import("./server-request-context-Bfvr_GIT.mjs");
	...
	const projectionReady = runtime.opts.updateCanary ? Promise.resolve(void 0) : startupTrace.measure("sessions.projection", async () => {
		const { createSessionRowProjection } = await import("./session-row-projection-B6zdpz0M.mjs");
	...
	const { createGatewayInstanceRuntime } = await import("./server-instance-runtime-Cgy43J0a.mjs");
...
function createLazyGatewayCronState(params) {
	...
	const cronStateLoader = createLazyPromiseLoader(() => import("./server-cron-sf6qzHhX.mjs").then(({ buildGatewayCronService }) => {
		loaded = {
...
async function prepareGatewayLifecycle(params) {
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-BNwsm64R.mjs");
	...
	const nodeDesktopService = (await import("./node-source-B4e6GZF0.mjs")).createNodeDesktopService({
		getConfig: getRuntimeConfig,
		nodeRegistry,
	...
	const { createWatchNodeHttpRuntime } = await import("./watch-node-http-Jr4q4fGO.mjs");
	...
	const { TerminalSessionManager, DEFAULT_TERMINAL_DETACH_SECONDS } = await import("./session-manager-DKY_1OWb.mjs");
	...
	const cronReconciliation = createGatewayCronReconciliation({
		...
		runHook: async (event, ctx) => {
			try {
				const hookRunner = (await import("./hooks-Bres9jjZ.mjs")).createHookRunner(pluginRuntime.registry);
...
async function prepareGatewayKernelState(params) {
	...
	const nodeDesktopStreamBroker = (await startupTrace.measure("node-desktop.runtime-import", () => import("./node-stream-broker-BoSLypJ1.mjs"))).createNodeDesktopStreamBroker();
	const hostDesktopService = (await startupTrace.measure("host-desktop.runtime-import", () => import("./host-source-BtO2QBKi.mjs"))).createHostDesktopService({
		getConfig: () => getRuntimeConfig().desktop?.host,
		registry: desktopSessionRegistry
	});
	const gatewayComputerService = (await startupTrace.measure("computer.runtime-import", () => import("./computer-service-SIlBfrzI.mjs"))).createGatewayComputerService({
		getConfig: getRuntimeConfig,
	...
	const workerPlacementRuntime = workerEnvironmentService && workerEnvironmentStartup && nodeWorkerGatewayNamespace && workerPlacementModule ? await startupTrace.measure("worker-environments.placement-runtime", async () => workerPlacementModule.createGatewayWorkerPlacementRuntime({
		...
		cancelSessionWork: async (request) => {
			...
			const { cancelGatewayWorkerSessionWork } = await import("./server-worker-placement-cancel-Bqmlhiqc.mjs");
	...
	if (workerPlacementRuntime && workerEnvironmentService) {
		const { createDevicePlacementDemandReader } = await import("./device-placement-demand-DHcbspoW.mjs");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-DJwoTCdA.mjs");
	...
	if (bootstrap.generatedStartupAuthToken && isLoopbackHost(bindHost)) {
		const { ensureStartupLocalCliPairing } = await startupTrace.measure("runtime.local-cli-pairing-import", () => import("./startup-local-cli-pairing-B_Om4FYJ.mjs"));
	...
	const { createTerminalLaunchPolicy } = await startupTrace.measure("terminal.launch-import", () => import("./launch-D-fMv7W0.mjs"));
	const terminalLaunchPolicy = createTerminalLaunchPolicy(cfgAtStart);
	const { runDefaultChannelSetupWizard, runDefaultSetupWizard } = await startupTrace.measure("gateway.wizard-imports", () => import("./wizard-DErJLCJK.mjs"));
	...
	const { createChannelManager } = await startupTrace.measure("gateway.channel-manager-import", () => import("./server-channels-BObkBsoI.mjs"));
...
async function prepareGatewayServerBootstrap(input) {
	try {
		...
		await withSqliteReadOnlyWorkerScope(async () => {
			...
			const { TESTCLAW_DATABASE_SCHEMA_DOCS_URL, AssistantDatabaseSchemaPreflightError, preflightAssistantDatabaseSchemas } = await startupTrace.measure("state.runtime-imports", () => import("./testclaw-database-preflight-CXmB84Lv.mjs"));
		...
		const { ensureGlobalUndiciEnvProxyDispatcher } = await startupTrace.measure("runtime.network-imports", () => import("./undici-global-dispatcher-DGwIkXP4.mjs"));
		...
		const startupConfigModulePromise = startupTrace.measure("config.runtime-imports", () => import("./server-startup-config-BNY-PgM3.mjs"));
		const loadStartupPluginsModule = createLazyPromise(() => import("./server-startup-plugins-BHnHE45n.mjs"), { cacheRejections: true });
		...
		if (!opts.updateCanary) try {
			const cleanup = await startupTrace.measure("agents.github-profile-cleanup", async () => {
				const { cleanupRetiredManagedGitHubProfiles } = await import("./github-tool-profile-cleanup-tj8XNZYy.mjs");
...
const loadGatewayModelCatalogModule = createLazyRuntimeModule(() => import("./server-model-catalog-DN9ENIlx.mjs"));
const bindGatewayModelCatalog = createLazyRuntimeMethodBinder(loadGatewayModelCatalogModule);
const loadWorkerEnvironmentStartupModule = createLazyRuntimeModule(() => import("./server-worker-environment-startup-DFeSIOsv.mjs"));
const loadWorkerPlacementStartupModule = createLazyRuntimeModule(() => import("./server-worker-placement-startup-DbHbgx5L.mjs"));
const loadGatewayStartupEarlyModule = createLazyRuntimeModule(() => import("./server-startup-early-CT2D-fnr.mjs"));
const loadGatewayPluginBootstrapModule = createLazyRuntimeModule(() => import("./server-plugin-bootstrap-BcHZFMgV.mjs"));
...
const getChannelRuntime = createLazyRuntimeModule(() => import("./runtime-channel-D0r95EHG.mjs").then(({ createRuntimeChannel }) => createRuntimeChannel()));
...
const getPluginIconHttpModule = createLazyRuntimeModule(() => import("./plugin-icon-http-D2QDiVFf.mjs"));
const getPluginThemeArtHttpModule = createLazyRuntimeModule(() => import("./plugin-theme-art-http-BRM22kkh.mjs"));
const getWorkspaceIconHttpModule = createLazyRuntimeModule(() => import("./workspace-icon-http-DDD5cxOw.mjs"));
const getChannelAvatarHttpModule = createLazyRuntimeModule(() => import("./channel-avatar-http-sNLe_x2Y.mjs"));
...
async function serveControlUiPublicSession(req, res, url, basePath, cfg, requestGate, clientKey, secureIngress, publicOrigin) {
	...
	try {
		const { resolvePublicSessionShareToken } = await import("./control-ui-public-session-token-6Lr1DUii.mjs");
		const locator = resolvePublicSessionShareToken(publicShare.token);
		if (!locator) {
			unavailable(404);
			return;
		}
		const { isPublicSessionShareActive, readPublicSessionShare } = await import("./control-ui-public-session-read-CVOkjnw3.mjs");
		const { renderPublicSessionDocument } = await import("./control-ui-public-session-render-YkduP-Zv.mjs");
...
const getControlUiModule = createLazyRuntimeModule(() => import("./control-ui-C8BHZ7XN.mjs"));
const getControlUiPluginAssetsModule = createLazyRuntimeModule(() => import("./control-ui-plugin-assets-Bq1pVWy7.mjs"));
const getCanvasServeModule = createLazyRuntimeModule(() => import("./serve.runtime.js"));
const getBoardHttpModule = createLazyRuntimeModule(() => import("./board-http-t5lYT4YS.mjs"));
const getEmbeddingsHttpModule = createLazyRuntimeModule(() => import("./embeddings-http-Dq19geCK.mjs"));
const getManagedMediaAttachmentsModule = createLazyRuntimeModule(() => import("./managed-image-attachments-BhqAPiat.mjs"));
const getArtifactDownloadsModule = createLazyRuntimeModule(() => import("./artifact-downloads-DaCna8Ar.mjs"));
const getMcpAppStandaloneModule = createLazyRuntimeModule(() => import("./mcp-app-standalone-BumhpWUe.mjs"));
const getModelsHttpModule = createLazyRuntimeModule(() => import("./models-http-DPgvPMBl.mjs"));
const getOpenAiHttpModule = createLazyRuntimeModule(() => import("./openai-http-DOcS31ru.mjs"));
const getOpenResponsesHttpModule = createLazyRuntimeModule(() => import("./openresponses-http-6fmIHXJo.mjs"));
const getSessionHistoryHttpModule = createLazyRuntimeModule(() => import("./sessions-history-http-BJh1fUN1.mjs"));
const getSessionKillHttpModule = createLazyRuntimeModule(() => import("./session-kill-http-CzbIEiWX.mjs"));
const getToolsInvokeHttpModule = createLazyRuntimeModule(() => import("./tools-invoke-http-CAu5uhmU.mjs"));
const getUserProfilesHttpModule = createLazyRuntimeModule(() => import("./user-profiles-http-DQpCsE3S.mjs"));
const getDevicePairingJoinHttpModule = createLazyRuntimeModule(() => import("./device-pairing-join-http-D5G6Eohx.mjs"));
const getPluginNodeCapabilityAuthModule$1 = createLazyRuntimeModule(() => import("./plugin-node-capability-auth-BLeLfSTJ.mjs"));
const getHttpAuthUtilsModule$2 = createLazyRuntimeModule(() => import("./http-auth-utils-DjRbCPCP.mjs"));
const getPluginRouteRuntimeScopesModule$1 = createLazyRuntimeModule(() => import("./plugin-route-runtime-scopes-Cc3bLXa6.mjs"));
//#endregion
...
const getHttpAuthUtilsModule$1 = createLazyRuntimeModule(() => import("./http-auth-utils-DjRbCPCP.mjs"));
...
const getPluginNodeCapabilityAuthModule = createLazyRuntimeModule(() => import("./plugin-node-capability-auth-BLeLfSTJ.mjs"));
const getHttpAuthUtilsModule = createLazyRuntimeModule(() => import("./http-auth-utils-DjRbCPCP.mjs"));
const getPluginRouteRuntimeScopesModule = createLazyRuntimeModule(() => import("./plugin-route-runtime-scopes-Cc3bLXa6.mjs"));
	...
	httpServer.on("upgrade", (req, socket, head) => {
		...
		const handleUpgrade = async () => {
			...
			if (requestPath === "/desktop/observe") {
				...
				const { handleDesktopObserveUpgrade } = await import("./observe-bridge-dArCEYKJ.mjs");
...
const loadGatewayPluginsHttpModule = async () => await import("./plugins-http-B0S-vaPd.mjs");
...
async function createGatewayHttpTransport(params) {
	...
	const getHookDispatcher = async () => {
		const { createGatewayHookDispatcher } = await import("./hooks-gGqiXWTK.mjs");
	...
	const handleHooksRequest = async (req, res) => {
		...
		return await runWithGatewayHttpWorkAdmission(res, async () => {
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-gGqiXWTK.mjs");
	...
	const handleMcpOAuthCallbackRequest = async (req, res) => {
		const { handleMcpOAuthCallback } = await import("./mcp-oauth-callback-C3nbEtc0.mjs");
	...
	params.admission?.activate({
		...
		prepareAgent: ({ agentId, paths, env, signal, assertCurrent }) => runWithSpawnBroker(broker, async () => {
			const [{ runStartupSessionMigration }, { refreshPreparedModelRuntimeSnapshots, getPreparedModelRuntimeSnapshot }, { listConfiguredOwnerInputs }, { getActiveSecretsRuntimeSnapshot, getActiveSecretsRuntimeSnapshotRevision, refreshActiveSecretsRuntimeSnapshotForConfig }] = await Promise.all([
				import("./server-startup-session-migration-C-s-Yolt.mjs"),
				import("./prepared-model-runtime-676SbNLR.mjs"),
				import("./prepared-model-runtime.configured-zapFogFj.mjs"),
				import("./runtime-xnvnIymm.mjs")
			]);
			assertCurrent();
...
async function finishGatewayStartup(params) {
	...
	const { attachGatewayWsConnectionHandler } = await startupTrace.measure("gateway.ws-imports", () => import("./ws-connection-CP29FFks.mjs"));
	...
	const loadScheduledServicesModule = createLazyPromise(() => import("./server-runtime-services-lNMv_7uP.mjs"), { cacheRejections: true });
	...
	const { createGatewayServerActiveWorkInspectors } = await startupTrace.measure("gateway.active-work-import", () => import("./server-active-work-CXNY0jhm.mjs"));
	...
	if (!minimalTestGateway) {
		const { startAssistantDatabaseIntegrityVerifier } = await import("./testclaw-database-verify-BntfmLSA.mjs");
		registerGatewayLifetimeSidecars(startAssistantDatabaseIntegrityVerifier({ env: process.env }));
	}
	postAttachRuntimeReturned = true;
	activateScheduledServicesWhenReady();
	const { startManagedGatewayConfigReloader } = await import("./server-reload-managed-CGkaYJFr.mjs");
			...
			const failed = (await Promise.allSettled([
				...
				(async () => {
					...
					if (customPluginUiEnabled !== appliedCustomPluginUiEnabled) {
						const { listControlUiPluginCatalog } = await import("./control-ui-plugin-assets-Bq1pVWy7.mjs");
	...
	if (!minimalTestGateway) {
		...
		registerGatewayLifetimeSidecars(gatewayRuntimeServices.scheduleGatewayIdleTask({
			...
			run: async () => {
				const { cleanupRetainedPluginInstallGenerations } = await import("./server-retained-plugin-cleanup-CFBAO1r0.mjs");
		...
		registerGatewayLifetimeSidecars(gatewayRuntimeServices.scheduleGatewayIdleTask({
			...
			repeatDelayMs: 9e5,
			run: async () => {
				const { reclaimAbandonedSqliteSnapshotsAsync } = await import("./sqlite-snapshot-staging-BLLXfZT_.mjs");
...
const loadGatewayStartupPostAttachModule = createLazyRuntimeModule(() => import("./server-startup-post-attach-Co8JH5GO.mjs"));
	...
	try {
		const transport = await createGatewayHttpTransport({
			...
			...!gatewayKernel.minimalTestGateway && gatewayKernel.tailscaleMode !== "off" ? { prepareManagedTailscaleIngress: async (backend) => {
				const { startGatewayTailscaleExposure } = await import("./server-tailscale-B6CXflYx.mjs");
