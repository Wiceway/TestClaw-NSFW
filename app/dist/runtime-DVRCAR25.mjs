...
import { i as copyConfigResolutionFactsExcept, t as cloneConfigWithResolutionFacts } from "./resolution-facts-CSuKIPux.mjs";
import { c as getRuntimeConfigSnapshotMetadata, s as getRuntimeConfigSnapshot, u as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-Dti8jFIP.mjs";
...
import { l as markAuthProfileMigrationRequired, t as AuthProfileMigrationRequiredError } from "./legacy-source-diagnostic-C3oR-sYo.mjs";
import { u as prepareRuntimeAuthProfileStoreSnapshots } from "./runtime-snapshot-owner-BRsxcyEE.mjs";
import { b as setPreparedSecretsRuntimeSnapshotRefreshContext, c as getActiveSecretsRuntimeRefreshContext, d as getPreparedSecretsRuntimeSnapshotRefreshContext, f as graftActiveSecretsRuntimeAuthState, i as clearSecretsRuntimeSnapshotState, l as getActiveSecretsRuntimeSnapshotRevisionState, n as activateSecretsRuntimeSnapshotState, r as activateSecretsRuntimeSnapshotStateIfCurrent, t as activateProviderAuthRuntimeSnapshot, u as getActiveSecretsRuntimeSnapshotState, v as restoreSecretsRuntimeSnapshotStateIfCurrent } from "./runtime-state-p_Glf0Cm.mjs";
import { c as loadAuthProfileStoreForSecretsRuntime, l as loadAuthProfileStoreWithoutExternalProfiles } from "./store-runtime-CZ_l0ERR.mjs";
import "./auth-profiles-3zYAJqiZ.mjs";
import { i as mergeSecretsRuntimeEnv, n as collectCandidateAgentDirs, o as resolveRefreshAgentDirs, r as createEmptyRuntimeWebToolsMetadata, t as canUseSecretsRuntimeFastPath } from "./runtime-fast-path-Gx01Xv9e.mjs";
...
const loadRuntimeOwnerAssignmentHelpers = createLazyRuntimeModule(() => import("./runtime-owner-assignments-CGVNlD0y.mjs"));
