...
import { A as parseAgentSessionKey, D as resolveSessionDispatchKind, l as resolveAgentIdFromSessionKey, y as isAcpSessionKey } from "./session-key-C_bfgyCp.mjs";
...
import { t as buildConversationRef } from "./conversation-ref-8kIjGCCc.mjs";
import { d as readAgentDatabaseAdmissionRefusal } from "./agent-database-admission-CyLpJ2LV.mjs";
import { f as withClaimingHookAdmission, h as fireAndForgetHook, r as createPluginSubagentRequesterContext, w as getGroupThreadTurn } from "./hooks-D28cLPAG.mjs";
import { n as getGlobalPluginRegistry, t as getGlobalHookRunner } from "./hook-runner-global-eA1aRrLi.mjs";
import { S as readAskUserQuestionId, T as setReplyPayloadMetadata, _ as isReplyPayloadTerminalContent, a as copyReplyPayloadMetadata, d as isFastModeAutoProgressPayload, h as isReplyPayloadStatusNotice, s as getReplyPayloadMetadata, u as isCommandReplyForDelivery } from "./reply-payload-DfG85mEo.mjs";
import { i as shouldCleanTtsDirectiveText, o as normalizeTtsAutoMode } from "./tts-config-HwBJb_1b.mjs";
...
import { _ as stripLegacyMediaContextFields } from "./media-facts-DBEv8hMW.mjs";
...
import { it as conversationIdentityFromMsgContext } from "./session-accessor.sqlite-entry-store-Ct1v5fIu.mjs";
...
import { r as appendTranscriptEventSync } from "./session-accessor.sqlite-transcript-write-CN6LnRPb.mjs";
...
import { Q as claimSessionPendingInputDedupeRecovery } from "./session-accessor-CtBBLApI.mjs";
import { n as classifySessionStateActor } from "./session-state-events-DiPU1ldX.mjs";
import { n as GENERIC_EXTERNAL_RUN_FAILURE_TEXT } from "./user-copy-COjqIhB4.mjs";
import { i as sanitizeUserFacingText } from "./user-facing-text-BzXrOtrH.mjs";
import { a as resolveSourceReplyExpectation, o as resolveSourceReplyVisibilityPolicy, r as isUnauthorizedTextSlashCommand, t as isExplicitSourceReplyCommand, u as resolveReplyCompletion } from "./source-reply-delivery-mode-D3Apdk4j.mjs";
...
import { i as buildPluginBindingErrorText, l as hasShownPluginBindingFallbackNotice, m as toPluginConversationBinding, o as buildPluginBindingUnavailableText, r as buildPluginBindingDeclinedText, u as markPluginBindingFallbackNoticeShown } from "./conversation-binding-BzujlTXm.mjs";
...
import { U as waitForReplyBarrierSettlement } from "./reply-run-registry.state-0DtmpREE.mjs";
import { h as replyRunRegistry, o as forceClearReplyRunBySessionId } from "./reply-run-registry.registry-CVdu99y8.mjs";
import "./reply-run-registry-C6CtjXiK.mjs";
import { d as markDiagnosticSessionProgress, n as logMessageDispatchStarted, t as logMessageDispatchCompleted } from "./diagnostic-CjDzLGgv.mjs";
import { i as resolveActiveEmbeddedRunSessionId } from "./active-run-projections-BihqvttO.mjs";
import { c as isRestartRecoveryTombstone, l as isSessionWorkStartInvalidatedError, n as SessionRestartRecoveryTombstoneError } from "./lifecycle-DX3moz6p.mjs";
import { r as normalizeExplicitSessionKey } from "./session-key-6n1n1Uwl.mjs";
import { t as appendAssistantMessageToSessionTranscript } from "./transcript-BsEPgzDM.mjs";
import { r as isFinalizedInboundContext, t as finalizeInboundContext } from "./inbound-context-pT-cPSwW.mjs";
import { d as findConversationTurnDeliveryByReplyTarget, h as markConversationDeliverySent, m as markConversationDeliveryReplied } from "./delivery-completion-B66srTGz.mjs";
import { i as resolveConversationRegistryScope, s as runConversationDatabaseWrite } from "./conversation-registry-BTf5r9fF.mjs";
...
import { g as shouldRetryReplyDispatch, h as resolveRoutedReplyDeliveryOutcome, n as bindReplyDispatcherConversationContext, o as prepareReplyPayloadForDispatcher, r as captureReplyDispatchDeliveryOutcome, s as waitForReplyDispatcherIdle, t as attachReplyDispatchUndeliveredFallback, u as ReplyDispatchDeliveryError } from "./reply-dispatcher-DlfZ8qsV.mjs";
import { n as resolveAgentIdentity } from "./identity-D5GWLt72.mjs";
import { a as toInternalMessageReceivedContext, c as toPluginInboundClaimPair, l as toPluginMessageContext, n as deriveInboundMessageHookContext, u as toPluginMessageReceivedEvent } from "./message-hook-mappers-DysHr6k7.mjs";
...
import { i as findCommandByNativeName, o as isActiveRunSafeCommandTurn } from "./commands-registry-BY5fwelV.mjs";
...
import { a as resolveConversationBindingContextFromMessage } from "./acp-reset-target-DlAG6YQ4.mjs";
import { n as createInternalHookEvent, u as triggerInternalHook } from "./internal-hooks-Mpc90vI4.mjs";
import { a as resolveVisibleRepliesPolicy, i as resolveTurnModelOverride, n as resolveStableMessageToolAvailability, o as loadSessionStoreEntry, r as createShouldEmitVerboseProgress } from "./session-stable-reply-mode-DQSqB31J.mjs";
import { n as resolveRoutedDeliveryThreadId, t as isSlackDirectRoutedThreadTurn } from "./routed-delivery-thread-Dvh9aG5N.mjs";
import { a as resolveDispatchConversationBinding, n as assertPreparedConversationBindingRouteCurrent, r as readPreparedConversationBindingRouteCurrent, t as assertPreparedConversationBindingRoute } from "./session-conversation-binding-ncm8jKlR.mjs";
import { c as bindPreparedReplyDispatchRuntime, d as canReplaceRestartTombstoneFromParent, o as withFullRuntimeReplyConfig, s as stageRemoteInboundMediaIfNeeded, t as resolveRunTypingPolicy, u as resolveAuthorizedSessionResetCommand } from "./typing-policy-Bn72gp9S.mjs";
import { b as reserveReplyAdmissionTicket, h as renderPostCompactionModelFailurePayload, r as isDuplicateRestartRecoverySource, t as resolveTurnCommentaryProgressOwner, u as buildTerminalAgentRunFailureReplyPayload, y as REPLY_ADMISSION_TICKET } from "./commentary-progress-owner-CslaiQ_O.mjs";
import { i as recordReplyOperationAgentTurn, n as resolveEffectiveReplyRoute, r as REPLY_OPERATION_RUN_STATE, s as resolveReplyOperationRunState } from "./effective-reply-route-BFmWQU6o.mjs";
...
import { a as isCaptionedFinalTextPayload, c as DispatchReplyOperationAbortedError, d as runWithDispatchAbortSignal, i as cleanDeferredFinalText, l as createAbortAwareDispatcher, o as mergeDeferredFinalText, r as buildCaptionedFinalTextFallback, s as shouldDeferFinalTtsText, t as finalizeDispatchAndAudit, u as isDispatchReplyOperationAbortedError } from "./dispatch-from-config.finalize-BGHqXPpt.mjs";
import { n as hasTrustedMessageAuditListeners, t as emitTrustedMessageAuditEvent } from "./message-audit-events-r-sGQykK.mjs";
import { t as createTtsDirectiveTextStreamCleaner } from "./directives-Ct_rho8o.mjs";
import { c as hasExecApprovalUnavailablePayload, d as shouldDeliverDespiteSourceReplySuppression, h as createBlockReplySource, i as createFinalizationAwareTtsPayloadApplier, l as prepareReplyPayloadForSideEffects, o as hasAskUserPayload, p as createBlockReplyContentKey, s as hasExecApprovalPayload, u as requiresDurableToolResultDelivery, v as recoverBlockReplySources, y as setBlockReplyDelivery } from "./dispatch-from-config.payloads-D6B1G-Eh.mjs";
import { n as suppressPendingFinalDelivery } from "./dispatch-from-config.pending-final-0ioUlqJ1.mjs";
import { n as buildChannelUserTurnSender, o as preparePersistedUserTurnMessageForTranscriptWrite } from "./user-turn-transcript.metadata-CRXr1P1Q.mjs";
import { n as runAgentHarnessBeforeMessageWriteHook } from "./hook-helpers-KHSyh5IQ.mjs";
import { b as isDispatchFinalReplySessionWriterAuthorized } from "./delivery-queue-recovery-BNw5bhX2.mjs";
import { h as normalizeAgentPlanSteps, u as formatPlanChecklistLines } from "./streaming-CDUnCr4v.mjs";
import { i as isAskUserPromptPending } from "./ask-user-tool-BQthJXu3.mjs";
import { t as settleProgressVisibilityCallbackResult } from "./progress-visibility-DVUJibF4.mjs";
import { o as takeCommandSessionMetadataChanges } from "./commands-goal-B0DKEphh.mjs";
import { t as createDiagnosticMessageLifecycle } from "./message-lifecycle-Blc7rS7l.mjs";
import { t as isRecoverableTerminalSessionStatus } from "./terminal-status-Z4Z1U4Xa.mjs";
import { c as resolveWorkerPlacementArchiveRestoreError, i as prepareSessionWorkerPlacementMutationCheck } from "./session-placement-lifecycle-6vB2bB_h.mjs";
import { c as admitReplyTurn, l as resolveReplyTurnKind, n as shouldBridgeCliPreambleEvents, o as createReplyTimingTracker, s as isReplyProfilerEnabled, u as runWithReplyOperationLifecycleAdmission } from "./get-reply.types-Dy99IQOQ.mjs";
...
import { t as noteDispatchProcessedOutcome } from "./dispatch-processed-outcome-iCFP6_hS.mjs";
import { t as hasInboundAudio } from "./inbound-media-BxZBsqcc.mjs";
import { n as resolveSendPolicy } from "./send-policy-C4GTelN2.mjs";
import { n as claimPendingConversationTurnReply } from "./conversation-turns-eNBxYuGT.mjs";
...
import { i as PLUGIN_COMMAND_DISPATCH, r as matchPluginCommandInvocation, t as createPluginCommandRuntime } from "./plugin-command-runtime-BDLXPkMN.mjs";
import { n as resolveCommandChannel } from "./commands-context-BT7SOU4K.mjs";
...
async function restoreArchivedDispatchSession(params) {
	...
	if (!placementContext) try {
		placementContext = (await import("./session-worker-placement-context-FPgTCEus.mjs")).resolveSessionWorkerPlacementContext();
	} catch {
		return entry;
	}
	...
	return await runExclusiveSessionLifecycleMutation({
		...
		run: async () => {
			...
			if (currentEntry.worktree) {
				const { synchronizeSessionWorktreeArchive } = await import("./session-worktree-lifecycle-CY1wEjTr.mjs");
...
//#endregion
export { emitInboundMessageAuditTerminal as a, resetInboundDedupe as i, dispatchReplyFromConfig as n, resolveBoundAcpDispatchSessionKey as o, emitMessageReceivedHooks as r, DispatchSessionRefreshRequiredError as s, dispatchLowLevelChannelReplyFromConfig as t };
