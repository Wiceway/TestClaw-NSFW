...
import { c as isRecord, i as asOptionalObjectRecord, r as asNullableRecord } from "./record-coerce-DItp3I4t.mjs";
...
import { T as tryResolveLegacyCompatibilityAgentId, g as resolveDefaultAgentId } from "./agent-scope-config-Dm8T0OhW.mjs";
import { i as normalizeMainKey } from "./session-key-B8Cn8Xls.mjs";
import { A as parseAgentSessionKey, _ as toAgentStoreSessionKey, r as agentSessionKeysMatchByRequestKey } from "./session-key-C_bfgyCp.mjs";
import { o as tryResolveDefaultAgentId } from "./agent-roster-Cl9s4QHb.mjs";
import "./legacy.default-agent-owner-C-WRgKDI.mjs";
import { A as formatRawAssistantErrorForUi, b as redactToolPayloadText } from "./redact-Db5P6nQB.mjs";
import { t as formatErrorMessage } from "./errors-DNLGIg8_.mjs";
import { i as stripAnsi, u as iterateAnsiSegments } from "./ansi-CWsy0bu4.mjs";
import { o as setConsoleSubsystemFilter } from "./console-CIWsc0DX.mjs";
...
import { _ as resolveSessionAgentId, l as resolveAgentIdByWorkspacePath } from "./agent-scope-_30Scclc.mjs";
import { n as resolvePersistedSessionStoreOwnerForKey } from "./session-store-owner-CZzLvJ5o.mjs";
import { f as resolveResponseUsageMode, i as isSessionDefaultDirectiveValue, l as normalizeUsageDisplay, s as normalizeThinkLevel } from "./thinking.shared-DS6qUUiH.mjs";
import { t as hasTerminalControl } from "./safe-text-CBmKtmbt.mjs";
...
import { cl as QuestionGetResultSchema, fl as QuestionRecordSchema, ul as QuestionListResultSchema, vl as QuestionResolveResultSchema, yl as QuestionResolvedEventSchema } from "./src-BNV0SJoP.mjs";
...
import { a as listThinkingLevelOptions, i as listThinkingLevelLabels } from "./thinking-jB2bcB7l.mjs";
import { r as isAuthErrorMessage } from "./message-patterns-D0mFl7L8.mjs";
import { d as readPersistedMediaFacts, o as isImageMediaFact } from "./media-facts-DBEv8hMW.mjs";
import { n as isApprovalStaleError } from "./approval-errors-BPkaCbRr.mjs";
import { t as classifyFailoverReasonCore } from "./classify-core-Cb9POCh7.mjs";
import { n as shouldForwardModelCommandToServer } from "./commands-registry.data-DuiUwkqd.mjs";
...
import { o as resolveToolDisplay, t as formatToolDetail } from "./tool-display-BCDt9U9m.mjs";
import { a as isChatStopCommandText } from "./chat-abort-CNLBLnF-.mjs";
import { r as resolveSessionInfoModelSelection } from "./model-selection-display-Q0UQ9JGt.mjs";
...
async function runTuiUnlocked(opts) {
	...
	if (opts.backend) client = opts.backend;
		...
		const { EmbeddedTuiBackend } = await import("./embedded-backend-Bv-5z4OI.mjs");
	...
	import("./tools-manager-BUN-l588.mjs").then(({ ensureTool }) => ensureTool("fd", true)).then((fdPath) => {
		if (fdPath) {
