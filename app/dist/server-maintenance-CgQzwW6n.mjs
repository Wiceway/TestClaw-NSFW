...
import { A as tryBeginGatewaySuspendAdmission, f as isGatewayWorkAdmissionClosed, s as getGatewayRestartDrainSignal } from "./gateway-work-admission-DeFm4gyw.mjs";
import { D as sweepStaleRunContexts } from "./agent-run-registry-DmVqATcC.mjs";
...
import { c as pruneExpiredDeliveryQueueTombstones } from "./delivery-queue-sqlite--DZfRz6l.mjs";
import { c as pruneOutboundMedia, l as prunePlaybackTranscodeCache, r as cleanOldMedia } from "./store-CgHi10YJ.mjs";
import { t as pruneOrphanedDeliveryQueueMedia } from "./delivery-queue-media-spool-DHyDsyKg.mjs";
import { i as waitForMediaCleanupDrainsToSettle, n as registerMediaCleanupDrain, r as waitForMediaCleanupDrains, t as MEDIA_CLEANUP_STOP_TIMEOUT_MS } from "./server-media-cleanup-lifecycle-CDoi9fu0.mjs";
import { c as removeChatAbortControllerEntry, t as abortChatRunById } from "./chat-abort-CNLBLnF-.mjs";
import { t as chatAbortMarkerTimestampMs } from "./server-chat-state-s6eZWEwx.mjs";
import { n as hasRegisteredChatRunForSessionKey } from "./session-active-runs-B7nF2tZH.mjs";
import { a as managedWorktrees, i as WORKTREE_GC_INTERVAL_MS, o as resolveWorktreeCleanupLimits } from "./service-CuvxqPzV.mjs";
import { n as checkGatewayInstallationReplacement } from "./stale-install-CNNGbxvW.mjs";
import { l as pruneExpiredDevicePairSetupCompletions } from "./device-bootstrap-CiR_v_ui.mjs";
...
import { r as registerSkillUsageTracking } from "./curator-kXugKvrj.mjs";
import { r as checkTelemetryUpdate } from "./telemetry-CS-odAI0.mjs";
import { r as pruneStaleControlPlaneBuckets } from "./control-plane-rate-limit-CUfpYCsm.mjs";
import "./server-shared-C-7Ahu3n.mjs";
import { s as setBroadcastHealthUpdate } from "./health-state-DPk6C9K0.mjs";
import { r as startSessionColdStorageMaintenance } from "./session-cold-storage-maintenance-C5TddxXT.mjs";
...
function startGatewayMaintenanceTimers(params) {
	...
	const runManagedOutgoingMediaGc = params.runManagedOutgoingMediaGc ?? (async () => {
		const { cleanupManagedOutgoingMediaRecords } = await import("./managed-image-attachments-BhqAPiat.mjs");
