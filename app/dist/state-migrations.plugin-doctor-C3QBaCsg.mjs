...
import { c as listPluginDoctorStateMigrationEntries, t as PluginDoctorStateMigrationDeclarationError } from "./doctor-contract-registry-BDzGBNcA.mjs";
...
import { c as runAssistantStateWriteTransaction, i as prepareAssistantStateDatabaseSchema, n as openExistingAssistantStateDatabaseReadOnly } from "./testclaw-state-db-BXFT1fUC.mjs";
...
import { a as importPluginStateEntriesForDoctor, d as getPluginStateCapacity, f as pluginStateDeleteEntriesIfUnchanged, p as pluginStateDoctorEntriesInKeyRange, r as createPluginStateKeyedStore } from "./plugin-state-store-CMkSV5C5.mjs";
import { r as listChannelIngressQueueAccountIdsReadOnly, t as createChannelIngressQueue } from "./ingress-queue-CLtOX3CO.mjs";
...
import { s as readExactSessionEntryRowValidated } from "./session-accessor.sqlite-entry-read-Cah7Q8q_.mjs";
import { p as dedupeSessionStoreTargetsBySqliteTarget } from "./targets-DS0OmfJW.mjs";
...
import { a as parseAcpDatabaseSessionKeyCandidates, c as selectAcpSessionRow, d as upsertAcpSessionMetaRow, n as buildAcpDatabaseSessionKey, o as resolveLegacyFreeAcpSessionKey, r as getAcpSessionKysely, t as acpSessionRowMatchesEntry, u as selectLegacyFreeAcpSessionRows } from "./session-meta-keys-CJLOjSom.mjs";
import "./session-accessor-CtBBLApI.mjs";
import { n as readSessionIdentityEvidenceBatch, t as loadExactSessionEntryReadOnlyResult } from "./session-accessor.sqlite-entry-availability-CAcfV00q.mjs";
...
import { r as rowToAcpSessionMeta } from "./session-meta-readonly-CArwCLAv.mjs";
import { a as readSessionStoreJson5 } from "./state-migrations.fs-BCymriz5.mjs";
import { s as readDeferredPluginSessionImport, u as resolveVerifiedSessionSource } from "./deferred-plugin-session-sources-BgPSH118.mjs";
import { r as formatStartupMigrationFailure } from "./state-migrations.messages-Q7LpdcwR.mjs";
import { t as autoMigrateLegacyStateDir } from "./state-migrations.state-dir-B3b2obwo.mjs";
...
async function runPostSessionPluginDoctorStateRepairs(params) {
	...
	const { assertDeferredPluginMigrationsCurrent, readDeferredPluginMigrations, recordDeferredPluginMigrations } = await import("./deferred-plugin-migrations-BgjNdUAt.mjs");
	maintenance.assertCurrent();
