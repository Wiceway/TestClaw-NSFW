      ...
      <div class="actions">
        ...
        >
          <span aria-hidden="true"
            >${this.copyResult===void 0?g.copy:this.copyResult?g.check:g.x}</span
          >
        </button>
        <wa-dropdown
          ...
          size="s"
          .distance=${4}
          aria-label=${r(`chat.mermaid.options`)}
        ...
        >
          <button
            ...
            type="button"
            aria-label=${r(`chat.mermaid.options`)}
            title=${r(`chat.mermaid.options`)}
          >
            <span aria-hidden="true">${g.moreHorizontal}</span>
          </button>
          <wa-dropdown-item
            value=${t?`diagram`:`source`}
            ?disabled=${t&&!this.imageUrl}
            >${r(t?`chat.mermaid.diagram`:`chat.mermaid.source`)}</wa-dropdown-item
          >
          <wa-dropdown-item value="expand" ?disabled=${!this.imageUrl}
            >${r(`chat.mermaid.expand`)}</wa-dropdown-item
          >
        </wa-dropdown>
      </div>
      <span class="copy-feedback" aria-live="polite"
        >${this.copyResult===void 0?u:n}</span
      >
      ${this.renderStatus&&(e||!this.imageUrl)?l`<p class="status" role="status">${r(`chat.mermaid.${this.renderStatus}`)}</p>`:u}
      ${t?l`<pre><code>${this.source}</code></pre>`:this.imageUrl?l`<div class="preview">
                <img
                  src=${this.imageUrl}
                  alt=${r(`chat.mermaid.title`)}
                  @error=${()=>{this.renderStatus=`imageError`,this.releaseImage()}}
                />
              </div>`:u}
      ${this.expanded&&this.imageUrl?l`<testclaw-image-lightbox
              src=${this.imageUrl}
              .imageTitle=${r(`chat.mermaid.title`)}
              @image-lightbox-close=${()=>{this.expanded=!1}}
            ></testclaw-image-lightbox>`:u}
    `}},n([h({attribute:!1})],J.prototype,`source`,void 0),n([f()],J.prototype,`imageUrl`,void 0),n([f()],J.prototype,`showSource`,void 0),n([f()],J.prototype,`expanded`,void 0),n([f()],J.prototype,`renderStatus`,void 0),n([f()],J.prototype,`copyResult`,void 0),customElements.get(`testclaw-mermaid`)||customElements.define(`testclaw-mermaid`,J)})))()}Y();export{G as mountMermaidBlocks};
//# sourceMappingURL=markdown-mermaid-CkdB19BL.js.map