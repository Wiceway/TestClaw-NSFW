...
import { r as PAIRING_SCOPE, t as ADMIN_SCOPE } from "./operator-scopes-D-CL26h0.js";
import { t as ErrorCodes } from "./gateway-error-details-D4L8ZwC-.js";
import { n as errorShape, r as missingScopeErrorShape } from "./error-codes-DQWjOSek.js";
import { An as validateNodeRenameParams, Cn as validateNodePairRejectParams, Sn as validateNodePairListParams, Tn as validateNodePendingAckParams, _n as validateNodeInvokeParams, bn as validateNodeListParams, hn as validateNodeEventParams, vn as validateNodeInvokeProgressParams, wn as validateNodePairRemoveParams, xn as validateNodePairApproveParams, yn as validateNodeInvokeResultParams } from "./validator-registry-Dpl5QmuY.js";
import { l as isForbiddenBrowserProxyMutation } from "./method-scopes-D0hbLMo0.js";
import { M as isBrowserProxyNodeInvokeCommand, N as isPrivateNodeInvokeCommand, j as isAdminOnlyNodeInvokeCommand } from "./node-commands-BLhGKTZa.js";
import { a as isForegroundRestrictedPluginNodeCommand, l as resolveNodeCommandAllowlist, o as isNodeCommandAllowed, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-D1CEhJWf.js";
import { n as awaitWithinDeadline, t as ABSOLUTE_DEADLINE_EXPIRED } from "./absolute-deadline-DKTfQpId.js";
import { a as missingSystemRunApprovalBinding, b as resolveSystemRunCommandRequest, d as toSystemRunApprovalMismatchError, i as matchSystemRunApprovalBinding, n as buildSystemRunApprovalBinding } from "./system-run-approval-binding-CMOqhQeA.js";
import { r as listApprovedPairedDeviceRoles } from "./device-pairing-identity-BcalhkNq.js";
import { a as listNodePairing, c as recordPairedNodeHostStats, d as renamePairedNode, i as getPendingNodePairing, l as rejectNodePairing, t as approveNodePairing } from "./device-pairing-node-D3__zSdN.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-C9zZgOCw.js";
import { l as removePairedDeviceRole, t as getPairedDevice } from "./device-pairing-CHVB12nQ.js";
import { _ as ApnsRegistrationPairingChangedError } from "./push-apns-store-DV_aAo_z.js";
import { t as assertValidParams } from "./validation-BZLpfukT.js";
import "./exec-approval-manager-DY3doaTS.js";
import { n as EXEC_APPROVAL_RESOLVED_ENTRY_GRACE_MS } from "./exec-approval-lifecycle-kimVVBA0.js";
import { n as respondUnavailableOnThrow } from "./response-Dq27VKLI.js";
import { a as removePendingNodeAction, i as listPendingNodeActions, n as clearRemovedNodeRuntimeState, o as replacePendingNodeActionsForGeneration, r as enqueuePendingNodeAction, s as reconcileRevokedDeviceWorker, t as acknowledgePendingNodeActions } from "./node-runtime-state-r0s6hw8a.js";
...
import { i as pairedDeviceHasNonOperatorRole, n as deniesCrossDeviceManagement, o as resolveDeviceManagementAuthz, s as resolveDeviceSessionAuthz, t as emitDeviceManagementSecurityEvent } from "./device-management-security-CMzp4gO7.js";
import { i as isNodePairingGenerationCurrent, n as captureNodePairingGeneration, r as captureNodePairingState } from "./device-pairing-node-state-EcH9PdTQ.js";
import { n as parseGatewayPayload, t as respondUnavailableOnNodeInvokeErrorWithProvenance } from "./nodes.helpers-CpiYIW8V.js";
import { a as resolveDispatchableNodeSession, i as isNodePairingWorkCurrent, n as maybeWakeNodeWithApns, o as respondPairingChanged, r as waitForNodeReconnect, t as maybeSendNodeWakeNudge } from "./nodes.wake-ZH1JwYqf.js";
...
import { n as refreshConnectedNodeSurfaceCaches, t as nodeReadHandlers } from "./nodes.read-DbAXkNIN.js";
...
const nodeEventHandlers = { "node.event": async ({ params, respond, context, client }) => {
	...
	await respondUnavailableOnThrow(respond, async () => {
		...
		const { handleNodeEvent } = await import("./server-node-events-D94bMy_U.js");
