...
import { h as resolveConfiguredModelRef, r as buildConfiguredModelCatalog } from "./model-selection-shared-YvCZW05m.js";
import { o as formatFastModeValue } from "./fast-mode-B_XB5FSo.js";
...
import { t as collectEnabledInsecureOrDangerousFlagsFromCurrentSnapshot } from "./dangerous-config-flags-current-Jhi1Yzre.js";
...
async function logGatewayStartup(params) {
	...
	const enabledDangerousFlags = collectEnabledInsecureOrDangerousFlagsFromCurrentSnapshot(params.cfg) ?? (await import("./dangerous-config-flags-CEBz-XUJ.js")).collectEnabledInsecureOrDangerousFlags(params.cfg);
...
async function collectConfiguredChannelStartupWarnings(params) {
	const [blockerModule, presencePolicyModule] = await Promise.all([import("./channel-plugin-blockers-_G67X5_W.js"), import("./channel-presence-policy-qXM1TRh8.js")]);
