...
import { a as NonEmptyString, c as UserProfileIdSchema } from "./primitives-BBZtPseE.js";
import { B as ToolsGitHubAuthorizeFailedResultSchema, G as ToolsGitHubAuthorizeSlowDownResultSchema, H as ToolsGitHubAuthorizeNetworkErrorResultSchema, L as ToolsGitHubAuthorizeAccessDeniedResultSchema, U as ToolsGitHubAuthorizePendingResultSchema, V as ToolsGitHubAuthorizeIncorrectDeviceCodeResultSchema, l as GitHubIdentityFactsSchema, z as ToolsGitHubAuthorizeExpiredResultSchema } from "./agents-models-skills-Bo_uJkDM.js";
...
closedObject(WizardResultFields);
closedObject({
	sessionId: NonEmptyString,
	...WizardResultFields
});
...
closedObject({ profiles: Type.Array(UserProfileSchema) });
const UsersSelfParamsSchema = closedObject({});
closedObject({ profile: UserProfileSchema });
...
closedObject({ removed: Type.Boolean() });
const UsersListChannelIdentitiesParamsSchema = closedObject({ profileId: UserProfileIdSchema });
closedObject({ links: Type.Array(UserChannelIdentityLinkSchema) });
...
closedObject({ links: Type.Array(UserProfileAuthLinkSchema) });
...
closedObject({ providers: Type.Array(closedObject({
...
closedObject({ disconnected: Type.Literal(true) });
...
//#endregion
export { UsersUnlinkChannelIdentityParamsSchema as A, ChatAccountSelectionSchema as B, UsersPrefsSetParamsSchema as C, UsersSetDisplayNameParamsSchema as D, UsersSetAvatarParamsSchema as E, WizardStartParamsSchema as F, WizardStatusParamsSchema as I, WizardStepSchema as L, WizardAnswerSchema as M, WizardCancelParamsSchema as N, UsersSetRoleParamsSchema as O, WizardNextParamsSchema as P, SetupInferenceActivationRejectionSchema as R, UsersPrefsGetParamsSchema as S, UsersSelfParamsSchema as T, ModelAuthProfileIdSchema as V, UsersLinkEmailParamsSchema as _, UsersAuthConnectAnswerParamsSchema as a, UsersListModelAccountsParamsSchema as b, UsersAuthConnectStartParamsSchema as c, UsersGitHubAuthorizePollParamsSchema as d, UsersGitHubAuthorizeStartParamsSchema as f, UsersLinkChannelIdentityParamsSchema as g, UsersLinkAuthProfileParamsSchema as h, UserChannelIdentitySchema as i, McpAuthLoginParamsSchema as j, UsersUnlinkAuthProfileParamsSchema as k, UsersAuthConnectStatusParamsSchema as l, UsersGitHubStatusParamsSchema as m, PersonalGitHubGenerationSchema as n, UsersAuthConnectCancelParamsSchema as o, UsersGitHubDisconnectParamsSchema as p, PersonalGitHubStatusSchema as r, UsersAuthConnectCatalogParamsSchema as s, PersonalGitHubAccountSchema as t, UsersGitHubAuthorizeCancelParamsSchema as u, UsersListAuthLinksParamsSchema as v, UsersSelectModelAccountParamsSchema as w, UsersListParamsSchema as x, UsersListChannelIdentitiesParamsSchema as y, SetupInferenceFailureStatusSchema as z };
