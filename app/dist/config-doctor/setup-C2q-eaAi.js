...
import { l as resolveOnboardingSetupTarget } from "./onboard-agent-target-DCLYyWdK.js";
import { a as readValidSetupConfigFile, c as resolveQuickstartGatewayDefaults, i as readSetupConfigFileSnapshot, l as writeWizardConfigFile, n as formatQuickstartGatewaySummary, o as requestTelemetryConsent, r as hasQuickstartGatewayOverrides, s as requireRiskAcknowledgement, t as createWizardInferenceConfigTarget } from "./setup.shared-Du-pVvdm.js";
import { n as showSessionMigrationWarnings, t as promptFirstOnboardingAgent } from "./onboard-first-agent-BPUE5gkC.js";
import { a as runSetupModelAuthStep, i as completeSetupModelAuth, n as listSetupMigrationOptions, r as runSetupMigrationImport, t as detectSetupMigrationSources } from "./setup.migration-import-Cqz2vW87.js";
import { n as SetupMigrationTargetChangedError, t as SetupMigrationFreshnessError } from "./setup.migration-snapshot-DtLGl2Bq.js";
...
const loadConfigLoggingModule = createLazyRuntimeModule(() => import("./logging-wOZBH0iK.js"));
const loadOnboardConfigModule = createLazyRuntimeModule(() => import("./onboard-config-Ze6y4Q9N.js"));
...
async function runSetupWizardOnce(initialOpts, runtimeInput, prompter) {
	...
	const remoteOnboard = seededRemoteUrl ? await import("./onboard-remote-1UGa727u.js") : null;
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = remoteOnboard ?? await import("./onboard-remote-1UGa727u.js");
	...
	if (opts.authChoice === void 0) {
		const { inferAuthChoiceFromFlags } = await import("./auth-choice-inference-D5azGNEO.js");
	...
	if (opts.skipChannels) await prompter.note(t("wizard.setup.skipChannels"), t("wizard.setup.channelsTitle"));
		...
		const { listChannelPlugins } = await import("./plugins-DE1tLQ6e.js");
		const { createChannelSetupHooks, setupChannels } = await import("./onboard-channels-DjATGXBW.js");
	...
	if (!usedImportFlow) {
		const { runSetupMemoryImportStep } = await import("./setup.memory-import-B5HmTF7p.js");
	...
	if (opts.skipSearch) await prompter.note(t("wizard.setup.skipSearch"), t("wizard.setup.searchTitle"));
		...
		const { runSearchSetupFlow } = await import("./search-setup-B-eQtMfs.js");
	...
	if (opts.skipSkills) await prompter.note(t("wizard.setup.skipSkills"), t("wizard.setup.skillsTitle"));
		...
		const { setupSkills } = await import("./onboard-skills-Z986F5_h.js");
	...
	if (flow !== "quickstart") {
		const { setupOfficialPluginInstalls } = await import("./setup.official-plugins-CBvOAGG7.js");
		...
		const { setupAppRecommendations } = await import("./setup.app-recommendations-DyKsvmdm.js");
		...
		const { setupPluginConfig } = await import("./setup.plugin-config-B0w2OtNK.js");
	...
	const { finalizeSetupWizard } = await import("./setup.finalize-Dx2-VRYY.js");
