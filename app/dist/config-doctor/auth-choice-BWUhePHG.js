...
import { n as resolveManifestDeprecatedProviderAuthChoice, r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-jz5pJx2z.js";
import { n as buildProviderPluginMethodChoice, r as parseProviderPluginMethodChoice, t as PROVIDER_PLUGIN_CHOICE_PREFIX } from "./provider-plugin-choice-QdkK_2Zi.js";
import { n as resolveProviderInstallCatalogEntries, t as resolveDeprecatedProviderInstallCatalogEntry } from "./provider-install-catalog-D4uH-cn1.js";
...
import { o as prepareAgentModelDefaults, s as projectAgentModelDefaults } from "./onboard-agent-target-DCLYyWdK.js";
import { t as normalizeApiKeyTokenProviderAuthChoice } from "./auth-choice.apply.api-providers-B42xhREr.js";
import { r as ensureModelSelectionRuntimePlugins, t as CODEX_RUNTIME_PLUGIN_ID } from "./runtime-plugin-install-D7EpAVjD.js";
import { t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-DLCGsi38.js";
import { c as parseNonInteractiveCustomApiFlags, d as resolveCustomProviderId, n as applyCustomApiConfig, p as normalizeSecretInputModeInput, t as CustomApiError } from "./onboard-custom-config-BChmdPVw.js";
...
async function loadPluginProviderRuntime() {
	return import("./auth-choice.plugin-providers.runtime-C5SVEddd.js");
}
...
async function applyNonInteractivePluginProviderChoice(params) {
	...
	const { isSetupCredentialReplacement, saveSetupCredential, selectSetupCredential } = await import("./setup-inference-credentials-Kfv8Ai3X.js");
	let result;
	if (isSetupCredentialReplacement({
		...
		const [{ withAuthProfileStoreAgentDir, clearRuntimeAuthProfileStoreSnapshot }, { loadAuthProfileStoreWithoutExternalProfiles, saveAuthProfileStore }, { loadPersistedAuthProfileStore }, { closeAuthProfileReadPool }, { closeAssistantAgentDatabases }, { splitTrailingAuthProfile }, { resolveSetupModel }, { prepareCustomSetupCredentials }] = await Promise.all([
			import("./store-bafjHjHV.js"),
			import("./store-runtime-CFMeXP8H.js"),
			import("./persisted-DeiH3eMk.js"),
			import("./sqlite-DsGOdiF6.js"),
			import("./testclaw-agent-db-B2wWqZ5R.js"),
			import("./model-ref-profile-CVfNMb6I.js"),
			import("./setup-inference-core-DubwE9qg.js"),
...
async function applyNonInteractiveAuthChoice(params) {
	...
	if (authChoice === "custom-api-key") try {
		...
		if (customApiKeyInput !== void 0 && resolvedCustomApiKey?.source !== "profile") {
			const { isSetupCredentialReplacement, saveSetupCredential } = await import("./setup-inference-credentials-Kfv8Ai3X.js");
			if (isSetupCredentialReplacement({
				provider: result.providerId,
				baseConfig,
				agentDir: params.target.agentDir
			})) {
				const { prepareCustomSetupCredentials } = await import("./setup-inference-custom-BjSyV5Tw.js");
