...
import { C as tryResolveAmbientOwnerAgentId, d as resolveAgentWorkspaceDir, g as resolveDefaultAgentId, j as listAgentIds, t as AgentSelectionRequiredError } from "./agent-scope-config-BEuqweC1.js";
...
import { i as SkillUploadRequestError } from "./testclaw-state-worker-error-DudqzgpE.js";
...
import { t as buildClawHubTrustErrorDetails } from "./clawhub-trust-error-details-BsNBm0Tv.js";
import { i as buildSkillProposalRevisionChangedErrorDetails, t as ErrorCodes } from "./gateway-error-details-D4L8ZwC-.js";
import { n as errorShape } from "./error-codes-DQWjOSek.js";
import { $i as validateSkillsProposalEvaluateParams, Gi as validateSkillsBinsParams, Ji as validateSkillsDetailParams, Ki as validateSkillsCuratorActionParams, Qi as validateSkillsProposalDecisionParams, Xi as validateSkillsProposalActionParams, Yi as validateSkillsInstallParams, Zi as validateSkillsProposalCreateParams, aa as validateSkillsProposalsListParams, ca as validateSkillsSkillCardParams, da as validateSkillsUploadBeginParams, ea as validateSkillsProposalEventsListParams, fa as validateSkillsUploadChunkParams, ia as validateSkillsProposalUpdateParams, la as validateSkillsStatusParams, ma as validateSkillsWorkshopReadParams, na as validateSkillsProposalRequestRevisionParams, oa as validateSkillsSearchParams, pa as validateSkillsUploadCommitParams, qi as validateSkillsCuratorStatusParams, ra as validateSkillsProposalReviseParams, sa as validateSkillsSecurityVerdictsParams, ta as validateSkillsProposalInspectParams, ua as validateSkillsUpdateParams } from "./validator-registry-Dpl5QmuY.js";
...
import { a as DEFAULT_MAX_ARCHIVE_BYTES_ZIP } from "./archive-yx_Z0RZv.js";
...
import { a as fetchClawHubSkillDetail } from "./clawhub-skills-8MWyro0j.js";
import { a as validateRequestedSkillSlug } from "./skill-tree-digest-BU-L5_Lq.js";
import { c as searchSkillsFromClawHub, f as parseRequestedClawHubSkillRef } from "./clawhub-status-D3qlBdgn.js";
import { i as prepareWorkspaceSkillEntries } from "./workspace-skill-loader-CyHERWkN.js";
...
import { L as resolveSkillProposalName } from "./store-B-O-kELr.js";
import { s as PROPOSAL_DRAFT_FILE } from "./store-sqlite-record-sIpr_4PH.js";
import { c as proposeCreateSkill, d as assertExpectedRevisionHash, f as evaluateSkillProposal, i as reviseSkillProposal, l as proposeUpdateSkill, n as quarantineSkillProposal, p as listSkillProposalEvents, r as rejectSkillProposal, t as applySkillProposal, u as SkillProposalRevisionChangedError } from "./service-CnuCwlN9.js";
...
import { n as readWritableWorkshopSkill, t as listWritableWorkshopSkillSummaries } from "./workspace-skill-read-B1nArF8V.js";
import { t as getRemoteSkillEligibility } from "./remote-BqP6PO5r.js";
import { n as ensureSkillsWatcher } from "./refresh-3-LtQ2C9.js";
import { r as fetchExactClawHubSkillSecurityVerdicts } from "./clawhub-install-trust-2OHHbZMC.js";
import { i as installSkillArchiveFromPath } from "./archive-install-KAhxhyJy.js";
import { r as updateSkillsFromClawHub, t as installSkillFromClawHub } from "./clawhub-BNk7nnR4.js";
import { n as getSkillCuratorStatus, t as SKILL_LIFECYCLE_CURATION_RETIRED_MESSAGE } from "./curator-CMZUxIA2.js";
import { n as installSkill } from "./install-CAyOvfFP.js";
import { r as skillsLibraryHandlers } from "./skills-library-CC9CgvAN.js";
import { t as assertValidParams } from "./validation-BZLpfukT.js";
import { t as registerClawHubCatalogIconUrls } from "./catalog-icon-registry-b1MkOn00.js";
	...
	return {
		...
		async withCommittedUpload(uploadIdRaw, action) {
			...
			return withLock(`${context.admission.databasePath}:upload:${uploadId}`, async () => {
				const { runAssistantStateWorkerOperation } = await import("./testclaw-state-worker-store-C-YrKqH_.js");
				const { withSkillUploadInstallOwner } = await import("./upload-store-install-owner-CVoiUDam.js");
...
async function forwardSkillWorkshopRevisionToChatSend(opts, params) {
	const { handleChatSendWithSkillWorkshopProposalRevision } = await import("./chat-send-handler-CUwkbSeJ.js");
	const chatParams = {
		sessionKey: params.sessionKey,
