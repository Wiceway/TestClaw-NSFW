...
import { i as nodeRuntimeFailure, n as detectCurrentSqliteCapabilities, t as SQLITE_CAPABILITY_PROBE } from "./node-sqlite-BYuCrQql.js";
...
async function findUsableNodeRuntime({ homeDir, allowInstall = false, env = process.env, acceptVersion, nodeVersion, installCommand } = {}) {
	...
	const { resolveUpdatedNodeRuntime } = await import("./node-runtime-update-m2Ae20fE.js");
