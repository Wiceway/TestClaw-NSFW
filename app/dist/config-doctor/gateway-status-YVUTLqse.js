...
import { n as ensureExplicitGatewayAuth } from "./client-bootstrap-PJVbtOFi.js";
...
import { a as resolveWideAreaDiscoveryDomain } from "./widearea-dns-91F75Em1.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-DzHmrR74.js";
import { n as buildGatewayDiscoveryTarget, r as serializeGatewayDiscoveryBeacon } from "./gateway-discovery-targets-D2BsAvv3.js";
import { a as isProbeReachable, c as renderTargetHeader, d as resolveTargets, f as sanitizeSshTarget, i as isPostConnectProbeFailure, l as resolveAuthForTarget, n as buildNetworkHints, o as isScopeLimitedProbeFailure, p as summarizeGatewayProbeCapability, r as extractConfigSummary, s as renderProbeSummaryLine, t as pickGatewaySelfPresence, u as resolveProbeBudgetMs } from "./gateway-presence-c6ta8krR.js";
...
const noReachableGatewayDiagnostic = "No gateway answered any probe and Bonjour discovery returned no local gateways. Run `testclaw gateway status --deep --require-rpc` to inspect service state, config paths, listener owners, and logs; include `ss -ltnp` or `lsof -nP -iTCP:<port> -sTCP:LISTEN` for the configured port when filing a report.";
...
function buildGatewayStatusWarnings(params) {
	...
	if (params.localTlsLoadError) warnings.push({
		...
		message: `Local gateway TLS is enabled but Assistant could not load the local certificate fingerprint: ${params.localTlsLoadError}`,
...
/** CLI entrypoint for `testclaw gateway probe`. */
const sshConfigModuleLoader = createLazyImportLoader(() => import("./ssh-config-nchlHyAI.js"));
const sshTunnelModuleLoader = createLazyImportLoader(() => import("./ssh-tunnel-xT8Wzbcr.js"));
const gatewayTlsModuleLoader = createLazyImportLoader(() => import("./gateway-BKJPyfob.js"));
