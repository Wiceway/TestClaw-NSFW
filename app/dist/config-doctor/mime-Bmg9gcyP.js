...
const FILE_TYPE_SNIFF_MAX_BYTES = 1048576;
const EXT_BY_MIME = {
	"image/avif": ".avif",
	"image/heic": ".heic",
...
async function detectMime(opts) {
	...
	const audioContainerHint = inferred && [...mimeHints, extMime].find((mime) => mime && AMBIGUOUS_VIDEO_MIME_BY_AUDIO_MIME[mime] === inferred);
...
function extensionForMime(mime) {
	...
	return Object.hasOwn(EXT_BY_MIME, normalized) ? EXT_BY_MIME[normalized] : void 0;
}
...
//#endregion
export { imageMimeFromFormat as a, kindFromMime as c, getFileExtension as i, mimeTypeFromFilePath as l, detectMime as n, isAudioFileName as o, extensionForMime as r, isZipContainerMime as s, FILE_TYPE_SNIFF_MAX_BYTES as t, normalizeMimeType as u };
