...
import { h as resolveNonEnvSecretRefApiKeyMarker, o as isNonSecretApiKeyMarker } from "./model-auth-markers-B_eyfwDG.js";
import { f as resolveOwningPluginIdsForProviderRef } from "./providers-BJqVIQwV.js";
import { a as resolveRuntimePluginDiscoveryProviders, n as normalizePluginDiscoveryResult, o as runProviderCatalog, r as prepareProviderStaticCatalog, s as runProviderStaticCatalog, t as groupPluginDiscoveryProvidersByOrder } from "./provider-discovery-Bfpchrcc.js";
import { g as prepareProviderExternalAuthWithPlugin } from "./provider-runtime-B3-FZB4p.js";
import { n as resolveManifestSyntheticAuthProviderRefState } from "./synthetic-auth.runtime-1WTMeGiK.js";
import { n as ensureAuthProfileStore } from "./store-runtime-gE8saxs_.js";
import { n as mergeProviderModels } from "./models-config.merge-C9b7a4jN.js";
import { l as resolveMissingProviderApiKey, r as createProviderAuthResolver, t as createProviderApiKeyResolver } from "./models-config.providers.secrets-CwlKE9Y6.js";
...
async function prepareProviderCatalogRun(params) {
	...
	const { prepareProviderCatalogOAuthAuth } = await import("./models-config.providers.discovery-auth.runtime-BtOaQ5W1.js");
...
async function reportProviderCatalogSecretFailure(error, params) {
	...
	const { resolveUnavailableDiscoveryAuthProfileId } = await import("./models-config.providers.discovery-auth.runtime-BtOaQ5W1.js");
...
async function resolveImplicitProviders(params) {
	...
	if (params.providerDiscoveryEntriesOnly !== true && hasLiveCatalog) {
		const { prepareProviderDiscoveryAuth } = await import("./models-config.providers.discovery-auth.runtime-BtOaQ5W1.js");
...
//#endregion
export { resolveImplicitProviders as n, prepareImplicitProviderStaticCatalog as t };
