...
import { a as resolveAgentDir, d as resolveAgentWorkspaceDir, j as listAgentIds, k as listAgentEntries, r as resolveAgentConfig, u as resolveAgentRunCwd, y as resolveNativeModelPrimary } from "./agent-scope-config-BEuqweC1.js";
import { a as classifySessionKeyShape, c as resolveAgentIdFromSessionKey, o as isUnscopedSessionKeySentinel, p as scopeLegacySessionKeyToAgent, x as isSubagentSessionKey } from "./session-key-AvQIavYt.js";
import { S as isSecretRef } from "./types.secrets-K95Dlap_.js";
import { t as formatErrorMessage } from "./errors-cp9Var1Z.js";
import { f as isDiagnosticsEnabled, s as emitTrustedDiagnosticEvent } from "./diagnostic-events-CzmzgdMI.js";
import { r as defaultRuntime } from "./runtime-kM7jday_.js";
import { t as createSubsystemLogger } from "./subsystem-B0s_EQTq.js";
import { Rt as normalizeAgentRunTerminalReceipt } from "./testclaw-state-db-readonly-mjFl_Qah.js";
...
import { h as resolveConfiguredModelRef, o as dedupeModelCatalogEntries, r as buildConfiguredModelCatalog } from "./model-selection-shared-YvCZW05m.js";
import { D as hasSessionAutoModelSelection, E as hasSessionAutoModelFallbackProvenance, N as resolveCollapsedSessionAuthPinSource, P as resolveSessionAuthProfileOverrideSource, T as hasSessionActiveAutoModelFallback, _ as resolveSessionAgentId, i as markAutoFallbackPrimaryProbe, k as resolveSessionModelOverrideRouteResolution, m as resolveEffectiveModelFallbacks, n as entryMatchesAutoFallbackPrimaryProbe, p as resolveAutoFallbackPrimaryProbe, r as hasLegacyAutoFallbackWithoutOrigin, t as clearAutoFallbackPrimaryProbeSelection, y as resolveSessionAgentIds } from "./agent-scope-BiRi-Smp.js";
import { n as resolveEffectiveAgentSkillFilter } from "./agent-filter-zOs7s0dg.js";
import { i as prepareModelRunCapabilities, n as findModelInCatalog } from "./model-catalog-lookup-_Hi_clcB.js";
import { t as resolveDefaultModelForAgent } from "./model-selection-config-Wz3M4QhR.js";
import { s as normalizeThinkLevel, u as normalizeVerboseLevel } from "./thinking.shared-DJ5AX7RA.js";
...
import { a as evaluateAgentDatabaseAdmissions, f as recordAgentDatabaseAdmissions, n as assertAgentDatabaseAdmitted, s as hasAgentDatabaseAdmissions } from "./agent-database-admission-D08lnQbi.js";
...
import { a as resolveMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-9H_XKKih.js";
import "./message-channel-iCC7oIhe.js";
import { d as patchSessionEntryCore } from "./session-accessor.sqlite-entry-CJ8WVyje.js";
import { l as getSessionWorkAdmissionOwnerRelease, n as beginSessionWorkAdmission } from "./session-lifecycle-admission-7kJ3kdsZ.js";
...
import { i as emitAgentEvent, n as captureAgentRunLifecycleGeneration, t as assertAgentRunLifecycleGenerationCurrent, y as withAgentRunLifecycleGeneration } from "./agent-events-CFq48PcN.js";
...
import { c as isValidAgentHarnessSessionStoreEntry, l as resolveAgentHarnessSessionContextError, t as AGENT_HARNESS_MODEL_RUN_FORBIDDEN_MESSAGE } from "./agent-harness-session-key-Bbf-OONo.js";
import { a as applyModelOverrideToSessionEntry, c as repairProviderWrappedModelOverride, i as ModelSelectionLockedError, s as isModelSelectionLocked, t as MODEL_SELECTION_LOCKED_MESSAGE } from "./model-overrides-D92VyxpR.js";
import { a as hasBillableUsage, d as toDiagnosticUsage } from "./usage-C3K3M4jZ.js";
import { t as buildRestartRecoveryClaimCleanupPatch } from "./restart-recovery-state-Bc2gwEgq.js";
import { o as getAdmittedRunDelegatedAuthority } from "./admitted-run-context-BE5EAdRS.js";
import { d as recordSessionHumanDirectMessage, n as classifySessionStateActor } from "./session-state-events-CHD4f1I_.js";
...
import { g as throwAgentRunRestartAbortReason, l as isAgentRunDirectAbortReason, m as resolveAgentRunErrorLifecycleFields, o as createAgentRunRestartAbortError, p as resolveAgentRunAbortLifecycleFields, u as isAgentRunRestartAbortReason } from "./run-termination-Ig3BzvZQ.js";
...
import { x as isSyntheticSourceReplyTurn } from "./task-notification-routing-CYDaelCz.js";
import { l as isAgentMediatedCompletionSourceTool, m as isSubagentCoordinationInputProvenance } from "./input-provenance-DGaz_sh7.js";
...
import { r as clearAgentRunTerminalWriteContext } from "./agent-run-terminal-writes-Ci0lfLsp.js";
import { n as prepareAgentCommandExecutionIdentity, r as sanitizePublicAgentCommandIngressOpts, t as executionIdentity } from "./agent-command-execution-identity-CWSS99nB.js";
import { t as buildMainSessionRecoveryClearPatch } from "./main-session-recovery-clear-cfgvJWei.js";
import { r as repairMainSessionRecoveryMutation } from "./main-session-recovery-lifecycle-CSH3ePDC.js";
import { a as createSessionWorkStartChangedError, d as resolveSessionWorkStartError, l as isSessionWorkStartInvalidatedError, r as SessionWorkStartChangedError } from "./lifecycle-DpcRUIUy.js";
import { a as releaseMainSessionRecoveryOwner, i as refreshMainSessionRecoveryOwner, r as inspectMainSessionRecoveryRequired, t as claimMainSessionRecoveryOwner } from "./main-session-recovery-store-Lj2mbsAU.js";
import { n as resolveSendPolicy } from "./send-policy-BpPQAAsR.js";
import { r as formatErrorMessageForDisplay } from "./error-diagnostics-D1OCFafW.js";
...
import { t as withLocalAgentCronJobsRemoved } from "./local-service-DTmFLDq1.js";
import { n as bindLegacyPluginSdkResourceHost, r as getLegacyPluginSdkResourceHost } from "./legacy-sdk-resource-host-COLfIZyZ.js";
import { t as loadGatewayConfigRevisionProjector } from "./config-revision-token-DBYY9CHj.js";
import { t as NodeRegistry } from "./node-registry-anoqVA6x.js";
import { r as createChatRunState } from "./server-chat-state-CYOw0v3Y.js";
...
import { i as normalizeThinkingCatalogProviders, n as hasResolvedThinkingCatalogEntry, o as resolveEffectiveAgentRuntime, r as needsThinkHydration } from "./thinking-runtime-DiGMOYgI.js";
import { n as loadManifestModelCatalog } from "./model-catalog-B6RrhAtj.js";
import { r as withAgentPluginRegistry } from "./runtime-plugins-DsAgPM8S.js";
import { a as readPreparedGatewayModelCatalogBatch, i as readPreparedGatewayModelCatalog, n as loadGatewayModelCatalogSnapshot, o as readPreparedGatewayModelCatalogOwnerSnapshot, r as loadPreparedGatewayModelCatalogSnapshot, t as loadGatewayModelCatalog } from "./server-model-catalog-Cu8q_Suv.js";
...
import { t as resolveSessionStableReplyMode } from "./session-stable-reply-mode-Ck1Q-Nji.js";
import { r as resolveMessageChannelSelection } from "./channel-selection-BPtL262w.js";
import { n as resolveAgentExplicitRecipientSession, r as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlanWithSessionRoute } from "./agent-delivery-B1h-BFF9.js";
...
import { l as resolveInternalEventTranscriptBody, o as prependInternalEventContext, s as resolveAcpPromptBody } from "./internal-events-fYW3tKod.js";
...
import { n as acquireWorktreeRunLease, o as resolveWorktreeIdForPath } from "./run-lease-ClmXh12n.js";
import { _ as resolveAgentCommandDeps, a as loadAcpPolicyRuntime, c as loadAgentRunnerMemoryRuntime, d as loadDeliveryRuntime, f as loadExecDefaultsRuntime, g as loadTranscriptResolveRuntime, h as loadTranscriptAppendRuntime, i as loadAcpManagerRuntime, l as loadAttemptExecutionRuntime, m as loadSkillsRuntime, n as scheduleSessionMaintenance, o as loadAcpRuntimeErrorsRuntime, p as loadSessionStoreRuntime, r as createCommandBudget, s as loadAcpSessionIdentifiersRuntime, t as createSessionMaintenanceFollowup, u as loadCliCompactionRuntime } from "./run-0SYvd2pU.js";
import { i as resolveSession, n as clearRotatedSessionMetadata } from "./session-BPKOjr3V.js";
...
import { n as createHarnessCompletionSourceAssertion, r as getOwedHarnessCompletionTask, t as captureHarnessCompletionRecovery } from "./agent-harness-completion-recovery-BwWneU8G.js";
import { a as hasVisibleAgentPayload } from "./message-visibility-C6u1cGtH.js";
import { _ as hasVisibleCommittedMessagingToolDeliveryEvidence, g as hasUnaccountedMessagingToolAggregateEvidence, i as collectMessagingToolDeliveredMediaUrls, l as hasCommittedOutboundDeliveryEvidence, r as collectDeliveredMediaUrls } from "./delivery-evidence-CDgoalBx.js";
import { n as mergeAttemptToolMediaPayloads } from "./tool-media-payloads-BM91CJJ6.js";
import { r as resolveInlineAgentImageAttachments } from "./agent-turn-attachments-C3Q68_tn.js";
import { r as recordAgentRunTerminalOutcome } from "./agent-run-terminal-outcome-DyU1LC7z.js";
import { n as getInstallationTarget, t as LOCAL_INSTALLATION_TARGET_UNSUPPORTED } from "./installation-target-context-B-FS4qIf.js";
import { n as prepareInternalSessionEffectsSession, t as createInternalSessionEffectsCleanup } from "./internal-session-effects-Mz-y27Yc.js";
import { r as classifyGatewayStaleInstall } from "./stale-install-Cz6VHd9H.js";
import { n as normalizeAgentRunTerminalDeliverySnapshot } from "./agent-run-status-Ie-4cjf6.js";
...
import { r as shouldPreserveUnavailableSessionAuthProfileOverride } from "./auth-profile-preservation-DmzJcXD9.js";
...
import { M as createDeferredEmbeddedRunLifecycleManager } from "./builtin-testclaw-D8svmGKw.js";
...
import "./live-model-switch-DHCxJFYD.js";
import { t as hasSameCompactionWriter } from "./agent-runner-compaction-accounting-B3SiBvkt.js";
import { n as incrementCompactionCount } from "./session-updates-CCJm1HuY.js";
import { n as applyVerboseOverride } from "./level-overrides-RhKvHfBy.js";
import { t as ensureSessionDiffBaseline } from "./session-diff-baseline-DrE-yO8_.js";
import { t as resolveAgentRunContext } from "./run-context-d-TBIv9W.js";
...
function createLocalGatewayRequestContext(params) {
	...
	context.ensureSessionRowProjection = () => {
		if (!initializing) {
			...
			initializing = import("./session-row-projection-MwvFdNb_.js").then(async ({ createSessionRowProjection }) => {
	...
	context.createAgentTurnFacade = async (principal) => {
		const { createInternalAgentTurnFacade } = await import("./internal-facade.runtime-BZuI32b2.js");
...
async function resolveAgentRuntimeConfig(runtime, params) {
	...
	const cfg = hasRuntimeSecretRefs ? await (async () => {
		...
		return (await (await import("./command-config-resolution.runtime-GFLdou3h.js")).resolveCommandConfigWithSecrets({
			config: loadedRaw,
			commandName: "agent",
	...
	if (activeSecretsConfig && cfg !== loadedRaw) setRuntimeConfigSnapshot(cfg, sourceConfig);
		...
		const secretsRuntime = await measureAgentStartup("secrets-runtime-import", () => import("./runtime-BBBvZ8cN.js"), { config: cfg });
...
async function prepareAgentCommandExecution(opts, runtime, runtimeContext) {
	...
	try {
		...
		if (!isRawModelRun && (message.includes("$") || message.trimStart().startsWith("/"))) {
			const { expandExplicitSkillReferences, hasSkillReferenceCandidate, prepareSkillCommandsForWorkspace, resolveEffectiveAgentSkillFilter } = await import("./chat-commands.runtime-BVCQKZUX.js");
...
function createLazyAcpElicitationHandler(params) {
	...
	return async (request, context) => {
		handler ??= import("./acp-elicitation-handler-Dilz6HM7.js").then(({ createAcpElicitationHandler }) => createAcpElicitationHandler(params));
...
async function clearCommandRecoveryClaim(params) {
	...
	try {
		...
		if ((sessionStore[sessionKey] ?? entry)?.restartRecoveryTerminalDeliveryEvidence?.some((receipt) => receipt.harnessCompletion)) {
			const { reconcileSessionHarnessCompletionDeliveries } = await import("./agent-harness-completion-delivery-Bk1bV-EF.js");
...
async function agentCommandInternal(prepared, initialOpts, admissionIngress, runtime = defaultRuntime, deps, watchSkills = false) {
	...
	try {
		const operatorSession = opts.operatorAuthority && sessionKey ? (await import("./operator-session-run-Bqe_59wD.js")).prepareGatewayOperatorSessionRun({
