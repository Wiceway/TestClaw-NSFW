...
import { r as isValidBase64 } from "./base64-B5EyWEOm.js";
...
import { n as resolveExplicitSessionName, r as sessionTitleRequests, t as hasExplicitSessionName } from "./session-title-state-DS7JC3mN.js";
...
async function generateDashboardSessionTitle(params) {
	...
	try {
		const { generateConversationLabelWithFallback } = await import("./conversation-label-generator-CGzF7WiF.js");
