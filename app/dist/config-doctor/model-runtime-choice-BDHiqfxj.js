...
import { n as findModelInCatalog, s as createModelCatalogIdentityKeyResolver } from "./model-catalog-lookup-_Hi_clcB.js";
import { t as FailoverError } from "./error-D_GewJgV.js";
//#region src/agents/model-runtime-choice.ts
const loadPreparedModelCatalog = createLazyPromise(() => import("./prepared-model-catalog-QaCXv2Di.js"));
const loadModelResolver = createLazyPromise(() => import("./model-Bkiu6p3A.js"));
const loadModelSelection = createLazyPromise(() => import("./model-selection-BItbyaBa.js"));
const loadModelRefProfile = createLazyPromise(() => import("./model-ref-profile-CVfNMb6I.js"));
const loadModelCatalogDecisions = createLazyPromise(() => import("./model-catalog-decisions-CTB11Znn.js"));
const loadPreparedRuntimeAuth = createLazyPromise(() => import("./prepared-model-runtime-auth-BCYqel7b.js"));
const loadProviderModelRoute = createLazyPromise(() => import("./provider-model-route-9rd_J9T9.js"));
const loadRuntimeModelMaterializer = createLazyPromise(() => import("./materialize-model-CRSCZNuY.js"));
const loadModelFallbackCandidates = createLazyPromise(() => import("./model-fallback-candidates-Ch95REvC.js"));
const loadProviderAuthAliases = createLazyPromise(() => import("./provider-auth-aliases-BKdRtVhM.js"));
const loadPluginGenerationScope = createLazyPromise(() => import("./generation-scope-CULfJRdz.js"));
const loadModelCatalogEntry = createLazyPromise(() => import("./model-catalog-entry-DIIlUTgc.js"));
