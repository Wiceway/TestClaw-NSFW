...
import { o as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-description-presets-CT4WhVkI.js";
import { i as toDisplayPath, r as resolveApplyPatchInputPath } from "./apply-patch-paths-BQVoOQ96.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-Dj1YnyaU.js";
import { a as markHostRootEscape, i as isPathBoundaryEscapeError, n as assertSandboxPath, r as isHostRootEscapeError } from "./sandbox-paths-C2TTxiUG.js";
import { a as toRelativeSandboxPath, i as resolveSandboxPathMapping, n as relativePathInsideSandboxRoot, r as resolvePathFromInput, t as preserveAtPrefixedRelativePath } from "./path-policy-CUndGQuU.js";
import { l as rewrapToolWithBeforeToolCallHook, u as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-BwZqazXs.js";
import { r as getAgentWorkspaceAccess, t as WorkspaceAccessUnavailableError } from "./workspace-access-B2mkdxzZ.js";
import { h as isToolWrappedWithBeforeToolCallHook, r as copyAgentToolMetadata, t as bindAgentToolActionDescriptor } from "./agent-tool-metadata-DkPGvtCv.js";
import { o as normalizeFileToolPathParam } from "./agent-tools.before-tool-call.decision-C6ZPXFnE.js";
import { r as captureAgentToolSourceExecutionGuard } from "./agent-tool-source-execution-guard-jLk-wb7O.js";
import { a as resolveToolResultBudget } from "./tool-result-limits-Lx_h0EBk.js";
import { D as withFileMutationQueueKeysResolution, E as withFileMutationQueueKeyResolution, O as decodeUtf8File, f as createReadTool, g as createLsTool, w as resolveFileMutationQueueKey } from "./tools-FoyuW2o_.js";
import { r as resolveReadOnlyWorkspaceSkillMounts } from "./workspace-mounts-BVUy-KWR.js";
import { r as resolveSandboxFileMutationQueueKey } from "./file-mutation-identity-Bmu3sjBc.js";
			...
			const remoteRead = createReadTool(options.codingRoot, {
				...
				operations: {
					...
					readFile: async () => {
						...
						const { prepareSkillBundle } = await import("./bundle-bIFaJ-9v.js");
...
//#endregion
export { readToolOperatorHint as a, finalizeAgentTools as i, isApplyPatchAllowedForModel as n, resolveConfiguredApplyPatchPolicy as r, createCoreCodingTools as t };
