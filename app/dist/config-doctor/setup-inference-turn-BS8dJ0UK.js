...
import { i as isMissingSecretRefResolutionError } from "./resolve-errors-YgWEeepi.js";
import { d as resolvePersistedAuthProfileOwnerAgentDir, n as captureAuthProfileStorePersistenceSnapshot, p as restoreAuthProfileStorePersistenceSnapshot } from "./store-D9AW3Yaj.js";
import { c as getRuntimeAuthProfileStoreCredentialsRevision, rt as getRuntimeAuthProfileStoreCredentialMutationToken } from "./runtime-snapshots-LZfHFeGe.js";
...
import { d as saveAuthProfileStoreIfPersistenceSnapshotMatches, l as loadAuthProfileStoreWithoutExternalProfiles, o as loadAuthProfileStoreForRuntime } from "./store-runtime-gE8saxs_.js";
...
import { _ as resolveToolFreeCliSetupError, a as SetupInferenceCancelledError, c as mapFailoverReasonToSetupStatus, f as redactSetupInferenceError, l as parseInferenceRef, m as resolveSetupInferenceWinnerError, o as SetupInferenceOwnerDriftError, s as invalidSetupConfigError, v as setupInferenceLog, y as throwIfSetupInferenceCancelled } from "./setup-inference-core-BwVzPhCm.js";
import { a as resolveSystemAgentVerifiedInferenceRoute, n as createSystemAgentVerifiedInferenceBinding, r as hasCurrentSystemAgentOwnerPluginArtifacts, t as captureSystemAgentOwnerPluginArtifacts } from "./verified-inference-CVC2Uoay.js";
...
async function withPreparedSetupCredentialAccess(ctx, staged, profileId, verify, failure) {
	...
	return await withSetupCredentialAccess(access, async () => {
		...
		const { prepareSecretsRuntimeSnapshot } = await import("./runtime-BBBvZ8cN.js");
...
async function runSetupInferenceTurn(params) {
	...
	try {
		...
		let result;
		if (route.runner === "cli") result = await (deps.runCliAgent ?? (await import("./cli-runner-Ba4qIkpQ.js")).runCliAgent)({
			...shared,
			...
			const runEmbedded = deps.runEmbeddedAgent ?? (await import("./embedded-agent-NT6PSa6u.js")).runEmbeddedAgent;
...
async function verifySetupInference(params) {
	const readSnapshot = params.deps?.readConfigFileSnapshot ?? (await import("./config-fCohulPn.js")).readConfigFileSnapshot;
...
async function completeSetupInference(params) {
	const snapshot = await (params.deps?.readConfigFileSnapshot ?? (await import("./config-fCohulPn.js")).readConfigFileSnapshot)();
	if (!snapshot.exists) return {
		ok: false,
		status: "unavailable",
