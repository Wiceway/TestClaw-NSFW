...
const gatewayRpcRuntimeLoader = createLazyImportLoader(() => import("./gateway-rpc.runtime-0rfH5HiB.js"));
...
async function canFallbackToImplicitLocalGateway(params) {
	const gateway = await import("./call-BUB0AMHV.js");
	const { isGatewayRpcUnavailableError } = await import("./transport-error-DZpvCxpP.js");
