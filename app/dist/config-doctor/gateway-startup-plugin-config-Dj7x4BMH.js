...
import { d as resolveEffectivePluginActivationState, h as resolveSelectedContextEnginePluginIdFromConfig } from "./config-state-D4j-tzq3.js";
...
import { l as normalizeResolvedSecretInputString } from "./types.secrets-K95Dlap_.js";
import { r as readBundledDiscoveryMode } from "./bundled-discovery-state-DLgcGE7d.js";
...
import { n as collectConfiguredModelRefs, r as listModelRefsFromConfigValue } from "./configured-model-refs-Cy0Q005p.js";
import "./plugin-registry-contributions-By7XcmN-.js";
import { i as listPotentialConfiguredChannelPresenceSignals, n as listExplicitlyDisabledChannelIdsForConfig, r as listPotentialConfiguredChannelIds } from "./config-presence-Cn440vQz.js";
...
import { t as CORE_BUILT_IN_MODEL_APIS } from "./provider-config-owner-BOsyuzHw.js";
...
import { d as ssrfPolicyFromHttpBaseUrlAllowedHostname } from "./ssrf-BgXBFPdG.js";
import { i as fetchWithSsrFGuard } from "./fetch-guard-BLzJd1EF.js";
import { a as createProviderHttpError, f as redactProviderResponseErrorText, o as readProviderJsonArrayFieldResponse } from "./provider-http-errors-BAwtNYrg.js";
import { c as resolveMemoryDreamingPluginId, o as resolveMemoryDreamingConfig, s as resolveMemoryDreamingPluginConfig, t as DEFAULT_MEMORY_DREAMING_PLUGIN_ID } from "./dreaming-DjkmR5Ly.js";
import { t as resolveConfiguredGenericEmbeddingProviderId } from "./embedding-provider-config-B7oW9g2j.js";
import "./config-contracts-BP6EmpGL.js";
...
async function resolveConfiguredProviderApiKey(params) {
	...
	if (!apiKey) return;
	const { resolveAgentDir, tryResolveAmbientOwnerAgentId } = await import("./agent-scope-config-DjAEl3pT.js");
	...
	const { resolveScopedAuthProfileStore, resolveProviderEntryApiKeyAuth } = await import("./model-auth-provider-DI3g5oZP.js");
	const authParams = {
...
async function createEmbeddingHttpError(response, requestHeaders) {
	...
	const error = await createProviderHttpError(new Response(safeBody, {
...
async function createOpenAICompatibleEmbeddingClient(options) {
	...
	const { embeddingProviderOwnsDestination, resolveEmbeddingEndpointUrl } = await import("./memory-core-host-engine-embeddings-ClbHtv-Q.js");
