...
import { Bt as validateEnvironmentsStatusParams, Ft as validateEnvironmentsPrepareParams, Mt as validateEnvironmentsCreateParams, Nt as validateEnvironmentsDestroyParams, Pt as validateEnvironmentsListParams, Rt as validateEnvironmentsSessionExecParams, St as validateDesktopReleaseParams, bt as validateDesktopLaunchParams, gs as validateWorkerDesktopObserveParams, hs as validateWorkerDesktopLaunchParams, xt as validateDesktopObserveParams } from "./validator-registry-Dpl5QmuY.js";
...
import { d as resolveRequiredNodeCommandAuthority, l as resolveNodeCommandAllowlist, o as isNodeCommandAllowed } from "./node-command-policy-D1CEhJWf.js";
import { n as readNodeSessionWithheldCommands } from "./node-registry-anoqVA6x.js";
import { t as collectNodeCatalogRuntimeState } from "./node-registry-private-XTdlHWHf.js";
import { i as getGatewayToolCallerIdentity } from "./gateway-caller-context-BrVUu-N_.js";
import { r as sanitizeExecApprovalDisplayTextWithStatus } from "./exec-approval-text-sanitize-sb55IYxr.js";
import { n as createAgentRuntimeIdentity } from "./agent-runtime-identity-token-DB94ummf.js";
...
import { o as resolveWorkerPlacementCapabilities } from "./placement-session-runtime-DFQYnjUZ.js";
import { m as projectNodePairing } from "./device-pairing-node-D3__zSdN.js";
...
import { o as projectPairedDeviceNodeBindings } from "./device-pairing-node-state-EcH9PdTQ.js";
import { r as listKnownNodes, t as createKnownNodeCatalog } from "./node-catalog-B51wMTxh.js";
import { i as summarizeWorkerEnvironment, n as resolveSessionEnvironmentCaller, r as captureSessionEnvironmentToolPolicy, t as environmentsSessionHandlers } from "./environments.session-D4huApuf.js";
import { n as getNodeDesktopService } from "./node-source-context-BPWy9Mf9.js";
...
async function listGatewayEnvironments(context, workers = listWorkerEnvironments(context), runtimeId, includeDesktopSetup = false) {
	...
	if (includeDesktopSetup && config.desktop?.host?.enabled !== true) {
		const { inspectHostDesktopSetup } = await import("./host-source-r08tycu2.js");
		gateway = {
			...gateway,
...
const environmentsHandlers = {
	...
	"desktop.release": async ({ params, respond, client, hasCurrentClientAuthority }) => {
		...
		const { releaseDesktopObserverToken } = await import("./observe-bridge-Bbhwh-Ub.js");
		await respondUnavailableOnThrow(respond, async () => {
