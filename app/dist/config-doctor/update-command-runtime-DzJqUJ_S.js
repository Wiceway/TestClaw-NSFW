...
import { l as isConfiguredPluginPathDiagnosticCode } from "./discovery-2wVyQ2Ni.js";
...
import { o as redactSupportString, r as redactPublicSupportDiagnosticLine } from "./diagnostic-support-redaction-DgR7hMLl.js";
import { i as parseConfigFailureFacts, n as createUpdateFailureFact, r as normalizeUpdateFailureFacts } from "./update-failure-facts-CzM99Hgb.js";
import { c as consumeUpdatePostInstallDoctorResult, i as UpdateDoctorError, r as UPDATE_POST_INSTALL_DOCTOR_RESULT_PATH_ENV, t as DoctorMaintenanceRefusalError, u as createUpdatePostInstallDoctorResultPath } from "./update-doctor-result-fRe8i0lu.js";
...
import { i as isPlainCommandExitFailure, n as createSanitizedCommandError, r as hasCommandProcessCleanupError, t as CommandProcessCleanupError } from "./exec-result-VkoWpd4F.js";
import { a as withoutPluginInstallRecords, i as withPluginInstallRecords } from "./installed-plugin-index-records-NgkzYl8d.js";
...
import { F as attachPluginInstallOwnerMigrations, z as resolvePluginInstallOwnerMigrations } from "./npm-managed-root-CfA_sn6m.js";
import { t as listPersistedBundledPluginLocationBridges } from "./location-bridges-mFYafZXS.js";
...
import { t as comparePackageUpdateVersions } from "./package-update-utils-CT9vtHYv.js";
import { d as resolveExactNpmSpecVersion, h as resolveNpmSpecPackageName, o as isPluginInstallRecordUpdateSource } from "./update-source-CZc00DTB.js";
import { r as resolveOfficialPluginCohortNpmSpecs } from "./plugin-version-drift-C4sYj3bb.js";
import { s as stripGatewayServiceMarkerEnv, t as disableUpdatedPackageCompileCacheEnv } from "./update-command-service-env-DYcjXvvU.js";
...
import { n as VERSION_BOUND_RUNTIME_PLUGIN_IDS } from "./configured-runtime-plugin-installs-BCSuu8T1.js";
import { r as reconcilePluginPackageUpdateConfig, t as capturePluginPackageUpdateSnapshot } from "./plugin-package-update-uAbOi7a9.js";
import { n as updateNpmInstalledPlugins, r as isClawHubTrustSkippedOutcome, t as syncPluginsForUpdateChannel } from "./update-D933vsvC.js";
import "./update-post-core-context-4DzUDiDA.js";
import { c as resolveUpdateInstallKind } from "./update-check-D4M5AA5a.js";
import { l as parseUpdateTimeoutMs, v as resolveNodeRunner } from "./shared-BUgQgLm0.js";
import { a as parseUpdateDoctorLintReport } from "./update-doctor-lint-ucnpJj2Y.js";
...
import { n as inspectUpdateDoctorChildSupport, r as withUpdateDoctorChild, t as assertUpdateDoctorChildSucceeded } from "./update-command-doctor-child-CczKS1rP.js";
import { c as withUpdateConfigWriteAuthority } from "./update-command-config-IaaoLXkX.js";
import { s as withGatewayRuntimeArtifactPublication } from "./update-command-service-maintenance-UY-WidjP.js";
import { n as assessPluginUpdate, o as createPluginUpdateWarning, r as buildInvalidConfigPostCoreUpdateResult } from "./update-command-plugins-internals-BGZUZuxB.js";
import { S as createUpdateCommandAuthority } from "./update-command-terminal-DclZGDYR.js";
import { a as UPDATE_POST_CORE_CONVERGENCE_ENV, d as resolvePostCoreConvergenceEnv, i as UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE_ENV, t as UPDATE_DEFER_CONFIGURED_PLUGIN_INSTALL_REPAIR_ENV } from "./update-phase-B3ln2lPo.js";
import { r as collectStateDatabasePaths, s as readUpdateStateDatabaseSizes } from "./update-candidate-state-CM0AfPoT.js";
import { t as hasDeferredUpdateModelRetirement } from "./update-deferred-model-retirement-CahiJZ1y.js";
import { t as assertInstalledPluginIdRecoveryCurrent } from "./installed-plugin-id-recovery-0FVTbB4Z.js";
import { t as collectMissingPluginInstallPayloads } from "./payload-verification-B0goCqx1.js";
import { t as runPostCorePluginConvergence } from "./post-core-plugin-convergence-ZY-90v3L.js";
