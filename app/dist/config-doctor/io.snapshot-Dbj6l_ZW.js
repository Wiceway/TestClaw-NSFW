...
import { S as isPlainObject, h as sleep } from "./utils-BfoJTy8l.js";
...
import { R as materializeModelPolicyAllowlist } from "./agent-scope-config-BEuqweC1.js";
import { E as resolveStateDir, b as resolveIsConfigReadOnly } from "./paths-DeOFr7iP.js";
...
import { a as hashConfigIncludeRaw, n as ConfigIncludeError } from "./includes-Be6ircIw.js";
...
import { a as withArtifactPreservingStateReads, d as withSynchronousArtifactPreservingStateSnapshot, r as isArtifactPreservingStateRead, u as withExistingAssistantStateDatabaseReadOnly } from "./testclaw-state-db-readonly-mjFl_Qah.js";
import { r as AssistantStateOwnershipError } from "./testclaw-state-ownership-B0rMwXgw.js";
...
import { n as replaceFileAtomic, r as replaceFileAtomicSync } from "./replace-file-GThucKH8.js";
import { a as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-record-match-DU0U5gm6.js";
import { r as shouldWarnOnTouchedVersion } from "./version-CKE5uMw2.js";
import { h as snapshotEnv, m as restoreEnvChangesIfUnchanged, n as cloneEnvWithPlatformSemantics, t as applyConfigEnvVars } from "./config-env-vars-CGWZEj0Z.js";
import { l as withPluginMetadataSnapshotScope } from "./current-plugin-metadata-snapshot-VdnPfhqM.js";
import { t as classifyOtelGrpcMigrationOwnership } from "./include-migration-ownership-CRaSKYvm.js";
import { t as inheritLegacyDefaultAgentId } from "./legacy.default-agent-owner-C3BvcqUT.js";
import { h as setConfigResolutionFacts, r as copyConfigResolutionFacts, t as cloneConfigWithResolutionFacts } from "./resolution-facts-BNNyTRcj.js";
import { i as isPluginSourceModulePath, u as tryNativeRequireModule } from "./native-module-require-CyWupBwM.js";
import { d as preparePluginLoaderAliases, t as getCachedPluginModuleLoader } from "./plugin-module-loader-cache-DFZdUh0W.js";
...
import { i as isPluginDoctorMigrationDeferred, m as applyPluginDoctorCompatibilityMigration, n as applyPluginDoctorCompatibilityMigrations, r as collectDoctorConfigRepairPluginIds } from "./doctor-contract-registry-DrNrLsUs.js";
import { i as resolveConfigWidePluginMetadataSnapshotAsync, r as resolveConfigWidePluginMetadataSnapshot } from "./io.plugin-metadata-DrtuqGpN.js";
...
import { n as LEGACY_CONFIG_MIGRATIONS, r as collectToolPolicyConflictWarnings, t as findLegacyConfigIssues } from "./legacy-BYmH9Ozt.js";
...
import { t as captureManagedConfigSnapshotPreparation } from "./runtime-snapshot-DTssNCAN.js";
...
import { o as readDeferredPluginMigrations, s as readDeferredPluginMigrationsAsync } from "./deferred-plugin-migrations-DGeuNy95.js";
import { c as shouldEnableShellEnvFallback, i as loadShellEnvFallback, o as resolveShellEnvFallbackTimeoutMs, s as shouldDeferShellEnvFallback } from "./shell-env-CotULTGh.js";
import { D as attachAgentListProjection, O as DuplicateAgentDirError, d as asResolvedSourceConfig, f as asRuntimeConfig, k as findDuplicateAgentDirs, p as materializeRuntimeConfig } from "./validation-core-DFctiTx0.js";
import { c as resolveManagedUnsetPathsForWrite, i as preserveDeferredPluginMigrationConfig, o as setDeferredPluginMigrationConfigFacts } from "./deferred-plugin-migration-config-DVpsClIV.js";
import { i as runAssistantStateWorkerOperation } from "./testclaw-state-worker-store-BMVEu7e2.js";
import { a as appendConfigAuditRecordSync, c as createConfigObserveAuditRecord, i as appendConfigAuditRecord } from "./io.audit-OUHRrOvm.js";
import { a as hashConfigRaw, c as parseConfigJson5, d as resolveConfigIncludesForRead, f as resolveConfigPathForDeps, i as hasConfigMeta, m as resolveGatewayMode, n as containsConfigIncludeDirective, o as maybeLoadDotEnvForConfig, s as normalizeConfigIoDeps, t as coerceConfig, u as resolveConfigForRead } from "./io.read-helpers-DjrAb5Uv.js";
...
import { n as createConfigWriteAuthorityGuard, t as composeConfigWriteAssertions } from "./write-authority-BBYsD_pp.js";
import { r as withFileLock } from "./file-lock-XibtmZie.js";
import { d as getUpdateDoctorConfigWriteAuthority, h as recordUpdateDoctorConfigWriteRefusal } from "./update-doctor-result-fRe8i0lu.js";
...
import { f as migrateLegacyContextBudgetConfig, n as prepareConfigSnapshotValidation, o as validateConfigObjectWithPlugins, s as validateConfigObjectWithPluginsAsync, t as materializeConfigSnapshotDefaults } from "./io.snapshot-preparation-BEHQru7Z.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath } from "./config-paths-Bb8CaCra.js";
import { t as resolveShellEnvExpectedKeys } from "./shell-env-expected-keys-CN9I5WJi.js";
import { i as shouldAttemptLastKnownGoodRecovery, n as isPluginLocalInvalidConfigSnapshot, t as collectPollutedSecretPlaceholders } from "./recovery-policy-BZDKJyRd.js";
import { a as includeContributionOwnsBindings, i as includeContributionOwnsAgentRoster } from "./agent-roster-provenance-CTSAwwv9.js";
