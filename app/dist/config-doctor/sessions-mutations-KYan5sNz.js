...
import { Dt as sqliteSessionEntriesEqual, Tt as assertLifecycleTargetSnapshotUnchanged } from "./session-accessor.sqlite-entry-store-BzD1qpup.js";
...
import { Ai as validateSessionsPluginPatchParams, Bi as validateSessionsSetInvolvementParams, Fi as validateSessionsResetParams, Jr as validateSessionsAssignOwnerParams, Oi as validateSessionsPatchManyParams, ki as validateSessionsPatchParams } from "./validator-registry-Dpl5QmuY.js";
...
import { E as applySessionEntryCanonicalReplacements, y as SessionLabelOwnerIndex } from "./session-accessor.reset-Cl1Mir1u.js";
import { m as resolveMissingAgentHarnessSessionError } from "./agent-harness-session-key-Bbf-OONo.js";
import { t as assignSessionOwner } from "./session-accessor.sqlite-owner-BAEDh6TK.js";
...
import { i as patchPluginSessionExtension } from "./host-hook-state-DB4lWCJV.js";
import { s as resolveGatewaySessionStoreTargetWithStore } from "./session-utils-store-lookup-BpmBw41u.js";
import { Q as disableCronJobsBoundToSessions } from "./session-row-prepared-read-x3FXwbu8.js";
import { n as projectSessionPatchResult } from "./session-utils-model-DNhbGjQT.js";
import { o as resolveCanonicalGatewaySessionStoreKey, s as resolveCanonicalSessionEntryFromStoreKeys } from "./session-utils-store-DlmWzvmc.js";
import { c as projectAssignableSessionOwner, l as projectSessionActor, v as resolveCurrentUserProfileDisplay } from "./session-utils-display-0bRfLd7U.js";
import { A as isSyntheticGatewayCaller, E as gatewayClientSessionCreator, _ as resolveSessionSharingTarget, n as authorizeIncognitoSessionTarget, u as hasSessionReadAccessChanged } from "./session-sharing-policy-rVme8bnl.js";
import { t as SessionMutationAuthorizationChangedError } from "./session-mutation-authorization-error-CCz8QGWh.js";
import { E as createSessionListEntryFilter, _ as ensureSessionGroupRegistered } from "./session-sharing-xa1VG8U2.js";
import { i as prepareSessionWorkerPlacementMutationCheck, r as prepareSessionWorkerPlacementArchiveCheck, t as SessionWorkerPlacementStopError } from "./session-placement-lifecycle-Bsc-2bR7.js";
import "./session-utils-DyRtmfj4.js";
import { n as isSessionStatusModelPatchOrigin, r as recordSessionStatusModelPatchOutcome } from "./session-model-patch-origin-BkJ4YDCU.js";
...
import { d as sessionLog, l as resolveSessionWorkerPlacementPatchError, n as isAgentMainSessionKey, o as loadSessionsRuntimeModule, s as requireSessionKey } from "./sessions-shared-C5bHh15Q.js";
import { t as WorkerInferenceSessionDrainBusyError } from "./inference-control-internal-Dk-ZtYoJ.js";
...
import { n as prepareSessionPatchRuntimeSelection, r as refreshSessionPatchQueuedSelection, s as sessionToolOverridesEqual, t as persistSessionPatchModelSelection } from "./sessions-patch-model-selection-Cd6_DEAs.js";
import { n as projectSessionsPatchEntry, t as prepareSessionsPatchEntry } from "./sessions-patch-DaH0XAUz.js";
import { i as synchronizeSessionWorktreeArchive, t as SessionWorktreeLifecycleError } from "./session-worktree-lifecycle-D8RJmK_D.js";
...
async function executeSessionPatchMutations(params) {
	...
	const permissionRuntime = "permissionMode" in params.patch ? await import("./sessions-patch-permissions.runtime-ClUb_P_a.js") : void 0;
	const sandboxRuntime = "sandboxMode" in params.patch || "nativeRuntimeConsent" in params.patch ? await import("./sessions-patch-sandbox.runtime-XD7OnZ1Z.js") : void 0;
