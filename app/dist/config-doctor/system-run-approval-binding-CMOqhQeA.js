...
import { o as normalizeHostOverrideEnvVarKey } from "./host-env-security-DywtW817.js";
import { h as resolveExecWrapperTrustPlan, s as resolveCommandResolutionFromArgv } from "./exec-command-resolution-hTQFa-so.js";
import { C as resolvePowerShellInlineCommandMatch, D as unwrapDispatchWrappersForResolution, L as splitShellArgs, O as unwrapKnownDispatchWrapperInvocation, P as normalizeExecutableToken, S as resolveInlineCommandMatch, a as extractShellWrapperCommand, g as advancePosixInlineOptionScan, h as POSIX_INLINE_COMMAND_FLAGS, m as NUSHELL_INLINE_COMMAND_FLAGS, n as POSIX_SHELL_WRAPPERS, p as unwrapKnownShellMultiplexerInvocation, s as hasEnvManipulationBeforeShellWrapper, t as POSIX_PARSEABLE_SHELL_WRAPPERS, x as isPowerShellInlineRestCommandFlag } from "./shell-wrapper-resolution-BVUBYqqS.js";
...
import { c as PNPM_CASE_SENSITIVE_OPTIONS_WITH_VALUE, d as PNPM_OPTIONS_WITH_VALUE, f as normalizePackageManagerExecToken, h as planShellAuthorization, l as PNPM_DLX_OPTIONS_WITH_VALUE, p as unwrapKnownPackageManagerExecInvocation, u as PNPM_FLAG_OPTIONS, v as analyzeArgvCommand, y as analyzeWindowsShellCommand } from "./exec-approvals-allowlist-BZrsAgyU.js";
import { s as detectInlineEvalInSegments } from "./extract-C85vXhx0.js";
import { t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-CyfB9_bL.js";
...
//#endregion
export { revalidateApprovedMutableFileOperand as _, missingSystemRunApprovalBinding as a, resolveSystemRunCommandRequest as b, prepareSystemRunMutableFileBinding as c, toSystemRunApprovalMismatchError as d, normalizeNonEmptyString as f, detectPolicyInlineEval as g, analyzeCommandForPolicy as h, matchSystemRunApprovalBinding as i, resolveMutableFileOperandSnapshotSync as l, hasMutableSymlinkPathComponentSync as m, buildSystemRunApprovalBinding as n, prepareSystemRunExecutableIdentityBinding as o, normalizeStringArray as p, buildSystemRunApprovalEnvBinding as r, prepareSystemRunMutableFileApproval as s, APPROVAL_SCRIPT_OPERAND_DRIFT_DENIED_MESSAGE as t, revalidateSystemRunMutableFileBinding as u, extractShellCommandFromArgv as v, formatExecCommand as y };
