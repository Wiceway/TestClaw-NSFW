...
import { t as captureSessionTranscriptStorageEnvironment } from "./transcript-target-binding-CriGFpOg.js";
import { a as prepareSqliteTargetFromSessionStorePath, c as resolveUnsuffixedSqliteTargetFromSessionStorePath } from "./session-sqlite-target-BANhXeoo.js";
import { t as ErrorCodes } from "./gateway-error-details-D4L8ZwC-.js";
import { n as errorShape } from "./error-codes-DQWjOSek.js";
import { ar as validateProgressCardRefreshParams, ir as validateProgressCardPutParams, rr as validateProgressCardGetParams } from "./validator-registry-Dpl5QmuY.js";
...
import { c as readSessionProgressCard, l as writeSessionProgressCard } from "./session-accessor.sqlite-lifecycle-DroV7NMI.js";
...
import { n as captureGatewaySessionStoreScope, r as resolveGatewaySessionDatabase } from "./board-store-DVUqUT4y.js";
...
function createProgressCardHandlers(store = progressCardStore) {
	return {
		"progressCard.refresh": async (invocation) => {
			...
			const { requestProgressCardRefresh } = await import("./progress-card-refresh-BCSyvp21.js");
