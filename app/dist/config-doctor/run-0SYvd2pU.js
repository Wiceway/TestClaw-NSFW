...
import { i as getPluginRuntimeGatewayRequestScope, n as getPluginRegistryForContext, s as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-B7K42D1p.js";
...
import { t as assertAgentRunLifecycleGenerationCurrent } from "./agent-events-CFq48PcN.js";
import "./runtime-B980B6n3.js";
import { n as fenceScheduledGatewayContextResolver } from "./scheduled-run-gateway-context-BZYTlZZ4.js";
import { n as createSessionMaintenanceOwner } from "./coordinator-D9EGY-yX.js";
//#region src/agents/command/runtime-loaders.ts
const loadAttemptExecutionRuntime = createLazyPromise(async () => {
	const [attempt] = await Promise.all([import("./attempt-execution.runtime-CEKQw4H8.js"), loadDeliveryRuntime()]);
	return attempt;
});
const loadAcpManagerRuntime = createLazyPromise(() => import("./manager-DWXImqwE.js"));
const loadAcpPolicyRuntime = createLazyPromise(() => import("./policy-D4pA0f4D.js"));
const loadAcpRuntimeErrorsRuntime = createLazyPromise(() => import("./errors-B7--7gGk.js"));
const loadAcpSessionIdentifiersRuntime = createLazyPromise(() => import("./session-identifiers-CE3-6E0I.js"));
const loadDeliveryRuntime = createLazyPromise(() => import("./delivery.runtime-Djh8z_tu.js"));
const loadSessionStoreRuntime = createLazyPromise(() => import("./session-store.runtime-DsaCSe7s.js"));
const loadCliCompactionRuntime = createLazyPromise(() => import("./cli-compaction-D6hKvkZW.js"));
const loadAgentRunnerMemoryRuntime = createLazyPromise(() => import("./agent-runner-memory-DkXLBzkE.js"));
const loadTranscriptResolveRuntime = createLazyPromise(() => import("./transcript-resolve.runtime-B8f_auJO.js"));
const loadTranscriptAppendRuntime = createLazyPromise(() => import("./transcript.runtime-D62AgULW.js"));
const loadCliDepsRuntime = createLazyPromise(() => import("./deps-Dzj87gLb.js"));
const loadExecDefaultsRuntime = createLazyPromise(() => import("./exec-defaults-BXbvfmoX.js"));
const loadSkillsRuntime = createLazyPromise(async () => {
	const [remote, sessionSnapshot] = await Promise.all([import("./remote-BNmDHk_7.js"), import("./session-snapshot-DPfXyjKz.js")]);
	return {
