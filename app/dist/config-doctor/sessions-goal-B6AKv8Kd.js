import { C as mutateSessionGoal, x as SessionGoalOperationError } from "./session-accessor-DMf92PxK.js";
import { t as ErrorCodes } from "./gateway-error-details-D4L8ZwC-.js";
import { n as errorShape } from "./error-codes-DQWjOSek.js";
import { _i as validateSessionsGoalUpdateParams, gi as validateSessionsGoalClearParams } from "./validator-registry-Dpl5QmuY.js";
import { n as resolveRequestedSessionAgentId } from "./session-request-agent-cU98pfB6.js";
import { E as gatewayClientSessionCreator, _ as resolveSessionSharingTarget } from "./session-sharing-policy-rVme8bnl.js";
...
async function handleSessionGoalMutation(options, request) {
	...
	try {
		...
		if (request.action === "resume") {
			const { handleSessionGoalResumeChat } = await import("./chat-send-handler-CUwkbSeJ.js");
