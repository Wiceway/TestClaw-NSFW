...
import { s as isOperatorUiClient } from "./message-channel-iCC7oIhe.js";
...
import { s as seedSkillLibrarySelection, v as resolveSkillLibraryActor } from "./selection-DpyzDWn0.js";
import { d as validateSkillLibraryPath, f as SkillLibraryError } from "./bundle-3bd61XSj.js";
...
import { g as waitForChatAbortTerminalPersistence, i as isChatAbortControllerEntryAbortable, t as abortChatRunById } from "./chat-abort-DEpgr_1N.js";
...
import { n as captureAbortedPartial } from "./chat-aborted-partial-ZsnDR_7k.js";
import { a as mutateSkillLibrary, c as saveSkillLibrary, i as listSkillLibrary, n as libraryAuthority, o as readSkillLibrary, s as resolveSkillLibraryPresentation, t as activateLibrarySelection } from "./skills-library-CC9CgvAN.js";
...
function createGatewayOperatorRunCancellation(params) {
	...
	const cancel = async () => {
		...
		if (!aborted) return;
		const failures = (await Promise.allSettled([waitForChatAbortTerminalPersistence(entry), ...snapshot ? [import("./chat-transcript-persistence.runtime-7z0xUjMW.js").then((transcript) => transcript.persistAbortedPartials({
			context,
			snapshots: [snapshot]
