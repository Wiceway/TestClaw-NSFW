...
import { C as freezeDiagnosticTraceContext, b as createChildDiagnosticTraceContext, c as emitTrustedDiagnosticEventWithPrivateData, k as runWithDiagnosticTraceContext, s as emitTrustedDiagnosticEvent, w as getActiveDiagnosticTraceContext, x as createDiagnosticTraceContext } from "./diagnostic-events-CzmzgdMI.js";
...
import { c as emitAgentRunOutputTokens, h as registerAgentEventLifecycleRotationHandler } from "./agent-events-CFq48PcN.js";
import { b as publishTranscriptUpdate } from "./session-accessor.sqlite-generation-copy-DcJmL4R4.js";
import { a as waitForSessionTranscriptProjection, h as sessionTranscriptIndexNeedsReconcile } from "./session-transcript-reconcile-Oplb6Sva.js";
import { d as getUserTurnTranscriptAdmissionOwner } from "./session-transcript-projection-error-D01U6hs1.js";
import { s as getOwnedSessionTranscriptWriterFence } from "./transcript-write-context-CW-keGmb.js";
import { M as rewriteTranscriptMessageAtAnchor, at as readActiveTranscriptEntryAnchor, b as sessionMatchesExpectedTranscriptTurn } from "./session-accessor-DMf92PxK.js";
import { n as resolveSessionTranscriptDatabasePath } from "./session-accessor.transcript-target-BQlRWMsR.js";
import { f as resolveAdmittedRunActiveAssertion, m as retainAdmittedRunBeforeToolCallRecovery, o as getAdmittedRunDelegatedAuthority, u as readAdmittedRunOperatorAuthority } from "./admitted-run-context-BE5EAdRS.js";
import { l as getActivePluginRegistry } from "./runtime-B980B6n3.js";
import { c as normalizeAgentRunAttemptTerminal, l as projectAgentRunAttemptTerminal } from "./agent-run-terminal-outcome-Dfr6s7I1.js";
import { g as throwAgentRunRestartAbortReason } from "./run-termination-Ig3BzvZQ.js";
import { o as recordAgentHarnessPreflightOwner, t as AgentHarnessPreflightError } from "./errors-Bd6GQRkh.js";
import { l as rewrapToolWithBeforeToolCallHook, y as runBeforeToolCallHook } from "./agent-tools.before-tool-call-BwZqazXs.js";
...
import { i as prepareActiveNodeContext, t as buildActiveNodeContextText } from "./active-node-context-Chc0tKJ6.js";
import { i as unwrapSecretSentinelsForProviderEgress, r as unwrapModelHeaderSentinelsForProviderEgress } from "./provider-secret-egress-gSti772c.js";
...
import { r as assertContextEngineHostSupport } from "./host-compat-BhcTjWs2.js";
import { r as resolveAgentHarnessSelectionDecision, t as buildAgentHarnessSelectionDecision } from "./selection-decision-BLKbNa0i.js";
import { r as copyAgentToolMetadata } from "./agent-tool-metadata-DkPGvtCv.js";
import { n as createCronScheduledToolProjection } from "./exec-tool-target-pinning-Dm1GAal9.js";
import { a as withGatewayToolApprovalOwner, c as wrapToolWithGatewayCallerIdentity, i as getGatewayToolCallerIdentity, n as createAdmittedGatewayToolCallerIdentity, o as withGatewayToolCallerIdentity } from "./gateway-caller-context-BrVUu-N_.js";
import { a as getCoreTtsToolResultMediaUrls, c as transferCoreTtsToolResultProvenance, r as copyCoreTtsAttemptResultProvenance } from "./session-async-task-status-cNEl5EC_.js";
import { a as withInstallationTarget, n as getInstallationTarget, r as installationTargetEnv } from "./installation-target-context-B-FS4qIf.js";
import { r as diagnosticErrorMessage, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-B-0Ci0dI.js";
...
import { F as isHostScopedAgentToolActive, I as runWithAgentRingZeroTools, n as createAssistantCodingToolsInternal } from "./agent-tools-CQ5emKZ2.js";
...
import { St as runBestEffortCallback, a as EmptySettledTurnFinalizationError, n as isBuiltInAssistantAgentHarness, r as assertSettledTurnFinalizationResult, t as createAssistantAgentHarness } from "./builtin-testclaw-D8svmGKw.js";
import { t as log$1 } from "./logger-BFBxDn9c.js";
import { t as resolveSkillResourceCandidates } from "./resource-candidates-CKrUlhxd.js";
import { n as wrapToolWithAbortSignal } from "./agent-tools.abort-Li6-S9bV.js";
import { a as registerAgentHarnessScheduledToolProjectionCapability, c as withAgentQuestionAnswerAuthority, o as registerAgentHarnessTtsProvenanceTransferCapability, r as registerAgentHarnessBeforeToolCallRetention, s as resolveAgentQuestionAnswerAuthority } from "./host-private-capabilities-DVuDNROK.js";
...
import { i as resolvePluginHarnessDenyAllToolPolicyPrompt, o as resolvePluginHarnessToolPolicies, t as assertAgentHarnessExecutionEnvironment } from "./execution-environment-B9x6G36U.js";
import { t as registerMcpToolApprovalBinding } from "./mcp-tool-approval-binding-EUXmUc0n.js";
import { s as prepareSystemRunMutableFileApproval } from "./system-run-approval-binding-CMOqhQeA.js";
import { t as formatHarnessApprovalPresentation } from "./native-hook-relay-approval-presentation-CIUIYNF1.js";
...
function bindHarnessContextMedia(params) {
	...
	return async (request) => {
		assertCurrent();
		const { prepareHarnessContextMedia } = await import("./context-media-runtime-8R23XkQq.js");
		assertCurrent();
...
function bindHarnessReplyMedia(params) {
	...
	return async (request) => {
		...
		assertCurrent();
		const { prepareHarnessReplyMedia } = await import("./reply-media-runtime-15j7NQSi.js");
		assertCurrent();
...
async function runAgentHarnessAttempt(params, nativeSessionRuntime) {
	...
	if (internalParams.systemAgentTool && !isSystemAgentOnlyAllowlist(internalParams.toolsAllow)) throw new Error("Assistant host authority requires toolsAllow: [\"testclaw\"]");
	const ringZeroTools = internalParams.systemAgentTool ? [(await import("./system-agent-tool-BqIw8FGl.js")).createSystemAgentTool(internalParams.systemAgentTool)] : [];
	...
	try {
		result = await runAgentHarnessOperation(harness, params, () => runWithAgentRingZeroTools(ringZeroTools, () => {
			...
			return import("./tool-authority.runtime-DGsw2iGg.js").then(({ withPreparedEmbeddedRunToolAuthority }) => withPreparedEmbeddedRunToolAuthority(internalParams, effectiveAttemptParams, selection.builtIn ? void 0 : (input) => {
