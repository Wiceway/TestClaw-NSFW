...
async function promptCustomApiConfig(params) {
	...
	const compatibilityChoice = await prompter.select({
		...
		options: COMPATIBILITY_OPTIONS.filter((option) => params.verification !== "deferred" || option.value !== "unknown").map((option) => ({
			value: option.value,
