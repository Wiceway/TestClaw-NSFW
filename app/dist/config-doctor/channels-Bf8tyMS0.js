...
import { s as getChannelsCommandSecretTargetIds } from "./command-secret-targets-CdV9gKy0.js";
import { o as callGateway } from "./call-CY0v-3Uc.js";
import { r as createMessageActionDiscoveryContext, u as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-CqFO4PjL.js";
...
import { i as withCommandPluginMetadata, n as requireValidConfigFileSnapshot, r as requireValidConfigForWrite } from "./config-validation-kR5vBxrW.js";
import { t as commitConfigWithPendingPluginInstalls } from "./install-record-commit-bx-_yGLM.js";
import { n as readConfiguredParsedLogTail } from "./log-tail-DvkURLY8.js";
import { n as channelLabel, r as applyChannelAccountRemoval, t as channelsAddCommand } from "./add-CpTDxlt9.js";
import { l as shouldUseWizard, s as formatChannelAccountLabel } from "./shared-CotY6oDf.js";
import { t as channelsListCommand } from "./list-Dsbnz8rV.js";
import { t as channelsStatusCommand } from "./status-D9VD4KrQ.js";
...
async function removeChannelAccount(writeSnapshot, opts, runtime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-5PzUIeQH.js");
