...
import { f as runGitBuffered, h as hasGitWorkerContext } from "./git-C6UqFKot.js";
...
import { h as isDerivedWorkspacePath, n as MAX_RECONCILIATION_FILE_BYTES } from "./workspace-manifest-DTqIPCiX.js";
import { c as pruneWorkspaceHashMemo, i as activeWorkspaceHashContext } from "./workspace-hash-memo-Bto8rdGB.js";
import { c as stagedWorkspaceEntryBytes, s as resolveStagedWorkspaceReadEntry } from "./workspace-result-inventory-Yxwk0T_A.js";
...
async function compute(command, signal) {
	if (hasGitWorkerContext()) {
		const { executeWorkspaceManifestComputation } = await import("./workspace-manifest-computation.runtime-BV08ZGZ-.js");
