...
import { C as freezeDiagnosticTraceContext, H as hasInternalDiagnosticEventListeners, S as createDiagnosticTraceContextFromActiveScope, b as createChildDiagnosticTraceContext, c as emitTrustedDiagnosticEventWithPrivateData, k as runWithDiagnosticTraceContext, s as emitTrustedDiagnosticEvent, t as areDiagnosticsEnabledForProcess } from "./diagnostic-events-CzmzgdMI.js";
...
import { n as captureAgentRunLifecycleGeneration, t as assertAgentRunLifecycleGenerationCurrent, y as withAgentRunLifecycleGeneration } from "./agent-events-CFq48PcN.js";
import { r as runWithCliHistoryWriter, t as getCliHistoryWriter } from "./cli-history-boundary-CwwMqsE-.js";
import { i as captureOwnedTranscriptWriteAssertion, s as getOwnedSessionTranscriptWriterFence, t as SessionTranscriptWriterClaimReboundError } from "./transcript-write-context-CW-keGmb.js";
...
import { a as isFailoverError, o as isSignalTimeoutReason, s as isTimeoutError } from "./error-D_GewJgV.js";
import { w as resolveReplyExpectation } from "./task-notification-routing-CYDaelCz.js";
import { s as resolveBlockMessage } from "./hooks-CL-Rsbd9.js";
...
import { n as appendExactAssistantMessageToSessionTranscript } from "./transcript-scRUtjvw.js";
...
import { r as coerceToFailoverError } from "./failover-error-D845uGox.js";
...
import { n as markAuthProfileFailure } from "./usage-6TTU-a96.js";
...
import { d as shouldClearInterruptedCliSessionBinding, o as isCliSessionInvalidatingFailoverReason } from "./cli-session-BGcKF-Kc.js";
import { y as resolveExplicitFinalSourceReplyDeliveryEvidence } from "./delivery-evidence-CDgoalBx.js";
...
import { a as awaitAgentEndSideEffects, i as runHarnessContextEngineMaintenance, n as bootstrapHarnessContextEngine, o as runAgentEndSideEffects, r as finalizeHarnessContextEngineTurn } from "./context-engine-lifecycle-KAuS8LLd.js";
...
import { a as runAgentHarnessLlmOutputHook, i as runAgentHarnessLlmInputHook, o as buildAgentHookContext } from "./lifecycle-hook-helpers-Bw4F3UwX.js";
...
import { a as resolveCliRuntimeOwnerFingerprint, i as resolveCliRuntimeArtifactFingerprint } from "./cli-auth-epoch-DY78O0DT.js";
import { n as cliBackendLog, r as formatCliBackendOutputDigest } from "./log-C7HxfZF4.js";
import { t as acceptsCliLiveSession, u as createCliFailoverError, y as runCliCleanup } from "./cli-live-session-registry-CkSzpSpT.js";
import { n as getCliMessagingDeliveryEvidence, r as projectCliMessagingDeliveryEvidence, t as attachCliMessagingDeliveryEvidence } from "./delivery-evidence-DH2y_idP.js";
import { a as hashCliReseedPrompt } from "./cli-session-history-DgsmTnKz.js";
import { c as CliAuthProfilePreparationError, i as loadCliSessionHistoryMessages, r as loadCliSessionContextEngineMessages, s as buildAgentHookConversationMessages, u as claudeCliSessionTranscriptHasContent } from "./session-history-BAGlYQtr.js";
...
async function settlePreparedCliRun(params) {
	...
	if (runParams.cleanupCliLiveSessionOnRunEnd === true) try {
		const { closeCliLiveSession } = await import("./cli-live-session-registry-DZZX6s-4.js");
		await closeCliLiveSession(context, "restart");
	} catch (error) {
		recordCleanupError(error);
	}
	if (runParams.cleanupBundleMcpOnRunEnd === true) try {
		const { retireSessionMcpRuntime } = await import("./agent-bundle-mcp-tools-BpVOjOA8.js");
...
async function runCliAgentInternal(params, diagnosticLifecycle) {
	...
	const { prepareCliRunContext } = await import("./prepare.runtime-D1VoujlX.js");
	let context;
	try {
...
async function runPreparedCliAgentOwned(context, diagnosticLifecycle) {
	...
	const executeRun = async () => {
		({executePreparedCliRun} = await import("./execute.runtime-91b-ZHBi.js"));
