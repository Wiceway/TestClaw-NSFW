...
import { C as freezeDiagnosticTraceContext, w as getActiveDiagnosticTraceContext, x as createDiagnosticTraceContext } from "./diagnostic-events-CzmzgdMI.js";
...
import { _ as resolveSessionAgentId, g as resolveRunModelFallbacksOverride, y as resolveSessionAgentIds } from "./agent-scope-BiRi-Smp.js";
import { a as projectModelThinkingCompat } from "./model-catalog-lookup-_Hi_clcB.js";
import { i as isOpenAIProvider } from "./openai-routing-BXJ-qR2p.js";
...
import { u as normalizeUsage } from "./usage-C3K3M4jZ.js";
...
import { t as createBundleLspToolRuntime } from "./agent-bundle-lsp-runtime-oNgHB5J4.js";
import { n as createBundleMcpToolRuntime } from "./agent-bundle-mcp-materialize-0yls35jH.js";
import "./agent-bundle-mcp-tools-DL_tAGSg.js";
import { r as applyPreparedRuntimeAuthToModel } from "./provider-local-service-reconcile-DGJJw1a3.js";
import { I as MissingProviderAuthError } from "./loader-runtime-load-B2ergWe-.js";
import { t as resolveAgentHarnessPolicy } from "./policy-DkYYnWfL.js";
import { d as resolveProviderRuntimePluginHandle, r as getModelProviderRuntimePluginHandle, s as resolveProviderFollowupFallbackRoute, t as attachModelProviderRuntimePluginHandle } from "./provider-hook-runtime-AjNWsmeV.js";
import { i as describeFailoverError, r as coerceToFailoverError, s as hasModelFallbackStop } from "./failover-error-D845uGox.js";
import { i as prepareActiveNodeContext, n as formatActiveNodeContextLabel, r as getCurrentActiveNodeContext } from "./active-node-context-Chc0tKJ6.js";
import { V as extractModelCompat } from "./prepared-model-runtime.full-catalog-D-4WACLM.js";
import { A as resolveProviderSystemPromptContribution, _ as prepareProviderRuntimeAuth, j as resolveProviderTextTransforms, z as transformProviderSystemPrompt } from "./provider-runtime-B3-FZB4p.js";
import { o as resolveCodexAgentHarnessNativeCompaction } from "./registry-DEnV0Kfy.js";
import { r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-DZbBeQ88.js";
...
import { bt as estimateTokens, f as estimateCompactedRequestTokens, i as agentSessionSetContextReplacementHook, o as setSessionModelUsageSink, r as agentSessionAutomaticCompaction } from "./resource-loader-BhZb0-S1.js";
import { n as applyLocalNoAuthHeaderOverride, o as resolveModelAuthMode, t as applyAuthHeaderOverride } from "./model-auth-Dgz6ND6Q.js";
import { n as resolveModelCandidateChain } from "./model-fallback-candidates-2WxNRofN.js";
import { o as projectPreparedModelProvider } from "./availability-BgNV4tHv.js";
...
import { f as prepareModelRuntimeSnapshot, t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-CvkqszTA.js";
...
import { n as createAssistantCodingToolsInternal } from "./agent-tools-CQ5emKZ2.js";
import { A as resolveEffectiveCompactionMode, C as consumeCompactionSafeguardCancellation, Ct as flushPendingToolResultsAfterIdle, D as applyAgentAutoCompactionGuard, E as createPreparedEmbeddedAgentSettingsManager, Nt as prepareEmbeddedSkills, O as applyAgentCompactionSettingsFromConfig, T as setCompactionSafeguardCancellation, b as isRealConversationMessage, c as prepareWatchedSessionsPrompt, d as splitSdkTools, dt as getHistoryLimitFromSessionKey, f as collectAllowedToolNames, ft as limitHistoryTurns, jt as estimateLlmBoundaryTokenPressure, k as isSilentOverflowProneModel, l as prepareAgentMemoryPrompt, lt as sanitizeSessionHistory, m as toSessionToolAllowlist, o as applyAgentRunSessionTargetIdentity, p as collectRegisteredToolNames, s as resolveAgentRunSessionTarget, ut as validateReplayTurns, v as buildEmbeddedSystemPrompt, w as getCompactionSafeguardRuntime, wt as logRuntimeToolSchemaQuarantine, y as buildEmbeddedExtensionFactories } from "./builtin-testclaw-D8svmGKw.js";
import { n as filterRuntimeCompatibleTools, t as filterProviderNormalizableTools } from "./tool-schema-projection-vedtaPlF.js";
...
import { i as buildBootstrapPromptWarningNotice, n as buildBootstrapBudgetState, r as buildBootstrapInjectionStats } from "./bootstrap-budget-Dik1JrOM.js";
import { a as getActiveMemorySearchManagerCore } from "./memory-runtime-CKf63XqK.js";
import { a as resolveBootstrapContextForRun, c as resolveContextInjectionMode, i as makeBootstrapWarn } from "./bootstrap-files-BJqBxKbW.js";
import { s as pickFallbackThinkingLevel } from "./embedded-agent-helpers-Cqdg7msJ.js";
import { i as resolveSessionPermissionExecMode, t as SESSION_PERMISSION_BY_EXEC_MODE } from "./session-permission-exec-mode-BzTqSt6n.js";
import { a as sanitizeToolUseResultPairingForModel } from "./session-transcript-repair-BNL2e-6A.js";
import { n as resolveSandboxContext } from "./context-CKS569CU.js";
import "./sandbox-w882SIpU.js";
import { a as resolvePreparedExtraParams, t as applyExtraParamsToAgent } from "./extra-params-Igp4MlRL.js";
import { l as guardSessionManager, r as createAgentSessionForEmbeddedRunner, t as createEmbeddedAgentResourceLoader } from "./resource-loader-B5lYAqRR.js";
import { l as prepareEmbeddedSessionActiveProjectKeys } from "./session-prompt-state-DrtDfyMQ.js";
...
import { n as mapThinkingLevelForProvider, t as mapThinkingLevel } from "./utils-7Z-554WK.js";
import { _ as resolveEmbeddedCompactionThinkingLevel, g as resolveEmbeddedCompactionTarget, h as resolveCompactionTargetRuntime, l as resolvePromptModeForSession, m as resolveCompactionHarnessRuntime, p as resolveCompactionContextTokenBudget, v as listActiveProcessSessionReferences } from "./context-engine-maintenance-CYyEcyUi.js";
...
import { r as prepareAgentRuntimeAuth } from "./prepare-auth-BjNxXpdc.js";
import { T as resolveTranscriptPolicy } from "./helpers-Cf_K4Mz5.js";
import { i as normalizeProviderToolSchemas, r as logProviderToolSchemaDiagnostics } from "./tools-CnhunNAi.js";
...
import { l as markDiagnosticEmbeddedRunStarted, n as closeDiagnosticEmbeddedRunOwner, r as createDiagnosticEmbeddedRunOwner } from "./diagnostic-run-activity-pyrECV9q.js";
import { i as resolveRuntimeOsLabel } from "./os-summary-B440lihS.js";
import "./sessions-DZ4KAu7C.js";
import { _ as resolveCompactionTimeoutMs, g as compactWithSafetyTimeout } from "./diagnostic-BpBZkcBo.js";
import { o as resolveAttemptSpawnWorkspaceDir } from "./system-prompt-report-CwpgafRk.js";
import { r as hasPersistedMedia, t as isReasoningTagProvider } from "./provider-utils-B9yvZLh8.js";
import { i as resolveEmbeddedAgentStream, n as resolveEmbeddedAgentApiKey, r as resolveEmbeddedAgentBaseStreamFn, t as wrapStreamFnWithDiagnosticModelCallEvents } from "./attempt.model-diagnostic-events-DSzYnvsl.js";
...
import { r as isFallbackSummaryError } from "./model-fallback-attempt-BPoUA1Sl.js";
import { n as classifyCompactionReason, o as resolveCompactionFailure, r as formatUnknownCompactionReasonDetail } from "./compact-reasons-YKHfUYtS.js";
import { o as createSkillInstructionDeliveryCache } from "./agent-tools.read-VydmzVNf.js";
...
import { f as runWithModelFallback, t as classifyEmbeddedAgentRunResultForModelFallback } from "./result-fallback-classifier-Dy1kJhGA.js";
import { n as resolveModelAsync } from "./model-B5xF_8T4.js";
import { n as supportsModelTools } from "./model-tool-support-DIQSEumC.js";
import { r as resolveAssistantReferencePaths } from "./docs-path-BUdO-egB.js";
import { n as resolveAgentPromptSurfaceForSessionKey } from "./runtime-prompt-BWe-C1iE.js";
import { t as getMachineDisplayName } from "./machine-name-SR6WYd4V.js";
import { n as resolveRuntimeAgentName, r as resolveSystemPromptRepoRoot } from "./system-prompt-params-QRdUBVTd.js";
import { r as resolveEmbeddedSandboxInfoExecPolicy, t as buildEmbeddedSandboxInfo } from "./sandbox-info-X_FET3oP.js";
import { i as selectAgentHarnessForPreparedModelProviders, r as selectAgentHarness } from "./selection-C3496UGG.js";
...
import { a as resolveReusableRuntimeModelAuth, r as providerUsesCredentialScopedModelMetadata } from "./credential-scoped-model-C2VTnM3c.js";
import { n as resolvePreparedRuntimeModelAuth, t as resolvePreparedRuntimeAuthAttempts } from "./resolve-auth-BXVTMykr.js";
import { n as resolveMemorySearchIndexConfig } from "./memory-search-C_fSkqnL.js";
...
async function compactNativeCliSession(params) {
	...
	const { runCliAgent } = await import("./cli-runner-Ba4qIkpQ.js");
...
//#endregion
export { setTranscriptBytePreflightClaim as a, resolveTieredModel as c, projectCodexHostTranscriptBytePreflightConfig as d, resolveCompactionRuntimeSelection as f, resolveProjectKey as h, resolveTranscriptBytePreflightAuthority as i, attachCompactionAccountingRecorder as l, runPostCompactionSideEffects as m, compactNativeCliSession as n, buildAgentRuntimeDeliveryPlan as o, asCompactionHookRunner as p, testing as r, buildAgentRuntimePlan as s, compactEmbeddedAgentSessionDirect as t, prepareCompactionHarnessAuth as u };
