...
function isHeadlessOpenPathError(error, command, platform = process.platform) {
	if (platform === "linux" && command.command === "xdg-open" && extractErrorCode(error) === "ENOENT") return true;
