...
import { a as reconcileAssistantStateSchemaPublication } from "./testclaw-state-db-BAeysXj_.js";
import { c as reconcileAbandonedUpdateRuns } from "./update-run-ledger-DLD5Q47c.js";
import { r as getUpdateRun, t as findActiveUpdateRun } from "./update-run-reader-CA3WJ8vB.js";
import { t as reconcileInterruptedUpdateRuns } from "./update-run-interruption-ChGJYvv5.js";
import { i as GATEWAY_EVENT_UPDATE_RUN_CHANGED } from "./events-CAEUKvkp.js";
		...
		try {
			...
			if (watched.phase !== run.phase) {
				...
				if (run.phase === "activating" || terminal && acknowledged) notices = work.track(() => notices.then(async () => {
					if (work.isClosing) return;
					const { notifyUpdateRunPhase } = await import("./update-run-notice.runtime-BtDG3sse.js");
