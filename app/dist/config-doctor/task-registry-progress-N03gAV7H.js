...
import { d as getAgentRunLifecycleGeneration, w as resolveProjectedAgentRunProgressState } from "./agent-run-registry-DbPiDevk.js";
...
import { y as readResidentTaskFlow } from "./task-flow-runtime-internal-CxdyhxyJ.js";
import { C as taskRegistryLog, S as taskProgressBatches, w as tasks } from "./task-registry-state-D1tTILHR.js";
import { p as getTasksByRunId } from "./task-registry.process-state-DBhKov6B.js";
import { a as isSubagentRunLive, j as subagentRuns } from "./subagent-run-liveness-D6t-uqkj.js";
import { a as getLatestLiveSubagentRunByChildSessionKey } from "./subagent-registry-read-DD46xgBs.js";
import { a as prepareTaskBackingRead, i as hasResidentTaskBacking } from "./task-backing-authority-Cwc8FxS7.js";
import { a as formatTaskStatusTitleText } from "./task-status-BLVYcOWO.js";
import { T as shouldAutoDeliverTaskStateChange, r as canDeliverToRequesterOrigin, s as resolveTaskDeliveryOwner } from "./task-notification-routing-CYDaelCz.js";
...
const loadProgressPresentation = createLazyPromise(() => import("./task-progress-presentation-Ci0AYnyV.js"));
const loadProgressRuntime = createLazyPromise(() => import("./task-registry-progress-runtime-CgWbiSJG.js"));
