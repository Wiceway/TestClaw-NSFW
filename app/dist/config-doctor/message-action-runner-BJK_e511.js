...
import { l as findCodeRegions } from "./text-projection-BoeR_I8Q.js";
...
import { I as renderMessagePresentationFallbackText, M as normalizeLegacyInteractiveReply, N as normalizeMessagePresentation, O as hasLegacyInteractiveReplyBlocks, T as setReplyPayloadMetadata, a as copyReplyPayloadMetadata, j as hasReplyPayloadContent, k as hasMessagePresentationBlocks, n as appendReplyMediaFailures, s as getReplyPayloadMetadata } from "./reply-payload-Ds4kei43.js";
...
import { n as listConfiguredMessageChannels, r as resolveMessageChannelSelection } from "./channel-selection-BPtL262w.js";
import { r as validateExplicitMessageAccountSelection } from "./message-account-selection-C8JpXtCj.js";
import { c as readPositiveIntegerParam, f as readSnakeCaseParamRaw, l as readStringArrayParam, u as readToolStringParam } from "./common-Bkl7CqHm.js";
import { i as enforceMessageActionAllowlist, n as buildCrossContextDecoration, o as resolveEffectiveMessageToolsConfig, r as enforceCrossContextPolicy, s as shouldApplyCrossContextMarker, t as applyCrossContextDecoration } from "./outbound-policy-CgOqTCFk.js";
import { i as isMessagingToolDeliveryAction } from "./embedded-agent-messaging-CqqWsn5l.js";
import { t as resolveLocalMediaPath } from "./local-media-path-BTtsPPoc.js";
...
import { l as isChannelPartialDeliveryError } from "./send-Bh8w6d4a.js";
import { p as throwIfAborted } from "./deliver-prepare-CG8EK6Ui.js";
import { D as OutboundHandoffRejectedError, O as assertOutboundHandoffCurrent } from "./delivery-queue-reconciliation-DmfgEjwu.js";
import { t as resolveAgentScopedOutboundMediaAccess } from "./read-capability-G0oVN5ri.js";
import { i as resolveResponsePrefix, t as resolveAgentIdentity } from "./identity-XLC8cjlS.js";
import { r as resolveOutboundMediaMaxBytes } from "./configured-max-bytes-B7PkzUe3.js";
import { n as resolveOutboundAttachmentFromUrl } from "./outbound-attachment-DqASet1i.js";
import { S as readBooleanParam, _ as parseInteractiveParam, b as resolveExtraActionMediaSourceParamKeys, d as shouldDeferExternalMessageActionTargetResolution, f as collectActionMediaSourceHints, g as normalizeSandboxMediaSource, h as normalizeSandboxMediaParams, i as actionRequiresTarget, m as hydrateAttachmentParamsForAction, n as resolveImplicitMessageActionTarget, o as extractToolPayload, p as collectAttachmentSources, s as dispatchChannelMessageAction, t as normalizeMessageActionInput, u as prepareExternalMessageActionTargetForResolution, v as parseJsonMessageParam, x as hasPotentialPluginActionParam, y as resolveAttachmentMediaPolicy } from "./message-action-normalization-BTFnJQdP.js";
import { a as pluginEnvelopeHas, o as projectEmbeddedMessageDeliveryFact, s as projectPluginMessageDeliveryFact } from "./embedded-agent-message-delivery--6HQyVIO.js";
import { i as isDeliveredCurrentSourceReplyAsync, n as cancelTerminalSourceReplyDelivery, o as reconcileTerminalSourceReplyDelivery, t as beginTerminalSourceReplyDelivery } from "./source-reply-mirror-DjEr751_.js";
import { t as normalizeConversationReadInvocationOrigin } from "./conversation-read-origin-E3olMOwo.js";
import { n as resolvePollMaxSelections } from "./polls-Dqx-5aUs.js";
import { n as sendPoll, r as resolveOutboundMessageGatewayOptions, t as sendMessage } from "./message-CLcEoDTf.js";
import { n as resolveMessageActionOutcome } from "./message-action-contracts-BsHpR9u1.js";
import { n as readClawHubRecommendations, t as CLAWHUB_RECOMMENDATIONS_CHANNEL_DATA_KEY } from "./clawhub-recommendations-yHhGdOvB.js";
...
const loadMessageActionGatewayRuntime = createLazyRuntimeModule(() => import("./message.gateway.runtime-BAAP26IP.js"));
...
const loadMessageActionTtsRuntime = createLazyRuntimeModule(() => import("./tts.runtime-CMfWJg8P.js"));
...
const loadInternalSourceReplyPersistence = createLazyRuntimeModule(() => import("./internal-source-reply-persistence-CNQH17pq.js"));
const loadClawHubRecommendations = createLazyRuntimeModule(() => import("./clawhub-recommendations-sH7Na9Qd.js"));
