...
import { J as registerRuntimeAuthMaterializationMutationListener, K as getPreparedRuntimeAuthMaterializations, a as createPreparedRuntimeAuthProfileUsageReader, x as registerRuntimeAuthProfileStoreMutationListener } from "./runtime-snapshots-LZfHFeGe.js";
import { t as collectConfiguredAgentHarnessRuntimes } from "./harness-runtimes-9kI9uJzh.js";
import { f as setPreparedModelRuntimeAuthMaterializations, l as setPreparedModelFullCatalogAuth, n as copyPreparedModelRuntimeAuthBindings, r as getPreparedModelFullCatalogAuth, s as hasSamePreparedModelCatalogAuth } from "./prepared-model-runtime-auth-DWsCgWGn.js";
import { r as resolvePublishedModelCatalogOwner, t as preparePublishedModelCatalogOwnerIdentity } from "./prepared-model-catalog-owner-Cr9f915l.js";
import { i as assertPreparedModelRuntimeInputCurrent, n as PreparedModelRuntimePublicationSupersededError, r as assertPreparedModelRuntimeCandidatesCurrent, t as PreparedModelRuntimeOwnerNotPublishedError } from "./prepared-model-runtime.errors-18hyOf9a.js";
import { C as closeEphemeralPreparedModelRuntimeResources, S as PreparedModelRuntimeBuildResources, W as resolveUsableAgentCredentialModes, _ as publishPreparedPluginGeneration, a as listExpiredPreparedModelCatalogProviders, b as retainPreparedPluginGeneration, c as mergePreparedNativeCatalog, d as prepareModelCatalogPublication, f as retainPreparedModelCatalogPublication, g as discardPreparedPluginGeneration, h as preparedPluginGenerationSupportsSelections, i as isPreparedModelCatalogFull, l as mergePreparedProviderCatalog, m as preparedPluginGenerationReusesBase, n as expirePreparedModelCatalogProviders, o as markPreparedModelCatalogFull, r as filterPreparedProviderCatalog, s as materializePreparedModelCatalog, t as createPreparedModelRuntimeSnapshot, u as prepareFullCatalogFacts, v as registerPreparedPluginLifetime, x as retainPreparedPluginRegistry, y as releasePreparedPluginPublication } from "./prepared-model-runtime.full-catalog-D-4WACLM.js";
import { i as AuthStorage } from "./model-registry-UE0EOYQn.js";
import { a as loadPersistedPluginModelCatalogsReadOnly } from "./plugin-model-catalog-5YFea29o.js";
...
import { i as listConfiguredOwnerInputs } from "./prepared-model-runtime.configured-C2ccdKs-.js";
import { n as augmentPreparedModelCatalogWithAgentHarness, r as isPreparedNativeModelCatalogReady } from "./model-catalog-CoZagILv.js";
import { o as resolveSelectedAgentHarnessRuntime } from "./runtime-plugin-load-plan-BlxUBe6z.js";
import { t as createPreparedModelCatalogProviderNormalizer } from "./model-catalog-provider-normalizer-D0tYrw7N.js";
import { a as registerPreparedModelRuntimeClose, i as createPreparedModelRuntimeReplacement, n as capturePreparedModelRuntimeLifetime, r as closePreparedModelRuntimeSnapshots, s as retirePreparedModelRuntimeGeneration, t as capturePreparedModelRuntimeGeneration } from "./prepared-model-runtime.lifecycle-D5VV7O0t.js";
import { t as getPreparedModelRuntimeBorrowedSnapshot } from "./prepared-model-runtime-generation-scope-Dbh_MtQt.js";
import { t as runAbortableTimeout } from "./with-timeout-CizoU_KI.js";
import { _ as prepareConfiguredRuntimeFacts, c as fingerprintPreparedRuntimeFacts, d as prepareWorkspaceBuildGroup, f as preparedModelInventoryKey, g as preparedModelRuntimeWorkspaceFactsKey, l as prepareConfiguredModelFacts, m as createPreparedInboundRegistryLoader, n as createPreparedModelCatalogWorker, p as scopeSyntheticAuthProviderRefs, s as captureModelsJsonContents, u as prepareConfiguredRuntimeFactsBatch } from "./prepared-model-catalog-worker-BQ2vH2eW.js";
import { a as resetPreparedModelRuntimePublicationListenersForTest, n as notifyPreparedModelCatalogPublication, r as notifyPreparedModelRuntimePublication, t as createCatalogAttemptReporter } from "./prepared-model-runtime.publication-events-F8euvkEq.js";
import { n as planAssistantModelsJsonSource, t as ensureAssistantModelsJson } from "./models-config-Mi8aPYWe.js";
import { n as setPreparedModelRuntimeStartupStatus } from "./prepared-model-runtime.startup-status-Da154XRr.js";
	...
	return async ({ providerIds, profileIds }) => {
		...
		const promise = (async () => {
			try {
				...
				_usingCtx$5.a({ [Symbol.asyncDispose]: retainPreparedPluginGeneration(params.pluginGeneration) });
...
async function prepareScopedReadOnlyModelCatalogWithMode(input, providerDiscoveryProviderIds, catalogMode) {
	try {
		...
		_usingCtx$3.a({ [Symbol.asyncDispose]: () => discardPreparedPluginGeneration(pluginGeneration) });
