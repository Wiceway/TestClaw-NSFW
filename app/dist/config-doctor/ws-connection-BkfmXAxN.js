...
import { s as resolvePreauthHandshakeTimeoutMs } from "./timeouts-Bm8XlcCK.js";
import { Q as WORKER_COMPUTER_PROTOCOL_FEATURE, c as WORKER_PORTAL_PROTOCOL_FEATURE, g as WORKER_SESSION_TOOLS_PROTOCOL_FEATURE, i as WORKER_HEARTBEAT_INTERVAL_MS, p as WORKER_PROTOCOL_METHODS, s as WORKER_LIVE_EVENT_PROTOCOL_FEATURE, v as WORKER_TRANSCRIPT_COMMIT_PROTOCOL_FEATURE } from "./worker-admission-D2iU0J8C.js";
...
import { l as isWebchatClient } from "./message-channel-iCC7oIhe.js";
import { C as runWithGatewayIndependentRootWorkContinuation, c as getGatewaySuspendAdmissionPhase, k as tryBeginGatewayRootWorkAdmission, u as isGatewayRestartDraining } from "./gateway-work-admission-DJ5CkZgB.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-Dx_kHnY5.js";
import { t as ErrorCodes } from "./gateway-error-details-D4L8ZwC-.js";
import { Ss as validateWorkerTranscriptCommitParams, _r as validateRequestFrame, _s as validateWorkerHeartbeatParams, bs as validateWorkerSessionsSendParams, ms as validateWorkerConnectRequestFrame, ps as validateWorkerComputerParams, vs as validateWorkerLiveEventParams, xs as validateWorkerSessionsSpawnParams, ys as validateWorkerPortalParams } from "./validator-registry-Dpl5QmuY.js";
import { d as validateWorkerInferenceStartParams, i as WORKER_PROTOCOL_MAX_INFERENCE_PAYLOAD_BYTES, l as validateWorkerInferenceCancelParams, n as WORKER_INFERENCE_METHODS } from "./worker-inference-B5p6MzmC.js";
import { t as GATEWAY_SERVER_CAPS } from "./server-capabilities-w8aSAGNB.js";
import { a as isLoopbackAddress, s as isLoopbackHost } from "./net-DLTbz3sZ.js";
...
import { r as classifyGatewayStaleInstall, t as GATEWAY_STALE_INSTALL_CLOSE_REASON } from "./stale-install-Cz6VHd9H.js";
import { c as cleanupTalkConnection } from "./session-sharing-xa1VG8U2.js";
import "./server-utils-CvEJ_kDk.js";
import { n as WORKER_SKILL_WORKSHOP_FEATURE, o as validateWorkerSkillWorkshopParams } from "./worker-skill-workshop-CYXgYvH-.js";
import { s as removeRemoteNodeInfo } from "./remote-BqP6PO5r.js";
import { s as recordPairedNodeDisconnection } from "./device-pairing-node-D3__zSdN.js";
import { u as AUTH_RATE_LIMIT_SCOPE_WORKER_ADMISSION } from "./auth-rate-limit-CAtkUs0M.js";
...
import "./placement-session-tool-operations-CBXUAlp5.js";
import { l as runWorkerTurnAdmissionContinuation } from "./placement-turn-claim-events-DHSjCCwa.js";
import { t as isWorkerTranscriptFrameWithinBudget } from "./worker-transcript-budget-0rmWNc-q.js";
import { t as startWebSocketKeepalive } from "./websocket-keepalive-DYmRD_O3.js";
import { i as upsertPresence, n as touchPresence } from "./system-presence-B2UbZ4Wg.js";
import { a as incrementPresenceVersion, r as getHealthVersion } from "./health-state-C05tfpvN.js";
import { i as clearNodeWakeState } from "./node-wake-state-CWVR-GCk.js";
import { i as indexPluginNodeCapabilitySurfaces, l as reconcileClientPluginNodeCapabilities } from "./plugin-node-capability-Dd8ciJ4U.js";
import { t as broadcastPresenceSnapshot } from "./presence-events-B-BwZnK6.js";
import { n as refreshClientPresence } from "./client-presence-CUrEecgH.js";
import { a as takePublicWorkerIngress, r as WS_HANDSHAKE_PHASES } from "./ws-types-CovtUmQe.js";
import { a as HandshakeAuthLogLimiter, i as rawDataByteLength, o as buildHandshakeAuthLogKey, r as createWorkerRpcDiagnostics, s as shouldLimitMissingCredentialAuthLog, t as captureGatewayRpcReceivedAt } from "./request-diagnostics-Ck2Ujtll.js";
...
function resolveHostedPluginSurfaceUrl(params) {
	...
	return `${scheme}://${host.includes(":") && !(host.startsWith("[") && host.endsWith("]")) ? `[${host}]` : host}:${exposedPort}`;
}
//#endregion
...
function attachGatewayWsMessageHandlerOnDemand(params) {
	...
	params.connectionWork.track(async () => {
		const { attachGatewayWsMessageHandler } = await import("./message-handler-BmKhyGzC.js");
