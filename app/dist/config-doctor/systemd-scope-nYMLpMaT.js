...
import { T as readSystemctlDetail, b as isSystemdUnitActive, c as resolveSystemdUnitPath, h as execSystemctl, p as execBusctlSystem, s as resolveSystemdServiceName } from "./systemd-service-files-Bb2bJdgP.js";
...
async function admitUserUnitActivationPastUnverifiableOwnership(env, error, timeoutMs) {
	...
	const { readSystemdDefinitionMutationCapability } = await import("./systemd-definition-mutation-D5-vQRbL.js");
...
async function findMarkerOwnedSystemSystemdUnit() {
	const { findSystemGatewayServices } = await import("./inspect-B7Hoz-pU.js");
	let services;
	try {
