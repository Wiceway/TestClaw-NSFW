...
import { n as CHANNEL_TARGET_DESCRIPTION, t as CHANNEL_TARGETS_DESCRIPTION } from "./channel-target-g69jtBF3.js";
			...
			try {
				await runCommandWithRuntime(defaultRuntime, async () => {
					...
					if (preloadPlan.preload) {
						...
						const { loadPluginRegistryHandle } = await import("./loader-DvGnwzCF.js");
					...
					const [{ messageCommand }, { createDefaultDeps }] = await Promise.all([import("./message-C1lnTey9.js"), import("./deps-Dzj87gLb.js")]);
