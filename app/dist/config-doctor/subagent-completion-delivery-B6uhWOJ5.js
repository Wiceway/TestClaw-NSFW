...
import { v as ensureDeliveryState } from "./subagent-registry.store.sqlite-DZjKXKC2.js";
import { n as findTaskByRunId, r as getTaskById } from "./task-registry-query-R9q--_2Z.js";
...
import { _ as SessionDeliveryDeadLetteredError, p as releaseSessionDeliveryClaim, v as SessionDeliveryDeferredError, x as prepareClaimedSessionDelivery } from "./session-delivery-queue-storage-DeSSrS9n.js";
import { A as safeRemoveAttachmentsDir, B as scheduleSessionDelivery, C as ANNOUNCE_COMPLETION_HARD_EXPIRY_MS, h as loadPendingFinalDeliveryPayload, i as publishCommittedRecords, n as admitSubagentCompletionDelivery, r as blockSubagentCompletionDelivery, s as settleSubagentCompletionDelivery, t as SUSPENDED_RETENTION_MS } from "./subagent-completion-admission.store-ZpYnpoI4.js";
...
async function settleCorrelatedSubagentDelivery(queued, outcome) {
	...
	publishCommittedRecords(subagent, projectedTask);
	const { resumeSubagentRun } = await import("./subagent-registry-B89YIjYr.js");
