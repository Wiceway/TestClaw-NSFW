...
import { a as asDateTimestampMs, x as parseStrictNonNegativeInteger } from "./number-coercion-0M4tZV2c.js";
import { t as createContainerEnvFile } from "./container-env-file-Cewis7OC.js";
...
async function createContainerSandboxBackend(engine, params, operatorAuthority) {
	...
	assertCurrent();
	const { createSandboxFsBridge } = await import("./fs-bridge-BT2y9s1f.js");
	assertCurrent();
