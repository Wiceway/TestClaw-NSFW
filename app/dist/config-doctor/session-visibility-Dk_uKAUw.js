...
import { c as resolveAgentIdFromSessionKey, v as isAcpSessionKey, x as isSubagentSessionKey } from "./session-key-AvQIavYt.js";
import { t as formatErrorMessage } from "./errors-cp9Var1Z.js";
import { t as redactIdentifier } from "./node-crypto-p3a5nOcB.js";
import { i as logWarn } from "./logger-DgjIIHeT.js";
import { t as GatewaySecretRefUnavailableError } from "./credentials-_4Zh4Pjr.js";
import { t as GatewayExplicitAuthRequiredError } from "./client-bootstrap-PJVbtOFi.js";
import "./client-Oba-QRH-.js";
import { t as GatewayClientRequestError } from "./request-error-Cn3ScUEY.js";
import { t as GatewayCredentialsRequiredError } from "./call-CY0v-3Uc.js";
...
async function listSpawnedSessionKeysWithResult(params) {
	...
	try {
		const list = await (params.callGateway ?? (await import("./in-process-gateway-DyMO0Hm5.js")).bindAgentToolGatewayRequest({ hostedOnly: true }))({
...
//#endregion
export { resolveSandboxSessionToolsVisibility as a, listSpawnedSessionKeysWithResult as c, lookupFailedOperationMessage as d, renderSessionVisibilityDenial as f, resolveEffectiveSessionToolsVisibility as i, logSessionOwnershipLookupFailure as l, sessionOwnershipLookupFailure as m, createSessionVisibilityChecker as n, resolveSessionToolsVisibility as o, sessionOwnershipLookupDenied as p, createSessionVisibilityRowChecker as r, createSessionVisibilityDecisionChecker as s, createAgentToAgentPolicy as t, lookupFailedDenialMessage as u };
