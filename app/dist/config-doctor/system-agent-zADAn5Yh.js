...
import { _a as validateSystemAgentSetupActivateParams, ba as validateSystemAgentSetupDetectParams, ga as validateSystemAgentChatParams, ha as validateSystemAgentChatHistoryParams, ks as normalizeSystemAgentPluginReference, va as validateSystemAgentSetupActivateStartParams, xa as validateSystemAgentSetupVerifyParams, ya as validateSystemAgentSetupAuthStartParams } from "./validator-registry-Dpl5QmuY.js";
...
import { r as describeSystemAgentPersistentOperation } from "./operations-parse-CJ16l1J7.js";
import "./operations-BB1UEP4Y.js";
import { t as assertValidParams } from "./validation-BZLpfukT.js";
import { n as SYSTEM_AGENT_APPROVAL_TIMEOUT_MS, t as SYSTEM_AGENT_APPROVAL_DECISIONS } from "./system-agent-approvals-r0J6k0r_.js";
...
import { i as buildRequestedApprovalEvent, r as broadcastApprovalResolvedEvent, s as handlePendingApprovalRequest } from "./approval-shared-BS71rxnr.js";
import { t as getUpdateAvailable } from "./update-status-state-CWEy2E9S.js";
import { n as getHealthCache } from "./health-state-C05tfpvN.js";
import { t as WizardSession } from "./session-DsnmHRHD.js";
import { i as runExclusiveSystemAgentSetupActivation, n as createAdmittedWizardSession, r as respondSetupAdmissionBusy, t as SetupAdmissionBusyError } from "./setup-admission-WhcDAsAj.js";
import { a as verifyGatewaySetupInference, i as runSystemAgentGatewayTask, n as startSetupActivationWizard, r as activateGatewaySetupInference, t as rejectExistingSetupWizardSession } from "./system-agent-setup-wizard-CAqYz8cW.js";
import { n as isSystemAgentInferenceUnavailableError } from "./inference-error-DWG7NHn3.js";
import { n as SystemAgentChatEngine, r as SystemAgentWizardAnswerError, t as buildOnboardingWelcome } from "./onboarding-welcome-BCoxopwW.js";
import { r as formatSystemAgentStartupMessage } from "./overview-BGFW4MAR.js";
...
const systemAgentHandlers = {
	...
	"testclaw.setup.detect": async ({ params, respond }) => {
		...
		const { detectSetupInference } = await import("./setup-inference-DqvZe-fa.js");
		...
		const session = await createAdmittedWizardSession(() => new WizardSession(async (prompter, signal, runnerSession) => {
			await runSystemAgentGatewayTask(async () => {
				const [{ prepareAuthChoiceLoadedPluginProvider }, setupShared, authConfig] = await Promise.all([
					import("./provider-auth-choice-BXnIlAeB.js"),
					import("./setup.shared-C8Nq4VZk.js"),
					import("./provider-auth-config-Sv7Pifos.js")
				]);
	...
	*/
	...
	"testclaw.chat": async ({ params: rawParams, respond, client, context }) => {
		...
		const pending = await runSystemAgentGatewayTask(async () => {
			...
			if (!session) {
				const { verifySystemAgentInferenceWithFallback } = await import("./inference-fallback-D-9VSpzq.js");
