...
function parseConcreteConfigPathWithProvenance(raw) {
	...
	for (const segment of parsed.tokens) if (typeof segment === "string" && isBlockedObjectKey(segment)) throw new Error(`Invalid path segment: ${segment}`);
	return parsed;
}
...
//#endregion
export { parseConcreteConfigPathWithProvenance as a, parseConcreteConfigPathTokens as i, formatConcreteConfigPath as n, toDotPath as o, parseConcreteConfigPath as r, tokenizeConcreteConfigPath as s, appendConfigPathSegment as t };
