...
import { T as setPluginInstallRecordMapEntry, a as loadInstalledPluginIndexInstallRecords, h as resolveInstalledPluginIndexStorePath, o as loadInstalledPluginIndexInstallRecordsSync, s as readPersistedInstalledPluginIndexInstallRecords, u as inspectPersistedInstalledPluginIndexInstallRecordsSync, v as copyPluginInstallRecordMap, x as inspectPluginInstallRecordMap } from "./installed-plugin-record-match-DU0U5gm6.js";
import { a as resolveTrustedOfficialClawHubPackageName, i as isTrustedOfficialPluginInstallRecord, o as resolveTrustedSourceLinkedOfficialClawHubInstall } from "./official-external-install-records-B1d0ysfv.js";
...
import { i as writePersistedInstalledPluginIndex } from "./installed-plugin-index-store-write-Bn0VUh5Y.js";
...
async function importShippedPluginInstallConfigForDoctor(snapshot, options = {}) {
	...
	if (source.status === "missing") return;
	if (source.status === "invalid") throw new InvalidPluginInstallRecordStateError(INVALID_CONFIG_INSTALL_RECORD_MESSAGE);
	const { readConfigFileSnapshotForWrite, withConfigMutationExclusive } = await import("./config-fCohulPn.js");
	...
	const { commitPluginInstallRecordsOnly } = await import("./install-record-commit-Cirt6yPQ.js");
...
async function readMigrationConfig(params) {
	...
	return await (await import("./config-fCohulPn.js")).readBestEffortConfig();
}
