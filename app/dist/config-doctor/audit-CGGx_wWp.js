...
import { N as tryResolveDefaultAgentId, O as hasAgentRosterProperty, T as tryResolveLegacyCompatibilityAgentId, k as listAgentEntries } from "./agent-scope-config-BEuqweC1.js";
...
import { f as resolveConfigSecretRef, r as copyConfigResolutionFacts, u as hasUnresolvedConfigPath } from "./resolution-facts-BNNyTRcj.js";
import "./agent-scope-BiRi-Smp.js";
import { d as resolveExecModePolicy } from "./exec-approvals-core-BW9WjMmv.js";
import { o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-DtTYx_hp.js";
import { t as createGatewayCredentialPlan } from "./credential-planner-CFcNwxh2.js";
import { a as inspectPathPermissions, i as formatPermissionRemediation, r as formatPermissionDetail } from "./permissions-Dw0_GTuv.js";
import "./exec-approvals-9hAP-z4b.js";
import { r as loadExecApprovals } from "./exec-approvals-store-BSrG9R8i.js";
import { l as isInterpreterLikeAllowlistPattern } from "./extract-C85vXhx0.js";
...
import { t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-DawNlwsR.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-CyfB9_bL.js";
import { r as isInvalidGatewaySecret } from "./known-weak-gateway-secrets-C8SO-t_g.js";
import { r as materializeGatewayAuthSecretRefs, t as canMaterializeGatewayAuthSecretRefsWithoutExec } from "./auth-config-utils-CCi3BnuX.js";
import { n as normalizeConfiguredTrustedSafeBinDirs, t as normalizeConfiguredSafeBins } from "./exec-safe-bin-config-DR-e0v9n.js";
import "./audit-fs-BGlapLYw.js";
import { t as resolveGatewayAuthTokenSourceConflict } from "./auth-token-source-conflict-CpAHKp26.js";
import { r as collectCoreInsecureOrDangerousFlags } from "./dangerous-config-flags-current-Jhi1Yzre.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-DLQUfdyE.js";
import { t as collectExecFilesystemPolicyDriftHits } from "./exec-filesystem-policy-DJipRdCn.js";
...
const loadAuditDeepModule = createLazyRuntimeModule(() => import("./audit.deep.runtime-DzaxjXYN.js"));
...
const loadReadOnlyChannelPlugins = createLazyRuntimeModule(() => import("./read-only-Cecfbh52.js"));
const loadAuditNonDeepModule = createLazyRuntimeModule(() => import("./audit.nondeep.runtime-AoSGVUnV.js"));
const loadAuditChannelModule = createLazyRuntimeModule(() => import("./audit-channel.collect.runtime-B61KIcYe.js"));
const loadPluginMetadataRegistryLoaderModule = createLazyRuntimeModule(() => import("./metadata-registry-loader-DXAU3EWu.js"));
const loadPluginAutoEnableModule = createLazyRuntimeModule(() => import("./plugin-auto-enable-Bve7UJCJ.js"));
const loadChannelPluginIdsModule = createLazyRuntimeModule(() => import("./channel-plugin-ids-ttTHEn4C.js"));
const loadPluginRuntimeModule = createLazyRuntimeModule(() => import("./runtime-DTvaNGCC.js"));
const loadGatewayProbeDeps = createLazyRuntimeModule(() => Promise.all([
	import("./call-BUB0AMHV.js"),
	import("./probe-auth-2zasygzT.js"),
	import("./probe-3RLf0B4X.js")
