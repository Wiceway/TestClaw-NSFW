...
import { i as resolveRequiredHomeDir, o as resolveUserPath, t as expandHomePrefix } from "./home-dir-DjuHbd5R.js";
import { d as sameFileIdentity, n as assertNoSymlinkParents } from "./fs-safe-advanced-CBSOsiER.js";
import { w as root$1 } from "./fs-safe-CZ3jhUUr.js";
...
import { j as listAgentIds, k as listAgentEntries } from "./agent-scope-config-BEuqweC1.js";
import { C as resolveOAuthDir, E as resolveStateDir, p as resolveConfigPath, w as resolveLegacyStateDirs } from "./paths-DeOFr7iP.js";
import { i as normalizeMainKey, n as buildAgentMainSessionKey, t as DEFAULT_MAIN_KEY } from "./session-key-C0UQClgw.js";
import { D as normalizeSessionKeyPreservingOpaquePeerIds, k as parseAgentSessionKey, n as LEGACY_IMPLICIT_AGENT_ID } from "./session-key-AvQIavYt.js";
...
import { U as readExistingAgentSchemaMeta, V as coerceRequiredSqliteNumber } from "./sqlite-live-snapshot-C0XwFcJs.js";
import { n as readFileWindowFullySync, t as readFileWindowFully } from "./file-read-EjE8avWj.js";
import { n as sha256Hex } from "./node-crypto-p3a5nOcB.js";
import { a as sha256FileSync, i as sha256File } from "./crypto-digest-BPwjfEnk.js";
import { t as resolveRuntimeWorkerArgv } from "./runtime-worker-url-B-Vaprol.js";
import { Xt as quoteSqliteIdentifier } from "./testclaw-state-db-cache-BxGqhkwE.js";
import { s as resolveAssistantStateSqlitePath } from "./testclaw-state-db.paths-qkMAjTSx.js";
import { T as string, _ as looseObject, d as array, f as boolean, g as literal, k as unknown, p as custom, y as number } from "./schemas-D6YHSiZI.js";
import { Bt as estimateAcpSessionRowBytes, a as withArtifactPreservingStateReads, s as withExistingAssistantStateDatabaseArtifactPreservingReadOnly, zt as estimateAcpEventRowBytes } from "./testclaw-state-db-readonly-mjFl_Qah.js";
import { i as resolveSqliteDatabaseFilePaths, t as SQLITE_SIDECAR_SUFFIXES } from "./sqlite-files-Bm4Vx3bT.js";
...
import { g as resolveLegacyInstalledPluginIndexStorePath } from "./installed-plugin-record-match-DU0U5gm6.js";
import "./installed-plugin-index-store-BKl_GqCp.js";
...
import { l as selectAcpSessionRowForStoreEntry } from "./session-meta-keys-DzM4byAj.js";
import { n as resolveSessionStoreCompatibilityAgentId } from "./legacy.default-agent-owner-C3BvcqUT.js";
import { f as collectRelevantDoctorPluginIds, i as isPluginDoctorMigrationDeferred, l as resolveLivePluginDoctorStateMigrationInventory, s as listPluginDoctorSessionStoreAgentIds, u as resolvePluginDoctorStateMigrationInventory } from "./doctor-contract-registry-DrNrLsUs.js";
import { c as runAssistantStateWriteTransaction, i as prepareAssistantStateDatabaseSchema, r as openAssistantStateDatabase } from "./testclaw-state-db-BAeysXj_.js";
import { f as syncDirectoryIfSupported, i as pinDirectory, s as requireDirectorySync } from "./directory-durability-Da6E02oI.js";
import { t as detectAssistantStateDatabaseSchemaMigrations } from "./testclaw-state-db-schema-discovery-D9NE2r-V.js";
import { i as isPidDefinitelyDead, t as getFileLockProcessStartTime } from "./pid-alive-BrVKCISp.js";
import { a as recordLegacyMigrationRun, i as recordLegacyMigrationReceipt, n as readLegacyMigrationReceipt, o as recordLegacyMigrationSource, r as readLegacyMigrationReceiptFromDatabase, s as resolveLegacyMigrationSourceKey, t as markLegacyMigrationSourceRemoved } from "./state-migrations.receipts-DhnDtGid.js";
...
import { n as CONFIG_AUDIT_SCOPE, t as CONFIG_AUDIT_MAX_ENTRIES } from "./io.audit-OUHRrOvm.js";
import { a as hashConfigRaw } from "./io.read-helpers-DjrAb5Uv.js";
import { t as importConfigMachineState } from "./config-machine-state-write-BsrY8iFO.js";
...
import { n as asFsSafeFileLockRoot, r as createFileLockManager } from "./file-lock-manager-D8DgtKut.js";
...
import "./testclaw-agent-db-schema-helpers-BWt3HuU6.js";
import { f as runAssistantAgentWriteTransaction } from "./testclaw-agent-db-Ckg86YCZ.js";
import { l as listAgentDatabaseAdmissionRefusals } from "./agent-database-admission-D08lnQbi.js";
import { o as closeAssistantAgentDatabaseByPathAsync } from "./testclaw-agent-db-lifecycle-lcOVPLQ6.js";
import { n as inspectAssistantRegisteredAgentDatabases } from "./testclaw-agent-db-registry-listing-DBxqeFUz.js";
import "./testclaw-agent-db-registry-DgP56LUX.js";
import { t as getChannelPlugin } from "./registry-PMJLv7Nh.js";
import { Ct as prepareLegacyAcpMigrationSource, St as legacyAcpMigrationSourceKey, bt as hasLegacyAcpMigrationCompletion, vt as readLegacyAcpMigrationContext, wt as recordLegacyAcpMigrationCompletion, xt as legacyAcpMigrationBindingMatches } from "./session-accessor.sqlite-entry-store-BzD1qpup.js";
import { t as normalizePersistedSessionEntryShape } from "./store-entry-shape-BgZ9IH1k.js";
import { a as resolveAllAgentSessionStoreTargetsSync, f as listConfiguredSessionStoreAgentIds, i as resolveAllAgentSessionStoreCandidateTargetsSync, l as resolveSessionStoreTargets, s as resolveConfiguredAgentDatabaseTargets } from "./targets-BxNVBaMw.js";
import { r as normalizeConversationRef, t as currentConversationBindingRow$1 } from "./current-conversation-binding-row-YDf7pu-e.js";
import { o as writeAcpSessionMetaForMigration } from "./session-meta-8OGO7A4a.js";
import { t as pathMayExistSync } from "./path-existence-CzRtGGnO.js";
import { t as mcpOAuthStoreKeyFromLegacyFileName } from "./mcp-oauth-identity-CcnMspqq.js";
import { p as parseMcpOAuthStoreJson } from "./mcp-oauth-store-BtgfVSNf.js";
import { S as resolveSharedMainAuthAgentDir, b as closeAuthProfileReadPool, n as inspectSharedAuthStoreOwnership, o as resolveSharedAuthStoreOwnership, r as noteCommittedSharedAuthStoreOwnership, u as SHARED_AUTH_STORE_STATE_KEY } from "./path-resolve-C56x-mXN.js";
import { C as inspectSharedAuthLegacyRowsReadOnly, S as hasPendingSharedAuthCleanup, T as readSharedAuthLegacyRowsFromDatabase, m as resolveAuthProfileDatabaseOwnerId, w as inspectSharedAuthLegacySourceFile, x as SharedAuthStoreSourceInspectionError } from "./sqlite-C9aIS6tB.js";
import { a as resolveLegacyStandaloneAgentDir, i as recordCompletedLegacyAgentDirMigration, r as legacyAgentQuarantineNotices, t as resolveInstallAgentDir } from "./install-agent-dir-Bb_wxFL0.js";
import { n as isUpdateRehearsalReadOnlyPath, r as resolveUpdateRehearsalRoot } from "./update-rehearsal-paths-SMf2br4D.js";
import { a as readWorkspaceStateSnapshot, d as isSafeWorkspaceAttestationFilename, m as registerWorkspaceStateAliasesInTransaction, u as WORKSPACE_LEGACY_STATE_MIGRATION_KIND } from "./workspace-state-store-Ch070VWA.js";
import { n as formatDoctorStateRepairFailure } from "./state-repair-message-Dr7vDKEC.js";
import { f as resolveLegacyWorkspaceSourcePaths, l as legacyWorkspaceSiblingAttestationMayExist, o as WORKSPACE_DOCTOR_CLAIM_SUFFIX, r as LEGACY_WORKSPACE_ATTESTATION_MAX_BYTES, t as LEGACY_WORKSPACE_ATTESTATION_DIRNAME } from "./workspace-legacy-state-DnXOnp9G.js";
import { n as resolveChannelDefaultAccountId } from "./helpers-DsHF8yVm.js";
import { C as rewriteRegistryWorktreePathsForMigration, b as listRegistryWorktreesForMigration, s as discardLegacyRegistryWorktrees, v as listLegacyRegistryWorktreesForMigration } from "./registry-BUL8lwJ9.js";
...
import { c as sessionFromRow, d as safeTranscriptPathSegment, f as transcriptSessionExportKey, h as renderTranscriptsMarkdown, l as TRANSCRIPT_EXPORT_FILE_NAMES, m as ensureMeetingTranscriptsSchema, p as transcriptSessionSelector, t as TranscriptsStore } from "./store-CfJzJT8L.js";
import { n as listLegacyPairingStoreFiles } from "./pairing-files-DQj3LJmV.js";
import { t as migrateLegacyMainSessionKeys } from "./legacy-main-session-migration-B4MbmhK3.js";
import { n as SYSTEM_AGENT_AUDIT_SCOPE, t as SYSTEM_AGENT_AUDIT_MAX_ENTRIES } from "./audit-DQGfckJV.js";
import { n as listWorkspaceStateDirs } from "./workspace-state-dirs-B-ckkUOw.js";
import { a as updateChannelPairingStateSnapshot, c as resolveAllowFromAccountId, l as safeAccountKey, s as dedupePreserveOrder, u as getPairingAdapter } from "./pairing-store-sqlite-D14WLPVy.js";
import { i as parseRestartSentinelEnvelope, o as readRestartSentinelRowSync, u as writeRestartSentinelRowSync } from "./restart-sentinel-store-DT36rrR6.js";
import { r as acquireGatewayLock } from "./gateway-lock-BdQ1BI9a.js";
import { n as LEGACY_NODE_HOST_CONFIG_FILE, r as NODE_HOST_CONFIG_KEY, t as LEGACY_NODE_HOST_CONFIG_CLAIM_SUFFIX, u as normalizeNodeHostCloudflareAccessConfig } from "./config-B82fRBcN.js";
...
import { a as legacyMigrationSourceOrClaimMayExist, c as readLegacyMigrationSourceSnapshotSync, i as claimLegacyMigrationSourceClaims, l as resolveLegacyMigrationRelativePath, n as assertLegacyMigrationSourceUnchanged, o as legacyMigrationSourceSnapshotsMatch, r as claimAndRemoveLegacyMigrationSource, s as readLegacyMigrationSourceSnapshot, t as LegacyMigrationSourceClaim, u as restoreLegacyMigrationSourceClaims } from "./state-migrations.source-snapshot-CDC-UEOk.js";
import { n as migrateLegacyExecApprovals, t as detectLegacyExecApprovals } from "./state-migrations.exec-approvals-B8XJH3iy.js";
import { c as recordLegacyAuditRawCheckpoint, d as prepareLegacyAuditRecords, f as serializePreparedAuditRecords, g as legacyAuditSourceGenerationKey, i as findPreviousLegacyAuditRawCheckpoint, l as restoreInterruptedAuditRecoveryArchive, m as hasLegacyAuditRawCheckpointCapacity, n as auditRecoveryCheckpointPrefixMatches, p as detectLegacyAuditLogs, r as finalizeLegacyAuditRecoveryArchive, s as readLegacyAuditSourceSnapshot, t as withLegacyAuditMigrationLease, u as scrubLegacyAuditRecoveryArchive } from "./state-migrations.audit-coordination-C8yVFlHN.js";
import { r as saveLegacySessionStore } from "./state-migrations.legacy-session-store-B-eMEqmK.js";
import { a as readSessionStoreJson5, i as parseSessionStoreJson5, n as existsDir, o as safeReadDir, r as migrationFileExists, t as ensureMigrationDir } from "./state-migrations.fs--hp5l-UV.js";
import { t as EMPTY_LEGACY_SESSION_SURFACES } from "./legacy-session-surfaces.types-BmAZdMse.js";
import { n as detectLegacyDeliveryQueueFiles } from "./delivery-queue-legacy-files-DY0490kz.js";
import { c as normalizeApnsEnvironment, f as normalizeCanonicalApnsRegistration, g as apnsRegistrationToRow, i as isValidApnsNodeId, l as normalizeApnsNodeId, t as apnsRegistrationFromRow } from "./push-apns-store-DV_aAo_z.js";
import { t as migrateLegacyConfigMachineState } from "./state-migrations.config-machine-state-FgU3DJ5p.js";
import { i as prepareDeferredPluginSessionImportReader, n as deferredPluginSessionStoreIds, o as preserveDeferredPluginSessionSource } from "./deferred-plugin-session-sources-D5oLJcfK.js";
import { a as mergeNotices, i as logStateMigrationResult, n as createLegacyStateMigrationStepReceipt, r as formatStartupMigrationFailure } from "./state-migrations.messages-DC2sfSBV.js";
import { d as managedImageRecordsEqual, l as managedImageRecordFromRow, t as MANAGED_OUTGOING_ORIGINALS_SUBDIR, u as managedImageRecordToRow } from "./managed-image-record-store-VIcssG1F.js";
import { n as collectPluginDoctorStateMigrationPlans, r as runPluginDoctorStateMigrationPlans } from "./state-migrations.plugin-doctor-CKfiKGwd.js";
import { _ as resolveLegacyTaskRunsSidecarPath, f as migrateLegacyTaskStateSidecars, g as resolveLegacyPluginStateSidecarPath, h as resolveLegacyFlowRunsSidecarPath, n as TASK_STATE_SQLITE_SIDECAR_SUFFIXES, o as hasPendingSqliteSidecarArchive, r as archiveLegacyImportSource, t as PLUGIN_STATE_SQLITE_SIDECAR_SUFFIXES } from "./state-migrations.storage-BWHMhYSJ.js";
import { n as migrateLegacyPluginStateSidecar, t as migrateLegacyInstalledPluginIndex } from "./state-migrations.plugin-state-ZLE9tTje.js";
import { c as resolvePendingLegacyStateDirMigrationPaths, o as resolveLegacyProfileWorkspaceMigrationPaths, r as migrateLegacyProfileWorkspace, s as resolvePendingLegacyProfileWorkspaceMigrationPaths, t as autoMigrateLegacyStateDir } from "./state-migrations.state-dir-DjDsSgGU.js";
import { n as preparePostSessionPluginMigration, t as buildPlannedPluginStateMigrationDescriptor } from "./state-migrations.plugin-plan-9T5cUEmI.js";
import { t as migrateLegacyMediaPersistence } from "./state-migrations.media-persistence-CRuDV1Rf.js";
import { n as normalizeVoiceWakeRoutingConfig } from "./voicewake-routing-8h6ci4pP.js";
import { a as hashWebPushEndpoint, c as webPushSubscriptionFromRow, i as createWebPushVapidKeyPair, l as webPushSubscriptionToRow, n as WEB_PUSH_VAPID_STATE_KEY, o as isValidWebPushEndpoint, s as isValidWebPushKey, u as webPushSubscriptionsEqual } from "./push-web-store.records-utoVeGqn.js";
import { n as ensureWebPushSubscriptionBindingColumns } from "./push-web-store.kernel-CK2_UqYf.js";
import { a as resolveWorkspaceMigrationSourceKey, i as readReceipt, n as createWorkspaceSetupFingerprint } from "./state-migrations.workspace-setup-receipts-C6_RF88l.js";
...
function buildLegacyStateMigrationPreludeSteps(params) {
	...
	if (params.invocationPurpose === "doctor") steps.push(sharedStep("transcript-directives", agentPersistence, agentPersistence, async () => {
		const { migrateHistoricalTranscriptDirectives } = await import("./state-migrations.transcript-directives-CJCjxM5R.js");
...
async function detectLegacyWorkspaceState(params) {
	...
	const { listLegacySkillWorkshopWorkspaceDirs } = await import("./doctor-skill-workshop-sources-Bjm_aEXq.js");
	const env = {
		...params.env ?? process.env,
		TESTCLAW_STATE_DIR: params.stateDir
	};
	...
	const doctorStateSteps = isDoctor ? [
		{
			...sharedStep("delivery-queues", async () => {
				const { migrateDoctorDeliveryQueues } = await import("./doctor-outbound-delivery-BDRHwMH5.js");
		...
		sharedStep("pairing-stores", async () => {
			const { migrateDoctorPairingStores } = await import("./state-migrations.pairing-4XHyaCKx.js");
	...
	const finalSteps = [
		...
		...isDoctor ? [{
			...finalStep("skill-workshop", async () => {
				const { migrateLegacySkillWorkshopProposals } = await import("./doctor-skill-workshop-sqlite-DjdOvefP.js");
...
async function executeLegacyStateMigrations(params, onUnexpectedFailure) {
	...
	const pluginPreparation = createPluginMigrationPreparationStep({
		...
		run: async () => {
			...
			legacySessionSurfaces = params.legacySessionSurfaces ?? (await import("./legacy-session-surfaces-CR-pYczD.js")).prepareLegacySessionSurfaces({
				config: params.cfg,
				env
			});
