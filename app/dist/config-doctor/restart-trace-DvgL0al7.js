...
const RESTART_TRACE_HANDOFF_STARTED_AT_ENV = "TESTCLAW_GATEWAY_RESTART_TRACE_STARTED_AT_MS";
const RESTART_TRACE_HANDOFF_LAST_AT_ENV = "TESTCLAW_GATEWAY_RESTART_TRACE_LAST_AT_MS";
const RESTART_TRACE_HANDOFF_MAX_AGE_MS = 6e5;
let startedAt = 0;
let lastAt = 0;
let active = false;
function nowMs() {
...
function isRestartTraceEnabled() {
	return isTruthyEnvValue(process.env.TESTCLAW_GATEWAY_RESTART_TRACE);
}
...
/** Starts a restart trace sequence when TESTCLAW_GATEWAY_RESTART_TRACE is enabled. */
