...
import { o as asFiniteNumber, s as asFiniteNumberInRange } from "./number-coercion-0M4tZV2c.js";
...
import { L as markHostPluginUsageDiagnosticEvent, f as isDiagnosticsEnabled, s as emitTrustedDiagnosticEvent } from "./diagnostic-events-CzmzgdMI.js";
...
import { n as estimateUsageCost, o as resolveModelCostConfig, t as estimateAggregateUsageCost } from "./usage-format-Bkf9MeNp.js";
import { t as compileModelAllowlist } from "./model-allowlist-D93cIoql.js";
import { n as writeRuntimeLog } from "./runtime-logging-BKTNtl1_.js";
...
async function resolveAgentId(params) {
	...
	const { resolveAmbientOwnerAgentId } = await import("./agent-scope-BM4mAou3.js");
...
function createRuntimeLlm(options = {}) {
	...
	return { complete: async (params) => {
		...
		const [{ acquireSimpleCompletionModelForAgent, completeWithPreparedSimpleCompletionModel, resolveSimpleCompletionSelectionForAgent }, cfg] = await Promise.all([import("./simple-completion-runtime-DLoaKZHH.js"), Promise.resolve(resolveRuntimeConfig(options))]);
