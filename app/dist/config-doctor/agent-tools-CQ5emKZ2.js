...
import { c as hasRestrictiveAllowPolicy, u as replaceWithEffectiveToolAllowlist } from "./tool-policy-BFaYCu9H.js";
...
import { n as generateSecureHex } from "./secure-random-D2trnoZY.js";
import { u as isCompletionReportInputProvenance } from "./input-provenance-DGaz_sh7.js";
import { Y as finalizeToolTerminalPresentation, a as isPreExecutionBlockedToolResult, d as captureAgentPluginRuntimeRefresh, l as rewrapToolWithBeforeToolCallHook, p as runWithToolExecutionValidation, r as getBeforeToolCallFailureDisposition, u as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-BwZqazXs.js";
...
import { a as protectNetworkToolExecutionError, i as isTrustedToolExecutionPreflightError, r as isToolResultError, u as resolveToolResultFailureKind } from "./tool-result-error-BN3NyZD4.js";
import { n as ToolInputError, t as ToolAuthorizationError } from "./tool-input-error-mjW74R8m.js";
import { o as transferMcpCodeModeGuestResult, s as toToolSearchJsonSafe } from "./mcp-content-Dl9PUDjg.js";
import { o as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-3FPGpNUN.js";
import { c as getChannelAgentToolMeta, f as getBeforeToolCallDiagnosticOptions, h as isToolWrappedWithBeforeToolCallHook, n as bindAssembledAgentToolActionDescriptor, r as copyAgentToolMetadata, v as finalizeAgentToolAvailability, x as resolveAgentToolExecutionSchema } from "./agent-tool-metadata-DkPGvtCv.js";
import { r as pinExecToolTarget } from "./exec-tool-target-pinning-Dm1GAal9.js";
import { c as wrapToolWithGatewayCallerIdentity } from "./gateway-caller-context-BrVUu-N_.js";
import { i as bindCronManagementGrant, n as bindActiveCronCreatorAuthorityResolver } from "./cron-creator-authority-context-v85EkXJb.js";
import { t as asToolParamsRecord } from "./common-Bkl7CqHm.js";
import { n as textResult } from "./tool-results-BCM3fdVS.js";
import { o as renderToolSearchControlText, s as serializeToolSearchControlResult } from "./code-mode-json-OfGm-ziD.js";
import { a as compactToolOutputHint, c as disposeCodeModeResults, i as compactToolInputHint, n as markToolContractFailure } from "./tool-contract-error-B3_K2-G0.js";
import { t as isCoreCodingSurfaceToolName } from "./core-tool-factory-descriptors-DJbcyZHz.js";
import { t as resolveNodeRuntimeExecutable } from "./node-runtime-executable-BdWI2YK9.js";
import { J as SESSION_TOOL_STDERR_TAIL_BYTES, Y as appendBoundedTextTail } from "./tools-FoyuW2o_.js";
import { t as sortAndLimitBy } from "./sort-and-limit-NdojqZsZ.js";
import { i as selectToolOutputSchema, r as readToolOutputSchemaVariants, t as captureToolOutputSelection } from "./tool-output-schema-Ct2l6sR_.js";
import { n as bindJoinedCollectorInvocation } from "./swarm-collector-capability-B6P9ecYw.js";
import { r as isAgentToolReplaySafe } from "./tool-replay-safety-Du3YIgFA.js";
import { t as levenshteinDistance } from "./levenshtein-distance-XjKurHYB.js";
import { a as resolveImageSanitizationLimits } from "./tool-images-CO_s00XX.js";
import { d as resolveAssistantPluginToolsForOptions, o as applySwarmCollectorToolContract, t as createAssistantTools, u as filterToolsByClientCaps } from "./testclaw-tools-DNer_RKI.js";
...
import { r as resolveToolFsConfig } from "./tool-fs-policy-DYTzi15n.js";
import { i as subagentAttachmentRootForRun } from "./subagent-attachment-paths-CP765sTv.js";
import { n as resolveSandboxFileIdentity } from "./file-mutation-identity-Bmu3sjBc.js";
import { S as waitForExecScope } from "./bash-process-registry-D03BGdo6.js";
...
import { i as resolveConversationToolPolicies, n as isConversationToolAllowed, t as buildConversationToolPolicyPipelineSteps } from "./conversation-tool-policy-pipeline-BklTZ6p6.js";
...
import { i as finalizeAgentTools, r as resolveConfiguredApplyPatchPolicy, t as createCoreCodingTools } from "./core-coding-tools-BdnK9ZeF.js";
...
import { d as wrapToolMemoryFlushAppendOnlyWrite, p as createMemoryWriteProvenanceObserver } from "./agent-tools.read-VydmzVNf.js";
import { n as listChannelAgentTools } from "./channel-tools-DjoJtPWL.js";
import { t as resolveSessionPlacementComputer } from "./session-placement-computer-BAbzhYAn.js";
...
async function validateCatalogSchemaValue(entry, schemaName, value, outputSelection) {
	...
	try {
		...
		if (!schema) return;
		schemaValidatorModulePromise ??= import("./schema-validator-CiznNKVh.js");
...
//#endregion
export { TOOL_SEARCH_CODE_MODE_TOOL_NAME as A, compactToolSearchCatalogEntry as C, restrictToolSearchCatalog as D, registerHeadlessToolSearchCatalog as E, isHostScopedAgentToolActive as F, runWithAgentRingZeroTools as I, TOOL_SEARCH_RAW_TOOL_NAME as M, retainToolSearchImplementation as N, TOOL_CALL_RAW_TOOL_NAME as O, getActiveAgentRingZeroTools as P, collectUniqueCatalogToolNames as S, isDirectVisibleCatalogTool as T, ToolSearchRuntime as _, resolveDelegationCapability as a, applyToolCatalogCompaction as b, isLocalModelLeanEnabled as c, addClientToolsToToolSearchCatalog as d, applyToolSearchCatalog as f, resolveToolSearchConfig as g, resolveToolSearchCatalogTool as h, applyDelegationCapability as i, TOOL_SEARCH_CONTROL_TOOL_NAMES as j, TOOL_DESCRIBE_RAW_TOOL_NAME as k, resolveLocalModelLeanPreserveToolNames as l, buildToolSchemaDirectoryPrompt as m, createAssistantCodingToolsInternal as n, filterToolsByMessageProvider as o, applyToolSchemaDirectoryCatalog as p, createScheduledMessageInvocationAdmission as r, filterLocalModelLeanTools as s, createAssistantCodingTools as t, messageToolOwnsVisibleReply as u, formatToolSearchControlResult as v, createToolSearchCatalogRef as w, clearToolSearchCatalog as x, addClientToolsToToolCatalog as y };
