...
import { c as bindCommandOwnerAuthority, r as prepareCommandOwnerAuthority } from "./command-auth-DG4f34BV.js";
import { n as parseAccessGroupAllowFromEntry, r as resolveGroupAllowFromSources, t as mergeDmAllowFromSources } from "./allow-from-Bl2YEFVK.js";
import { t as readChannelIngressStoreAllowFrom } from "./store-allow-from-19N5OzAU.js";
...
function resolveChannelIngressEffectiveAllowFromLists(params) {
	...
	const storeAllowFrom = Array.isArray(params.storeAllowFrom) ? params.storeAllowFrom : void 0;
	return {
		...
		effectiveGroupAllowFrom: resolveGroupAllowFromSources({
			allowFrom,
			groupAllowFrom,
...
//#endregion
export { copyChannelParticipantAdmissionEvidence as _, implicitMentionKindWhen as a, readChannelContextGatewayContextResolver as b, createHostChannelInboundEventContextBuilder as c, prepareSessionParticipantInput as d, readSessionInputProfileId as f, consumeChannelAdmissionEvidence as g, compareChannelAdmissionParticipants as h, resolveStableChannelIngressPolicy as i, isSessionPersonalBootstrapTurn as l, combineChannelAdmissionEvidence as m, createHostChannelIngressRuntime as n, resolveInboundMentionDecision as o, sessionParticipantInput as p, resolveChannelIngressPolicy as r, resolveCommandAuthorizedFromAuthorizers as s, createChannelIngressPolicyResolver as t, prepareChannelParticipantObservation as u, createChannelAdmissionAudit as v, recordChannelAdmissionDecision as x, readChannelContextAdmissionEvidence as y };
