...
import "./kysely-sync-cache-state-C8TndyjF.js";
import { i as getNodeSqliteKysely, l as sqliteStringSet, n as executeSqliteQuerySync, s as prepareSqliteQuerySync } from "./kysely-sync-CICmT-bh.js";
import { i as runSqliteDeferredTransactionSync } from "./sqlite-transaction-C94DYooc.js";
import { H as normalizeSqliteNumber, J as tableHasColumns, K as tableExists } from "./sqlite-live-snapshot-C0XwFcJs.js";
import { i as assertSqliteTableIntegrity } from "./error-utils-B4pDpAz2.js";
import { w as ensureTaskExecutionOwnerSchema } from "./testclaw-state-db-BAeysXj_.js";
...
import { a as parseOptionalTaskTerminalOutcome, c as parseTaskRuntime, l as parseTaskScopeKind, o as parseTaskDeliveryStatus, r as isTerminalTaskStatus, s as parseTaskNotifyPolicy, u as parseTaskStatus } from "./task-registry.types-CkM1jc3D.js";
...
//#endregion
export { deleteTaskFlowRowInDatabase as $, filterTasksByRunScope as A, selectTaskRecordsForOwnerTree as B, buildTaskRecordForCreate as C, cloneTaskRecordForObserver as D, cloneTaskRecord as E, normalizeTaskTimestamps as F, isActiveTaskStatus as G, appendTaskEvent as H, pickPreferredRunIdTask as I, normalizeTaskSummary as J, mapAgentRunTerminalOutcomeToTaskStatus as K, resolveTaskAgentId as L, isEquivalentTaskRecord as M, listTasksFromIndex as N, compareTasksForRunIdLookup as O, matchesTaskPersistenceReceipt as P, bindTaskFlowRecord as Q, resolveTaskCreateIdentity as R, applyTaskRecordPatch as S, cloneTaskDeliveryState as T, assertTaskOwner as U, selectTaskRecordsWithAncestors as V, ensureNotifyPolicy as W, resolveTaskTerminalOutcome as X, resolveTaskLifecycleTerminalError as Y, shouldApplyRunScopedStatusUpdate as Z, hasAuthoritativeTaskBackingFromRecords as _, listTaskRecordsByRuntimeSourceIdInDatabase as a, areTaskFlowRecordsEqual as at, sameTaskBackingInstance as b, readTaskRegistrySnapshot as c, buildManagedTaskFlowPatch as ct, upsertTaskRunRowInDatabase as d, normalizeRestoredFlowRecord as dt, readTaskFlowRecord as et, upsertTaskWithDeliveryStateInDatabase as f, prepareTaskMirroredFlowSyncFromCurrent as ft, filterCurrentTaskRunBackings as g, createSubagentTaskBackingDetail as h, SUBAGENT_KILL_TASK_ERROR as ht, hasTaskSessionOwnerInDatabase as i, upsertTaskFlowRowInDatabase as it, getTaskRelatedSessionIndexKeys as j, compareTasksNewestFirst as k, readTaskRegistrySnapshotIfReady as l, buildTaskMirroredFlowCreateFields as lt, createManagedTaskBackingDetail as m, DetachedTaskRuntimeOwnerRetiredError as mt, deleteTaskRowsWithDeliveryState as n, syncTaskMirroredFlowRecordInDatabase as nt, readTaskRecord as o, assertControllerId as ot, createAcpTaskBackingDetail as p, selectTaskFlowRecords as pt, normalizeTaskStatus as q, findTaskRecordByRunIdForViewInDatabase as r, updateTaskFlowRecordInDatabase as rt, readTaskRegistryMutationSnapshotInDatabase as s, buildFlowRecord as st, bindTaskRecord as t, readTaskFlowRegistrySnapshot as tt, upsertTaskDeliveryStateInDatabase as u, cloneFlowRecord as ut, readManagedTaskBacking as v, captureTaskPersistenceReceipt as w, selectCurrentCanonicalTaskBacking as x, readTaskBackingInstance as y, sameTaskRunScope as z };
