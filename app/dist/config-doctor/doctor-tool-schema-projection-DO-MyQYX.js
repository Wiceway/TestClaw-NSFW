...
import { r as inspectRuntimeToolInputSchemas } from "./tool-schema-projection-vedtaPlF.js";
import { n as normalizeAgentRuntimeTools } from "./tools-CnhunNAi.js";
import { t as buildReadableToolsByName } from "./tools-effective-inventory-build-DmbzFnud.js";
...
async function collectAgentRuntimeToolSchemaFindings(params) {
	let tools;
	try {
		const { createAssistantCodingTools } = await import("./agent-tools-HjbTV8w1.js");
