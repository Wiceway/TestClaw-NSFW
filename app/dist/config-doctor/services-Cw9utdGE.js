...
import { R as markTrustedOtelDiagnosticListener, _ as waitForDiagnosticEventsDrained, c as emitTrustedDiagnosticEventWithPrivateData, m as onTrustedInternalDiagnosticEvent, y as registerDiagnosticTracePropagationBridge } from "./diagnostic-events-CzmzgdMI.js";
...
import { a as getGatewayContextResolver, i as getGatewayContextLifetime, r as getCanonicalGatewayContextResolver } from "./gateway-context-binding-Cy-ZcQj8.js";
import { t as resolvePluginReturnPromise } from "./plugin-return-value-CKL2xLy9.js";
import { c as getPluginRecordRegistry, d as isPluginRecordActive } from "./registry-lifecycle-Dw-35-pc.js";
...
import { t as createScheduledGatewayRunner } from "./scheduled-run-gateway-context-BZYTlZZ4.js";
import { i as recordDiagnosticExporterHealth } from "./diagnostic-stability-DI-nq_eY.js";
import { t as createPluginServiceGatewayEvents } from "./gateway-events-D1jV4SB0.js";
import { t as createPluginServiceHealthReporter } from "./service-health-CWHk0Dok.js";
...
function createPluginServiceNodeInvoker(options) {
	...
	const invoke = async (request, authority, stream, streamSignal) => {
		...
		assertCurrent();
		const [{ dispatchGatewayRequestInProcess }, { createSyntheticPluginRuntimeClient }] = await Promise.all([import("./server-in-process-dispatch-Bc6BXJl2.js"), import("./server-plugin-runtime-client-RWpH3N3c.js")]);
		assertCurrent();
	...
	return {
		...
		async openDuplex(request) {
			...
			const { openOwnedGatewayNodeDuplex } = await import("./server-plugins-node-runtime-3NrCqsJR.js");
