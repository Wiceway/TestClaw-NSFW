...
import { a as hasGatewayClientCap, n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-_nFH9T9d.js";
...
import { O as parseDiagnosticTraceparent, b as createChildDiagnosticTraceContext, k as runWithDiagnosticTraceContext, l as emitTrustedSecurityEvent, x as createDiagnosticTraceContext } from "./diagnostic-events-CzmzgdMI.js";
...
import { i as isGatewayCliClient, l as isWebchatClient, n as isBrowserOperatorUiClient, r as isEphemeralGatewayClient, s as isOperatorUiClient, t as isBrowserCopilotClient } from "./message-channel-iCC7oIhe.js";
import { O as tryBeginGatewayRestartStartupRootWorkAdmission, S as runWithGatewayIndependentRootWorkAdmission, c as getGatewaySuspendAdmissionPhase, k as tryBeginGatewayRootWorkAdmission, u as isGatewayRestartDraining, y as runOutsideGatewayRootWorkAdmission } from "./gateway-work-admission-DJ5CkZgB.js";
import { a as MAX_PAYLOAD_BYTES, i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES, s as TICK_INTERVAL_MS } from "./server-constants-Dx_kHnY5.js";
import { t as ErrorCodes } from "./gateway-error-details-D4L8ZwC-.js";
import { n as errorShape } from "./error-codes-DQWjOSek.js";
import { _r as validateRequestFrame, at as validateConnectParams } from "./validator-registry-Dpl5QmuY.js";
...
import { s as adoptTailscaleProfileAvatar } from "./user-profiles-oLBI9gsy.js";
import { c as classifyTailscaleLogin, i as prepareUserProfileRoleAuthority } from "./user-channel-identity-operations-_TkW3mpq.js";
...
import { a as isLoopbackAddress, c as isPrivateOrLoopbackAddress, d as isTrustedProxyAddress, i as isLocalishHost } from "./net-DLTbz3sZ.js";
import { t as normalizeControlUiBasePath } from "./control-ui-shared-BiO6QP54.js";
import { h as resolveDeviceAuthConnectErrorDetailCode, i as buildPairingConnectErrorMessage, m as resolveAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-tmXBi5gw.js";
...
import { a as onOperatorRolePolicyChanged, f as resolveOperatorRolePolicyForAssignment } from "./operator-role-policy-gPgbkoHA.js";
...
import { t as resolveIdentityOperatorScopes } from "./operator-identity-scopes-IJD0CgVb.js";
import { n as captureGatewayDeviceRevocation } from "./device-revocation-BGfJjW3h.js";
...
import { i as TALK_PTT_COMMANDS, n as IOS_WATCH_RELAY_COMMANDS, r as PLATFORM_DEFAULTS, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-D1CEhJWf.js";
import { t as resolveEffectiveComputerUseDescriptor } from "./node-computer-use-descriptor-D_tS4bop.js";
import { r as serializeEventPayload } from "./node-registry-anoqVA6x.js";
import { r as classifyGatewayStaleInstall } from "./stale-install-Cz6VHd9H.js";
import { a as verifyAgentRuntimeIdentityToken } from "./agent-runtime-identity-token-DB94ummf.js";
import { n as isOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token--E4Uo0PU.js";
...
import { a as registerGatewayPolicyResponse, i as onGatewayPolicyClientInvalidated, r as invalidateGatewayPolicyClient, t as hasCurrentGatewayPolicyClientSource } from "./ws-policy-close-kVVlCuV_.js";
import { t as SharedGatewaySessionGenerationState } from "./server-shared-auth-generation-CPSQNwFX.js";
import { r as bindWebSocketRequestMutationAuthority } from "./session-mutation-guards-EqzBBshC.js";
import { n as resolveControlUiLinkLocation } from "./control-ui-link-base-DzGGlGmD.js";
import { n as resolveGatewayAgentSelectionState } from "./agent-list-C7FjDSZV.js";
import { a as listControlUiPluginWidgetKinds, i as listControlUiPluginTabs, t as listControlUiLinkReaders } from "./control-ui-plugin-tabs-3aTzPb2k.js";
import { C as authenticatedProfileUnavailableError, t as allowedSessionVisibilities } from "./session-sharing-policy-rVme8bnl.js";
import { n as createExpectedProfileBinding, r as prepareGatewayRecipientProfile } from "./expected-profile-DRRHY4tb.js";
import "./session-sharing-xa1VG8U2.js";
import { n as loadVoiceWakeConfig } from "./server-utils-CvEJ_kDk.js";
...
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./remote-BqP6PO5r.js";
import { i as listEffectivePairedDeviceRoles, n as hasEffectivePairedDeviceRole, r as listApprovedPairedDeviceRoles } from "./device-pairing-identity-BcalhkNq.js";
import { f as requestNodePairing, n as beginNodePairingConnect, o as recordPairedNodeConnection, r as finalizeNodePairingCleanupClaim, t as approveNodePairing, u as releaseNodePairingCleanupClaim } from "./device-pairing-node-D3__zSdN.js";
import { i as verifyDeviceToken, t as ensureDeviceToken } from "./device-pairing-tokens-BsZmSIcr.js";
import { d as updatePairedDeviceMetadata, i as listDevicePairing, o as pruneSupersededSilentPairedDevices, t as getPairedDevice, u as requestDevicePairing } from "./device-pairing-CHVB12nQ.js";
import { c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, o as AUTH_RATE_LIMIT_SCOPE_NODE_PAIRING } from "./auth-rate-limit-CAtkUs0M.js";
import { n as PROXY_ATTRIBUTION_REQUIRED_REASON } from "./ingress-attribution-AXzxarHX.js";
import { n as isGatewayHostBrowserOrigin, r as normalizeChromeExtensionOrigin } from "./origin-check-CI0MDeEk.js";
import { n as withSerializedRateLimitAttempt, t as withSerializedCredentialFallbackAttempt } from "./rate-limit-attempt-serialization-CBcdHXbk.js";
...
import { n as logWs, t as formatForLog } from "./ws-log-CZGKk4Rg.js";
...
import { a as resolveBrowserAuthOrigin } from "./provider-browser-auth-DQZUXef-.js";
import { a as getBoundDeviceBootstrapProfile, d as restoreGenericDeviceBootstrapToken, f as verifyDeviceBootstrapToken, i as getBoundDeviceBootstrapContext, u as redeemDeviceBootstrapTokenProfile } from "./device-bootstrap-BbNakzE6.js";
import { n as approveDevicePairing, t as approveBootstrapDevicePairing } from "./device-pairing-approval-DU5Ougtr.js";
import { t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-8h6ci4pP.js";
import { r as resolveChatAttachmentPolicy } from "./chat-attachment-policy-C3tsxS7F.js";
import { r as prepareGatewayLocalUserIngress, t as attachGatewayLocalUserIngress } from "./local-user-ingress-Cd2IWSaH.js";
import { n as parseGatewayRole, r as roleCanSkipDeviceIdentity } from "./role-policy-D90Ep5US.js";
import { i as upsertPresence } from "./system-presence-B2UbZ4Wg.js";
import { a as canReadDetailedUpdateMetadata } from "./events-CAEUKvkp.js";
import { n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-C05tfpvN.js";
...
import { t as resolveLocalNodeId } from "./local-id-Cdk2zX2i.js";
import { a as mintPluginNodeCapabilityToken, d as resolvePluginNodeCapabilityExpiresAtMs, i as indexPluginNodeCapabilitySurfaces, p as setClientPluginNodeCapability, t as buildPluginNodeCapabilityScopedHostUrl } from "./plugin-node-capability-Dd8ciJ4U.js";
import { t as broadcastPresenceSnapshot } from "./presence-events-B-BwZnK6.js";
import { t as buildAuthenticatedPresenceUser } from "./authenticated-presence-user-D9ZcZCVC.js";
import { a as scheduleNodeConnectionNotification, o as retireDeviceTokenClients, r as resolveGatewayWsBrowserOrigin, t as checkGatewayWsBrowserOrigin } from "./ws-origin-policy-DCOP8Oiy.js";
import { t as truncateCloseReason } from "./close-reason-C2Y4g2RQ.js";
import { a as HandshakeAuthLogLimiter, i as rawDataByteLength, n as createGatewayRpcDiagnostics, o as buildHandshakeAuthLogKey, s as shouldLimitMissingCredentialAuthLog } from "./request-diagnostics-Ck2Ujtll.js";
import { a as consumeSetupHandoff, c as isNativeAppUiClient, d as resolvePairingLocality, f as resolveUnauthorizedHandshakeContext, h as shouldSkipLocalBackendSelfPairing, i as confirmSetupHandoffDelivery, l as resolveDeviceSignaturePayloadVersion, m as shouldPreserveLocalCliSharedAuthScopes, n as broadcastSetupHandoffCompletion, o as resolveConnectAuthDecision, p as shouldAllowSilentLocalPairing, r as broadcastSetupHandoffDeliveryUncertain, s as resolveConnectAuthState, t as reconcileNodePairingOnConnect, u as resolveHandshakeBrowserSecurityContext } from "./node-connect-reconcile-CZuKaAWQ.js";
...
const loadGatewayServerMethods = createLazyPromise(() => import("./authenticated-request-dispatch.server-methods.runtime-CPXNLNIQ.js"));
