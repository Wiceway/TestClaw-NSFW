...
import { i as getGatewayContextLifetime, r as getCanonicalGatewayContextResolver } from "./gateway-context-binding-Cy-ZcQj8.js";
import { a as READ_SCOPE, d as isOperatorScope, t as ADMIN_SCOPE, u as WRITE_SCOPE } from "./operator-scopes-D-CL26h0.js";
import { s as projectOperatorScopesForMethod } from "./method-scopes-D0hbLMo0.js";
...
import { n as authorizeGatewaySessionCreation, u as resolveGatewayOperatorRoleActor } from "./operator-role-policy-gPgbkoHA.js";
...
import { a as readInProcessSubagentResume, i as bindInProcessSubagentResume, n as mergePluginRuntimeClientInternal, t as createSyntheticPluginRuntimeClient } from "./server-plugin-runtime-client-B4BzDaVD.js";
import { t as captureGatewayOperatorRunAuthority } from "./operator-run-authority-H3Zmpcg0.js";
import { i as unwrapGatewayMethodDispatchResponse, n as dispatchGatewayRequestInProcessRaw, r as throwIfGatewayDispatchAborted } from "./server-in-process-dispatch-DVz377la.js";
import { r as registerSubagentCompletionToolHandoff, t as cancelSubagentCompletionToolHandoff } from "./subagent-completion-tool-handoff-zQCxVtB0.js";
...
function prepareInProcessAgentExecution(params) {
	...
	return {
		...
		async authorize() {
			assertLifetime();
			const { authorizeGatewayRequestPreDispatch, createRequestGatewayMethodRegistry } = await import("./server-methods-BJBUEtdd.js");
			assertLifetime();
