import { t as DEFAULT_GATEWAY_REQUEST_TIMEOUT_MS } from "./timeouts-Bm8XlcCK.js";
...
import { i as registerGatewayRecoveryRuntime } from "./server-recovery-runtime-context-BJDQV0nt.js";
import { t as createSyntheticPluginRuntimeClient } from "./server-plugin-runtime-client-B4BzDaVD.js";
import { t as dispatchGatewayRequestInProcess } from "./server-in-process-dispatch-DVz377la.js";
...
import { t as createApprovalNativeRouteCoordinator } from "./approval-native-route-coordinator-BYaMnzf6.js";
import { t as createTypingCallbacks } from "./typing-B0J6DlW0.js";
import "./agent-job-DFmcvi7C.js";
import { t as createInternalAgentTurnFacade } from "./internal-facade-FjfwYPC3.js";
import { t as GATEWAY_NATIVE_APPROVAL_METHODS } from "./approval-gateway-runtime-methods-9ZecnqvZ.js";
	...
	return {
		start(params) {
			...
			(async () => {
				...
				const [adapter, { resolveAgentConfig }] = await Promise.all([options.resolveAdapter(params.channel), import("./agent-scope-config-DjAEl3pT.js")]);
...
const loadRecoveryTypingAdapter = createLazyRuntimeModule(() => import("./plugins-DE1tLQ6e.js"));
const loadOutboundMessageRuntime = createLazyRuntimeModule(() => import("./message-C2C1rYnr.js"));
