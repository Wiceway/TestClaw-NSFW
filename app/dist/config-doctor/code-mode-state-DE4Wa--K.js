...
import { E as resolveExpiresAtMsFromDurationSeconds, h as isFutureDateTimestampMs } from "./number-coercion-0M4tZV2c.js";
...
import { s as isToolExecutionAllowed, t as TOOL_EXECUTION_GATED_MESSAGE } from "./tool-policy-shared-CvUcH_7-.js";
import { p as onAgentEventForRun } from "./agent-events-CFq48PcN.js";
import { n as CODE_MODE_WAIT_TOOL_NAME, t as CODE_MODE_EXEC_TOOL_NAME } from "./code-mode-control-tools--dZmMBiE.js";
import { d as captureAgentPluginRuntimeRefresh, r as getBeforeToolCallFailureDisposition } from "./agent-tools.before-tool-call-BwZqazXs.js";
import { n as ToolInputError, r as isTrustedToolInputError } from "./tool-input-error-mjW74R8m.js";
import { t as consumeMcpCodeModeGuestResult } from "./mcp-content-Dl9PUDjg.js";
...
import { a as toCodeModeJsonSafe, r as boundCodeModeError } from "./code-mode-json-OfGm-ziD.js";
import { o as toolSchemaDeclaration, s as createCodeModeResultsAccess, t as getToolContractFailureCode } from "./tool-contract-error-B3_K2-G0.js";
import { r as readToolOutputSchemaVariants } from "./tool-output-schema-Ct2l6sR_.js";
import { i as isCollectorSpawnTool } from "./swarm-collector-capability-B6P9ecYw.js";
import { n as decodeSkillXml } from "./skill-contract-C0RMAf9Y.js";
import { t as parseNodeList } from "./node-list-parse-B-QeHrg4.js";
import { t as raceWithAbortSignal } from "./agent-tools.abort-Li6-S9bV.js";
...
async function createCodeModeToolApiFile(callableName, entry) {
	...
	let optional = false;
	if (trusted) {
		const { validateJsonSchemaValue } = await import("./schema-validator-CiznNKVh.js");
		try {
...
const loadSwarmHandlers = createLazyRuntimeNamedExport(() => import("./code-mode-swarm.runtime-CqZbidHz.js"), "codeModeSwarmHandlers");
