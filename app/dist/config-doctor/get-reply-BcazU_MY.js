...
import { M as resolveTimerTimeoutMs, O as resolveIntegerOption, S as parseStrictPositiveInteger, a as asDateTimestampMs, m as finiteSecondsToTimerSafeMilliseconds, n as MAX_TIMER_TIMEOUT_MS } from "./number-coercion-0M4tZV2c.js";
import { d as normalizeStringEntries, i as normalizeAtHashSlug, y as uniqueStrings } from "./string-normalization-DsCfAx8q.js";
import { r as truncateUtf16Safe } from "./utf16-slice-D_ngcYKd.js";
import { n as createLazyPromise, r as createLazyPromiseLoader, t as createLazyImportLoader } from "./lazy-promise-DGqyc4Y4.js";
...
import { i as normalizeChatChannelId, n as CHAT_CHANNEL_ORDER } from "./ids-Bp7HxmUs.js";
import { a as resolveAgentDir, d as resolveAgentWorkspaceDir, k as listAgentEntries, n as isImplicitAcpWorkspaceCandidate, r as resolveAgentConfig, u as resolveAgentRunCwd } from "./agent-scope-config-BEuqweC1.js";
...
import { l as MESSAGE_TOOL_ONLY_DELIVERY_HINT } from "./strip-inbound-meta-Bb3_IiBS.js";
import { a as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as isSilentReplyText } from "./tokens-BbfKzfAT.js";
import { n as WorkspaceAliasRepointedError, r as WorkspaceVanishedError } from "./workspace-state-identity-hLL0vTIh.js";
import { c as isDiagnosticFlagEnabled, o as measureDiagnosticsTimelineSpan } from "./diagnostics-timeline-DDShltPN.js";
import { r as logVerbose } from "./globals-NNTJbzqD.js";
import { c as resolveSessionFilePathOptions, l as resolveSessionStorePathCore, s as resolveSessionFilePathCore } from "./paths-ViQaz2td.js";
import { J as resolveOwnerPromptNumbers } from "./io.snapshot-Dbj6l_ZW.js";
...
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-BbU4k6fu.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-BIKs-96s.js";
import { v as resolveModelRefFromString } from "./model-selection-shared-YvCZW05m.js";
import { E as hasSessionAutoModelFallbackProvenance, N as resolveCollapsedSessionAuthPinSource, _ as resolveSessionAgentId, f as resolveAgentSkillsFilter, p as resolveAutoFallbackPrimaryProbe, r as hasLegacyAutoFallbackWithoutOrigin, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-BiRi-Smp.js";
import { a as normalizeElevatedLevel, c as normalizeTraceLevel, i as isSessionDefaultDirectiveValue, o as normalizeReasoningLevel, s as normalizeThinkLevel, u as normalizeVerboseLevel } from "./thinking.shared-DJ5AX7RA.js";
import { c as resolveContextConfigProviderForRuntime } from "./openai-routing-BXJ-qR2p.js";
import { i as isWorkspaceBootstrapPending, t as ensureAgentWorkspace } from "./workspace-_6eikbXk.js";
...
import { t as findChatChannelMeta } from "./chat-meta-q64Qbd4g.js";
import { r as getRuntimeConfig } from "./io.runtime-C0vFx1Ic.js";
import "./config-CiBXBfE2.js";
import { n as canonicalizeMainSessionAlias } from "./main-session-DzZK9knv.js";
import "./heartbeat-CZVa2fL6.js";
import { r as resolveInternalTurnTranscript } from "./conversation-label-BR8cc3ny.js";
...
import { c as normalizeSessionDeliveryState, n as deliveryContextKey, o as normalizeDeliveryChannelRoute, s as normalizeDeliveryContext } from "./delivery-context.shared-DQinGDrS.js";
...
import { ht as conversationRouteContextFromMsgContext, kt as deriveSessionMetaPatch, mt as conversationIdentityFromMsgContext } from "./session-accessor.sqlite-entry-store-BzD1qpup.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-BYC4PoOZ.js";
import { E as resolveSessionStorePathForScope, O as sessionEntryForkedFromParent, s as loadSessionEntry } from "./session-accessor.sqlite-entry-CJ8WVyje.js";
import { S as runExclusiveSessionStoreWrite, f as interruptSessionWorkAdmissions, g as runExclusiveSessionLifecycleMutation, l as getSessionWorkAdmissionOwnerRelease } from "./session-lifecycle-admission-7kJ3kdsZ.js";
...
import { n as buildSessionCreationStamp, s as sessionPersonalProfileId } from "./session-entry-provenance-DvvCadpW.js";
import { a as hasStagedMediaFacts, l as normalizeMediaFacts, o as isImageMediaFact } from "./media-facts-CfqEsuNX.js";
import { O as loadTranscriptEventsSync, Q as selectVisibleTranscriptEvents } from "./session-accessor.sqlite-transcript-store-BX2GNujg.js";
...
import { t as DEFAULT_RESET_TRIGGERS } from "./types-BhbLC9G7.js";
import "./session-accessor-DMf92PxK.js";
import { l as updateSessionEntry, n as commitReplySessionInitialization, r as loadReplySessionInitializationSnapshot, x as selectSessionModelOverride } from "./session-accessor.reset-Cl1Mir1u.js";
import { l as resolveAgentHarnessSessionContextError } from "./agent-harness-session-key-Bbf-OONo.js";
import { i as ModelSelectionLockedError, r as MODEL_SELECTION_LOCKED_RESET_MESSAGE, s as isModelSelectionLocked, t as MODEL_SELECTION_LOCKED_MESSAGE } from "./model-overrides-D92VyxpR.js";
...
import { n as getCliSessionBinding, t as clearAllCliSessions } from "./cli-session-binding-DqRmdzvi.js";
import { g as registerMainSessionGroupWatch, n as classifySessionStateActor, t as acknowledgeSessionStateNotices, w as decodeSessionStateNoticeContextKey } from "./session-state-events-CHD4f1I_.js";
import { n as enqueueSystemEvent, o as peekSystemEventEntries, t as consumeSelectedSystemEventEntries } from "./system-events-BUr4KJmI.js";
import { n as appendChannelPromptContext } from "./channel-prompt-context-BgpVDndp.js";
import "./history-DNG_z37D.js";
import { C as resolveReplyCompletion, b as resolveSilentReplySettings, h as isInternalSourceReplyChannel, v as resolveSourceReplyExpectation, x as isSyntheticSourceReplyTurn } from "./task-notification-routing-CYDaelCz.js";
import { a as annotateInterSessionPromptText, c as hasInterSessionUserProvenance, d as isInterSessionInputProvenance } from "./input-provenance-DGaz_sh7.js";
import { a as isNativeCommandTurn, c as resolveCommandTurnContext, i as isExplicitCommandTurn, l as resolveCommandTurnTargetSessionKey, o as isTextSlashCommandTurn, r as isAuthorizedTextSlashCommandTurn } from "./command-turn-context-CmPEYNmV.js";
import { d as fireAndForgetHook, f as formatHookErrorForLog, y as getGroupThreadTurn } from "./hooks-CL-Rsbd9.js";
...
import { t as hasControlCommand } from "./command-detection-B0wcgFdq.js";
import { a as normalizeGroupActivation } from "./commands-registry.data-C3W8E-Ao.js";
import { f as resolveThinkingSelectionForModel, n as formatThinkingLevels, r as isThinkingLevelSupported } from "./thinking-0TzFLcYt.js";
import { t as isCommandEnabled } from "./commands-registry-list-CD-Rd_uT.js";
...
import { a as copyReplyPayloadMetadata, x as markReplyPayloadForSourceSuppressionDelivery, y as markCommandReplyForDelivery } from "./reply-payload-Ds4kei43.js";
...
import { r as sanitizeModelSpecialTokens } from "./external-content-CpqslxXH.js";
import "./agent-bundle-mcp-tools-DL_tAGSg.js";
import { n as classifyHeartbeatPendingFinalDelivery, r as sanitizePendingFinalDeliveryText, t as PENDING_FINAL_DELIVERY_CLEAR_PATCH } from "./pending-final-delivery-state-B6oYoz1h.js";
import { d as resolveChannelResetConfig, f as resolveSessionResetType, p as resolveThreadFlag } from "./sessions-4kX-llHk.js";
import { c as isRestartRecoveryTombstone, d as resolveSessionWorkStartError, l as isSessionWorkStartInvalidatedError, o as hasTerminalMainSessionTranscriptNewerThanRegistry, u as resolveSessionLifecycleTimestamps } from "./lifecycle-DpcRUIUy.js";
import { c as resolveSessionParentSessionKey } from "./delivery-info-B5Y1TlNL.js";
import { i as resolveSessionResetPolicy, r as evaluateSessionFreshness } from "./entry-freshness-WwtUSunX.js";
import { n as resolveSessionKey } from "./session-key-DDv-cbQO.js";
import { t as resolveAgentHarnessPolicy } from "./policy-DkYYnWfL.js";
import { _ as copyChannelParticipantAdmissionEvidence, f as readSessionInputProfileId, l as isSessionPersonalBootstrapTurn, u as prepareChannelParticipantObservation, y as readChannelContextAdmissionEvidence } from "./runtime-CmHwV-9X.js";
import { c as bindCommandOwnerAuthority, s as shouldUseFromAsSenderFallback, t as isConfiguredCommandOwner, u as getCommandOwnerAuthority } from "./command-auth-DG4f34BV.js";
import { n as clearCommandLane, o as getQueueSize } from "./command-queue-BKEY7Dlw.js";
...
import { n as hasResolvedThinkingCatalogEntry, o as resolveEffectiveAgentRuntime } from "./thinking-runtime-DiGMOYgI.js";
import { t as resolveHookConfig } from "./policy-CborS2Xj.js";
import { t as MAIN_SESSION_RECOVERY_WORK_ADMISSION_OWNER } from "./main-session-recovery-admission-Du-SOjwy.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-DW27nR9p.js";
import { t as resolveChannelModelOverride } from "./model-overrides-DGdOTFgJ.js";
import { n as resolveStoredModelOverride } from "./stored-model-overrides-CP51vjqV.js";
...
import { i as resolveTurnModelOverride, t as resolveSessionStableReplyMode } from "./session-stable-reply-mode-Ck1Q-Nji.js";
...
import { n as clearBootstrapSnapshotOnSessionBoundary } from "./bootstrap-cache-CEXmU8a0.js";
import "./cli-session-BGcKF-Kc.js";
import { d as isFreshChannelCronAuthorityTurn, f as runWithCronCreatorAuthorityCapability, u as createCronCreatorAuthorityCapability } from "./cron-creator-authority-context-v85EkXJb.js";
import { i as withPreparedModelRuntimePluginGenerationScope } from "./prepared-model-runtime-generation-scope-Dbh_MtQt.js";
import { n as hasInboundMedia, r as hasInboundMediaForUnderstanding, t as hasInboundAudio } from "./inbound-media-b-kCcwh2.js";
import { n as buildChannelUserTurnSender } from "./user-turn-transcript.metadata-BAAmUJGD.js";
...
import { i as resolveBootstrapMode } from "./skill-workshop-workspace-context-BUfqeeR8.js";
import { t as appendCurrentInboundContext } from "./runtime-context-prompt-B-jR1a9s.js";
...
import { t as resolveEffectiveToolFsRootExpansionAllowed } from "./tool-fs-policy-DYTzi15n.js";
import "./sandbox-w882SIpU.js";
import { t as buildInboundMediaNoteProjection } from "./media-note-DMU_fCWz.js";
import { c as resolvePersistedUserTurnText } from "./user-turn-transcript.message-W5Lni2jm.js";
...
import { r as projectConversationToolNames } from "./conversation-tool-policy-pipeline-BklTZ6p6.js";
import { o as formatSingleUnitDuration } from "./format-duration-CeDWULoS.js";
import { r as isCommandBearingToolCall } from "./tool-display-BtDuD-A6.js";
import { t as collectTextContentBlocks } from "./content-blocks-DRK0dze4.js";
import { i as deriveInboundMessageHookContext, l as toInternalMessageTranscribedContext, o as toInternalMessagePreprocessedContext } from "./delivery-queue-reconciliation-DmfgEjwu.js";
import { t as finalizeInboundContext } from "./inbound-context-DWtLx7J6.js";
import { d as isChannelProgressDraftWorkToolName } from "./streaming-PVbiPLhy.js";
import { Y as REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS, _ as resolveActiveReplyRunSessionId, c as interruptReplyRunTarget, h as replyRunRegistry, u as isReplyRunActiveForSessionId, v as resolveActiveReplyRunThreadId, x as waitForReplyRunEndBySessionId } from "./reply-run-registry.registry-HFAU31nF.js";
...
import { n as normalizeQueueDropPolicy, r as normalizeQueueMode } from "./settings-s5_14LyX.js";
import { i as getExistingFollowupQueue } from "./state-uhBkFAkN.js";
import { r as resolveStickyModelSelectionScope } from "./sticky-model-selection-B1bMZDjc.js";
import { u as revokeRequesterCronAuthority } from "./requester-final-attachment-DSeQfLmW.js";
import { i as resolveUserTimezone, t as formatDateStamp } from "./date-time-BxM1pkzX.js";
import { a as resolveTimezone, n as formatUtcTimestamp, r as formatZonedTimestamp } from "./format-datetime-CSLJIAzN.js";
import { t as appendCronStyleCurrentTimeLine } from "./current-time-CxJ5Rrrs.js";
...
import { n as resolveModelRuntimeDirective } from "./directive-handling.model-runtime-CTSNgFzh.js";
import { t as ensureSessionDiffBaseline } from "./session-diff-baseline-DrE-yO8_.js";
import "./config-D2F1t3ts.js";
...
import { a as buildSessionStartHookPayload, i as buildSessionEndHookPayload, o as resolveExplicitSessionEndReason, r as noteActiveSessionForShutdown, s as resolveStaleSessionEndReason, t as forgetActiveSessionForShutdown } from "./active-sessions-shutdown-tracker-DIgXoebl.js";
import { n as createSourceReplyDeliveryRuntime, t as bindSourceReplyDeliveryRuntime } from "./source-reply-delivery-runtime-CxW5X9hr.js";
import { t as runIsolatedCompletion } from "./isolated-completion-BLdidIHd.js";
import { t as resolveBlockStreamingChunking } from "./block-streaming-D6uVBnnZ.js";
...
import { a as createReplySessionEntryHandle, c as admitReplyTurn, d as isSlackDirectRoutedThreadTurn, f as resolveRoutedDeliveryThreadId, o as createReplyTimingTracker, r as withExtractedFileImages, s as isReplyProfilerEnabled, t as prepareInternalGetReplyOptions } from "./get-reply.types-dxfJo32O.js";
import { a as shouldUseReplyFastTestRuntime, d as canReplaceRestartTombstoneFromParent, f as prepareReplySessionParentFork, g as resolveBoundAcpSessionForCommandReset, i as shouldUseReplyFastTestBootstrap, l as getPreparedReplyDispatchRuntime, m as assertPreparedConversationBindingRouteCurrent, n as initFastReplySessionState, r as resolveGetReplyConfig, s as stageRemoteInboundMediaIfNeeded, t as resolveRunTypingPolicy, u as resolveAuthorizedSessionResetCommand, v as resolveSessionConversationBinding, y as resolveSessionDefaultAccountId } from "./typing-policy-CFAgLygL.js";
import { a as recordReplyPreRunRejection, n as resolveEffectiveReplyRoute, s as resolveReplyOperationRunState } from "./effective-reply-route-XkUfd_HO.js";
import { t as getReplySystemEventContext } from "./system-event-session-key-DEc-8EhH.js";
import { s as takeCommandSessionMetadataChangesFromTargets } from "./commands-goal-B96ZPlKo.js";
...
import { a as resolveReplyToMode } from "./reply-threading-D21jua_A.js";
...
import { a as isExecCompletionEvent, c as prepareReplyConversation, l as resolveDefaultModel } from "./heartbeat-events-filter-ClDh70Bb.js";
import { r as resolveActiveExplicitSteerSessionKey, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-D8l3WE-c.js";
import { a as mergeExplicitSkillSelections, i as listReservedChatSlashCommandNames, n as expandExplicitSkillReferences, o as resolveSkillCommandInvocation, r as hasSkillReferenceCandidate, s as skillCommandsToExplicitSelections, t as expandBundleCommandPromptTemplate } from "./chat-command-invocation-D6fN2e7X.js";
import { _ as resolveModelSelectionFromDirective, b as maybeHandleUnexpectedDirectiveArguments, f as formatModelSelectionScopeAck, v as createModelSelectionState, y as isStaleHeartbeatAutoFallbackOverride } from "./directive-handling.shared-CqZ1dIV0.js";
...
import { n as isAbortRequestText, r as setAbortMemory, t as getAbortMemory } from "./abort-primitives-WW-13sK4.js";
...
import { i as resolveReplyQueueAdmissionState, n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-C8RKWV9K.js";
import { t as buildChannelSummary } from "./channel-summary-DDUAygdz.js";
import { r as resolveEnvelopeFormatOptions } from "./envelope-E-FBLYkh.js";
import { a as resolveInboundUserContextPromptJoiner, n as buildInboundUserContextPrefix, r as formatActiveGoalContext, t as buildInboundMetaSystemPrompt } from "./inbound-meta-DxEwMn-3.js";
import { r as resolveEffectiveToolInventory, t as acquireEffectiveToolInventoryRuntimeModelContext } from "./tools-effective-inventory-ojhwpjs7.js";
import { t as resolveCurrentTurnImages } from "./current-turn-images-C7kZepQy.js";
import { n as flushSessionActivityAssistantNote, r as noteSessionActivityEvent, t as createSessionActivityNoteState } from "./session-activity-notes-DTgk9WCX.js";
import { t as PROGRESS_STATUS_PREAMBLE_FRESH_MS } from "./progress-draft-compositor-WJYGGpAt.js";
import { a as sanitizeProgressStatusText } from "./progress-draft-status-text-DTdEmkAX.js";
import { a as clearSessionResetRuntimeState, i as SessionResetCleanupError, o as createSessionResetCleanupGuard, s as stopSessionResetSubagents, t as emitSessionAutoResetHook } from "./session-auto-reset-BdZWTYSE.js";
...
import { n as readBeforeResetMessages } from "./commands-reset-hooks-tAifXohw.js";
import { n as runWithSessionInitConflictRetry, t as ReplySessionInitConflictError } from "./session-init-conflict-retry-Q67G6Tdm.js";
...
const commandsStatusLoader = createLazyImportLoader(() => import("./commands-status.runtime-CvNP3AQq.js"));
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-BMu2hAEE.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-D_KKozQA.js"));
const directivePersistLoader = createLazyImportLoader(() => import("./directive-handling.persist.runtime-C9A56tNI.js"));
...
const groupsRuntimeLoader = createLazyImportLoader(() => import("./groups.runtime-cHgLtR8f.js"));
...
const commandsRegistryLoader = createLazyImportLoader(() => import("./commands-registry.runtime-D7vw9Eva.js"));
const skillCommandsLoader = createLazyImportLoader(() => import("./chat-commands.runtime-BVCQKZUX.js"));
...
const skillCommandsRuntimeLoader$1 = createLazyImportLoader(() => import("./chat-commands.runtime-BVCQKZUX.js"));
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-BbIR5ZwD.js"));
const abortCutoffRuntimeLoader = createLazyImportLoader(() => import("./abort-cutoff.runtime--lXE8-67.js"));
const commandsRuntimeLoader$1 = createLazyImportLoader(() => import("./commands.runtime-C0loqsmr.js"));
...
async function handleInlineActions(params) {
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const dependencies = params.skillToolDispatchDependencies ?? await import("./testclaw-tools-CU2Fgxqi.js");
...
const commandsRuntimeLoader = createLazyImportLoader(() => import("./commands.runtime-C0loqsmr.js"));
const skillCommandsRuntimeLoader = createLazyImportLoader(() => import("./chat-commands.runtime-BVCQKZUX.js"));
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-D_0nnh-A.js"));
...
const mediaUnderstandingApplyRuntimeLoader = createLazyImportLoader(() => import("./apply.runtime-CeE4XdsG.js"));
const linkUnderstandingApplyRuntimeLoader = createLazyImportLoader(() => import("./apply.runtime-CChWskO0.js"));
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent.runtime-D6i3WC81.js"));
const agentRunnerRuntimeLoader = createLazyImportLoader(() => import("./agent-runner.runtime-DG1agiZq.js"));
const sessionUpdatesRuntimeLoader = createLazyImportLoader(() => import("./session-updates.runtime-CcHpCuvK.js"));
...
async function runPreparedReply(params) {
	try {
		...
		const { acquireAgentRunPreparedModelRuntime } = await import("./prepared-model-runtime-DBXu5YaT.js");
...
const loadDeliverRuntime = createLazyPromiseLoader(() => import("./runtime-D6O3gAHo.js"), { cacheRejections: true }).load;
...
const sessionResetModelRuntimeLoader = createLazyImportLoader(() => import("./session-reset-model.runtime-B2wPoAcn.js"));
const stageSandboxMediaRuntimeLoader = createLazyImportLoader(() => import("./stage-sandbox-media.runtime-6IpO3vCV.js"));
const replyResolverTimingLog = createSubsystemLogger("auto-reply/reply-resolver-timing");
const commandsCoreRuntimeLoader = createLazyImportLoader(() => import("./commands-core.runtime-DGv78o0V.js"));
...
async function getReplyFromConfig(ctx, options, configOverride) {
	...
	try {
		workspace = await traceGetReplyPhase("reply.ensure_workspace", async () => useFastTestBootstrap ? (await fs$1.mkdir(workspaceDirRaw, { recursive: true }), { dir: workspaceDirRaw }) : await ensureAgentWorkspace({
			...
			provisioning: await (await import("./acp-workspace-provisioning-m9Gy0l-a.js")).resolveAcpAgentWorkspaceProvisioningForTurn(acpWorkspaceProvisioningInput)
		}));
	} catch (error) {
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, 300).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionEntry } = await import("./session-accessor-BeRUNjQG.js");
