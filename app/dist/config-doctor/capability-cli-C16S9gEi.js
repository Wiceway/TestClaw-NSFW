...
import { h as normalizeRootLogLevelArgv, n as getCommandPathWithRootOptions } from "./argv-zmtAhw2-.js";
import { r as providerSummaryText, t as emitJsonOrText } from "./output-D5mZF4lu.js";
...
const capabilityCommandGroups = [
	["model", async () => (await import("./model-CIbk6wwp.js")).registerModelCapabilityCommands],
	["image", async () => (await import("./image-X_tztHA8.js")).registerImageCapabilityCommands],
	["audio", async () => (await import("./audio-BgX7ufIt.js")).registerAudioCapabilityCommands],
	["tts", async () => (await import("./tts-U7mytRmo.js")).registerTtsCapabilityCommands],
	["video", async () => (await import("./video-CRrWBTZb.js")).registerVideoCapabilityCommands],
	["web", async () => (await import("./web-DM9qtQmk.js")).registerWebCapabilityCommands],
	["embedding", async () => (await import("./embedding-BMrLyxXa.js")).registerEmbeddingCapabilityCommands]
];
