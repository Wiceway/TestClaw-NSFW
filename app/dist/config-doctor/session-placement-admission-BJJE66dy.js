...
import { T as retainQueuedAgentRunContext, s as getActiveAgentRunDelegatedAuthority } from "./agent-run-registry-DbPiDevk.js";
import { n as captureAgentRunLifecycleGeneration, t as assertAgentRunLifecycleGenerationCurrent } from "./agent-events-CFq48PcN.js";
import { f as resolveAdmittedRunActiveAssertion } from "./admitted-run-context-BE5EAdRS.js";
import { c as createSessionPlacementSettlementClosedAbortError } from "./run-termination-Ig3BzvZQ.js";
import { f as isMainSessionRestartRecoveryInputProvenance } from "./input-provenance-DGaz_sh7.js";
import { t as DEFAULT_AGENT_TIMEOUT_MS } from "./timeout-CchFM1Z3.js";
import { n as recordModelFallbackStop } from "./model-fallback-stop-iEWdge8e.js";
import "./failover-error-D845uGox.js";
import { c as isCommandLaneTaskMarkerCurrent, r as enqueueCommandInLane } from "./command-queue-BKEY7Dlw.js";
...
import { n as hasCompletionMessageSessionSpawn, r as mergeAcceptedSessionSpawnsForRun } from "./accepted-session-spawn-DkICVXqZ.js";
import { H as registerReplyOperationSuccessorBarrier } from "./reply-run-registry.registry-HFAU31nF.js";
import "./reply-run-registry-Cvzq21q7.js";
import { i as withoutSessionPlacementForcedTerminalSettlement, n as resolveSessionPlacementTurnSettlementAssertion, t as resolveSessionPlacementForcedTerminalSettlement } from "./session-placement-forced-terminal-settlement-IJxHlJBn.js";
import { O as settleRequesterAfterSessionSpawns, g as markRequesterTurnYielded } from "./subagent-registry-CW6ZXPPf.js";
...
//#endregion
export { resolveSessionPlacementSandbox as a, EMBEDDED_RUN_LANE_TIMEOUT_GRACE_MS as c, shouldNoteLaneWait as d, withEmbeddedRunLaneTimeout as f, resolveSessionPlacementRuntimeOverride as i, resolveEmbeddedRunLaneTimeoutMs as l, settleRequesterRun as m, installSessionPlacementAdmissionProvider as n, withLocalSessionPlacementTurnSettlement as o, settleFailedRequesterRun as p, recoverTerminalSessionPlacementTurn as r, withSessionPlacementTurnAdmission as s, captureSessionPlacementCompactionSuccessorAssertion as t, resolveEmbeddedRunSessionLanePolicy as u };
