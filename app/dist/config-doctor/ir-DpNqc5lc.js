import { c as visibleWidth, d as eastAsianWidthType } from "./ansi-CWsy0bu4.js";
...
function findAssistantTranscriptRoleHeaderSpans(text, excludedRanges = []) {
	...
	while (lineStart < text.length) {
		...
		if (span) {
			...
			const excludedRange = sortedExcludedRanges[excludedRangeIndex];
			if (!excludedRange || !rangesOverlap(span, excludedRange)) spans.push(span);
		}
...
//#endregion
export { markdownToIRWithMeta as a, matchMarkdownHtmlTag as c, createStyleSpan as d, mergeAnnotationSpans as f, findAssistantTranscriptRoleHeaderSpans as h, markdownToIR as i, tokenizeHtmlTags as l, copyHtmlTags as m, countMarkdownFencedCodeChars as n, renderMarkdownCodeTable as o, mergeStyleSpans as p, getMarkdownTableSource as r, renderMarkdownTableBullets as s, appendMarkdownIR as t, sliceMarkdownIRRanges as u };
