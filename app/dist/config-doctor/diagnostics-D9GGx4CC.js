...
import { t as STATIC_COMMAND_LANES } from "./lanes-W9o_i0xH.js";
import { a as getCommandLaneSnapshot, d as listCommandLaneTotals } from "./command-queue-BKEY7Dlw.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-DI-nq_eY.js";
import { n as getBackgroundWorkSnapshot, r as isBackgroundWorkLane } from "./background-work-BSUE43Rn.js";
...
const diagnosticsHandlers = {
	"diagnostics.cpuProfile": async ({ req, client, signal, context, respond, hasCurrentClientAuthority }) => {
		...
		const { captureDiagnosticCpuProfile } = await import("./diagnostic-cpu-profile-f2aFeDJI.js");
	...
	"diagnostics.heapProfile": async ({ req, client, signal, context, respond, hasCurrentClientAuthority }) => {
		...
		const hasAuthority = () => !client?.invalidated && (hasCurrentClientAuthority?.() ?? true);
		const { captureDiagnosticHeapProfile } = await import("./diagnostic-heap-profile-Dv1b5AxB.js");
