...
import { d as projectSessionParticipant, h as projectSessionProfileInvolvement, t as projectGatewaySessionActiveRun } from "./session-utils-display-0bRfLd7U.js";
import { E as gatewayClientSessionCreator, n as authorizeIncognitoSessionTarget, y as resolveSessionVisibility } from "./session-sharing-policy-rVme8bnl.js";
import { D as prepareProjectedSessionSharing } from "./session-sharing-xa1VG8U2.js";
...
async function readSessionListRowTitleFields(row, requireOwner) {
	...
	const { readSessionTitleFieldsFromTranscriptAsync } = await import("./session-transcript-title-reader-BLLWFJQW.js");
