...
import { a as routeLogsToStderr, t as enableConsoleCapture } from "./console-CPuEo0lT.js";
...
import { i as isWorkerTranscriptMessageFrameSafe } from "./transcript-message-DAAqfjn2.js";
import { t as NODE_WORKER_CONNECTION_FAILURE_MESSAGE_TYPE } from "./node-supervisor-protocol-CbrvrkkM.js";
...
async function runWorkerDescriptor(descriptor, options = {}) {
	...
	function loadRuntimeImports() {
		const imports = [import("./embedded-agent.runtime-Dym47IkM.js"), import("./inference-stream.runtime-BTpshsNc.js")];
	...
	try {
		...
		const github = descriptor.assignment.github ? await import("./github-binding.runtime-BFwzKCVE.js").then(({ prepareWorkerGitHubEnvironment }) => prepareWorkerGitHubEnvironment({
