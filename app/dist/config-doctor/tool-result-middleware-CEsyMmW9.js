...
import { n as isDeliveredMessagingToolResult } from "./embedded-agent-message-tool-source-reply-CoT7ZR29.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-DRfteSd0.js");
