...
import { r as prepareAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-DMxaESun.js";
import "./provider-auth-choice-preference-BcBlNlGj.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { resolveLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-C7H5iX0O.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-CMFYvANj.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-6UyqmHCJ.js");
	...
	const { resolveDeprecatedProviderInstallCatalogEntry } = await import("./provider-install-catalog-uuE_fFy_.js");
