...
import { i as resolveUtilityModelSeparationError } from "./utility-model-separation-migration-DYgvUenY.js";
...
import { i as resolveManifestProviderAuthChoices, r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-jz5pJx2z.js";
...
import { n as applyProviderPluginAuthMethodResultConfig, r as prepareAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-DMxaESun.js";
import { C as validateSetupModelTarget, a as SetupInferenceCancelledError, g as resolveSetupModel, l as parseInferenceRef, w as waitForProviderAuth, y as throwIfSetupInferenceCancelled } from "./setup-inference-core-BwVzPhCm.js";
import { c as supportsSetupTextInference, s as supportsSetupManualSecret, t as choiceMatchesCredential } from "./setup-inference-auth-options-7rcn86-s.js";
import { n as createQuickstartNotePrompter } from "./setup-apply-CApOVL5Y.js";
import { t as prepareCustomSetupCredentials } from "./setup-inference-custom-BAJ_Ccxr.js";
import { r as projectSetupInferenceConfig } from "./setup-model-selection-BQrQo8Ip.js";
...
async function stageSavedAuthCandidate(ctx, profileId) {
	...
	const materialize = async (loaded) => {
		...
		const { validateConfigObjectRaw } = await import("./validation-core-BUzDN3gt.js");
...
async function stageProviderAuthCandidate(ctx, interactive, agentRuntimeId) {
	...
	if (interactive && authChoice === "custom-api-key") {
		...
		const { promptCustomApiConfig } = await import("./onboard-custom-BMSRIeUQ.js");
