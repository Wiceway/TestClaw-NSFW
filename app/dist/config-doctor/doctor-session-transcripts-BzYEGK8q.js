...
import { c as resolveAgentIdFromSessionKey, k as parseAgentSessionKey, t as DEFAULT_AGENT_ID } from "./session-key-AvQIavYt.js";
...
import { o as normalizeExecSecurity, r as normalizeExecAsk, s as normalizeExecTarget, u as resolveExecModeFromPolicy } from "./exec-approvals-core-BW9WjMmv.js";
...
import { c as isAssistantAgentDatabaseOpen, f as runAssistantAgentWriteTransaction, l as openAssistantAgentDatabase } from "./testclaw-agent-db-Ckg86YCZ.js";
import { n as withAssistantAgentDatabaseReadOnly } from "./testclaw-agent-db-readonly-BtPeevnE.js";
import { a as closeAssistantAgentDatabaseByPath, o as closeAssistantAgentDatabaseByPathAsync } from "./testclaw-agent-db-lifecycle-lcOVPLQ6.js";
import { E as copySessionNodeArtifactsForRepair, O as deleteSessionMembersForRepair } from "./session-accessor.sqlite-entry-store-BzD1qpup.js";
import { d as setCanonicalSqliteSessionMainKey } from "./session-canonical-key-Bxbtl4CI.js";
import { a as publishSessionEntryCacheInvalidation, v as parseReadableSqliteSessionEntryRow } from "./session-accessor.sqlite-entry-cache-CTTseQJ_.js";
import { r as stripRuntimeOnlySessionSkillsFields } from "./store-entry-shape-BgZ9IH1k.js";
import { o as resolveDeliveryProvenCanonicalSessionKey } from "./store-entry-BKQU6sPT.js";
import { a as getSessionKysely, f as resolveSqliteTranscriptArchiveDirectory, g as toDatabaseOptions, u as resolveSqliteScope } from "./session-accessor.sqlite-scope-D-yDm5hE.js";
import { d as patchSessionEntryCore, i as listSessionEntryKeysReadOnly, s as loadSessionEntry } from "./session-accessor.sqlite-entry-CJ8WVyje.js";
...
import { x as writeTranscriptArchive } from "./session-accessor.sqlite-generation-copy-DcJmL4R4.js";
...
import { c as readSessionTranscriptMessageEventPage, s as readSessionTranscriptBoundedMessageTailPage } from "./session-accessor.sqlite-active-events-CuvrkABH.js";
import { c as hasInterSessionUserProvenance } from "./input-provenance-DGaz_sh7.js";
import { b as listRegistryWorktreesForMigration } from "./registry-BUL8lwJ9.js";
...
import { i as sqliteMessageEventWithSeq } from "./session-transcript-entry-message-CmdK_pJw.js";
import { t as deriveGoalSessionTitle } from "./derive-goal-session-title-Cl-2aSma.js";
import { h as resolveExecTarget } from "./bash-tools.exec-runtime-BNNrdT4O.js";
import { n as projectSessionDisplayMessage } from "./session-display-projection-BofAJNvj.js";
import { a as normalizeLegacyOpenAICodexTranscriptMetadata, i as hasBrokenPromptRewriteBranch, o as selectActivePath } from "./session-sqlite-transcript-verification-DCxUiGYw.js";
import { d as resolveTargetSqlitePath, i as projectExistingAgentDatabaseTargets, r as listExistingAgentDatabaseTargets, u as resolveTargetSqliteOptions } from "./session-sqlite-migration-readers-Avj9aNfl.js";
import { n as normalizeLegacySessionEntryDelivery } from "./state-migrations.legacy-session-store-B-eMEqmK.js";
...
import { t as formatSessionSqliteMigrationWarnings } from "./doctor-session-sqlite-warnings-B7pYzDj1.js";
import { n as createLegacyStateMigrationStepReceipt } from "./state-migrations.messages-DC2sfSBV.js";
import { a as repairAcpSessionMetaKeysForDoctor, i as runPostSessionPluginDoctorStateRepairs } from "./state-migrations.plugin-doctor-CKfiKGwd.js";
import { s as resolveProjectRegistry } from "./project-registry-BR2wcDEJ.js";
import { i as isInformationalMissingSessionIndex } from "./doctor-session-sqlite-types-B5o24UoE.js";
import { n as runDoctorAgentDatabaseOperationAsync, t as runDoctorAgentDatabaseOperation } from "./doctor-agent-database-operation-Cs6PsrVv.js";
import { r as sessionTitleRequests, t as hasExplicitSessionName } from "./session-title-state-DS7JC3mN.js";
...
async function noteSessionSqliteMigrationHealth(params) {
	const { runDoctorSessionSqlite } = await import("./doctor-session-sqlite-BgKPYvhz.js");
	...
	const runSessionSqlite = async (maintenanceAuthority) => {
		...
		const { migrateLegacyMainSessionKeys } = await import("./legacy-main-session-migration-fhUTI0FX.js");
		...
		try {
			pluginRepair = await runPostSessionPluginDoctorStateRepairs({
				...
				...maintenanceAuthority ? { beforeCompletion: async (completedPluginIds, assertCurrent) => {
					const { settleRetainedDoctorSessionSources } = await import("./doctor-session-sqlite-BgKPYvhz.js");
