...
import { M as resolveTimerTimeoutMs, O as resolveIntegerOption, k as resolveNonNegativeIntegerOption } from "./number-coercion-0M4tZV2c.js";
import { r as truncateUtf16Safe } from "./utf16-slice-D_ngcYKd.js";
import { t as createDeferredCore } from "./deferred-D0La5CRk.js";
import { i as resolveGlobalSingleton, n as resolveGlobalMap } from "./global-singleton-DmdlcXls.js";
import { C as shortenPathWithHome } from "./utils-BfoJTy8l.js";
import { t as resolveIdentityPathViaExistingAncestorSync } from "./boundary-path-BBHaqzpY.js";
import { i as readRegularFileSync, r as readRegularFile } from "./regular-file-DOXBdrLD.js";
...
import { a as getBashShellEnv, i as getBashShellConfig, s as sanitizeBinaryOutput, t as buildShellCommandInvocation } from "./shell-utils-Bvgm8qFu.js";
import { n as formatPathRelativeToCwdOrAbsolute } from "./paths-CIwQeLl6.js";
...
import { f as sliceToolResultTextToBudget, s as toolResultFitsBudget } from "./tool-result-limits-Lx_h0EBk.js";
import { t as levenshteinDistance } from "./levenshtein-distance-XjKurHYB.js";
import { a as convertImageToPng, p as createImageProcessor } from "./image-ops-BTYtooXp.js";
import { r as executionTitleSchema } from "./typebox-B5XjoGtB.js";
import { t as getAgentToolExecutionContext } from "./tool-execution-context-C6v2UVPI.js";
import { n as formatFullOutputFooter, t as ReadToolContinuationSchema } from "./tool-contracts-Cdelnh4l.js";
import { i as normalizeMediaReferenceSource, r as classifyMediaReferenceSource, s as resolveMediaReferenceLocalPath } from "./media-reference-DHQmzlyp.js";
import { o as getReadmePath, t as ensureTool } from "./tools-manager-CYHvkyJr.js";
import { i as formatDurationSeconds } from "./format-duration-CeDWULoS.js";
import { a as resolveToCwd, i as resolveLocalPathToCwd, n as getReadPathVariants, r as getReadQueuePaths } from "./path-utils-Dahl-O6E.js";
...
function appendBoundedTextTail(current, chunk, maxBytes = SESSION_TOOL_STDERR_TAIL_BYTES) {
	...
	return {
		tail,
		droppedBytes: Buffer$1.byteLength(combined) - Buffer$1.byteLength(tail)
	};
}
...
function buildFindResult(params) {
	...
	const { content, ...truncation } = truncateHead(params.paths.slice(0, params.effectiveLimit).map((foundPath) => {
					...
					try {
						...
						spawnedChild.nodeChildProcess.on("close", (code) => {
							...
							(async () => {
								...
								const { content, ...truncation } = truncateHead(outputLines.join("\n"), { maxLines: Number.MAX_SAFE_INTEGER });
								const details = { content };
								const notices = [];
...
//#endregion
export { createBashToolDefinition as A, OutputAccumulator as B, createEditToolDefinition as C, withFileMutationQueueKeysResolution as D, withFileMutationQueueKeyResolution as E, interactiveAgentTheme as F, truncateHead as G, DEFAULT_MAX_BYTES as H, loadThemeFromPath as I, SESSION_TOOL_STDERR_TAIL_BYTES as J, truncateLine as K, decodeHtmlEntities as L, wrapToolDefinition as M, wrapToolDefinitions as N, decodeUtf8File as O, createLocalBashOperations as P, addIgnoreRules as R, createEditTool as S, withFileMutationQueue as T, DEFAULT_MAX_LINES as U, writePrivateTempFile as V, formatSize as W, normalizePositiveLimit as X, appendBoundedTextTail as Y, createLsToolDefinition as _, createCodingTools as a, createFindTool as b, createTool as c, createWriteToolDefinition as d, createReadTool as f, createLsTool as g, formatReadContinuationNotice as h, createCodingToolDefinitions as i, createToolDefinitionFromAgentTool as j, createBashTool as k, createToolDefinition as l, createBoundedReadTextPage as m, createAllToolDefinitions as n, createReadOnlyToolDefinitions as o, createReadToolDefinition as p, truncateTail as q, createAllTools as r, createReadOnlyTools as s, allToolNames as t, createWriteTool as u, createGrepTool as v, resolveFileMutationQueueKey as w, createFindToolDefinition as x, createGrepToolDefinition as y, normalizeNativePathSeparators as z };
