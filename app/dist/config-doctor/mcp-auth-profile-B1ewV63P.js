...
const resolveMcpAuthProfileBearerToken = createLazyRuntimeMethod(() => import("./mcp-auth-profile.runtime-BhHx4stS.js"), (runtime) => runtime.resolveMcpAuthProfileBearerToken);
async function resolveMcpBearerToken(params) {
	...
	const [{ operatorMcpOAuthIdentity }, { resolveMcpOAuthAccessToken }] = await Promise.all([import("./mcp-oauth-identity-lDU73Jpy.js"), import("./mcp-oauth-RlQQ35x4.js")]);
...
//#endregion
export { resolveMcpBearerBundleConfig as n, withMcpAuthProfileBearer as r, resolveMcpAuthProfileId as t };
