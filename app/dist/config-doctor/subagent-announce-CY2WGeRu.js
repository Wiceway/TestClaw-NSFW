...
import { c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as isSilentReplyText, s as startsWithSilentToken } from "./tokens-BbfKzfAT.js";
...
import { g as shouldIgnorePostCompletionAnnounceForSession, h as resolveRequesterForChildSession, i as countPendingDescendantRuns, o as getLatestSubagentRunByChildSessionKey, p as listSubagentRunsForRequester, u as isSubagentSessionRunActive } from "./subagent-registry-read-DD46xgBs.js";
import { t as INTERNAL_PROVENANCE_SOURCE_CHANNEL } from "./input-provenance-DGaz_sh7.js";
import { i as logWarn } from "./logger-DgjIIHeT.js";
import { c as getSubagentDepthFromSessionStore } from "./subagent-capabilities-9LXIvheU.js";
import { i as formatAgentInternalEventsForPrompt } from "./internal-events-fYW3tKod.js";
import { n as dispatchGatewayMethodInProcess } from "./server-plugin-in-process-dispatch-CQ88kUjk.js";
import { I as waitForEmbeddedAgentRunEnd, d as isEmbeddedAgentRunActive } from "./runs-CKg3ezhN.js";
import { n as buildAnnounceIdempotencyKey, t as buildAnnounceIdFromChildRun } from "./announce-idempotency-CkUlnjaT.js";
import { a as terminateAcceptedCollectorRun, h as deleteSubagentSessionForCleanup } from "./subagent-spawn-cleanup-DMJLvyZI.js";
import { a as filterCurrentDirectChildCompletionRows, c as readSubagentOutput, d as waitForSubagentRunOutcome, i as dedupeLatestChildCompletionRows, l as readSubagentRunAnnounceResult, n as buildCompactAnnounceStatsLine, o as readChildCompletionFindings, p as callSubagentLifecycleGateway, s as readLatestSubagentOutputWithRetry, t as applySubagentWaitOutcome, u as readSubagentTimeoutProgress } from "./subagent-announce-output-DkOV7uVE.js";
import { o as SUBAGENT_COMPLETION_OUTCOME_INSTRUCTION, s as SUBAGENT_PRIVATE_COMPLETION_INSTRUCTION } from "./subagent-completion-delivery-B6uhWOJ5.js";
import { a as loadSessionEntryByKey, i as loadRequesterSessionEntry, n as resolveAnnounceOrigin, o as resolveSubagentAnnounceTimeoutMs, r as resolveSubagentCompletionOrigin, s as runAnnounceDeliveryWithRetry, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-BcfACx3J.js";
...
*/
const subagentRegistryRuntimeLoader = createLazyImportLoader(() => import("./subagent-registry-runtime-BI_--kMf.js"));
