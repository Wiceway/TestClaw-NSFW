...
import { r as copyConfigResolutionFacts } from "./resolution-facts-BNNyTRcj.js";
...
import { r as resolveConfiguredSetupModelForAgent } from "./utility-model-CCzqUQSQ.js";
...
async function resolveSystemAgentConfiguredRouteFromConfig(runConfig, requestedAgentId, deps = {}, configSnapshot) {
	...
	const [modelSelection, modelRuntimeAliases, simpleCompletion, harnessPolicy] = await Promise.all([
		import("./model-selection-BItbyaBa.js"),
		import("./model-runtime-aliases-B6VpZgX6.js"),
		import("./simple-completion-runtime-DLoaKZHH.js"),
		import("./policy-DQHliTwI.js")
	]);
...
async function projectInferenceRoute(config, requestedAgentId, deps = {}, sourceConfig = config) {
	const { resolveProviderIdForAuth } = await import("./provider-auth-aliases-BKdRtVhM.js");
