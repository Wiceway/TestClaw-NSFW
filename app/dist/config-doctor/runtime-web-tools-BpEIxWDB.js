...
import { j as secretRefKey, p as resolveSecretInputRef } from "./types.secrets-K95Dlap_.js";
...
import { c as pushInactiveSurfaceWarning, f as isExpectedResolvedSecretValue, l as pushWarning, m as digestRuntimeWebOwnerContract } from "./runtime-shared-CzmRi8K6.js";
...
import { a as isProviderScopedSecretResolutionError, t as describeSecretResolutionError } from "./resolve-errors-YgWEeepi.js";
import { r as resolveSecretRefValues } from "./resolve-DMtxtf08.js";
import { i as associateSecretResolutionErrorOwners, l as isRetryableSecretDegradationReason } from "./runtime-degraded-state-DcNWEaY3.js";
...
import { i as warnDegradedSecretOwner, t as classifySecretOwnerDegradationState } from "./runtime-owner-assignments-DjHW_NCF.js";
import { t as hasCredentialBearingObjectValue } from "./runtime-secret-scan-BN8zC4n8.js";
...
const loadResolveManifestContractOwnerPluginId = createLazyRuntimeNamedExport(() => import("./runtime-web-tools-manifest.runtime-ClanhKqq.js"), "resolveManifestContractOwnerPluginId");
...
const loadRuntimeWebToolsFallbackProviders = createLazyRuntimeSurface(() => import("./runtime-web-tools-fallback.runtime-DwTNT5jF.js"), ({ runtimeWebToolsFallbackProviders }) => runtimeWebToolsFallbackProviders);
const loadRuntimeWebToolsPublicArtifacts = createLazyRuntimeSurface(() => import("./runtime-web-tools-public-artifacts.runtime-C3gIB0Jc.js"), (mod) => mod);
const loadRuntimeWebToolsManifest = createLazyRuntimeSurface(() => import("./runtime-web-tools-manifest.runtime-ClanhKqq.js"), (mod) => mod);
...
async function resolveRuntimeWebTools(params) {
	...
	if (search || hasPluginWebSearchConfig) {
		const searchSurface = await resolveRuntimeWebProviderSurface({
			...
			readConfiguredCredentialFallback: ({ provider, config }) => provider.getConfiguredCredentialFallback?.(config),
