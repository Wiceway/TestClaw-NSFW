...
import { a as setPluginToolMeta, r as getPluginToolMeta } from "./tool-metadata-BnzelBzh.js";
import { n as recordAgentCleanupFailure } from "./run-cleanup-timeout-EEG0etQn.js";
import { c as getSessionMcpRequestSignal, l as runWithSessionMcpRequestSignal, s as mergeMcpConnectCatalog } from "./mcp-app-model-context-E6EDyxFj.js";
import { a as setMcpCodeModeGuestResultFromAgentResult, i as setMcpCodeModeGuestResult, n as projectMcpCallToolResult, r as projectMcpGetPromptResult, s as toToolSearchJsonSafe } from "./mcp-content-Dl9PUDjg.js";
import { t as isMcpToolAllowed } from "./mcp-tool-filter-DHh4eeEi.js";
import { n as buildMcpAppCanvasPayload, r as fetchMcpAppView } from "./mcp-ui-resource-6G08roM0.js";
...
async function materializeBundleMcpToolsForRun(params) {
	...
	const dispose = async () => {
		disposal ??= (async () => {
			try {
				const { releaseSessionMcpRuntime } = await import("./agent-bundle-mcp-manager-api-BGkaAO-3.js");
...
async function createBundleMcpToolRuntime(params) {
	...
	const createRuntime = params.createRuntime ?? (await import("./agent-bundle-mcp-runtime-CDhu0xw2.js")).createSessionMcpRuntime;
	signal?.throwIfAborted();
