...
import { n as resolveCommitHash } from "./git-commit-Ct-xaMfF.js";
import { n as decorativePrefix, r as stripDecorativeEmojiForTerminal, t as decorativeEmoji } from "./decorative-emoji-u16wtyJo.js";
import { c as hasRootVersionAlias } from "./argv-zmtAhw2-.js";
...
const DEFAULT_TAGLINE = "All your chats, one Assistant.";
...
const TAGLINES = [
	...
	"You had me at 'testclaw gateway start.'",
	...
	"If found wandering, please return to ~/.testclaw.",
	...
	"Assistant Support will never DM you first. I, on the other hand, absolutely will.",
...
function pickTagline(options = {}) {
	...
	const override = (options.env ?? process.env)?.TESTCLAW_TAGLINE_INDEX;
	if (override !== void 0) {
...
function formatCliBannerLine(version, options = {}) {
	...
	const title = decorativePrefix("🦞", "Assistant", emojiOptions);
