...
import { P as tryResolveSoleAgentId } from "./agent-scope-config-BEuqweC1.js";
...
import { n as inspectLocalAudioSelection, t as formatLocalAudioSelection } from "./local-audio-DIQwp6E5.js";
...
async function collectProviderCatalogProjectionFindings(cfg, workspaceDir) {
	const { runProviderStaticCatalog } = await import("./provider-discovery-cSigoIgA.js");
