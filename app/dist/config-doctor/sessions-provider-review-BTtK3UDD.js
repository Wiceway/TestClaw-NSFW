...
import { Mi as validateSessionsProviderReviewContinueParams } from "./validator-registry-Dpl5QmuY.js";
import { n as resolveRequestedSessionAgentId } from "./session-request-agent-cU98pfB6.js";
import { _ as issueProviderReviewAcknowledgment, b as retireProviderReviewAcknowledgment, v as readProviderReviewAcknowledgment } from "./lifecycle-DpcRUIUy.js";
...
const sessionProviderReviewHandlers = { "sessions.providerReview.continue": async (options) => {
	...
	try {
		...
		const { handleProviderReviewContinuationChat } = await import("./chat-send-handler-CUwkbSeJ.js");
		assertCurrent();
		handedOff = true;
