...
import { s as restoreTerminalState, t as ExitError } from "./runtime-kM7jday_.js";
import { i as formatExternalSupervisorActionRequired, o as isGatewayExternallySupervised } from "./gateway-supervision-De8qPH1y.js";
import { _ as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-_6eikbXk.js";
import { t as isContainerEnvironment } from "./container-environment-CNsJSTpY.js";
import { C as runTui, t as cancelProcessExitAfterTuiReturn, w as scheduleProcessExitAfterTuiReturn, x as resolveTuiShutdownHardExitMs } from "./tui-JvS5ih5H.js";
...
import { r as listConfiguredWebSearchProviders } from "./runtime-D-Rb0NPn.js";
import { t } from "./i18n-BgYW2H_X.js";
import { w as isSystemdUserServiceAvailable } from "./systemd-service-files-Bb2bJdgP.js";
import { a as formatCompletionReloadCommand, d as resolveCompletionProfilePath, i as findCompletionProfileWriteError, o as installCompletion, u as resolveCompletionProfileHint } from "./completion-runtime-R_70qtS5.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CdTwKGNX.js";
import { a as resolveGatewayService, o as startGatewayService, s as formatGatewayServiceStartRepairIssues, t as describeGatewayServiceRestart } from "./service-lSBwGN47.js";
...
import { p as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-CO30s3pJ.js";
...
import { i as waitForControlUiDocument, r as resolveControlUiHandoffTarget } from "./control-ui-handoff-DaFYzBCm.js";
...
async function startSessionGatewayForOnboarding(params) {
	...
	try {
		const { startGatewayServer } = await import("./server-DPIKvUuv.js");
...
const loadSearchSetupModule = createLazyRuntimeModule(() => import("./search-setup-B-eQtMfs.js"));
...
async function finalizeSetupWizard(options) {
	...
	try {
		...
		const [{ resolveDefaultModelAuthStatus, resolveDefaultModelCatalogFacts }, { loadPreparedModelCatalogSnapshot }] = await Promise.all([import("./auth-choice-K5TLCIPj.js"), import("./prepared-model-catalog-QaCXv2Di.js")]);
