...
const CONTEXT_WINDOW_RUNTIME_STATE = (() => {
	...
	if (!state) {
		state = {
			...
			modelsConfigRuntimeLoader: createLazyImportLoader(() => import("./models-config.runtime-DG2hzhAe.js"))
		};
		...
		state.modelsConfigRuntimeLoader ??= createLazyImportLoader(() => import("./models-config.runtime-DG2hzhAe.js"));
	}
	return state;
})();
...
const loadPreparedModelCatalogRuntime = () => import("./prepared-model-catalog-QaCXv2Di.js");
