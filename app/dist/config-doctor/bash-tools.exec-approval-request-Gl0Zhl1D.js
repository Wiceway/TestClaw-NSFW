...
import { P as normalizeExecutableToken, f as resolveShellWrapperTransportArgv, t as POSIX_PARSEABLE_SHELL_WRAPPERS, u as isShellWrapperExecutable } from "./shell-wrapper-resolution-BVUBYqqS.js";
import { t as markToolDecisionRecorded } from "./agent-tools.before-tool-call.decision-C6ZPXFnE.js";
import { t as callGatewayTool } from "./gateway-DSMADMfF.js";
import { n as DEFAULT_APPROVAL_TIMEOUT_MS, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS } from "./bash-tools.exec-runtime-BNNrdT4O.js";
...
const loadExecApprovalCommandSpansRuntime = createLazyPromise(() => import("./bash-tools.exec-approval-request.runtime-BNhXalaV.js"), { cacheRejections: true });
