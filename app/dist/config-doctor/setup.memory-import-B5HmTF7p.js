...
import { n as planProviderMemoryImport, r as withMemoryMigrationProviders, t as applyProviderMemoryImport } from "./memory-import-BKXtq5EF.js";
import { t } from "./i18n-BgYW2H_X.js";
import { r as createMigrationLogger } from "./context-Dqd6TkZg.js";
...
async function runSetupMemoryImportStep(params) {
	...
	return await withMemoryMigrationProviders(params.config, async (providers) => {
		...
		params.runtime.error(`Memory import result retained, but plugin cleanup failed: ${formatErrorMessage(error)}`);
	});
}
//#endregion
