...
import { r as estimateTokensFromChars } from "./src-D9uQ497Z.js";
import { t as expectDefined } from "./expect-lbe3Hgrh.js";
import { F as timestampMsToIsoString, T as resolveExpiresAtMsFromDurationMs, a as asDateTimestampMs, k as resolveNonNegativeIntegerOption } from "./number-coercion-0M4tZV2c.js";
...
import { r as clampInt } from "./utils-BfoJTy8l.js";
...
import { c as resolveAgentIdFromSessionKey, o as isUnscopedSessionKeySentinel } from "./session-key-AvQIavYt.js";
...
import { c as resolveSessionFilePathOptions, i as resolveDefaultSessionStorePath, l as resolveSessionStorePathCore, s as resolveSessionFilePathCore } from "./paths-ViQaz2td.js";
import { C as resetConfigOverrides, J as resolveOwnerPromptNumbers, S as getConfigOverrides, T as unsetConfigOverride, w as setConfigOverride } from "./io.snapshot-Dbj6l_ZW.js";
...
import { d as toolPolicyRestrictsTools } from "./tool-policy-BFaYCu9H.js";
import { s as getRuntimeConfigSnapshot } from "./runtime-snapshot-DTssNCAN.js";
import { M as isProviderLoginPatchPersisted, N as resolveCollapsedSessionAuthPinSource, _ as resolveSessionAgentId, j as decideProviderLoginSessionAdoption, y as resolveSessionAgentIds } from "./agent-scope-BiRi-Smp.js";
import { d as resolveEffectiveResponseUsage, i as isSessionDefaultDirectiveValue, l as normalizeUsageDisplay } from "./thinking.shared-DJ5AX7RA.js";
...
import { n as redactConfigSnapshot, t as redactConfigObject } from "./redact-snapshot-BWzl0z3_.js";
...
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-Bb8CaCra.js";
...
import { n as mutateConfigFileWithRetry, o as transformConfigFileWithRetry } from "./mutate-CFZDg_sD.js";
...
import { a as normalizeStoreSessionKey, c as resolveSessionStoreEntryCore } from "./store-entry-BKQU6sPT.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-BYC4PoOZ.js";
import { E as resolveSessionStorePathForScope, M as listSessionEntriesReadOnly, d as patchSessionEntryCore, l as loadSessionEntryReadOnly } from "./session-accessor.sqlite-entry-CJ8WVyje.js";
import { u as scanSessionTranscriptTree } from "./session-transcript-read-bytes-DN8QSHRu.js";
...
import { i as renderExecExitLabel } from "./bash-tools.exec-output-Cei3R_ZV.js";
import { i as formatTaskStatusTitle, n as formatTaskStatus, r as formatTaskStatusDetail } from "./task-status-BLVYcOWO.js";
import { t as getSessionBindingService } from "./session-binding-service-CEhxAzP2.js";
import { a as executePluginCommand, s as matchPluginCommand } from "./command-detection-B0wcgFdq.js";
import { t as isCommandFlagEnabled } from "./commands.flags-j7w7Md11.js";
import { i as formatFastModeCurrentStatus } from "./fast-mode-B_XB5FSo.js";
import { i as parseSlashCommandOrNull, o as parseActivationCommand, r as parseSendPolicyCommandBody } from "./commands-registry.data-C3W8E-Ao.js";
...
import { c as readTaskStatusSnapshots } from "./task-status-access-saQ8mgsA.js";
...
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-scRUtjvw.js";
...
import { n as formatProviderLoginCompletion, r as formatProviderLoginFailure } from "./provider-login-recovery-DjGoA3IK.js";
import { i as resolveCliBackendConfig } from "./cli-backends-iul3yJ4V.js";
import { i as isCliRuntimeAliasForProvider, s as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-DwpwjGzF.js";
import { n as resolveManualCompactionCliTarget } from "./session-runtime-compat-BUc95NVY.js";
import { n as createInternalHookEvent, u as triggerInternalHook } from "./internal-hooks-BxqiEtdk.js";
import { a as resolveConfigWriteTargetFromPath, i as formatConfigWriteDeniedMessage, n as authorizeConfigWrite, o as resolveExplicitConfigWriteTarget, r as canBypassConfigWritePolicy } from "./channel-config-helpers-tX9QNb5l.js";
import { n as mintMessageActionTurnCapability, s as revokeMessageActionTurnCapability, t as isTrustedMessageActionTurnIngress } from "./message-action-turn-capability-DonQYF8t.js";
import { o as sessionSnapshotChangesApplied } from "./session-snapshot-merge-Br9OMCio.js";
import { At as estimateMessageCharsCached, b as isRealConversationMessage, kt as createMessageCharEstimateCache } from "./builtin-testclaw-D8svmGKw.js";
import { i as resolveBootstrapTotalMaxChars, r as resolveBootstrapMaxChars } from "./bootstrap-BEnm1JgQ.js";
import { r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-Dik1JrOM.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BX_OpEuD.js";
import { i as summarizeUpdateRunResponse, n as SKILL_AUTHORING_STANDARDS_PROMPT, r as DEFAULT_UPDATE_TIMEOUT_MS } from "./testclaw-tools-DNer_RKI.js";
import { a as getInProcessGatewayToolContext, r as callInProcessGatewayTool } from "./in-process-gateway-BZDacuc9.js";
import "./sandbox-w882SIpU.js";
import { a as migrateSessionEntries } from "./session-manager-codec-CSC986xU.js";
import "./session-manager-B9vSB5Dk.js";
import { l as getFinishedSession, t as acknowledgeNotifyOnExit, u as getSession } from "./bash-process-registry-D03BGdo6.js";
...
import { t as buildSystemPromptReport } from "./system-prompt-report-CwpgafRk.js";
...
import { a as isBenignCompactionSkipResult, n as classifyCompactionReason } from "./compact-reasons-YKHfUYtS.js";
...
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-C400XKhi.js";
import { r as routeReply } from "./route-reply-3k2txuk0.js";
...
import { _ as resolveTtsPrefsPath, a as getTtsMaxLength, c as isTtsEnabled, h as resolveTtsConfig, l as listTtsPersonas, o as getTtsPersona, s as isSummarizationEnabled } from "./tts-settings-UQqeRJB6.js";
...
import { T as isTtsProviderConfigured, _ as setTtsProvider, c as getLastTtsAttempt, d as setLastTtsAttempt, f as setSummarizationEnabled, g as setTtsPersona, h as setTtsMaxLength, m as setTtsEnabled, t as getTtsProvider, w as getResolvedSpeechProviderConfig } from "./runtime-api-CjUPhjru.js";
import { n as textToSpeech } from "./tts-CjxOmBze.js";
import { r as selectAgentHarness } from "./selection-C3496UGG.js";
import { r as createExecTool } from "./bash-tools-DfVHI8Nv.js";
import { t as cancelBackgroundExecSession } from "./bash-process-control-B7ou7NQL.js";
import { t as runBtwSideQuestion } from "./btw-DNtv1EH5.js";
import { n as detectNodeClaudePlacement } from "./prepare.runtime-C8SLwi2b.js";
import { n as agentHarnessExposesAssistantTools } from "./tool-surface-3xu_-s3Q.js";
...
import { i as resolveConversationBindingContextFromAcpCommand } from "./acp-reset-target-DpEJ4z_3.js";
import { a as markCommandSessionMetadataChanged, n as handleGoalCommand } from "./commands-goal-B96ZPlKo.js";
...
import { a as matchCommandPrefix, c as requireCommandFlagEnabled, i as defineGatewayControlCommand, l as requireGatewayClientScope, n as commandReply, o as rejectNonOwnerCommand, r as defineAuthorizedTextCommand, s as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-B1twWQps.js";
import { i as PLUGIN_COMMAND_DISPATCH, n as executePluginCommandDispatch, r as matchPluginCommandInvocation, t as createPluginCommandRuntime } from "./plugin-command-runtime-CmQlunul.js";
import { n as parseSteerMessage, r as resolveActiveExplicitSteerSessionKey, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-D8l3WE-c.js";
import { n as expandExplicitSkillReferences, o as resolveSkillCommandInvocation, s as skillCommandsToExplicitSelections } from "./chat-command-invocation-D6fN2e7X.js";
...
import { n as resolveConfiguredModelCompat, r as resolveEffectiveToolInventory, t as acquireEffectiveToolInventoryRuntimeModelContext } from "./tools-effective-inventory-ojhwpjs7.js";
import { t as resolveCurrentTurnImages } from "./current-turn-images-C7kZepQy.js";
import { r as stopSubagentsForRequester, t as abortSessionRunTargetWithOutcome } from "./abort-operation-DnQjKtBC.js";
import { t as formatAbortReplyText } from "./abort-cJx1mWuY.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-CRGqaTch.js";
import { b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-Da3BTrZ5.js";
import { r as resolveRequesterSessionKey, t as buildSubagentsHelp } from "./shared-Djh50T-6.js";
import { i as buildHelpMessage, n as buildCommandsMessage, r as buildCommandsMessagePaginated, t as buildToolsMessage } from "./status-CvnbnuL0.js";
import { c as removeChannelAllowFromStoreEntry, n as addChannelAllowFromStoreEntry, s as readChannelAllowFromStore } from "./pairing-store-DfgcjOc7.js";
...
import { a as resolvePluginCapabilityConsent, i as resolvePendingPluginCapabilityReview } from "./capability-consent-CFggQgL_.js";
import { t as handleApproveCommand } from "./commands-approve-CXwJkORS.js";
import { t as extractBtwQuestion } from "./btw-command-CVp_8hfx.js";
import { n as loadGatewayRuntimeConfigSchema } from "./runtime-schema-DwBbiD7r.js";
...
import { t as isSessionFileEntry } from "./session-file-parser-CISggO0B.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-DdoTbkH1.js";
import { n as buildStatusReply, t as buildStatusPluginsReply } from "./commands-status-yDowala9.js";
import { n as resolveSkillWorkshopToolPolicyAvailability } from "./tool-policy-diagnostic-DTCVEE9D.js";
import { n as ProviderBrowserSignInUnavailableError, r as createProviderBrowserAuthSession } from "./provider-browser-auth-DQZUXef-.js";
import { a as resolveProviderChannelLoginChoice, n as formatProviderOAuthLoginRef, t as formatProviderLoginChoiceRef } from "./provider-login-options-BeAHVXuA.js";
import { t as listConfiguredMcpServers } from "./mcp-config-D38Bdd8b.js";
import { n as unsetConfiguredMcpServer, t as setConfiguredMcpServer } from "./mcp-config-mutation-CrTe8i56.js";
import { t as handleModelsCommand } from "./commands-models-Co-st7Cs.js";
import { n as resolvePluginCapabilityConsentCliOptions, t as formatPluginCapabilityConsentLines } from "./plugin-capability-consent-adu9UDLs.js";
...
import { a as buildPluginInspectReport, c as withPluginDiagnosticsReportForInspection, t as buildAllPluginInspectReports } from "./status-CzhzPQAa.js";
import { t as formatPluginCompatibilityNotice } from "./status-compatibility-DdQ1VWdc.js";
import { t as buildPluginRegistrySnapshotReport } from "./status-snapshot-DJdaIxXD.js";
import { n as createPluginInstallLogger } from "./plugins-command-helpers-Da2MI_nu.js";
import { a as resolvePluginInstallSourcePlan } from "./install-source-plan-D511dvMe.js";
import { t as installManagedPlugin } from "./management-mutations-DAboa6_S.js";
import { i as setChannelConversationBindingMaxAgeBySessionKeyAsync, n as setChannelConversationBindingIdleTimeoutBySessionKeyAsync } from "./conversation-bindings-YtBgHyeC.js";
import { T as writeRestartSentinel, c as formatDoctorNonInteractiveHint, i as clearRestartSentinelIfRevision } from "./restart-sentinel-NcxkaoWW.js";
import { p as triggerAssistantRestart, u as scheduleGatewayRestart } from "./restart-BjZoWnnd.js";
import "./update-run-ledger-DLD5Q47c.js";
import { r as getUpdateRun } from "./update-run-reader-CA3WJ8vB.js";
import { a as renderUpdateRunReport } from "./update-run-report-Cx8a5c8n.js";
...
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-C11GAeXK.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-CeVoPB3M.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-BsWm_rRg.js"));
...
const compactRuntimeLoader = createLazyImportLoader(() => import("./commands-compact.runtime-WcWWVUeG.js"));
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-DGE9V52L.js");
...
const loadProviderAuthLoginFlowRuntime = createLazyRuntimeModule(() => import("./auth-CzU9ddyO.js"));
...
async function answerProviderLoginModelAccess(params) {
	...
	assertAuthority();
	const { completeProviderModelAccess, prepareProviderModelAccess, ProviderModelPolicyChangedError } = await import("./auth-model-policy-BAIi6MpQ.js");
...
async function refreshProviderLoginAuthState(params) {
	...
	readConfig();
	const { refreshModelAuthStateAfterMutation } = await import("./model-auth-refresh-BmH8QHJI.js");
	readConfig();
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-D-sLidA4.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-CS7_AxgF.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-DEaaroEm.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-DUwo5pbg.js"));
const controlRuntimeLoader = createLazyImportLoader(() => import("./subagent-control-scope-CEKWrrn2.js"));
...
const handleSystemAgentCommand = async (params, allowTextCommands) => {
	...
	const { extractSystemAgentRescueMessage, runSystemAgentRescueMessage } = await import("./rescue-message-D72dyeki.js");
