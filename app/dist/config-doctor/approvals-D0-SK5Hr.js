...
closedObject({ approval: ApprovalSnapshotSchema });
...
withSince("2026.7", Type.Union([PendingSessionApprovalEventSchema, TerminalSessionApprovalEventSchema]));
withSince("2026.7", closedObject({
	sessionKey: NonEmptyString,
	updatedAtMs: Type.Integer({ minimum: 0 }),
...
//#endregion
export { ApprovalResolveParamsSchema as a, ApprovalPresentationSchema as i, ApprovalGetParamsSchema as n, ApprovalScopeSchema as o, ApprovalHistoryParamsSchema as r, ApprovalChannelReviewerSchema as t };
