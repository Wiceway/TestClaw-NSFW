import { a as GATEWAY_SUPERVISOR_EXIT_MARGIN_MS, i as GATEWAY_SHUTDOWN_TIMEOUT_MS, r as GATEWAY_SHUTDOWN_RESERVE_MS } from "./gateway-shutdown-budget-E5oPIr_h.js";
...
import { t as drainGlobalSingletonLifecycleState } from "./global-singleton-DmdlcXls.js";
...
import { i as GATEWAY_SERVICE_RUNTIME_PID_ENV } from "./constants-DaCUjVXa.js";
import { t as CONFIG_PATH, u as normalizeStateDirEnv, v as resolveGatewayPort } from "./paths-DeOFr7iP.js";
...
import { o as setConsoleSubsystemFilter, s as setConsoleTimestampPrefix } from "./console-CPuEo0lT.js";
import { t as createSubsystemLogger } from "./subsystem-B0s_EQTq.js";
import { r as cleanupSnapshotOperations } from "./sqlite-readonly-location-cleanup-CwtWaSiY.js";
...
import { r as flushDiagnosticsTimeline } from "./diagnostics-timeline-DDShltPN.js";
import "./globals-NNTJbzqD.js";
import { n as clearRuntimeConfigSnapshot } from "./runtime-snapshot-DTssNCAN.js";
import { t as getFileLockProcessStartTime } from "./pid-alive-BrVKCISp.js";
import { i as isInvalidConfigError, r as isDoctorRecoverableInvalidConfigError } from "./io.invalid-config-CKzyW0XS.js";
import { t as quoteCliArg } from "./quote-cli-arg-BEt71TUh.js";
import { f as SqliteIntegrityWorkerInterruptedError } from "./testclaw-agent-db-maintenance-DEefvrFC.js";
...
import { o as runWithProcessCleanupBudget } from "./child-CHZrqaDL.js";
import { n as formatInvalidConfigPort, r as formatInvalidPortOption } from "./error-format-DwvUV8m_.js";
import { a as registerGatewayInstallationReplacementHandler } from "./stale-install-Cz6VHd9H.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-D2uZX48J.js";
import { c as isTailscaleRouteOwnershipConflictError } from "./tailscale-5b9qukjh.js";
import { n as setGatewayWsLogStyle } from "./ws-logging-86BGsxSJ.js";
import { m as normalizeSystemdUnit } from "./restart-BjZoWnnd.js";
import { g as execSystemctlUser, h as execSystemctl } from "./systemd-service-files-Bb2bJdgP.js";
import { i as isGatewayLifecycleContentionError, n as GatewayLockError, r as acquireGatewayLock } from "./gateway-lock-BdQ1BI9a.js";
import { v as findVerifiedGatewayListenerPidsOnPortSync, y as formatGatewayPidList } from "./schtasks-COcnfadp.js";
...
import { a as recordGatewayBootstrapStep } from "./startup-trace-6G1pu5mk.js";
...
import { r as isTerminalInteractive, t as NON_INTERACTIVE_GATEWAY_RUN_FORCE_MESSAGE } from "./terminal-interactivity-DNRSXUP6.js";
import { t as parsePort } from "./parse-port-DzBdkItZ.js";
import { n as normalizeGatewayHttpProbeHost, r as requestGatewayLocalHttpProbe, t as createConfiguredGatewayLocalProbe } from "./local-http-probe-B5uoTIsd.js";
import { a as formatGatewayCrashLoopManualChannelStartHint, d as recordGatewayCrashLoopRecovery, i as completeGatewayBootLifecycle, n as GATEWAY_CRASH_LOOP_RECOVERED_REASON, o as formatGatewayRepeatedSignalHint, r as GATEWAY_SIGNAL_REPEAT_WINDOW_MS, s as inspectGatewayCrashLoopBreaker, t as GATEWAY_CRASH_LOOP_BREAKER_REASON, u as recordGatewayBootStart } from "./gateway-boot-lifecycle-C4c8g5-D.js";
import { t as printClawBanner } from "./claw-banner-BzRDfssn.js";
import { n as consumeGatewaySuspendHandoff, r as disarmGatewaySuspendHandoff } from "./gateway-suspend-coordinator-6MOFY0oz.js";
import { d as enforceGatewayRunFutureConfigGuard, r as getGatewayStartGuardErrors } from "./pre-bootstrap-BdiD-wah.js";
import { n as isGatewayEffectiveConfigConflictError } from "./server-runtime-config-D4V6z85_.js";
import { a as markGatewayRestartTrace, f as startGatewayRestartTrace, o as measureGatewayRestartTrace, r as createGatewayRestartTraceHandoffEnv, t as captureGatewayRestartTraceHandoff } from "./restart-trace-DvgL0al7.js";
import { t as GatewayStartupCleanupError } from "./server-shutdown-NIQrjE8q.js";
import { n as scheduleSafeGatewayRestart } from "./restart-coordinator-BkJMbR5B.js";
import { n as resolveGatewayStartupMaintenanceReason } from "./startup-maintenance-DyW_OEDs.js";
...
const gatewayLifecycleRuntimeLoader = createLazyImportLoader(() => import("./lifecycle.runtime-k4u-b_sQ.js"));
...
async function triageGatewayStartupFailure(runtime, error, signal) {
	let triage;
	try {
		triage = await import("./triage-failure-B1uU-ppT.js");
	} catch (importError) {
...
async function resolveGatewayPasswordOption(opts) {
	...
	if (file) {
		const { readSecretFromFile } = await import("./secret-file-DQ5phiqH.js");
...
async function readGatewayStartupConfig(params) {
	const { readConfigFileSnapshotWithPluginMetadata } = await import("./config-fCohulPn.js");
...
async function resolveGatewayRunShellEnvFallbackPlan(cfg) {
	const { createConfigRuntimeEnv } = await import("./env-vars-FtQRJfpc.js");
	const { resolveShellEnvFallbackTimeoutMs, shouldDeferShellEnvFallback, shouldEnableShellEnvFallback } = await import("./shell-env-B4lG9EgX.js");
	...
	const { resolveShellEnvExpectedKeys } = await import("./shell-env-expected-keys-BDK1q1wc.js");
	return {
		enabled: true,
...
async function loadGatewayRunShellEnvFallback(plan) {
	const { loadShellEnvFallback } = await import("./shell-env-B4lG9EgX.js");
...
async function clearGatewayRunShellEnvFallback(values) {
	...
	const { clearShellEnvAppliedKeys } = await import("./shell-env-B4lG9EgX.js");
...
async function maybeWriteGatewayStartupFailureBundle(err, reason = "gateway.startup_failed") {
	const { writeDiagnosticStabilityBundleForFailureSync } = await import("./diagnostic-stability-bundle-D0b5I0It.js");
...
async function runGatewayCommandOnce(opts, hooks = {}) {
	...
	const { clearGatewayRunConfigEnvironment } = await import("./pre-bootstrap-DMSqx8mb.js");
	...
	const serverImportMeasurement = startupTrace.startMeasure("cli.server-import", () => import("./server-DPIKvUuv.js"));
	...
	if (devMode) {
		if (opts.reset) {
			const { recheckGatewayRunReset } = await import("./pre-bootstrap-DMSqx8mb.js");
			if (!await recheckGatewayRunReset({
				opts,
				runtime: defaultRuntime
			})) return;
		}
		const { ensureDevGatewayConfig } = await import("./dev-D4irWL5b.js");
	...
	if (snapshot) {
		const { applyFinalGatewayRunConfigEnv } = await import("./pre-bootstrap-DMSqx8mb.js");
	...
	if (process.env.TESTCLAW_SERVICE_MARKER?.trim()) {
		...
		if (process.platform === "darwin") {
			const { warnAboutGatewayRestartStorm } = await import("./restart-storm-DaWv_z6g.js");
	...
	if (process.env.TESTCLAW_SERVICE_MARKER?.trim()) {
		const { cleanStaleGatewayProcessesSync } = await import("./restart-stale-pids-3ovXZqFj.js");
		...
		if (stale.length > 0) {
			...
			if (process.platform === "linux") {
				const { findSystemdGatewayInstallation, formatDuelingScopesWarning } = await import("./systemd-CXRrNlHX.js");
	...
	if (opts.force) {
		...
		try {
			const { forceFreePortAndWait, waitForPortBindable } = await import("./ports-DUzHmrkF.js");
	...
	const { resolveGatewayAuth } = await import("./auth-XleQXiXV.js");
	...
	const startLoop = async (lifecycleLockDeadlineMs) => await runGatewayLoop({
		...
		start: async ({ processStartedAt, startupStartedAt, requestHotReloadRecovery, hostLifecycle, startupOperation } = {}) => {
			const snapshotPreparation = await import("./io.snapshot-preparation-fgkhZ6JC.js");
	...
	const { detectRespawnSupervisor } = await import("./supervisor-markers-YlBNHu5Y.js");
	...
	try {
		...
		if (isGatewayLockError(err)) {
			...
			try {
				const [{ formatPortDiagnostics }, { inspectPortUsage }] = await Promise.all([import("./ports-format-yilYm6yD.js"), import("./ports-inspect-CV5w0miQ.js")]);
				const diagnostics = await inspectPortUsage(port);
				if (diagnostics.status === "busy") for (const line of formatPortDiagnostics(diagnostics)) defaultRuntime.error(line);
			} catch {}
			const { maybeExplainGatewayServiceStop } = await import("./shared-GAs_NDxq.js");
...
async function runGatewayCommand(opts, hooks = {}, recoveryDeps) {
	if (opts.taskSupervisor) {
		const { runWindowsGatewayTaskSupervisor } = await import("./task-supervisor-BWSY-2cz.js");
