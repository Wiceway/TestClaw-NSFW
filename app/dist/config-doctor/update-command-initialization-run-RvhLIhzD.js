...
import { a as resolveUpdateTargetEnv, c as withOwnedManagedUpdateEnv, l as withUpdateInProgressEnv } from "./update-command-service-env-DYcjXvvU.js";
...
import { a as withUpdateInitializationCleanup, n as confirmFreshUpdateDowngrade, r as initializeUpdateStateFromTarget, t as acquireLegacyUpdateInitializationFence } from "./update-command-initialization-C_FvXj1B.js";
import { f as assertUpdatePackageActivationAdmission, l as withUpdateCommandTerminalResult, s as reportUnreportedUpdateAdmissionOutcome, v as recordUpdateCommandTarget } from "./update-command-terminal-DclZGDYR.js";
import { t as prepareUpdateCommandFailureTriage } from "./update-command-triage-CIEakJzF.js";
...
import { n as resolveUpdateCommandTarget, t as resolveFreshUpdateMetadata } from "./update-command-target-DsZs-vku.js";
		...
		await withUpdateCommandTerminalResult((registerRun) => withUpdateInProgressEnv(invocationCwd, () => withUpdateCommandExecutor(runId, async (executor) => {
			...
			const runSelectedTarget = async () => {
				...
				const checkSchemas = async () => {
					const { readUpdateChannelConfig } = await import("./update-command-config-BeLjqAEr.js");
				...
				const { stagePackageInstallUpdate } = await import("./update-command-package-ir5IhauF.js");
				assertCurrent();
			...
			const { runFreshUpdateArtifact } = await import("./update-command-artifact-B_iRGLfw.js");
