...
import { i as resolveCliBackendConfig, o as resolveCliRuntimeCanonicalProvider } from "./cli-backends-iul3yJ4V.js";
import { i as isCliRuntimeAliasForProvider, s as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-DwpwjGzF.js";
import { r as resolveAgentHarnessSelectionDecision } from "./selection-decision-BLKbNa0i.js";
...
import { n as classifyAssistantFailoverReason, t as buildAssistantFailoverSignal } from "./assistant-message-failures-CEIqmlfG.js";
import { i as preparedAgentRuntimeProfileAttemptHasCandidate, n as canRunPreparedAgentRuntimeAuthAttempt, r as prepareAgentRuntimeAuth } from "./prepare-auth-BjNxXpdc.js";
...
import { r as scopeAuthProfileStoreToPreparedPlan } from "./resolve-auth-BXVTMykr.js";
...
async function runIsolatedCompletionOwned(params, onAcquired, captureWorkContext) {
	...
	try {
		...
		const run = async () => {
			...
			const harness = selection.builtIn ? (await import("./builtin-testclaw-BbYjwAEb.js")).createAssistantAgentHarness() : selection.harness;
			assertCurrent();
