...
import { C as parsePluginInstallRecordMap } from "./installed-plugin-record-match-DU0U5gm6.js";
...
import { d as asResolvedSourceConfig, f as asRuntimeConfig } from "./validation-core-DFctiTx0.js";
import { c as parseConfigJson5 } from "./io.read-helpers-DjrAb5Uv.js";
import { t as composeConfigWriteAssertions } from "./write-authority-BBYsD_pp.js";
...
async function planUpdateChannelLegacyConfig(snapshot) {
	...
	const { planLegacyConfigForUpdateChannel } = await import("./legacy-config-repair-CMuHhKgk.js");
...
async function maybeRepairLegacyConfigForUpdateChannel(params) {
	...
	const { repairLegacyConfigForUpdateChannel } = await import("./legacy-config-repair-CMuHhKgk.js");
