...
import { k as listAgentEntries, o as resolveAgentEntry, p as resolveAmbientOwnerAgentId, x as toAgentEntriesRecord } from "./agent-scope-config-BEuqweC1.js";
...
import { r as hasResolvedRosterBeforeMigrations, t as configIncludeOwnsAgentRoster } from "./agent-roster-provenance-CTSAwwv9.js";
...
*/
const loadAgentWorkspaceModule = createLazyPromise(() => import("./workspace-DcJhb3CO.js"));
const loadConfigIOModule = createLazyPromise(() => import("./config-fCohulPn.js"));
const loadConfigLoggingModule = createLazyPromise(() => import("./logging-wOZBH0iK.js"));
...
async function resolveDefaultSessionTranscriptsDir(agentId) {
	const { resolveSessionTranscriptsDirForAgent } = await import("./sessions-tY2rXd7z.js");
...
async function setupCommand(opts, runtime = defaultRuntime) {
	...
	if (snapshot.exists && !snapshot.valid) {
		if (opts?.json) {
			const [{ formatCliJsonFailure }, { normalizeConfigIssues }] = await Promise.all([import("./failure-output-2IHf1cPf.js"), import("./issue-format-okewmkFG.js")]);
