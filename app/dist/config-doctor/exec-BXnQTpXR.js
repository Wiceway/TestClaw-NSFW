...
import { a as isPlainCommandSignalFailure, i as isPlainCommandExitFailure, n as createSanitizedCommandError, o as resolveProcessExitCode } from "./exec-result-VkoWpd4F.js";
import { c as waitForCommandSpawn, i as runOutsideCommandProcessScope, n as resolveCommandProcessSignal, o as spawnCommand, r as retainCommandProcessCleanup, s as spawnCommandWithInvocation } from "./exec-spawn-USR_FeKZ.js";
	...
	try {
		...
		const completion = (async () => {
			...
			if (acceptingOutput && resolvedOptions?.logOutput !== false) {
				const [{ shouldLogVerbose }, { logDebug, logError }] = await Promise.all([import("./globals-CXgGxogb.js"), import("./logger-BMqPAMUZ.js")]);
				if (shouldLogVerbose()) {
		...
		if (resolvedOptions?.logOutput !== false) {
			const logging = await Promise.all([import("./globals-CXgGxogb.js"), import("./logger-BMqPAMUZ.js")]).catch(() => void 0);
			if (logging) {
