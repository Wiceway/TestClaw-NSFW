...
import { S as getExistingAssistantStateSchemaPath } from "./testclaw-state-db-cache-BxGqhkwE.js";
...
import { O as buildCloudflareAccessHeaders } from "./worker-process-protocol-CmSwaDXb.js";
import { i as loadDeviceAuthTokenReadOnly } from "./device-auth-store-CZZryI9H.js";
import { i as loadOrCreateDeviceIdentity } from "./device-identity-m0trcYgZ.js";
...
import { a as loadNodeHostConfig, d as resolveNodeHostCloudflareAccess, i as configureNodeHost } from "./config-B82fRBcN.js";
import { n as prepareNodeHostRuntime, r as startNodeHostConnection, t as runStartupMigrations } from "./startup-state-migrations-BKw-0YSp.js";
import { t as resolveMachineModelIdentifier } from "./machine-model-DY35fxv0.js";
import { a as watchNodeHostParentStdin, i as setNodeHostLauncherRestartArguments, n as notifyNodeHostLauncherReady, t as isNodeHostLauncherChild } from "./launcher-client-Bk5ZBI52.js";
...
async function runNodeHost(opts) {
	...
	async function announceLauncherReady(url, tlsFingerprint) {
		...
		autoUpdateStart ??= import("./auto-update-17qLSzLH.js").then(({ startNodeHostAutoUpdate }) => {
