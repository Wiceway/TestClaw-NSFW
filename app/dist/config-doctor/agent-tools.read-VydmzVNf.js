...
import { a as canonicalPathFromExistingAncestor, s as findExistingAncestor, t as FsSafeError, w as root } from "./fs-safe-CZ3jhUUr.js";
...
import { r as overwriteFileHandle } from "./file-descriptor-BakyKUdY.js";
import { a as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-CJf584nJ.js";
import { n as detectMime } from "./mime-Bmg9gcyP.js";
import { t as isWindowsDrivePath } from "./archive-path-BizE0Q_D.js";
import { n as assertSandboxPath, o as normalizeFileReferencePrefix } from "./sandbox-paths-C2TTxiUG.js";
import { i as resolveSandboxPathMapping, o as toRelativeWorkspacePath } from "./path-policy-CUndGQuU.js";
import { i as logWarn } from "./logger-DgjIIHeT.js";
import { r as decodeWindowsTextFileBuffer } from "./windows-encoding-CzxaGNeo.js";
import { t as createCorePluginStateKeyedStore } from "./plugin-state-store-B74db6Ob.js";
import { a as assertRequiredParams, i as REQUIRED_PARAM_GROUPS, l as wrapToolParamValidation, o as normalizeFileToolPathParam, s as normalizeFileToolPathParamsFromKeys } from "./agent-tools.before-tool-call.decision-C6ZPXFnE.js";
import { r as captureAgentToolSourceExecutionGuard } from "./agent-tool-source-execution-guard-jLk-wb7O.js";
import { a as resolveToolResultBudget, s as toolResultFitsBudget } from "./tool-result-limits-Lx_h0EBk.js";
import { H as DEFAULT_MAX_BYTES, S as createEditTool, U as DEFAULT_MAX_LINES, X as normalizePositiveLimit, f as createReadTool, h as formatReadContinuationNotice, m as createBoundedReadTextPage, u as createWriteTool } from "./tools-FoyuW2o_.js";
import { r as sanitizeToolResultImages } from "./tool-images-CO_s00XX.js";
import { r as resolveSandboxFileMutationQueueKey } from "./file-mutation-identity-Bmu3sjBc.js";
import { t as ReadToolContinuationSchema } from "./tool-contracts-Cdelnh4l.js";
import { i as normalizeMediaReferenceSource, l as resolveMediaReferenceSandboxPath, r as classifyMediaReferenceSource } from "./media-reference-DHQmzlyp.js";
import { a as resolveToCwd, t as expandOsHomePrefix } from "./path-utils-Dahl-O6E.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-C-3dMSx5.js";
