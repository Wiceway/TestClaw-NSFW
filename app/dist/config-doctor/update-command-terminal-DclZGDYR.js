import { s as formatUnsupportedNodeVersionMessage } from "./node-version-pLsxezYK.js";
...
import { O as union, T as string, d as array, g as literal, j as uuid, l as _enum, w as strictObject } from "./schemas-D6YHSiZI.js";
import { a as formatExternalSupervisorUpdateRequired, o as isGatewayExternallySupervised } from "./gateway-supervision-De8qPH1y.js";
...
import { a as assertManagedUpdateLeaseDatabaseIdentity, c as withExistingSqliteRollbackDatabase, d as cleanupStaleManagedServiceUpdateHandoffs } from "./update-managed-service-handoff-lease-BvLK_tcK.js";
...
import { _ as inspectUpdateRecoveries, a as finishInterruptedUpdatePreview, f as recordUpdateRunPhase, g as recordUpdateRunVerification, h as recordUpdateRunStep, i as finishInterruptedUpdateBeforeActivation, n as adoptUpdateRun, r as createUpdateRun, s as heartbeatUpdateRun, v as readRecoveries } from "./update-run-ledger-DLD5Q47c.js";
import { a as recordUpdateRunDiagnostics, l as isUpdateRunVerificationConfirmed, o as updateRunLedgerSchema, t as finishUpdateRun } from "./update-run-write-B_JenWiI.js";
import { a as readUpdateRunRecord } from "./update-run-read.kernel-8MZChvyU.js";
import { r as getUpdateRun } from "./update-run-reader-CA3WJ8vB.js";
import { i as updateRunStepsFromResultStep, r as isUpdateGatewayReadinessPending } from "./update-run-step-Bl6FePhX.js";
import { t as exitCliAfterOutput } from "./one-shot-exit-B3PJYhQA.js";
import { t as disableCurrentAssistantUpdateLaunchdJob } from "./launchd-D7dcSeIP.js";
import { c as resolveManagedServiceUpdateFailureExitCode, d as normalizeControlPlaneUpdateResult, s as readControlPlaneUpdateSentinelMeta } from "./update-control-plane-sentinel-DsR_Dem9.js";
import { a as resolveManagedUpdateRequester, n as createManagedUpdateRequesterAuthority, t as UpdateRequesterRevokedError } from "./update-requester-authority-NppA3WQu.js";
import { c as withOwnedManagedUpdateEnv, i as resolveServiceRefreshEnv, n as resolveOwnedManagedUpdateEnv } from "./update-command-service-env-DYcjXvvU.js";
import { i as parseDevUpdateTargetEnv, t as UPDATE_DEV_TARGET_REF_ENV } from "./update-dev-target-iraOEwDA.js";
import { A as createFreeBsdPkgOwnershipInspection, C as verifyPackageUpdateRecovery } from "./update-runner-command-DRKLhVpa.js";
import { t as readCurrentGitUpdateRecovery } from "./update-runner-git-recovery-DnU46Qxp.js";
import { d as UpdateCommandRecoveryPendingError, r as captureUpdateCommandExecutorAuthority, u as UpdateActivationTimeoutError } from "./update-command-executor-DuTNaN2c.js";
import { n as POST_CORE_UPDATE_ENV, t as POST_CORE_UPDATE_CHANNEL_ENV } from "./update-post-core-context-4DzUDiDA.js";
import { c as resolveUpdateInstallKind } from "./update-check-D4M5AA5a.js";
import { l as parseUpdateTimeoutMs, m as resolveUpdateRoot } from "./shared-BUgQgLm0.js";
import { n as printResult } from "./progress-CexvC1Oq.js";
import { n as assertUpdateRecoveryDirectoryAdmission, r as loadUpdateRecovery, t as assertUpdateRecoveryAdmission } from "./update-run-recovery-admission-yJ0TbWTp.js";
import { d as resolveManagedServicePackageUpdatePlan, i as assertGatewayServiceManagementAllowedForUpdate, l as readManagedGatewayServiceForUpdate, n as GatewayServiceUpdateOwnershipError, s as isGatewayServiceManagementAllowedForUpdate } from "./update-command-service-plan-CJ1UFeyr.js";
import { i as UpdateCommandPendingRecoveryFailure, n as UpdateCommandFailure, o as createUpdateCommandFailureResult, p as recordUpdateResultNextAction, r as UpdateCommandFinalizedRecoveryFailure, s as failUpdateCommandRun, t as UnreportedUpdateAdmissionOutcome, v as writeControlPlaneUpdateRestartSentinelBestEffort } from "./update-command-result-CBXlnujV.js";
import { a as resolveForegroundUpdateAdmission } from "./update-command-handoff-D4ZQzt2T.js";
import { a as revalidateUpdateDatabaseContext } from "./update-command-managed-context-C0iYNXEp.js";
