...
import { A as listAgentEntriesWithSource, O as hasAgentRosterProperty, T as tryResolveLegacyCompatibilityAgentId, k as listAgentEntries } from "./agent-scope-config-BEuqweC1.js";
...
import { c as resolveAgentExplicitModelPrimary, u as resolveAgentModelFallbacksOverride } from "./agent-scope-BiRi-Smp.js";
...
async function createRuntimeModelRefResolver() {
	const [agentScope, modelSelection] = await Promise.all([import("./agent-scope-BM4mAou3.js"), import("./model-selection-BItbyaBa.js")]);
	let modelModules;
	const loadModelModules = () => modelModules ??= Promise.all([import("./model-Bkiu6p3A.js"), import("./prepared-model-runtime-DBXu5YaT.js")]);
