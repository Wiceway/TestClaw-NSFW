...
import { c as readErrorName, u as toErrorObject } from "./error-coercion-C787aVxk.js";
...
import { C as parseRawSessionConversationRef, S as parseCronRunScopeSuffix, T as parseThreadSessionSuffix, a as classifySessionKeyShape, b as isCronSessionKey, c as resolveAgentIdFromSessionKey, k as parseAgentSessionKey, v as isAcpSessionKey, x as isSubagentSessionKey } from "./session-key-AvQIavYt.js";
import { t as formatErrorMessage } from "./errors-cp9Var1Z.js";
import { r as emitDiagnosticEvent } from "./diagnostic-events-CzmzgdMI.js";
...
import { i as resolveExplicitAgentSessionKey, r as resolveAgentMainSessionKey } from "./main-session-DzZK9knv.js";
...
import { a as mergeDeliveryContext, c as normalizeSessionDeliveryState, s as normalizeDeliveryContext } from "./delivery-context.shared-DQinGDrS.js";
import { n as isGatewayMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-9H_XKKih.js";
import "./message-channel-iCC7oIhe.js";
import { f as patchSessionEntryTarget } from "./session-accessor.sqlite-entry-CJ8WVyje.js";
import { n as beginSessionWorkAdmission } from "./session-lifecycle-admission-7kJ3kdsZ.js";
import { O as validateAgentRunDelegatedAuthority, a as clearAgentRunContext, c as getAgentRunContext, r as claimAgentRunContext } from "./agent-run-registry-DbPiDevk.js";
...
import { c as normalizeAgentRunTimeoutPhase, i as classifyAgentRunTerminalOutcome, n as AGENT_RUN_RESTART_ABORT_STOP_REASON } from "./agent-run-terminal-outcome-CRosFSL8.js";
import { l as getAgentEventLifecycleGeneration, t as assertAgentRunLifecycleGenerationCurrent, u as isAgentEventLifecycleGenerationCurrent } from "./agent-events-CFq48PcN.js";
...
import { F as hasSessionTranscriptEventsSync } from "./session-accessor-DMf92PxK.js";
import { t as ErrorCodes } from "./gateway-error-details-D4L8ZwC-.js";
import { n as errorShape, r as missingScopeErrorShape } from "./error-codes-DQWjOSek.js";
import { g as AGENT_SESSION_RESET_COMMAND_RE } from "./method-scopes-D0hbLMo0.js";
...
import { C as applySessionEntryReplacements } from "./session-accessor.reset-Cl1Mir1u.js";
import { t as clearAllCliSessions } from "./cli-session-binding-DqRmdzvi.js";
import { u as resolveRestartRecoveryChannelAuthority } from "./restart-recovery-state-Bc2gwEgq.js";
import { n as isExecutionIdentityCollectionEnabled } from "./audit-config-BXFCjLO0.js";
import { a as parseExecutionIdentityAdmissionToken, o as executionIdentitySpawnAdmission } from "./execution-identity-admission-B6Lrfbks.js";
import { a as createOperationalRunInstanceRef, f as resolveAdmittedRunActiveAssertion, i as createExecutionIdentityRecoveryAdmission, o as getAdmittedRunDelegatedAuthority } from "./admitted-run-context-BE5EAdRS.js";
import { r as isRetainedExecutionOwnerBinding, t as createExecutionStartedOwnerBinding } from "./execution-owner-binding-spQL-oQK.js";
import { K as mapAgentRunTerminalOutcomeToTaskStatus } from "./task-registry.store.kernel-Bnd9Ls7p.js";
...
import { s as isTimeoutError } from "./error-D_GewJgV.js";
...
import { m as captureTaskCancellationControl, x as getTaskRunOwner, y as bindTaskRunOwner } from "./task-registry-lFPM6OHy.js";
import { a as annotateInterSessionPromptText, h as normalizeInputProvenance, m as isSubagentCoordinationInputProvenance, u as isCompletionReportInputProvenance } from "./input-provenance-DGaz_sh7.js";
import { r as getTaskById } from "./task-registry-query-R9q--_2Z.js";
import { n as findTaskViewByRunIdAsync } from "./runtime-internal-CtpnHnDF.js";
import { a as finalizeTaskRunByRunId, c as prepareRunningTaskRun } from "./detached-task-runtime-BFCkmbS8.js";
...
import { a as attachAgentCommandAdmissionFacts, i as withAgentCommandExecutionIdentitySpawnFacts, o as attachAgentCommandRecoveryAdmissionFacts } from "./agent-command-execution-identity-CWSS99nB.js";
...
import { d as resolveSessionWorkStartError, s as hasTerminalMainSessionTranscriptNewerThanRegistrySync, u as resolveSessionLifecycleTimestamps } from "./lifecycle-DpcRUIUy.js";
import { i as resolveSessionResetPolicy, r as evaluateSessionFreshness, t as hasProviderOwnedSession } from "./entry-freshness-WwtUSunX.js";
import "./main-session-restart-recovery-shared-BNmDrEPh.js";
import { c as transitionMainSessionRecovery, t as getMainSessionRecoveryRetryCount } from "./main-session-recovery-state-jeJ60hDx.js";
import { a as releaseMainSessionRecoveryOwner, n as commitMainSessionRecovery } from "./main-session-recovery-store-Lj2mbsAU.js";
import { n as resolveSendPolicy } from "./send-policy-BpPQAAsR.js";
import { a as normalizeCronToolsAllowExecTarget, c as resolveCronToolsAllowExecTargetRecoveryError, i as normalizeCronScheduledToolPolicy, l as restoreCronPinnedExecGrant, r as normalizeCronScheduledToolCallerOrigin } from "./scheduled-tool-policy-CQE6r880.js";
import { h as resolveAgentRunSessionCreation, l as resolveCreatorSandbox, n as authorizeGatewaySessionCreation } from "./operator-role-policy-gPgbkoHA.js";
...
import { n as agentCommandFromGatewayIngress } from "./agent-command-BOcF0ZE4.js";
...
import { o as resolveTrustedGroupId } from "./agent-tools.policy-YnK9GY_V.js";
...
import { r as hasGeneratedMediaCompletionEvent } from "./internal-event-contract-pF6FHp8g.js";
import { r as resolveIngressWorkspaceOverrideForSessionRun } from "./spawned-context-orLaH93_.js";
import "./cli-session-BGcKF-Kc.js";
import { r as resolveExistingSessionKeyForRequest } from "./session-BPKOjr3V.js";
...
import { n as readAgentRunTerminalOutcome, t as readAgentRunTerminalError } from "./agent-run-terminal-outcome-DyU1LC7z.js";
import { i as buildRunUserTurnIdempotencyKey } from "./user-turn-transcript.metadata-BAAmUJGD.js";
import { c as readAgentRuntimeExecutionLineage, o as consumeAgentRuntimeExecutionLineage } from "./agent-runtime-identity-token-DB94ummf.js";
...
import { n as runWithCanonicalSkillWorkspace } from "./skill-workshop-workspace-context-BUfqeeR8.js";
import { t as assertPreparedSkillLibrarySelection } from "./selection-DpyzDWn0.js";
import { a as readInProcessSubagentResume } from "./server-plugin-runtime-client-B4BzDaVD.js";
import { n as consumeSubagentCompletionToolHandoff } from "./subagent-completion-tool-handoff-zQCxVtB0.js";
import { i as deleteMediaBuffer } from "./store-CiT93cXA.js";
import { t as createUserTurnTranscriptRecorder } from "./user-turn-transcript-9nytJfWI.js";
import { M as retainEmbeddedAgentRunAbortabilityForRunId, a as clearEmbeddedAgentRunAbortabilityForRunId, u as isEmbeddedAgentRunAbortableForRunId } from "./runs-CKg3ezhN.js";
...
import { T as gatewayClientSenderFields, a as authorizeResolvedSessionMutation } from "./session-sharing-policy-rVme8bnl.js";
...
import { o as resolveExactSubagentCompletionEvent } from "./requester-tool-policy-CkAQNbta.js";
import { n as resolveScheduledToolPolicyContext } from "./scheduled-tool-policy-e4v6VtLS.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-Dw0NNID2.js";
import { a as prepareParentSubagentResume, i as assertParentSubagentResumeSuccessorCurrent, r as assertParentSubagentResumeCurrent } from "./sessions-spawn-tool-lDYjL84K.js";
...
import { i as isExecApprovalFollowupSessionRebound, n as claimExecApprovalFollowupRuntimeHandoff, r as finalizeExecApprovalFollowupRuntimeHandoff, s as releaseExecApprovalFollowupRuntimeHandoff } from "./bash-tools.exec-approval-followup-state-BfxmdAgJ.js";
import { r as buildExecApprovalContinuationPrompt } from "./bash-tools.exec-approval-output-CTLhdKM-.js";
import { t as formatForLog } from "./ws-log-CZGKk4Rg.js";
import { a as setChannelSourceTurnSameThreadRequired, i as setChannelSourceTurnId } from "./source-turn-id-CFcRZLv8.js";
...
import { a as prepareSkillLibrarySessionCreation, i as retainGatewayOperatorRun, n as prepareGatewaySkillAuthoring, r as resolveGatewayInputParticipant } from "./skill-library-authoring-COuPPtT5.js";
import { f as updateChatRunProvider, l as resolveAgentRunExpiresAtMs, s as registerChatAbortController, t as abortChatRunById } from "./chat-abort-DEpgr_1N.js";
import { t as createChatAbortOps } from "./chat-abort-ops-lFr576Vk.js";
import { r as resolveGatewayCronCreatorAuthorityAdmission } from "./cron-creator-authority-admission-kUC-r5YW.js";
...
async function deliverBareSessionResetResult(params) {
	const { deliverAgentCommandResult } = await import("./delivery.runtime-Djh8z_tu.js");
...
async function registerPluginSubagentRunFromGateway(params) {
	...
	const { adoptPausedSubagentRunForFollowUp, registerSubagentRun } = await import("./subagent-registry-B89YIjYr.js");
