...
import { i as updateRecoverySchema, t as UpdateDestinationFailureSchema } from "./update-run-schema-CfrM5CV3.js";
import { a as redactSupportDiagnosticLine, o as redactSupportString, t as normalizeSupportDiagnosticErrorCode } from "./diagnostic-support-redaction-DgR7hMLl.js";
import { r as UPDATE_ENVIRONMENT_FAILURE_REASONS, t as SKIPPED_UPDATE_OUTCOMES } from "./update-outcome-Dj5_EBo1.js";
...
import { c as isServiceInspectionReason } from "./service-inspection-error-B0LJdIzc.js";
...
function loadPublicPluginIds() {
	publicPluginIds ??= Promise.all([import("./official-external-plugin-bundled-catalogs-CVFY6NcE.js"), import("./official-external-plugin-catalog-source-Qk3XqiXE.js")]).then(([catalogs, identities]) => {
...
function loadPublicDoctorCheckIds() {
	publicDoctorCheckIds ??= import("./doctor-health-contributions-wRpdbW3i.js").then((doctor) => doctor.resolveDoctorContributionHealthChecks()).then((checks) => new Set(checks.map((check) => check.id)));
