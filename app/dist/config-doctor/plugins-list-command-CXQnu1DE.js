...
async function loadHumanListModules() {
	const [sourceDisplay, table, themeModule, commandFormat, listFormat] = await Promise.all([
		import("./source-display-B7kNJCKJ.js"),
		import("./table-7sU0fOFD.js"),
		import("./theme-DuoAdBFg.js"),
		import("./command-format-D3Y_YGPO.js"),
		import("./plugins-list-format-BTJpeG8w.js")
	]);
	return {
...
async function runPluginsListCommand(opts, runtime = defaultRuntime) {
	const { buildPluginRegistrySnapshotReport } = await import("./status-snapshot-XS-vC29o.js");
