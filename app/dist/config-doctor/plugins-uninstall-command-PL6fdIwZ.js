...
async function runPluginUninstallCommand(ids, opts = {}, runtime = defaultRuntime) {
	...
	const { preparePluginUninstall, uninstallPluginWithPolicy } = await import("./management-uninstall-CduZVClc.js");
	const { formatUninstallActionLabels, resolveUninstallChannelConfigKeys } = await import("./uninstall-DGrNNIKQ.js");
	const { collectClawPluginUninstallWarnings } = await import("./uninstall-claw-references-CrXlsrcc.js");
	const { PromptInputClosedError, promptYesNo } = await import("./prompt-DurHTrbP.js");
