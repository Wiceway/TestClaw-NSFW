import { n as isRich } from "./theme-DLJw9KCD.js";
import { t as styleHealthChannelLine } from "./health-style-Cs0761hR.js";
...
import { a as buildGatewayProbeConnectionDetails, d as formatGatewayTransportErrorJson, i as buildGatewayConnectionDetails, l as formatGatewayAuthErrorJson, o as callGateway, p as isGatewayCredentialsRequiredError, u as formatGatewayClientRequestErrorJson } from "./call-CY0v-3Uc.js";
import { t as formatDurationCompact } from "./format-duration-CeDWULoS.js";
import { r as withProgress } from "./progress-47BE6b88.js";
import { t as formatExactDuration } from "./format-duration-exact-hT1gVF5x.js";
...
import { r as formatHealthChannelLines, t as formatDeliveryQueueHealthLine } from "./health-format-CuRv3MSd.js";
import { n as resolveHealthAccountContext } from "./account-context-C-u1bXWP.js";
import { a as GATEWAY_HEALTH_REACHABLE_LINE, c as gatewayConnectErrorWasRateLimited, l as gatewayProbeResultSawGateway, o as buildCredentialsRequiredHealthDiagnostic, s as buildRateLimitedHealthDiagnostic, u as gatewayProbeResultWasRateLimited } from "./gateway-health-auth-diagnostic-DQZTqXaT.js";
...
const loadConfigRuntime = async () => await import("./config-fCohulPn.js");
...
async function healthCommand(opts, runtime) {
	...
	if (opts.json) writeRuntimeJson(runtime, summary);
		...
		const { buildHealthAgentSummaries, resolveHealthAgentOrder } = await import("./collector-fyCj7kO_.js");
