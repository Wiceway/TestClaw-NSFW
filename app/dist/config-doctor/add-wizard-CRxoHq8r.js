...
import { S as tryResolveAgentOperationAgentId, j as listAgentIds, m as resolveConfiguredAgentId, t as AgentSelectionRequiredError } from "./agent-scope-config-BEuqweC1.js";
...
import { f as readCurrentConfigForPolicyCheck, u as readConfigFileSnapshotForWrite } from "./io.runtime-C0vFx1Ic.js";
...
import { t as applyAgentBindings } from "./agents.bindings-HbQwHWBw.js";
...
async function resolveInitialWizardChannelTarget(raw, cfg, workspaceDir) {
	...
	const [{ listActiveChannelSetupPlugins }, { resolveChannelSetupEntries }] = await Promise.all([import("./setup-registry-_RjhMPxy.js"), import("./discovery-Du67JCB8.js")]);
...
async function runChannelsAddWizardFlow(params) {
	...
	const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-BI8yjNY9.js"), import("./onboard-channels-DjATGXBW.js")]);
