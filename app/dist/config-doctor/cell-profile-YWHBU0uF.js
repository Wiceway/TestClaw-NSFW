...
const DEFAULT_FLEET_IMAGE = "ghcr.io/testclaw/testclaw:latest";
const FLEET_BASE_PORT = 19100;
const FLEET_GATEWAY_PORT = 18789;
const FLEET_CONTAINER_HOME = "/home/node";
const FLEET_CONTAINER_STATE_DIR = "/home/node/.testclaw";
const FLEET_CONTAINER_AUTH_SECRET_DIR = "/home/node/.config/testclaw";
const FLEET_TENANT_LABEL = "testclaw.fleet.tenant";
const FLEET_OWNER_LABEL = "testclaw.fleet.owner";
const FLEET_ATTEMPT_LABEL = "testclaw.fleet.attempt";
const FLEET_ENV_KEYS_LABEL = "testclaw.fleet.env-keys";
const FLEET_DISK_LIMIT_LABEL = "testclaw.fleet.disk-limit";
...
function buildCellEnvironment(token, userEnv) {
	...
	return {
		...
		TESTCLAW_HOME: FLEET_CONTAINER_HOME,
		TESTCLAW_STATE_DIR: FLEET_CONTAINER_STATE_DIR,
		TESTCLAW_CONFIG_PATH: `${FLEET_CONTAINER_STATE_DIR}/testclaw.json`,
		TESTCLAW_WORKSPACE_DIR: `${FLEET_CONTAINER_STATE_DIR}/workspace`,
		TESTCLAW_GATEWAY_TOKEN: token,
		XDG_CACHE_HOME: `${FLEET_CONTAINER_STATE_DIR}/cache`,
		...userEnv
	};
}
function cellContainerName(tenantId) {
	return `testclaw-cell-${validateTenantId(tenantId)}`;
}
