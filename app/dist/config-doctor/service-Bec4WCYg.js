import { B as WorkerSessionsSendParamsSchema, F as WorkerPortalParamsSchema, H as WorkerSessionsSpawnParamsSchema, tt as WorkerComputerResultSchema } from "./worker-admission-D2iU0J8C.js";
...
import { o as WorkerSessionAlreadyAttachedError } from "./testclaw-state-worker-error-DudqzgpE.js";
...
import { m as listAgentRunsForSession, p as hasLiveAgentRunContext } from "./agent-run-registry-DbPiDevk.js";
...
import { gt as WorkerOperatingSystemSchema, ht as WorkerMachineOptionsSchema } from "./agents-models-skills-Bo_uJkDM.js";
import { f as validateWorkerInferenceTerminalFrame, i as WORKER_PROTOCOL_MAX_INFERENCE_PAYLOAD_BYTES, p as validateWorkerInferenceTerminalOutcome, u as validateWorkerInferenceEventFrame } from "./worker-inference-B5p6MzmC.js";
...
import { o as matchesAgentLifecycleBinding, r as captureAgentLifecycleBinding } from "./agent-lifecycle-registry-BHA6mh5y.js";
import { o as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-3FPGpNUN.js";
import { c as ScreenSnapshotParamsSchema, o as ComputerActParamsSchema } from "./computer-use-contract-CJT9uLIu.js";
import { u as resolveGitRepositoryPaths } from "./git-C6UqFKot.js";
...
import { i as WorkerSkillWorkshopParamsSchema } from "./worker-skill-workshop-CYXgYvH-.js";
import { a as normalizeWorkerSshEndpoint } from "./store-native-publication-CBjzYlTV.js";
import { t as FORCED_WORKER_ABANDONMENT_ERROR, v as sameWorkerSessionTurnClaim, y as serializeWorkerSessionTurnClaim } from "./placement-record-C2yWLyZY.js";
...
import { r as workerLocalProjectKey, t as prepareWorkerProjectSnapshot } from "./workspace-git-base-_mmefrMP.js";
import { t as acknowledgeWorkerTurnFinishing } from "./placement-turn-claim-events-DHSjCCwa.js";
import { t as NodeWorkerComputerCloseParamsSchema } from "./node-computer-protocol-Bm2hCQFj.js";
import { i as registerWorkerInferenceSessionControl, t as WorkerInferenceSessionDrainBusyError } from "./inference-control-internal-Dk-ZtYoJ.js";
...
import { a as validateWorkerConnectionIdentity, c as createWorkerCredentialMaterial, l as hashWorkerCredential, n as StaleWorkerBuildError, o as verifyWorkerAdmissionHandshake, r as admitWorkerConnection } from "./admission-Do2L6F6_.js";
import { n as readWorkerProjectPreparation, t as createWorkerProjectPreparationIdentity } from "./preparation-identity-1cnOkjpc.js";
import { a as WorkerRuntimeRefreshPendingError, c as deriveEnvironmentIntent, i as readRepositoryWorkerProjectSnapshot, n as readWorkerProjectSetupRecipe, o as createWorkerRuntimeRefresher, r as readWorkerProjectSnapshot, t as createWorkerProjectPreparation } from "./project-preparation-BCmo2hFi.js";
import { n as workerBootstrapOperationTimeoutMs } from "./bootstrap-qeiHSLu3.js";
import { n as normalizeWorkerDesktopEndpoint } from "./store-BtlppN8w.js";
import { n as serializeWorkerSessionToolResult, r as workerSessionToolErrorResult } from "./worker-session-tool-result-CifqfWdr.js";
...
async function prepareRepositoryWorkerProjectSource(params) {
	...
	return {
		...
		...metadata.private ? { prepareGitPack: async (input) => {
			...
			const { prepareRepositoryWorkerGitPack } = await import("./repository-git-pack-CG-c-P4P.js");
			assertFetchCurrent();
