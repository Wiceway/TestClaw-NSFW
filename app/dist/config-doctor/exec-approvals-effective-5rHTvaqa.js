...
import { d as resolveExecModePolicy, u as resolveExecModeFromPolicy } from "./exec-approvals-core-BW9WjMmv.js";
import { c as resolveExecApprovalsDisplayPath, t as DEFAULT_EXEC_APPROVAL_ASK_FALLBACK } from "./exec-approvals-config-BN4b4XLr.js";
import { b as maxAsk, r as resolveExecApprovalsFromFile, w as resolveExecApprovalAllowedDecisions, x as minSecurity } from "./exec-approvals-9hAP-z4b.js";
...
function formatRequestedSource(params) {
	return params.sourcePath === "__default__" ? `Assistant default (${params.defaultValue})` : `${params.sourcePath}.${params.field}`;
}
function formatModeSource(params) {
	if (params.sourcePath === "__default__") return "derived from Assistant defaults";
...
function formatHostFieldSource(params) {
	...
	if (params.field === "askFallback") return `Assistant default (${DEFAULT_EXEC_APPROVAL_ASK_FALLBACK})`;
...
function resolveExecPolicyScopeSnapshot(params) {
	...
	return {
		...
		host: {
			...
			requestedSource: requestedHost.sourcePath === "__default__" ? "Assistant default (auto)" : `${requestedHost.sourcePath === "scope" ? params.configPath : requestedHost.sourcePath}.host`
		},
		mode: {
