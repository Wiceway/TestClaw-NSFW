...
import { u as resolveEffectiveUpdateChannel } from "./update-channels-BBbFgcw3.js";
...
import { r as requestNodeHostLauncherRestart, t as isNodeHostLauncherChild } from "./launcher-client-Bk5ZBI52.js";
import { c as resolveUpdateInstallKind, n as compareSemverStrings, o as resolveNpmChannelTag } from "./update-check-D4M5AA5a.js";
...
function startNodeHostAutoUpdate(params) {
	...
	const tryActivate = async () => {
		...
		paused = true;
		try {
			const { assertNodeRuntimeUpdateCompatible } = await import("./auto-update-compatibility-CFIkWcZZ.js");
			signal.throwIfAborted();
	...
	const check = async () => {
		...
		const { prepareNodeRuntimeUpdate } = await import("./auto-update-install-gc2GmJ1l.js");
