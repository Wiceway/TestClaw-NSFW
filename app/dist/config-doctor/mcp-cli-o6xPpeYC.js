...
import { y as parseStrictFiniteNumber } from "./number-coercion-0M4tZV2c.js";
import { t as createLazyRuntimeMethod } from "./lazy-runtime-CgCh8H_K.js";
...
import { n as operatorMcpOAuthIdentity } from "./mcp-oauth-identity-CcnMspqq.js";
import { u as readMcpOAuthStoreReadOnly } from "./mcp-oauth-store-BtgfVSNf.js";
import { a as completeMcpOAuthAuthorization, c as readMcpOAuthCredentialsStatus, f as startMcpOAuthAuthorization, n as clearMcpOAuthCredentials, s as countMcpOAuthPrincipals } from "./mcp-oauth-Z7lToIiK.js";
...
import { i as updateConfiguredMcpServerTools, n as unsetConfiguredMcpServer, r as updateConfiguredMcpServer, t as setConfiguredMcpServer } from "./mcp-config-mutation-CrTe8i56.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-CtHbbO7Z.js";
...
const createSessionMcpRuntime = createLazyRuntimeMethod(() => import("./agent-bundle-mcp-runtime-CDhu0xw2.js"), (runtime) => runtime.createSessionMcpRuntime);
const disposeAllSessionMcpRuntimes = createLazyRuntimeMethod(() => import("./agent-bundle-mcp-manager-api-BGkaAO-3.js"), (runtime) => runtime.disposeAllSessionMcpRuntimes);
...
async function readMcpProbeResult(runtime) {
	const { buildBundleMcpToolsFromCatalog } = await import("./agent-bundle-mcp-materialize-DpTbicdG.js");
...
function registerMcpCli(program) {
	...
	mcp.command("serve").description("Expose Assistant channels over MCP stdio").option("--url <url>", "Gateway WebSocket URL (defaults to gateway.remote.url when configured)").option("--token <token>", "Gateway token (if required)").option("--token-file <path>", "Read gateway token from file").option("--password <password>", "Gateway password (if required)").option("--password-file <path>", "Read gateway password from file").option("--claude-channel-mode <mode>", "Claude channel notification mode: auto, on, or off", "auto").option("-v, --verbose", "Verbose logging to stderr", false).action(async (opts) => {
		try {
			...
			const { serveAssistantChannelMcp } = await import("./channel-server-BeLjEUwP.js");
