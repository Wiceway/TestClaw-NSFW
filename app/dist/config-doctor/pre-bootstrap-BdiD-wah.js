...
import { _ as formatFutureConfigActionBlock, g as ALLOW_OLDER_BINARY_DESTRUCTIVE_ACTIONS_ENV, n as cloneEnvWithPlatformSemantics, o as createConfigRuntimeEnv, p as resetPublishedConfigRuntimeEnv, v as resolveFutureConfigActionBlock } from "./config-env-vars-CGWZEj0Z.js";
import { r as CONFIG_AUDIT_STORE_LABEL } from "./io.audit-OUHRrOvm.js";
...
import { a as resolveStartupConfigSnapshot, r as isStartupConfigRepairResult } from "./automatic-startup-config-repair-DKkpZDEd.js";
...
async function pinGatewayRunRuntimePaths() {
	const [{ pinRuntimePaths }, { pinConfigDir }] = await Promise.all([import("./paths-BkEiZ7Rh.js"), import("./utils-DJOF0N_1.js")]);
...
async function readGuardedGatewayRunConfig(params) {
	...
	const { createConfigIO } = await import("./io.factory-ZAIc2POP.js");
...
async function guardGatewayRunSelectedConfig(params) {
	...
	const [path, { applyConfigEnvVars, isConfigRuntimeEnvVarAllowed }, { loadGlobalRuntimeDotEnvFiles }, { normalizeEnv }, { normalizeStateDirEnv, resolveStateDir }, { resolveConfigDir }, { collectEnvSecretRefIds }, { clearMissingManagedServiceEnvKeys, readManagedSystemdServiceEnvKeysFromEnvironment }] = await Promise.all([
		import("node:path"),
		import("./config-env-vars-Dao9ia0x.js"),
		import("./dotenv-global-Br3mHdMo.js"),
		import("./env-DfraWN9s.js"),
		import("./paths-BkEiZ7Rh.js"),
		import("./utils-DJOF0N_1.js"),
		import("./resolution-facts-BwQTtlj7.js"),
		import("./service-managed-env-c5ieEoAu.js")
	]);
...
async function prepareGatewayRunBootstrap(params) {
	...
	const { planPristineStartupConfigMigrations, planPristineStartupStateMigrations } = await import("./pristine-startup-state-lvYd8h9W.js");
