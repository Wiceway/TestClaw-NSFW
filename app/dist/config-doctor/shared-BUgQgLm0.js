...
import { r as resolveBrewAssistantPath } from "./brew-RJsrRjnj.js";
...
import { o as UPDATE_INSTALL_SKIP_GUIDANCE } from "./update-outcome-Dj5_EBo1.js";
import { l as createUpdatePreflightFailure, r as normalizeUpdateFailureFacts } from "./update-failure-facts-CzM99Hgb.js";
...
import { n as COMPLETION_SKIP_PLUGIN_COMMANDS_ENV } from "./completion-runtime-R_70qtS5.js";
import { s as parseSemver } from "./runtime-guard-BdmhcCcQ.js";
import { A as createFreeBsdPkgOwnershipInspection, d as detectGlobalInstallManagerForRoot, i as runStep, l as createGlobalInstallEnv, o as canResolveRegistryVersionForPackageTarget, u as detectGlobalInstallManagerByPresence } from "./update-runner-command-DRKLhVpa.js";
import { r as resolveUnmanagedUpdateInstallReason, t as describeUpdateInstallRoot } from "./update-runner-install-surface-BZJ3RMOC.js";
import { r as fetchNpmTagVersion } from "./update-check-D4M5AA5a.js";
...
async function requestUpdateDowngradeConfirmation(params) {
	...
	const { stylePromptMessage } = await import("./prompt-style-B5EdoIoi.js");
...
async function confirmUpdateDowngrade(params) {
	const { finishUpdateRun } = await import("./update-run-ledger-BevfPmYr.js");
