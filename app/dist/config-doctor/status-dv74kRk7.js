...
import { o as isDefaultInstallIdentity, x as resolveIsNixMode } from "./paths-DeOFr7iP.js";
...
import { m as readSourceConfigBestEffort } from "./io.runtime-C0vFx1Ic.js";
...
import { n as readSessionSqliteMigrationWarnings } from "./doctor-session-sqlite-warnings-B7pYzDj1.js";
import { t as collectNodeRuntimeFindings } from "./node-runtime-diagnostics-apg00EaF.js";
import { i as formatGitInstallLabel, t as checkUpdateStatus } from "./update-check-D4M5AA5a.js";
import { a as resolveUpdateAvailability, i as resolveStatusRegistryUpdateChannel, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-CM8gQYqH.js";
import { t as readUpdateRunReportHealth } from "./update-run-report-health-BkWhIrCp.js";
import { t as readUpdateRunStatus } from "./update-run-status-DWw4zbdZ.js";
import { c as parseTimeoutMsOrExit, m as resolveUpdateRoot } from "./shared-BUgQgLm0.js";
//#region src/cli/update-cli/status.ts
async function readChannelStatusIssues(config, timeoutMs = 5e3) {
	try {
		const [{ callGateway }, { collectChannelStatusIssues }] = await Promise.all([import("./call-BUB0AMHV.js"), import("./channels-status-issues-x1ssd_NB.js")]);
