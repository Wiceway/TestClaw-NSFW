...
import { n as claimAgentRunApprovalAuthority, s as getActiveAgentRunDelegatedAuthority } from "./agent-run-registry-DbPiDevk.js";
...
import { i as resolveGatewayCredentialsFromConfig } from "./credentials-_4Zh4Pjr.js";
import { i as getGatewayToolCallerIdentity } from "./gateway-caller-context-BrVUu-N_.js";
import { a as verifyAgentRuntimeIdentityToken, c as readAgentRuntimeExecutionLineage, i as mintAgentRuntimeIdentityToken, n as createAgentRuntimeIdentity, s as createAgentRuntimeExecutionLineageHandoff } from "./agent-runtime-identity-token-DB94ummf.js";
import { a as resolveMessageActionTurnCapability } from "./message-action-turn-capability-DonQYF8t.js";
import { o as callGateway } from "./call-CY0v-3Uc.js";
import { t as getOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token--E4Uo0PU.js";
import { n as loadOrCreateDeviceIdentityAsync, t as loadDeviceIdentityIfPresentAsync } from "./device-identity-async-BHuPqegQ.js";
import { c as readPositiveIntegerParam, u as readToolStringParam } from "./common-Bkl7CqHm.js";
...
async function callGatewayTool(method, opts, params, extra) {
	...
	if (inProcess) {
		...
		const { callAgentToolGatewayRequest, withAgentToolGatewayRuntimeIdentity } = await import("./in-process-gateway-DyMO0Hm5.js");
