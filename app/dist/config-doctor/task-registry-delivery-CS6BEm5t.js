...
import { s as getGatewayRestartDrainSignal, u as isGatewayRestartDraining, x as runWithGatewayDetachedWorkContinuation } from "./gateway-work-admission-DJ5CkZgB.js";
import { A as filterTasksByRunScope, D as cloneTaskRecordForObserver, E as cloneTaskRecord, H as appendTaskEvent, I as pickPreferredRunIdTask, J as normalizeTaskSummary, M as isEquivalentTaskRecord, P as matchesTaskPersistenceReceipt, S as applyTaskRecordPatch, T as cloneTaskDeliveryState, X as resolveTaskTerminalOutcome, Z as shouldApplyRunScopedStatusUpdate, q as normalizeTaskStatus, y as readTaskBackingInstance, z as sameTaskRunScope } from "./task-registry.store.kernel-Bnd9Ls7p.js";
...
import { A as getTaskFlowRegistryStore, D as updateFlowRecordByIdExpectedRevision, d as getTaskFlowById, g as prepareTaskFlowRegistryRead, o as ensureTaskFlowRegistryReadyAsync, w as runTaskFlowRegistryWorkerMutation } from "./task-flow-runtime-internal-CxdyhxyJ.js";
...
import { C as updateRunIdIndex, _ as recordTaskRegistryProjectionWrite, d as deleteRelatedSessionKeyIndex, l as deleteOwnerKeyIndex, n as addParentFlowIdIndex, r as addRelatedSessionKeyIndex, t as addOwnerKeyIndex, u as deleteParentFlowIdIndex } from "./task-registry.process-state-DBhKov6B.js";
import { i as getTaskRegistryStore, l as tryPersistTaskUpsert } from "./task-registry.store-Di0Stfa8.js";
...
import { A as formatTaskTerminalMessage, D as shouldSuppressDuplicateTerminalDelivery, E as shouldAutoDeliverTaskTerminalUpdate, T as shouldAutoDeliverTaskStateChange, a as queueBlockedTaskFollowup, c as resolveTaskStateChangeIdempotencyKey, i as getPeerTasksForDelivery, j as shouldUseParentReviewTaskTerminalMessage, k as formatTaskStateChangeMessage, l as resolveTaskTerminalIdempotencyKey, n as canDeliverTaskToRequesterOrigin, o as queueTaskSystemEvent, s as resolveTaskDeliveryOwner, t as canDeliverParentReviewTaskToThreadOrigin } from "./task-notification-routing-CYDaelCz.js";
import { _ as ensureLinkedTaskFlowRegistryReady, d as listTasksForFlowId } from "./task-registry-query-R9q--_2Z.js";
import { i as loadTaskRegistryDeliveryRuntime } from "./task-registry-runtime-loaders-CxcY7ell.js";
...
function captureTaskNotificationMutationOwner(assertDeliveryCurrent) {
	...
	const startMutation = (command) => {
		...
		const operation = Promise.resolve().then(async () => {
			assertCurrent();
			const { settleTaskRecordTransitionAsync } = await import("./task-executor-transition.async-kuYxpstX.js");
		...
		async prepare(consume, subagentChildSessionKey) {
			...
			for (;;) {
				...
				if (subagentChildSessionKey) {
					const { withPreparedLatestSubagentRunByChildSessionKey } = await import("./subagent-registry-read-FCaxGrkj.js");
					assertCurrent();
...
//#endregion
export { updateTaskWithPublication as a, runTaskRecordTransitionOperation as c, retainTaskMutationFlowEffects as d, updateTask as i, captureTaskMutationContext as l, maybeDeliverTaskTerminalUpdate as n, isOneTaskFlowEligible as o, publishTaskRecordUpdate as r, prepareTaskRecordUpdate as s, maybeDeliverTaskStateChangeUpdate as t, finishTaskMutation as u };
