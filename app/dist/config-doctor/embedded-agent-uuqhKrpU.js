...
import { S as parseCronRunScopeSuffix, c as resolveAgentIdFromSessionKey, k as parseAgentSessionKey } from "./session-key-AvQIavYt.js";
import "./redact-myZeUWr_.js";
import { t as formatErrorMessage } from "./errors-cp9Var1Z.js";
import { t as classifyGatewayStorageFailure } from "./sqlite-error-diagnostics-E0F_10pq.js";
import { C as freezeDiagnosticTraceContext, r as emitDiagnosticEvent, t as areDiagnosticsEnabledForProcess } from "./diagnostic-events-CzmzgdMI.js";
import { t as createSubsystemLogger } from "./subsystem-B0s_EQTq.js";
import "./sqlite-live-snapshot-C0XwFcJs.js";
import { t as redactIdentifier } from "./node-crypto-p3a5nOcB.js";
import { T as string, g as literal, w as strictObject, y as number } from "./schemas-D6YHSiZI.js";
...
import { n as withPluginRuntimeGenerationScope, t as runOutsidePluginRuntimeGenerationScope } from "./generation-scope-DFHRRtMK.js";
...
import { _ as resolveSessionAgentId, g as resolveRunModelFallbacksOverride, h as resolveModelFallbackAvailability, y as resolveSessionAgentIds } from "./agent-scope-BiRi-Smp.js";
import { t as providerModelRouteAcceptsAuthMode } from "./provider-model-route-auth-DkAaX3ui.js";
import { i as modelMatchesProviderModelRoute, r as isProviderModelRerouted } from "./provider-model-route-DOpiS-VB.js";
import { o as resolvePreparedModelThinkingCompat } from "./model-catalog-lookup-_Hi_clcB.js";
import { c as resolveContextConfigProviderForRuntime, d as resolveSelectedOpenAIRuntimeProvider, n as OPENAI_PROVIDER_ID } from "./openai-routing-BXJ-qR2p.js";
...
import { o as isMarkdownCapableMessageChannel } from "./message-channel-iCC7oIhe.js";
import { n as parseSqliteSessionFileMarker, t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-BYC4PoOZ.js";
import { M as listSessionEntriesReadOnly, d as patchSessionEntryCore, l as loadSessionEntryReadOnly, s as loadSessionEntry } from "./session-accessor.sqlite-entry-CJ8WVyje.js";
import { n as beginSessionWorkAdmission } from "./session-lifecycle-admission-7kJ3kdsZ.js";
import { T as retainQueuedAgentRunContext, _ as registerAgentRunContext, c as getAgentRunContext, r as claimAgentRunContext } from "./agent-run-registry-DbPiDevk.js";
import { i as classifyAgentRunTerminalOutcome } from "./agent-run-terminal-outcome-CRosFSL8.js";
import { i as emitAgentEvent, l as getAgentEventLifecycleGeneration, n as captureAgentRunLifecycleGeneration, p as onAgentEventForRun, s as emitAgentEventIfCurrent, t as assertAgentRunLifecycleGenerationCurrent, u as isAgentEventLifecycleGenerationCurrent, y as withAgentRunLifecycleGeneration } from "./agent-events-CFq48PcN.js";
import "./session-cold-storage-state-Dw0_36rK.js";
...
import { Q as selectVisibleTranscriptEvents } from "./session-accessor.sqlite-transcript-store-BX2GNujg.js";
...
import { d as withOwnedSessionTranscriptWrites, l as runWithoutOwnedSessionTranscriptWrites, t as SessionTranscriptWriterClaimReboundError } from "./transcript-write-context-CW-keGmb.js";
import { U as appendTranscriptMessage, X as withTranscriptWriteLock, tt as projectPublicSessionEntry } from "./session-accessor-DMf92PxK.js";
import { l as updateSessionEntry } from "./session-accessor.reset-Cl1Mir1u.js";
import { t as prepareSessionEntryPresenceRead } from "./session-transcript-worker-runtime-CBtrr-9r.js";
import { h as resolveSessionPinnedHarnessId } from "./agent-harness-session-key-Bbf-OONo.js";
import { n as deriveContextPromptTokens, u as normalizeUsage } from "./usage-C3K3M4jZ.js";
import "./user-profile-list-CfxnGEeA.js";
import "./user-profiles-oLBI9gsy.js";
import { n as readLatestSessionTranscriptMessageEvent } from "./session-accessor.sqlite-active-events-CuvrkABH.js";
import { i as resolveSessionTranscriptRuntimeTarget, t as bindSessionTranscriptStoreScope } from "./session-accessor.transcript-target-BQlRWMsR.js";
import { f as resolveAdmittedRunActiveAssertion, o as getAdmittedRunDelegatedAuthority, p as resolvePreparedRunAdmission } from "./admitted-run-context-BE5EAdRS.js";
import { y as requireActivePluginRegistry } from "./runtime-B980B6n3.js";
import { l as projectAgentRunAttemptTerminal, r as buildAgentRunTerminalOutcomeFromAttempt } from "./agent-run-terminal-outcome-Dfr6s7I1.js";
import { m as isTimeoutErrorMessage, u as isProviderRequestSizeCeilingError } from "./message-patterns-CDG01Jhe.js";
import { i as getFailoverErrorCode, t as FailoverError } from "./error-D_GewJgV.js";
import { a as createAgentRunDirectAbortError, m as resolveAgentRunErrorLifecycleFields } from "./run-termination-Ig3BzvZQ.js";
import { a as formatBillingErrorMessage, f as renderAuthProfileFailoverCopy } from "./user-copy-CP-Iqg-t.js";
import { n as OAuthRefreshFailureError } from "./oauth-refresh-failure-DLQDPLGc.js";
import { h as parseImageSizeError, m as parseImageDimensionError } from "./classify-core-DfbxbHyL.js";
import { t as AgentHarnessPreflightError } from "./errors-Bd6GQRkh.js";
import { S as observeReplyDelivery, w as resolveReplyExpectation } from "./task-notification-routing-CYDaelCz.js";
import { d as captureAgentPluginRuntimeRefresh, f as createAgentPluginRuntimeRefresh } from "./agent-tools.before-tool-call-BwZqazXs.js";
import { c as resolveFastModeModelAutoOnSeconds, n as formatFastModeAutoProgressText, s as resolveFastModeForElapsed } from "./fast-mode-B_XB5FSo.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-B45lHO9j.js";
import { T as setReplyPayloadMetadata, _ as isReplyPayloadTerminalContent, a as copyReplyPayloadMetadata, j as hasReplyPayloadContent, s as getReplyPayloadMetadata, t as FAST_MODE_AUTO_PROGRESS_KIND, x as markReplyPayloadForSourceSuppressionDelivery } from "./reply-payload-Ds4kei43.js";
import { n as resolveAgentTimeoutMs } from "./timeout-CchFM1Z3.js";
import { c as resolveSecretSentinel, o as looksLikeSecretSentinel } from "./sentinel-De2SwPfV.js";
...
import { n as readProviderRefusalReview, t as isProviderRefusalAssistantError } from "./diagnostics-CAGhEztD.js";
import { d as resolveSessionWorkStartError, g as createSessionProviderReview, h as claimProviderReviewAttempt, p as assertSessionProviderReviewWorkStart, v as readProviderReviewAcknowledgment, y as recordSessionProviderReview } from "./lifecycle-DpcRUIUy.js";
import { a as resolveMirroredTranscriptText } from "./transcript-scRUtjvw.js";
import { r as resolveEmbeddedRunTerminalToolFailure } from "./terminal-tool-failure-DZbIPAR8.js";
import { Y as revokeRuntimeAuthMaterializations, q as recordRuntimeAuthMaterialization } from "./runtime-snapshots-LZfHFeGe.js";
import { r as applyPreparedRuntimeAuthToModel, s as getModelProviderRequestRouteFacts } from "./provider-local-service-reconcile-DGJJw1a3.js";
import { I as MissingProviderAuthError, v as isConfigBackedInlineProviderApiKey } from "./loader-runtime-load-B2ergWe-.js";
import { n as inheritRuntimeCompactionDelegate, t as bindContextEngineCompaction } from "./compaction-watchdog-Cg7dxcCu.js";
import { c as resolveContextEngineOwnerPluginId, s as resolveContextEngine } from "./registry-Tav6IqeL.js";
import { O as resolveSubscriptionAuthModeForProfiles, h as isProfileInCooldown, x as resolveProfilesUnavailableReason } from "./order-D7DJivFp.js";
import { d as resolveProviderRuntimePluginHandle, o as resolveProviderAuthProfileId, t as attachModelProviderRuntimePluginHandle } from "./provider-hook-runtime-AjNWsmeV.js";
import { a as isLikelyContextOverflowError, n as classifyFailoverSignal, r as isFailoverErrorMessage, t as classifyFailoverReason } from "./classify-g_cTi4L9.js";
import { n as recordModelFallbackStop } from "./model-fallback-stop-iEWdge8e.js";
import { a as findCliTerminalStopError, f as resolveFailoverReasonFromError, i as describeFailoverError, l as hasRecordedModelFallbackStop, p as resolveFailoverStatus, r as coerceToFailoverError, u as isCliTerminalStopCode } from "./failover-error-D845uGox.js";
import { a as getCommandLaneSnapshot, l as isCommandLaneTaskTimeoutError, r as enqueueCommandInLane } from "./command-queue-BKEY7Dlw.js";
import "./control-reply-text-DBCNOdDS.js";
import "./chat-display-projection.helpers-CRHULe2N.js";
import { i as assertPreparedModelRuntimeInputCurrent } from "./prepared-model-runtime.errors-18hyOf9a.js";
import { _ as prepareProviderRuntimeAuth, y as providerOwnsDynamicModelPreparation } from "./provider-runtime-B3-FZB4p.js";
...
import { n as isTerminalAssistantError, t as isRetryableAssistantError } from "./retry-aTvyL7NL.js";
import { i as markAuthProfileSuccess } from "./repair-BgK-Q2lS.js";
import "./auth-profiles-pp6W0I8V.js";
import { n as markAuthProfileFailure, r as markInlineProviderApiKeyFailure } from "./usage-6TTU-a96.js";
import { t as sanitizeForConsole } from "./console-sanitize-CaBHLewO.js";
import { i as getApiKeyForModelCore, n as applyLocalNoAuthHeaderOverride, t as applyAuthHeaderOverride } from "./model-auth-Dgz6ND6Q.js";
...
import { c as resolveAgentHarnessPreparedRouteSupport, r as assertPluginHarnessConversationToolPolicySupport, s as resolveAgentHarnessPreparedAuthSupport } from "./availability-BgNV4tHv.js";
import { a as resolveCandidateThinkingLevel } from "./thinking-runtime-DiGMOYgI.js";
import { a as prepareAgentWorkspaceAttachments } from "./workspace-access-B2mkdxzZ.js";
import { n as TESTCLAW_EMBEDDED_CONTEXT_ENGINE_HOST } from "./host-compat-BhcTjWs2.js";
...
import { a as resolveSessionKeyForRequestCore, o as resolveStoredSessionKeyForSessionId } from "./session-BPKOjr3V.js";
...
import { i as withPreparedModelRuntimePluginGenerationScope, n as getPreparedModelRuntimePluginGeneration, r as runOutsidePreparedModelRuntimePluginGenerationScope } from "./prepared-model-runtime-generation-scope-Dbh_MtQt.js";
import { a as acquireReadOnlyPreparedModelRuntime, t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-CvkqszTA.js";
import { b as resolveSourceReplyDelivery, h as hasOutboundDeliveryEvidence, m as hasMessagingToolDeliveryEvidence } from "./delivery-evidence-CDgoalBx.js";
...
import { n as mergeAttemptToolMediaPayloads, t as createPendingToolMediaCarry } from "./tool-media-payloads-BM91CJJ6.js";
import "./user-turn-transcript.metadata-BAAmUJGD.js";
import { n as mintMessageActionTurnCapability, o as resolveMessageActionTurnCapabilityLifetime, s as revokeMessageActionTurnCapability, t as isTrustedMessageActionTurnIngress } from "./message-action-turn-capability-DonQYF8t.js";
import { t as estimateAggregateUsageCost } from "./usage-format-Bkf9MeNp.js";
import { t as beginForegroundSessionMaintenance } from "./coordinator-D9EGY-yX.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-R_Tm-ora.js";
import { a as resolveDelegationCapability } from "./agent-tools-CQ5emKZ2.js";
import { r as isHeartbeatLifecycleRunKind } from "./skill-workshop-workspace-context-BUfqeeR8.js";
import { $ as isStrictAgenticExecutionContractActive, B as hasYieldContinuationEvidence, Dt as createEmbeddedRunStageTracker, Et as createEmbeddedRunStageSummaryEmitter, F as getProviderPromptState, G as shouldRetryMissingAssistantTurn, H as resolveReplayInvalidFlag, I as markLastProviderPromptContextRejected, J as resolveSettledToolBatchEvidence, K as resolveEmptyResponseRetryInstruction, L as createAttemptCarryover, Nt as prepareEmbeddedSkills, Ot as formatEmbeddedRunStageSummary, P as clearProviderPromptState, Q as countSettledTurnDeliveryPayloads, R as TRUNCATED_REPLY_NOTICE_TEXT, St as runBestEffortCallback, Tt as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, U as resolveRunLivenessState, V as resolveIncompleteTurnPayloadText, W as resolveSilentToolResultReplyPayload, X as shouldRetrySilentErrorAssistantTurn, Y as resolveSettledToolTerminalContinuationInstruction, Z as shouldTreatEmptyAssistantReplyAsSilent, _t as resolveEmbeddedRunAttemptTerminalOutcome, at as prepareEmbeddedAttemptPromptExecution, bt as observeReplayMetadata, et as hasAsyncActivity, gt as isEmbeddedRunTimeoutFinal, ht as isEmbeddedRunTerminalTimeout, i as resolveSettledTurnFinalizationText, it as shouldContinueInteractiveAcceptedSessionSpawns, j as measureEmbeddedAgentPreparation, mt as isEmbeddedRunTerminalInterrupted, nt as isCurrentAttemptReplaySafe, o as applyAgentRunSessionTargetIdentity, ot as applyResolvedToolPromptFinalizer, pt as isEmbeddedRunTerminalAbort, q as resolveReasoningOnlyRetryInstruction, rt as resolveCurrentAttemptAssistant, s as resolveAgentRunSessionTarget, tt as hasAttemptTerminalState, u as resolveEmbeddedSessionContextLimits, vt as resolveEmbeddedRunAttemptTerminalState, xt as createToolTerminalObserver, yt as createEmbeddedRunReplayState, z as YIELD_DIAGNOSTIC_TEXT } from "./builtin-testclaw-D8svmGKw.js";
import { i as resolveLiveToolResultMaxChars } from "./tool-result-limits-Lx_h0EBk.js";
import { t as log$4 } from "./logger-BFBxDn9c.js";
import { a as remapSkillReferencePaths } from "./runtime-capabilities-CXOtoB1T.js";
import { i as resolveRetryAfterMs, r as hasLongWindowRateLimitEvidence, t as classifyRateLimitWindow } from "./retry-evidence-r2MRZSDb.js";
import { a as isFailoverAssistantError, i as isBillingAssistantError, n as classifyAssistantFailoverReason, o as isRateLimitAssistantError, r as isAuthAssistantError, t as buildAssistantFailoverSignal } from "./assistant-message-failures-CEIqmlfG.js";
import { _ as extractObservedOverflowTokenCount, h as formatUserFacingAssistantErrorText, m as formatAssistantErrorText, s as pickFallbackThinkingLevel, v as isCompactionFailureError } from "./embedded-agent-helpers-Cqdg7msJ.js";
import { i as resolveCurrentSourceMessagingToolPartial, r as normalizeTextForComparison } from "./messaging-dedupe-CV3bjnn4.js";
import { l as shouldIncludeProgressCardToolForAssistantTools } from "./testclaw-tools-DNer_RKI.js";
import { s as buildContextEngineRuntimeSettings } from "./context-engine-lifecycle-KAuS8LLd.js";
import { i as resolveSessionPermissionExecMode } from "./session-permission-exec-mode-BzTqSt6n.js";
import { n as resolveHarnessWorkspace, t as resolveAttemptWorkspaceSandbox } from "./workspace-sandbox-BgaUx8VA.js";
import { s as sessionLikelyHasOversizedToolResults, u as truncateOversizedToolResultsInSessionManager } from "./tool-result-truncation-BJlekSxn.js";
import { i as getEmbeddedSessionPromptState, l as prepareEmbeddedSessionActiveProjectKeys } from "./session-prompt-state-DrtDfyMQ.js";
...
import { n as mapThinkingLevelForProvider } from "./utils-7Z-554WK.js";
import { a as forgetPromptBuildDrainCacheForRun, d as resolveContextEngineCapabilities, f as buildEmbeddedCompactionRuntimeContext, n as waitForDeferredTurnMaintenanceForSession, p as resolveCompactionContextTokenBudget, t as runContextEngineMaintenance, v as listActiveProcessSessionReferences } from "./context-engine-maintenance-CYyEcyUi.js";
...
import { n as canRunPreparedAgentRuntimeAuthAttempt, r as prepareAgentRuntimeAuth } from "./prepare-auth-BjNxXpdc.js";
import { a as buildUsageAgentMetaFields, c as resolveActiveErrorContext, d as resolveFinalAssistantVisibleText, f as resolveLatestCallUsage, i as buildErrorAgentMeta, l as resolveEmbeddedAttemptBasePrompt, m as resolveReportedModelRef, n as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, o as createRunRecoveryDiagId, p as resolveMaxRunRetryIterations, r as RUNTIME_AUTH_REFRESH_RETRY_MS, s as normalizeAssistantUsageForContext, t as RUNTIME_AUTH_REFRESH_MARGIN_MS, u as resolveFinalAssistantRawText } from "./helpers-Cf_K4Mz5.js";
import { t as emitAgentActivityEvent } from "./agent-activity-events-D9Q3Q7vm.js";
import { r as isExecLikeToolName } from "./tool-error-summary-BaGFLXPN.js";
import { r as mergeAcceptedSessionSpawnsForRun } from "./accepted-session-spawn-DkICVXqZ.js";
import { n as buildAgentHookContextIdentityFields, t as buildAgentHookContextChannelFields } from "./hook-agent-context-C34HDoNk.js";
import "./sessions-DZ4KAu7C.js";
import "./reply-run-registry.registry-HFAU31nF.js";
import { _ as resolveCompactionTimeoutMs, h as compactContextEngineWithSafetyTimeout } from "./diagnostic-BpBZkcBo.js";
import { n as resolveSessionPlacementTurnSettlementAssertion } from "./session-placement-forced-terminal-settlement-IJxHlJBn.js";
import { C as resolveActiveEmbeddedRunHandleSessionIdBySessionFile, N as setActiveEmbeddedRun, P as supersedeEmbeddedAgentRunByRunId, S as resolveActiveEmbeddedRunHandleSessionId, f as isEmbeddedAgentRunHandleActive, g as markEmbeddedRunRecoveringTimeout, i as clearActiveEmbeddedRun, j as restoreEmbeddedRunTimeoutAbandonment } from "./runs-CKg3ezhN.js";
import { i as toNormalizedUsage, n as mergeAttemptRunStatsIntoAccumulator, r as mergeUsageIntoAccumulator, t as createUsageAccumulator } from "./usage-accumulator-CIKTNR4i.js";
import { t as ensureContextEnginesInitialized } from "./init-BonoIl6z.js";
import { r as isBackgroundWorkLane } from "./background-work-BSUE43Rn.js";
import "./session-transcript-entry-message-CmdK_pJw.js";
...
import "./session-display-projection-BofAJNvj.js";
import "./session-utils-display-0bRfLd7U.js";
import { n as registerAgentRunCapacityWait } from "./agent-run-capacity-wait-CVvo1Uxt.js";
import "./session-transcript-readers-D3eaTHpA.js";
import { r as buildUsageWithNoCost, t as buildAssistantMessage } from "./stream-message-shared-DXRciV40.js";
import { t as createTrajectoryRuntimeRecorder } from "./runtime-CI9lo7So.js";
...
import { _ as buildApiErrorObservationFields, y as shouldSuppressRawErrorConsoleSuffix } from "./model-fallback-attempt-BPoUA1Sl.js";
import { n as classifyCompactionReason, t as DEFERRED_CONTEXT_ENGINE_COMPACTION_REASON } from "./compact-reasons-YKHfUYtS.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-DBQPRU0c.js";
import { h as LiveSessionModelSwitchError, m as shouldUseTransientCooldownProbeSlot } from "./result-fallback-classifier-Dy1kJhGA.js";
import { i as resolveSessionSuspensionTarget, o as suspendSession, r as resolveSessionSuspensionReason } from "./session-suspension-DjKGzDsr.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-CVttd5qX.js";
import { i as resolveMessagingToolPayloadDedupe, n as filterMessagingToolReplyPayload, t as filterMessagingToolMediaDuplicates } from "./reply-payloads-dedupe-DSnD9NT1.js";
import "./active-run-projections-B6zm9PS3.js";
import { n as resolveModelAsync, t as createEmptyAgentDiscoveryStores } from "./model-B5xF_8T4.js";
import { r as resolveSystemPromptRepoRoot } from "./system-prompt-params-QRdUBVTd.js";
import { a as selectContextEngineForTranscriptHost, i as createContextEngineLogicalTurnLease, n as drainPendingContextEngineTurnsBeforeRun } from "./context-engine-turn-attempt-B2MZPSvu.js";
import { n as resolveAgentHarnessNativeToolPolicyRestricted, t as assertAgentHarnessExecutionEnvironment } from "./execution-environment-B9x6G36U.js";
import { i as selectAgentHarnessForPreparedModelProviders, n as runAgentHarnessSettledTurnFinalization, r as selectAgentHarness, t as runAgentHarnessAttempt } from "./selection-C3496UGG.js";
import { t as createAssistantErrorTranscript } from "./assistant-error-transcript-CX8t5or2.js";
import { a as resolveSessionPlacementSandbox, c as EMBEDDED_RUN_LANE_TIMEOUT_GRACE_MS, d as shouldNoteLaneWait, f as withEmbeddedRunLaneTimeout, l as resolveEmbeddedRunLaneTimeoutMs, m as settleRequesterRun, p as settleFailedRequesterRun, s as withSessionPlacementTurnAdmission, u as resolveEmbeddedRunSessionLanePolicy } from "./session-placement-admission-BJJE66dy.js";
import { r as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-DHCxJFYD.js";
...
import { t as resolveExternalCliAuthOverlayScopeFromSelection } from "./external-cli-auth-selection-DZ37PWMB.js";
import { a as fingerprintResolvedAuthProfileCredential, i as fingerprintOpaqueRuntimeOwner, n as fingerprintAuthProfileOwnerShape, o as fingerprintResolvedProviderAuth, r as fingerprintAwsSdkRuntimeOwner } from "./execution-auth-binding-CnsJRKRM.js";
import { r as stripAssistantMcpToolPrefix } from "./tool-policy-CGS64Qk1.js";
import { r as hasPairedCardRenderer } from "./device-pairing-CHVB12nQ.js";
import { n as resolveRunWorkspaceDir, r as recordAdmittedModelRoutingDecision, t as redactRunIdentifier } from "./workspace-run-BHD357gu.js";
import { t as protectPreparedProviderRuntimeAuth } from "./provider-runtime-auth-protection-B63vLHbk.js";
import { t as materializePreparedRuntimeModel } from "./materialize-model-BtgxqjPl.js";
import { i as resolveCredentialScopedAuthAttemptModelDecision, n as hasPreparedAuthAttemptModelMetadata, r as providerUsesCredentialScopedModelMetadata, t as createPreparedRuntimeModelMaterializer } from "./credential-scoped-model-C2VTnM3c.js";
import { n as buildHandledBeforeAgentReplyPayloads, r as runBeforeAgentReplyForTurn, t as resolveAuthProfileFailureReason } from "./auth-profile-failure-policy-Yg40XSLp.js";
import { t as buildEmbeddedRunPayloads } from "./payloads-D93MgGhX.js";
import { n as readChannelSourceTurnId, r as readChannelSourceTurnSameThreadRequired } from "./source-turn-id-CFcRZLv8.js";
import { i as isRecoverableNativeHarnessBindingFailure, n as resolveContextEngineCompactionSuccessor, r as maybeCompactAgentHarnessSession, t as acceptCompactionSuccessor } from "./compaction-successor-D5_m43lr.js";
import { a as setTranscriptBytePreflightClaim, c as resolveTieredModel, d as projectCodexHostTranscriptBytePreflightConfig, f as resolveCompactionRuntimeSelection, h as resolveProjectKey, i as resolveTranscriptBytePreflightAuthority, l as attachCompactionAccountingRecorder, m as runPostCompactionSideEffects, n as compactNativeCliSession, p as asCompactionHookRunner, s as buildAgentRuntimePlan, u as prepareCompactionHarnessAuth } from "./compact-jIWA2Bat.js";
import { n as resolveAgentLifecycleTerminalMetadata, t as createAgentLifecycleTerminalBackstop } from "./agent-lifecycle-terminal-BPBd8u4L.js";
import { t as resolveEmbeddedCliBackendDispatchEligibility } from "./cli-backend-dispatch-eligibility-7N1JcnY7.js";
import { a as resolveHookModelSelection, i as resolveEmbeddedRuntimeModelPolicy, n as createNativeModelOwnedRuntimeModel, r as resolveAgentHarnessRunAdmissionError, t as buildBeforeModelResolveAttachments } from "./setup-DGkhy7_a.js";
import { t as createEmbeddedRunPermissionChanges } from "./permission-change-CbRK3FxS.js";
import { t as captureAgentRunProviderReview } from "./provider-review-terminal-Bev_jQXD.js";
import { t as resolveGitCoauthorAttribution } from "./git-coauthor-attribution-CHyu9nVZ.js";
import { n as agentHarnessExposesAssistantTools, t as agentHarnessBuildsAssistantTools } from "./tool-surface-3xu_-s3Q.js";
import { n as resolveSessionSkillResourceSnapshot } from "./session-placement-skill-resources-DwA3986B.js";
import { o as prepareGitHubPublicationAvailability } from "./github-publication-availability-DCPDRC4e.js";
import { a as resolveRequestStreamTransportOverrides, i as resolveInitialThinkLevel, n as resolveAttemptTrajectoryAttribution, r as resolveInitialEmbeddedRunModel } from "./runtime-resolution-Br0r_WNk.js";
import { r as readSourceReplyDeliveryRuntime } from "./source-reply-delivery-runtime-CxW5X9hr.js";
import "./chat-display-projection-C8q6oDEf.js";
import { t as applyPreparedReplyMedia } from "./reply-media-paths-DUztLq4c.js";
...
async function runEmbeddedAgentViaCliBackend(params, dispatch) {
	const { runCliAgent } = await import("./cli-runner.runtime-b5Og3Ge1.js");
		...
		async settle(attempt) {
			...
			if (refusal?.category === "misalignment" && assistant?.stopReason === "error" && params.sessionPersistence !== "detached") {
				...
				try {
					...
					try {
						const { clearSessionQueues } = await import("./cleanup-CzfT56gY.js");
						assertCurrent();
...
//#endregion
export { withSessionTranscriptWriteLock as n, compactEmbeddedAgentSession as r, runEmbeddedAgent as t };
