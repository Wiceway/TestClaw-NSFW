...
import { n as resolveBundledProviderPolicySurface, r as resolveProviderPolicySurface } from "./provider-public-artifacts-dXokXAXw.js";
import { r as matchesProviderPluginRef } from "./provider-registry-shared-Cu63TehG.js";
import "./provider-failover-D4XkUNZE.js";
import { a as nativePluginBindings } from "./loader-runtime-load-B2ergWe-.js";
import { d as resolveOwningPluginIdsForProvider, f as resolveOwningPluginIdsForProviderRef, i as resolveCatalogHookProviderPluginIds, m as resolveUsageHookProviderPluginContracts, p as resolveProviderRefOwnership } from "./providers-BJqVIQwV.js";
import { a as resolveLoadedProviderRuntimePlugin, c as resolveProviderHookPlugin, l as resolveProviderPluginsForHooks, n as ensureProviderRuntimePluginHandle, u as resolveProviderRuntimePlugin } from "./provider-hook-runtime-AjNWsmeV.js";
import { n as getRegisteredAgentHarness } from "./registry-DEnV0Kfy.js";
import { n as mergePluginTextTransforms, t as applyPluginTextReplacements } from "./plugin-text-transforms-DZbBeQ88.js";
import { i as unwrapSecretSentinelsForProviderEgress } from "./provider-secret-egress-gSti772c.js";
import { a as providerUsageLabel } from "./provider-usage.shared-DWke4i1Y.js";
import { n as resolvePluginDiscoveryProvidersRuntime } from "./provider-discovery.runtime-CtuPMDTI.js";
...
async function resolveProviderUsageSnapshotWithPlugin(params) {
	...
	if (!harness) {
		...
		const { withAgentPluginRegistry } = await import("./runtime-plugins-BgH1q0Nj.js");
		const { ensureSelectedAgentHarnessPlugin } = await import("./runtime-plugin-BH40Cf9T.js");
