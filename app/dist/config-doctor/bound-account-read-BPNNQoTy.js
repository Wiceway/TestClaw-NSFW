...
import { a as routeBindingScopeMatches, i as resolveNormalizedRouteBindingMatch, n as normalizeRouteBindingId, r as normalizeRouteBindingRoles, t as normalizeRouteBindingChannelId } from "./binding-scope-B5G3-w8D.js";
import { t as normalizeChatType } from "./chat-type-VRUlDKAl.js";
import { r as listConfiguredBindings, t as isRouteBinding } from "./bindings-CI-O7TMQ.js";
import { s as peerKindMatches } from "./resolve-route-BBuGiPPu.js";
...
function resolveFirstBoundAccountId(params) {
	...
	const scope = {
		...
		get memberRoleIds() {
			return params.memberRoleIds ? memberRoleIds ??= new Set(params.memberRoleIds) : void 0;
		}
	};
	...
	for (const binding of listConfiguredBindings(params.cfg)) {
		...
		if (!routeBindingScopeMatches(resolved, scope)) continue;
