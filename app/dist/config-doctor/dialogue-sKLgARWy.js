import { c as isInvalidConfigSetOperation, o as parseSystemAgentOperation, r as describeSystemAgentPersistentOperation } from "./operations-parse-CJ16l1J7.js";
import "./operations-BB1UEP4Y.js";
import { a as resolveSystemAgentVerifiedInferenceRoute } from "./verified-inference-CVC2Uoay.js";
import { t as SystemAgentInferenceUnavailableError } from "./inference-error-DWG7NHn3.js";
import { i as loadSystemAgentOverview } from "./overview-BGFW4MAR.js";
...
async function resolveSystemAgentOperation(input, runtime, opts) {
	...
	const planner = opts.planWithAssistant ?? (await import("./assistant-CJP8gS32.js")).planSystemAgentCommand;
	let plan;
	try {
		plan = await planner({
			input,
