...
import { o as modelSelectionShouldEnsureCodexPlugin, s as parseModelRefProvider } from "./openai-routing-BjbLRc1p.mjs";
...
async function repairRuntimePluginInstallForModelSelection(params) {
	...
	const { repairMissingPluginInstallsForIds } = await import("./missing-configured-plugin-install-CH62redj.mjs");
