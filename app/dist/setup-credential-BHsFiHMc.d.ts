...
import { d as SecretInput } from "./types.secrets-BR-Cncxg.js";
import { d as ChannelSetupAdapter } from "./manifest-registry-BbQfGHTp.js";
import { a as ChannelSetupWizardCredential, c as PromptAccountId, n as ChannelSetupWizard, o as ChannelSetupWizardStatus, p as WizardPrompter, s as ChannelSetupWizardTextInput, t as ChannelSetupDmPolicy } from "./setup-wizard-types-CW2TaT9P.js";
import { u as ChannelSetupPromotionSurface } from "./setup-helpers-CO8RKx0A.js";
...
declare function setTopLevelChannelDmPolicyWithAllowFrom(params: {
  ...
  channel: string;
  dmPolicy: DmPolicy;
  getAllowFrom?: (cfg: TestclawConfig) => Array<string | number> | undefined;
}): TestclawConfig;
declare function createTopLevelChannelDmPolicy(params: {
  ...
  policyKey: string;
  allowFromKey: string;
  getCurrent: (cfg: TestclawConfig) => DmPolicy;
...
declare function createTopLevelChannelDmPolicySetter(params: {
  channel: string;
  getAllowFrom?: (cfg: TestclawConfig) => Array<string | number> | undefined;
}): (cfg: TestclawConfig, dmPolicy: DmPolicy) => TestclawConfig;
declare function createTopLevelChannelAllowFromSetter(params: {
  channel: string;
  enabled?: boolean;
}): (cfg: TestclawConfig, allowFrom: string[]) => TestclawConfig;
declare function createTopLevelChannelGroupPolicySetter(params: {
  channel: string;
  enabled?: boolean;
}): (cfg: TestclawConfig, groupPolicy: "open" | "allowlist" | "disabled") => TestclawConfig;
...
declare function setSetupChannelEnabled(cfg: TestclawConfig, channel: string, enabled: boolean): TestclawConfig;
...
declare function runSingleChannelSecretStep(params: {
  ...
  applyUseEnv?: (cfg: TestclawConfig) => TestclawConfig | Promise<TestclawConfig>;
  applySet?: (cfg: TestclawConfig, value: SecretInput, resolvedValue: string) => TestclawConfig | Promise<TestclawConfig>;
}): Promise<{
  cfg: TestclawConfig;
...
declare function promptParsedAllowFromForAccount<TConfig extends TestclawConfig>(params: {
  cfg: TConfig;
  accountId?: string;
  defaultAccountId: string;
...
declare function createPromptParsedAllowFromForAccount<TConfig extends TestclawConfig>(params: {
...
declare function createTopLevelChannelParsedAllowFromPrompt(params: {
  channel: string;
  defaultAccountId: string | ((cfg: TestclawConfig) => string);
  enabled?: boolean;
  noteTitle?: string;
  noteLines?: string[];
  message: string;
  placeholder: string;
  parseEntries: (raw: string) => ParsedAllowFromResult;
  getExistingAllowFrom?: (cfg: TestclawConfig) => Array<string | number>;
  mergeEntries?: (params: {
    existing: Array<string | number>;
    parsed: string[];
  }) => string[];
...
declare function createAllowlistSetupWizardProxy<TGroupResolved>(params: {
  loadWizard: () => Promise<ChannelSetupWizard>;
  createBase: (handlers: {
    promptAllowFrom: (params: PromptAllowFromParams) => Promise<TestclawConfig>;
...
type TokenCredentialParams<TAccount extends ResolvedCredentialAccount> = Omit<ChannelSetupWizardCredential, "inspect" | "applySet" | "applyUseEnv"> & {
  ...
  patchAccount?: (params: CredentialPatchParams<TAccount>) => TestclawConfig | Promise<TestclawConfig>;
  set?: {
    clearFields?: string[];
