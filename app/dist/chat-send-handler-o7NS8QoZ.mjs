...
import { A as parseAgentSessionKey, D as resolveSessionDispatchKind, S as isSubagentSessionKey, m as scopeLegacySessionKeyToAgent, x as isCronSessionKey, y as isAcpSessionKey$1 } from "./session-key-C_bfgyCp.mjs";
...
import { n as emitDiagnosticsTimelineEvent, o as measureDiagnosticsTimelineSpan, s as measureDiagnosticsTimelineSpanSync } from "./diagnostics-timeline-CE0XVKRv.mjs";
...
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-C2LdSyZM.mjs";
...
import { a as isInternalMessageChannel, i as isGatewayCliClient, l as isWebchatClient, n as isBrowserOperatorUiClient, s as isOperatorUiClient, t as isBrowserCopilotClient } from "./message-channel-C5zrzt0f.mjs";
import { a as loadOrCreateProcessDeviceIdentity } from "./device-identity-DxW0pian.mjs";
import { t as ErrorCodes } from "./gateway-error-details-D85F07e9.mjs";
import { Rg as readAgentRuntimeRestrictionErrorDetails, _h as formatValidationErrors, q as validateChatSendParams, zg as isCloudWorkerPlacementState } from "./src-BNV0SJoP.mjs";
...
import { a as clearAgentRunContext, c as getAgentRunContext, r as claimAgentRunContext } from "./agent-run-registry-DmVqATcC.mjs";
...
import { a as readSessionTranscriptRunId, r as onInternalSessionTranscriptUpdate } from "./transcript-events-2IQDJBb1.mjs";
import { r as hasGlobalHooks, t as getGlobalHookRunner } from "./hook-runner-global-eA1aRrLi.mjs";
...
import { c as runWithOwnedSessionTranscriptWrite, i as captureOwnedTranscriptWriteAssertion, t as SessionTranscriptWriterClaimReboundError } from "./transcript-write-context-DD1eJxQX.mjs";
import { o as resolveSessionRoutingContract, r as resolveAgentMainSessionKey, t as SESSION_ROUTING_CHANGED_ERROR_REASON } from "./main-session-E7DOhW9Q.mjs";
import { i as resolveCommandAuthorization } from "./command-auth-DGAhZSN0.mjs";
import { i as prepareSessionParticipantInput } from "./host-context-builder-BkWvew0V.mjs";
...
import "./channel-outbound-DFUa-qia.mjs";
import { n as getRegisteredAgentHarness } from "./registry-C_fuy_an.mjs";
import { a as isAgentHarnessSessionKey, m as resolveMissingAgentHarnessSessionError } from "./agent-harness-session-key-J-d5OkuD.mjs";
...
import { f as interruptSessionWorkAdmissions, n as beginSessionWorkAdmission, p as isCompetingSessionWorkAdmissionActive } from "./session-lifecycle-admission-8OlXMJli.mjs";
...
import { j as recordAssistantManagedMediaUrls, k as applyAssistantDeliveryDirectives, s as loadTranscriptEventRowsAfterSeqSync } from "./session-accessor.sqlite-read-jqSNqbjI.mjs";
...
import { a as sanitizeReplyDirectiveId, n as parseInlineDirectives, s as stripInlineDirectiveTagsForDelivery } from "./directive-tags-POTcKgXn.mjs";
...
import { at as normalizeMessageClientSources, d as readSessionTranscriptWatermark, g as buildRestartRecoveryExpectedState, k as rewriteTranscriptMessageAtAnchor, nt as readSessionSubmittedInput, v as SessionGoalOperationError, y as lookupSessionGoalOperation } from "./session-accessor-CtBBLApI.mjs";
...
import { n as formatChatWorkContext, t as captureChatWorkContext } from "./work-context-DbM-9rw7.mjs";
import { a as hasRestartRecoveryTerminalRun, t as buildRestartRecoveryClaimCleanupPatch } from "./restart-recovery-state-BKIzpuLl.mjs";
import { n as resolveSessionTranscriptDatabasePath } from "./session-accessor.transcript-target-I2MKxREg.mjs";
import { a as readSessionTranscriptActivePathEntryRelation } from "./session-accessor.sqlite-active-events-CM5yNO6K.mjs";
...
import { n as isInternalSourceReplyChannel } from "./source-reply-delivery-mode-D3Apdk4j.mjs";
import { g as progressCardRefreshRunProjection, h as normalizeInputProvenance, p as isProgressCardRefreshInputProvenance } from "./input-provenance-C_XMHkN_.mjs";
...
import { i as resolveTextCommand } from "./commands-registry-normalize-D_t-v1PZ.mjs";
import { a as shouldComputeCommandAuthorized } from "./command-detection-CLXcpXCd.mjs";
...
import { W as REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS, _ as isReplyRunAbortableForSignal } from "./reply-run-registry.state-0DtmpREE.mjs";
import { E as finalizeReplyMessageInjectionAttempt, T as beginReplyMessageInjectionTarget, c as interruptReplyRunTarget, h as replyRunRegistry } from "./reply-run-registry.registry-CVdu99y8.mjs";
import "./reply-run-registry-C6CtjXiK.mjs";
import { a as logMessageReceived, r as logMessageProcessed } from "./diagnostic-CjDzLGgv.mjs";
import { n as listActiveEmbeddedRunSessionIds } from "./active-run-projections-BihqvttO.mjs";
import "./sessions-QjbxjKuh.mjs";
import { b as retireProviderReviewAcknowledgment, d as resolveSessionWorkStartError, v as readProviderReviewAcknowledgment } from "./lifecycle-DX3moz6p.mjs";
...
import { n as splitMediaFromOutput } from "./reply-directives-Ca_shzJt.mjs";
...
import { i as withChannelReadAuthority, t as captureChannelReadAuthority } from "./channel-read-authority-BHkhzers.mjs";
import { n as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-DpTMne3_.mjs";
...
import { i as dispatchInboundMessageWithProjectedDispatcher } from "./dispatch-CVeZAiNb.mjs";
import { a as emitInboundMessageAuditTerminal, r as emitMessageReceivedHooks, s as DispatchSessionRefreshRequiredError } from "./dispatch-from-config-CdQiTkYH.mjs";
...
import { o as isMainSessionRecoveryReconciliationCandidate } from "./main-session-recovery-state-B4QBDXeq.mjs";
...
import { a as isChatStopCommandText, f as updateChatRunProvider, i as isChatAbortControllerEntryAbortable, s as registerChatAbortController, u as resolveChatRunExpiresAtMs } from "./chat-abort-CNLBLnF-.mjs";
import { n as appendChatCanvasBlocksToMessage, o as isToolHistoryBlockType } from "./chat-display-projection.canvas-CLqGX0v7.mjs";
import { n as isSuppressedControlReplyText } from "./control-reply-text-CuBh_CaB.mjs";
import { n as chatRunBelongsToSelectedAgent, r as resolveChatRunOwnerAgentId } from "./chat-run-owner-NKQwqiCy.mjs";
import { t as chatAbortMarkerTimestampMs } from "./server-chat-state-s6eZWEwx.mjs";
import { a as registerQueuedChatTurn, o as retireQueuedChatTurnCancellation, r as completeQueuedChatTurn } from "./chat-queued-turns-DzHkfrdt.mjs";
...
import { l as resolveDeletedAgentIdFromSessionKey, r as loadGatewaySessionEntry } from "./session-utils-store-BVoy_pJn.mjs";
import { o as hasPendingFollowupQueueWork } from "./state-BiFUkrFk.mjs";
import { E as gatewayClientSessionCreator, O as resolveChatSendCallerContext, T as gatewayClientSenderFields } from "./session-sharing-policy-gt4OMoUR.mjs";
import { r as hasTrackedActiveSessionRun } from "./session-active-runs-B7nF2tZH.mjs";
import { t as SessionMutationAuthorizationChangedError } from "./session-mutation-authorization-error-CCz8QGWh.mjs";
import { t as ExpectedProfileMismatchError } from "./expected-profile-CzQ2eY_c.mjs";
import { t as resolveSessionMutationAuthorization } from "./session-sharing-ByqW1ZoJ.mjs";
import "./session-utils-CUcWGvVN.mjs";
import { n as readSessionMessageByIdAsync } from "./session-transcript-readers-DgYp6UTC.mjs";
...
import { n as buildInboundUserContextPrefix } from "./inbound-meta-CD27cSzj.mjs";
...
import { r as githubApiToken } from "./github-public-api-XWoQpu0y.mjs";
...
import { h as resolveProjectDirectory } from "./project-registry-DkFSqSMs.mjs";
import { n as resolveExplicitSessionName, t as hasExplicitSessionName } from "./session-title-state-BQCPqYS_.mjs";
import { a as buildManagedMediaFailureBlock, d as prepareOutgoingMediaFromReplyPayload, i as attachManagedOutgoingMediaToMessage, p as removeManagedOutgoingMediaBlocks, s as createManagedOutgoingMediaBlocks } from "./managed-image-attachments-BRMIS9SL.mjs";
import { a as hasAssistantDisplayMediaContent, c as isMediaBearingPayload, d as stripManagedOutgoingAssistantContentBlocks, i as extractAssistantDisplayText, l as prepareAssistantDisplayText, n as buildAssistantReplyContentFromInputs, o as hasManagedOutgoingAssistantContent, r as combineNonStreamingReplyParts, s as hasVisibleAssistantFinalMessage, u as sanitizeAssistantDisplayText } from "./chat-assistant-content-C-tEYKYK.mjs";
import { r as setGatewayDedupeEntry, t as captureAgentJobSession } from "./agent-job-D2lVOt0a.mjs";
import { a as discardPreparedInboundMedia, c as persistInboundImagesForTranscript, i as UnsupportedAttachmentError, l as stripImageMediaMarkers, n as INLINE_IMAGE_DURABLE_OMISSION_MARKER, o as logAttachmentFailure, r as MediaOffloadError, s as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-Bo1xFyYM.mjs";
import { i as persistGatewaySessionLifecycleEvent, n as deriveGatewaySessionLifecycleSnapshot } from "./session-event-payload-C6MsfOsM.mjs";
import { r as emitSessionsChanged } from "./session-change-event-DJR94g0D.mjs";
import { a as prepareSkillLibrarySessionCreation, i as retainGatewayOperatorRun, n as prepareGatewaySkillAuthoring, r as resolveGatewayInputParticipant, t as invalidateSkillAuthoringForOtherRequester } from "./skill-library-authoring-BN5l4A99.mjs";
import { t as createChatAbortOps } from "./chat-abort-ops-lFr576Vk.mjs";
import { r as withAbortedPartialPersistenceWarning, t as abortedPartialPersistenceError } from "./chat-aborted-partial-AYvMDMAj.mjs";
import { t as resolveSessionWorkspaceRoots } from "./session-workspace-roots-CdiU8XoZ.mjs";
import { a as shouldIncludeChatSendAckServerTiming, i as roundedChatSendTimingMs, n as emitOperatorChatSendServerTiming, r as resolveControlUiReconnectResumeParams, t as chatSendAckServerTimingAttributes } from "./chat-server-timing-Ol7N6U2x.mjs";
import { n as pendingChatSendDedupeKey, t as PENDING_CHAT_SEND_DEDUPE_PREFIX } from "./server-shared-C-7Ahu3n.mjs";
import { r as hasActiveAgentRuntimeAuthority } from "./agent-runtime-authority-BbJvP-mx.mjs";
import { n as normalizeUnknownChatText, t as normalizeOptionalChatText } from "./chat-text-normalization-HsVzW9xs.mjs";
import { a as descendantAbortError, d as readPreRegisteredRun, f as resolveChatAbortRequester, m as writePreRegisteredChatAbort, o as buildAbortedChatSendPayload, t as abortChatRunsForSessionKeyWithPartials } from "./chat-abort-runtime-SXuuU9qT.mjs";
...
import { a as broadcastSideResult, i as broadcastChatTerminal, n as broadcastChatError, o as isBtwReplyPayload, r as broadcastChatFinal, s as isSourceReplyTranscriptMirrorPayload, t as broadcastChatDelta, u as sanitizeChatSendMessageInput } from "./chat-broadcast-CU8LLIwI.mjs";
import { i as maybeGenerateDashboardSessionTitle, n as generateWorktreeSessionTitle, r as isDashboardSessionTitleCandidate, t as buildDashboardSessionTitleSource } from "./dashboard-session-title-B7IFWwjj.mjs";
import { t as captureGatewayUiCommandTarget } from "./ui-command-target-C6KJjlQM.mjs";
import { n as refreshProjectClone, t as materializeProjectClone } from "./project-clone-DIwIPQLC.mjs";
...
import { r as resolveSessionWorktreeBase, t as prepareSessionWorktree } from "./session-worktree-preparation-CHLumVPR.mjs";
import { i as resolveSessionNativeRuntimeRestriction, o as normalizeSessionToolOverrides, s as sessionToolOverridesEqual } from "./sessions-patch-model-selection-BdGiDSAz.mjs";
...
async function prestageMediaPathOffloads(params) {
	...
	try {
		const [{ ensureSandboxWorkspaceForSession }, { SANDBOX_MEDIA_MAX_BYTES, stageSandboxMedia }] = await Promise.all([import("./context-AinW0JGs.mjs"), import("./stage-sandbox-media-lwooy6ld.mjs")]);
		params.abortSignal.throwIfAborted();
...
async function runChatSendPreAdmission(params) {
	...
	if (entry && isMainSessionRecoveryReconciliationCandidate(entry)) {
		const { reconcileOrphanedGatewaySessionRecovery } = await import("./session-recovery-service-jolVkjC2.mjs");
		try {
...
async function prepareChatSendNativeRuntimeRestriction(params) {
	...
	const [{ loadReplySessionInitializationSnapshot, commitReplySessionInitialization }, { recordSessionCreated }] = await Promise.all([import("./session-accessor.reset-DcTqfPkR.mjs"), import("./session-created-CpZOkOTE.mjs")]);
	params.assertCurrent?.();
	const scope = {
		agentId,
		sessionKey,
...
const mediaDocumentContextLoader = createLazyImportLoader(() => import("./file-context-CUE05sAQ.mjs"));
