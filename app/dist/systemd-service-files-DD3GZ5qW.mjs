...
import { a as collectConfigServiceEnvVars } from "./config-env-vars-DSeyJ5Sb.mjs";
import { a as findServiceOwnershipRefusal, i as ServiceOwnershipRefusalError, n as ServiceDefinitionInspectionError, r as ServiceInspectionError } from "./service-inspection-error-DLyDrlb3.mjs";
...
async function readSystemdServiceExecStart(env, options) {
	try {
		const target = options?.systemdReadTarget ?? await (await import("./systemd-scope-a8DBafo7.mjs")).findInstalledSystemdGatewayScope(env);
		const opts = target ? {
			...options,
