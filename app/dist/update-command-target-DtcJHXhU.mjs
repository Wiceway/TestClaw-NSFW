...
import { g as SqliteReadOnlyInspectionContentionError } from "./sqlite-readonly-worker-6W33iy-a.mjs";
import { a as channelToNpmTag, r as EXTENDED_STABLE_TAG_UNSUPPORTED_REASON, u as resolveEffectiveUpdateChannel } from "./update-channels-D-eqC5La.mjs";
import { i as UPDATE_FOREIGN_DESTINATION_REASON } from "./update-outcome-Dj5_EBo1.mjs";
import { l as createUpdatePreflightFailure, n as createUpdateFailureFact } from "./update-failure-facts-CQQBnbzM.mjs";
...
import { A as createFreeBsdPkgOwnershipInspection, D as resolveNpmGlobalPrefixLayoutFromGlobalRoot, T as probeNpmGlobalPrefix, _ as resolveGlobalInstallSpec, l as createGlobalInstallEnv, m as isPackageTargetAlreadyCurrent, o as canResolveRegistryVersionForPackageTarget, v as resolveGlobalInstallTarget, w as inspectNpmLauncher, y as resolveNpmLifecyclePolicyGate } from "./update-runner-command-Dn-V6rM4.mjs";
import { i as resolveUpdateInstallSurface, r as resolveUnmanagedUpdateInstallReason, t as describeUpdateInstallRoot } from "./update-runner-install-surface-DkLXK-KU.mjs";
import { t as resolveNodeRunner } from "./node-runner-Cua6MUxg.mjs";
import { r as captureUpdateCommandExecutorAuthority } from "./update-command-executor-C_9Me3Ow.mjs";
import { _ as readDevUpdateTarget, f as assertUpdatePackageActivationAdmission, o as reportPreMutationUpdateResult, v as recordUpdateCommandTarget } from "./update-command-terminal-BZCyq7aD.mjs";
import { a as resolveExtendedStablePackage, n as compareSemverStrings, o as resolveNpmChannelTag } from "./update-check-iRYMjMOk.mjs";
import { f as resolveGlobalManager, n as UpdatePreMutationError, p as resolveTargetVersion, s as normalizeTag, t as DEFAULT_PACKAGE_NAME } from "./shared-hPUQ-y6A.mjs";
...
import { r as resolveCanonicalPath } from "./package-update-manager-preflight-ZuGnGbnx.mjs";
import { t as CLI_NAME } from "./cli-name-CJ5c6edK.mjs";
import { r as UPDATE_DESTINATION_RECOVERY } from "./update-failure-facts-format-CZkbXnqQ.mjs";
import { a as gatewayServiceCommandUsesRoot, d as resolveManagedServicePackageUpdatePlan, l as readManagedGatewayServiceForUpdate, s as isGatewayServiceManagementAllowedForUpdate } from "./update-command-service-plan-BvweOT5A.mjs";
...
import { i as readUpdateCandidateSource } from "./update-command-managed-context-D58QmDxh.mjs";
