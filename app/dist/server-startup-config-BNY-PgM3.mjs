...
import { b as applyConfigOverrides } from "./io.snapshot-B8cv2I8b.mjs";
import { b as resolveIsConfigReadOnly, l as isNixMode } from "./paths-DvpAEtA8.mjs";
import { i as tryGetLegacyDefaultAgentId, r as retainLegacyDefaultAgentId, t as inheritLegacyDefaultAgentId } from "./legacy.default-agent-owner-C-WRgKDI.mjs";
...
import { i as materializeLegacyDefaultAgentRoles } from "./legacy.roster-D3iAUtdH.mjs";
...
import { n as evaluateGatewayAuthSurfaceStates, t as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-gateway-auth-surfaces-BF7PWFjR.mjs";
import { a as isProviderScopedSecretResolutionError, n as describeSecretResolutionOperatorDiagnostic, o as isSecretResolutionError, r as describeSecretResolutionOperatorRecovery } from "./resolve-errors-YgWEeepi.mjs";
...
import { n as formatPluginPackagingRuntimeOutputRecoveryHint, t as formatInvalidConfigRecoveryHint } from "./config-recovery-hints-CttFawkt.mjs";
...
import { a as classifySecretResolutionErrorDegradations, h as redactSecretDegradationReason, l as isRetryableSecretDegradationReason, m as listSecretResolutionErrorOwners, t as SECRET_DEGRADATION_RETRY_HINT } from "./runtime-degraded-state-C2v6LD8h.mjs";
import { c as hasLegacyAuthProfileSourcesForStartup } from "./legacy-source-diagnostic-C3oR-sYo.mjs";
import { _ as registerProviderAuthRuntimeSnapshotActivationOwner, f as graftActiveSecretsRuntimeAuthState, g as hasSameSecretReloadContract, l as getActiveSecretsRuntimeSnapshotRevisionState, m as hasCurrentAuthStoreCredentialsRevision, n as activateSecretsRuntimeSnapshotState, p as hasActiveSecretsRuntimeSnapshotLineage, u as getActiveSecretsRuntimeSnapshotState } from "./runtime-state-p_Glf0Cm.mjs";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-Mga9Up7v.mjs";
import { n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-BRavxagO.mjs";
import { a as prepareSecretsRuntimeFastPathSnapshot, n as collectCandidateAgentDirs } from "./runtime-fast-path-Gx01Xv9e.mjs";
...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = createLazyPromise(() => import("./runtime-xnvnIymm.mjs"), { cacheRejections: true });
	const loadAuthProfiles = createLazyPromise(() => import("./auth-profiles-Dpn4Ykj8.mjs"), { cacheRejections: true });
