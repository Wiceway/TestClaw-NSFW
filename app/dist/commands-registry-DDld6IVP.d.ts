...
import { r as ThinkingCatalogEntry } from "./thinking.shared-v9njecCe.js";
import { l as NativeCommandSpec, o as CommandDetection, r as CommandArgDefinition, s as CommandNormalizeOptions, t as ChatCommandDefinition, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-DCRSSKne.js";
...
declare function isCommandEnabled(cfg: TestclawConfig, commandKey: string): boolean;
/** Lists commands visible for a specific config, preserving dynamic skill commands. */
declare function listChatCommandsForConfig(cfg: TestclawConfig, params?: {
  skillCommands?: SkillCommandSpec[];
}): ChatCommandDefinition[];
//#endregion
...
declare function getCommandDetection(_cfg?: TestclawConfig): CommandDetection;
/** Resolves a raw text command to the matching normalized alias when known. */
declare function maybeResolveTextAlias(raw: string, cfg?: TestclawConfig): string | null;
/** Resolves a raw text command into its command definition and raw argument tail. */
declare function resolveTextCommand(raw: string, cfg?: TestclawConfig): {
...
declare function listNativeCommandSpecsForConfig(cfg: TestclawConfig, params?: {
  skillCommands?: SkillCommandSpec[];
  provider?: string;
} & NativeCommandProviderLookupOptions): NativeCommandSpec[];
