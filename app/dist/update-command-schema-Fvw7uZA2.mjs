...
import { l as createUpdatePreflightFailure } from "./update-failure-facts-CQQBnbzM.mjs";
import { r as theme } from "./theme-DzaUZY4q.mjs";
import { i as runCommandWithTimeout } from "./exec-BddaUUYf.mjs";
import { t as CommandProcessCleanupError } from "./exec-result-DDSLXVaJ.mjs";
...
import { c as withUpdateCommandExecutorChild } from "./update-command-executor-C_9Me3Ow.mjs";
import { C as createUpdateCommandAuthority } from "./update-command-terminal-BZCyq7aD.mjs";
import { d as resolveGitInstallDir, n as UpdatePreMutationError } from "./shared-hPUQ-y6A.mjs";
import { c as resolveUpdateStateContentVersion, o as readUpdateStateSchemaVersions } from "./update-candidate-state-JShE70Pv.mjs";
import { t as prepareUpdateCommandNativeGate } from "./update-command-native-gate-CQdMGbmx.mjs";
import { t as checkGlobalPackageUpdatePermissions } from "./package-update-manager-preflight-ZuGnGbnx.mjs";
import { n as printResult } from "./progress-BO9Yypli.mjs";
import { f as resolvePackageRuntimePreflight } from "./update-command-service-plan-BvweOT5A.mjs";
import { i as hasSchemaRefusal, n as checkTargetDatabaseSchemasForContexts, r as formatSchemaRefusalLines } from "./schema-preflight-BSE2UQ3z.mjs";
...
async function preflightUpdateCommandSchemas(params) {
	...
	if ((opts.dryRun || updateInstallKind === "package") && updateInstallKind !== "unknown") try {
		const { inspectUpdateDatabaseContexts } = await import("./update-command-database-context-Byr7wBam.mjs");
		const { inspectGitDryRunTargetSchemaVersions } = await import("./update-command-git-CWmZgia7.mjs");
