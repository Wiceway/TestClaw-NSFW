import { $p as removeProviderAuthProfilesWithLock, Al as ProviderAuthMethod, Fp as omitEnvKeysCaseInsensitive, Hl as isProviderAuthProfileConfigured, Hp as ensureAuthProfileStoreForLocalUpdate, Iu as OAuthCredentials, Ml as ProviderAuthResult, Np as resolveEnvApiKey, Pl as ProviderPluginWizardSetup, Pp as ProviderEnvVarLookupParams$1, Qp as SecretInputMode, Ul as listUsableProviderAuthProfileIds, Vl as isProviderApiKeyConfigured, Vp as ensureAuthProfileStore, Wl as resolveProviderAuthProfileApiKey, am as resolveAuthProfileOrder, cm as DEFAULT_OAUTH_REFRESH_MARGIN_MS, dr as readCodexCliCredentialsCached, em as upsertAuthProfile, kl as ProviderAuthContext, lm as hasUsableOAuthCredential, qp as updateAuthProfileStoreWithLock, tm as listProfilesForProvider } from "../agent-harness-runtime-DNhAy8yX.js";
import { r as TestclawConfig } from "../types.testclaw-C-wX50Nb.js";
import { _ as resolveDefaultSecretProviderAlias, d as SecretInput, f as SecretRef, o as coerceSecretRef, s as hasConfiguredSecretInput } from "../types.secrets-BR-Cncxg.js";
import { b as PluginMetadataSnapshot } from "../io-D98w0DmD.js";
import "../types-RdRiGrAp.js";
import "../config-Q4A7ydl1.js";
import { C as AuthProfileCredential, D as OAuthCredential, E as AuthProfileStore } from "../types-DUHHqvaV.js";
import { i as resolveRequiredHomeDir } from "../home-dir-QeDmch_s.js";
import { p as WizardPrompter } from "../setup-wizard-types-CW2TaT9P.js";
import { a as isNonSecretApiKeyMarker, i as isKnownEnvApiKeyMarker, n as CUSTOM_LOCAL_AUTH_MARKER, o as resolveOAuthApiKeyMarker, r as MINIMAX_OAUTH_MARKER } from "../model-auth-markers-1ePEMiK3.js";
import { i as resolveNonEnvSecretRefApiKeyMarker, n as normalizeSecretInput, t as normalizeOptionalSecretInput } from "../normalize-secret-input-Dxh5lAWq.js";
...
export declare const validateApiKeyInput: (value: string) => "Paste the API key value, not an Testclaw onboarding command." | "Required" | undefined;
...
export declare function applyAuthProfileConfig(cfg: TestclawConfig, params: {
  profileId: string;
  provider: string;
...
type ProviderApiKeyAuthMethodOptions = {
  ...
  noteMessage?: string;
  noteTitle?: string;
  applyConfig?: (cfg: TestclawConfig) => TestclawConfig;
...
//#endregion
//#region src/plugin-sdk/provider-env-vars.d.ts
type ProviderEnvVarLookupParams = ProviderEnvVarLookupParams$1 | (Omit<ProviderEnvVarLookupParams$1, "metadataSnapshot"> & {
...
export declare function buildOauthProviderAuthResult(params: {
  ...
  configPatch?: Partial<TestclawConfig>;
...
export declare function resolveCopilotApiToken(params: {
  ...
  githubDomain?: string;
  /**
   * Testclaw config used to resolve the persisted `githubDomain` provider
