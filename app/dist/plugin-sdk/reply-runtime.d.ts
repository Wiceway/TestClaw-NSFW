import { Aa as InternalGetReplyOptions, Da as DispatchReplyFromConfig, Ea as DispatchFromConfigResult, Oa as CommandSessionMetadataChange, Sa as createReplyDispatcherWithTyping, _a as DispatchReplyWithBufferedBlockDispatcher, ba as ReplyDispatcherWithTypingOptions, ga as settleReplyDispatcher, ha as finalizeInboundContextForSdk, ka as InternalGetReplyFromConfig, va as DispatchReplyWithDispatcher, xa as createReplyDispatcher, ya as ReplyDispatcherOptions } from "../agent-harness-runtime-DNhAy8yX.js";
import { r as TestclawConfig } from "../types.testclaw-C-wX50Nb.js";
import { C as ReplyToMode } from "../types.base-CA0_JvyZ.js";
import { h as GetReplyOptions, l as RuntimeMsgContext, m as BlockReplyContext, mt as CommandTurnContext, n as ChannelStructuredContextEntry, p as UntrustedStructuredContextEntry, r as FinalizedMsgContext, s as MsgContext } from "../templating-Cj1bgdNt.js";
import "../types-RdRiGrAp.js";
import "../config-Q4A7ydl1.js";
import { E as SourceReplyDeliveryMode, h as ReplyPayload$1 } from "../reply-payload-wovcll2t.js";
import "../deliver-types-BuX1nYGX.js";
import { c as ChunkMode, d as chunkMarkdownText, f as chunkMarkdownTextWithMode, g as resolveTextChunkLimit, h as resolveChunkMode, m as chunkTextWithMode, p as chunkText } from "../outbound.types-BEE1v82E.js";
import { bt as ReplyFollowupAdmissionBarrierTimeoutPolicy, gt as ReplyDispatchKind, ht as ReplyDispatchBeforeDeliverOptions, vt as ReplyDispatchRuntimeInfo, yt as ReplyDispatcher } from "../hook-runner-global-DblUKtLd.js";
import { i as isSilentReplyText, n as SILENT_REPLY_TOKEN, t as HEARTBEAT_TOKEN } from "../tokens-CLx0Aap_.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "../inbound-debounce-CvKXezR0.js";
import { i as ReplyPayload } from "../reply-payload-B6aAIyDb.js";
import { n as isAbortRequestText, t as isBtwRequestText } from "../btw-command-B9UHtupN.js";
import { n as generateConversationLabel, t as ConversationLabelParams } from "../conversation-label-generator-B-PRN_Ja.js";
...
export declare function getReplyFromConfig(ctx: RuntimeMsgContext, options?: GetReplyOptions, configOverride?: TestclawConfig): Promise<ReplyPayload$1 | ReplyPayload$1[] | undefined>;
//#endregion
