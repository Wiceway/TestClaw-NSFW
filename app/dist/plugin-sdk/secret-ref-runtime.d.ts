...
import { d as SecretInput, f as SecretRef, i as SecretProviderConfig, o as coerceSecretRef, t as PluginIntegrationSecretProviderConfig } from "../types.secrets-BR-Cncxg.js";
import { n as PluginManifestRegistry } from "../manifest-registry-BbQfGHTp.js";
import { a as createResolverContext, d as SecretRefResolveCache, r as applyResolvedAssignments } from "../runtime-shared-YBVRKPwm.js";
...
/** Serialized plan produced by `testclaw secrets configure` or supplied manually. */
type SecretsApplyPlan = {
  version: 1;
  protocolVersion: 1;
  generatedAt: string;
  generatedBy: "testclaw secrets configure" | "manual";
...
export declare function createPluginSecretRefSetupCli(params: PluginSecretRefSetupCliParams): {
  inspectProvider: (config: TestclawConfig, requestedAlias?: string) => {
    providerAlias: string;
