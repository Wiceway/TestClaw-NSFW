import { $t as isGatewayTransportError, Au as PLUGIN_NODE_CAPABILITY_PATH_PREFIX, Mu as mintPluginNodeCapabilityToken, Nu as normalizePluginNodeCapabilityScopedUrl, Os as GatewayRequestHandlerOptions, Ou as DEFAULT_PLUGIN_NODE_CAPABILITY_TTL_MS, Pu as RespondFn, Qt as isGatewayClientRequestError, Tc as NodeSession, ju as buildPluginNodeCapabilityScopedHostUrl, ks as GatewayRequestHandlers, ku as NormalizedPluginNodeCapabilityUrl } from "../agent-harness-runtime-DNhAy8yX.js";
import { F as GatewayTailscaleMode, I as GatewayTrustedProxyConfig, M as GatewayAuthConfig, P as GatewayTailscaleConfig, r as TestclawConfig } from "../types.testclaw-C-wX50Nb.js";
import { Yt as errorShape, tn as ErrorCodes } from "../index-BLZetC4l.js";
import { r as ChannelAccountSnapshot } from "../types.core-DUehY8AL.js";
import { t as isLoopbackHost } from "../net-DcNvJ9wn.js";
import { n as GatewayClientOptions, r as startGatewayClientWhenEventLoopReady, t as GatewayClient } from "../client-qT7XHQF_.js";
import { n as callGatewayFromCli, r as GatewayRpcOpts, t as addGatewayClientOptions } from "../gateway-rpc-CBN_NHzi.js";
import "../auth-rate-limit-B4f-1qQN.js";
...
export declare function resolveNodeCommandAllowlist(cfg: TestclawConfig, node?: NodeCommandPolicyNode): Set<string>;
...
type NodeMatchCandidate = {
  ...
  connected?: boolean;
  /** Client id used to prefer current Testclaw nodes over legacy migration ties. */
  clientId?: string;
};
//#endregion
