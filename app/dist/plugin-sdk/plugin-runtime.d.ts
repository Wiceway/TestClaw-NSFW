import { As as TestclawPluginApi, Fs as PluginInteractiveRegistration, Pa as TestclawPluginConfigSchema, Ps as PluginInteractiveHandlerRegistration, ac as TestclawPluginCommandDefinition, eu as getPluginRuntimeGatewayRequestScope, ic as PluginCommandResult, nc as AgentPromptSurfaceKind, rc as PluginCommandContext, ui as PluginRuntime, vo as RuntimeLogger } from "../agent-harness-runtime-DNhAy8yX.js";
import { r as TestclawConfig } from "../types.testclaw-C-wX50Nb.js";
import { t as getGlobalHookRunner } from "../hook-runner-global-DblUKtLd.js";
import { n as PluginConversationBindingRequestParams, r as PluginConversationBindingRequestResult, t as PluginConversationBinding } from "../conversation-binding.types-CbHkCpBU.js";
import { t as getPluginCommandSpecs } from "../command-specs-9XADqC4z.js";
import { i as requestPluginConversationBinding } from "../conversation-binding-CaUaJxY_.js";
//#region src/plugins/command-registry-state.d.ts
type RegisteredPluginCommand = TestclawPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
...
export declare function registerPluginCommand(pluginId: string, command: TestclawPluginCommandDefinition, opts?: {
  pluginName?: string;
  pluginRoot?: string;
...
//#endregion
export { type LazyPluginServiceHandle, type PluginConversationBinding, type PluginConversationBindingRequestParams, type PluginConversationBindingRequestResult, type PluginInteractiveRegistration, type PluginRuntime, type RuntimeLogger, type TestclawPluginApi, type TestclawPluginConfigSchema, getGlobalHookRunner, getPluginCommandSpecs, getPluginRuntimeGatewayRequestScope };