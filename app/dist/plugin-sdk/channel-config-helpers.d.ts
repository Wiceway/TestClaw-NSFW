...
import { F as ConfigWriteScopeLike, I as ConfigWriteTargetLike, M as canBypassConfigWritePolicy, N as formatConfigWriteDeniedMessage, P as ConfigWriteAuthorizationResultLike, j as authorizeConfigWrite, s as ChannelConfigAdapter } from "../types.adapters-8WMF_p63.js";
import { n as clearAccountFieldsFromConfigSection } from "../config-helpers-BXJSV8ds.js";
...
type ChannelConfigAccessorParams<Config extends TestclawConfig = TestclawConfig> = {
  cfg: Config;
  accountId?: string | null;
};
type MultiAccountChannelConfigAdapterParams<ResolvedAccount, AccessorAccount = ResolvedAccount, Config extends TestclawConfig = TestclawConfig> = {
  sectionKey: string;
...
type NamedAccountChannelConfigBaseParams<ResolvedAccount, Config extends TestclawConfig = TestclawConfig> = {
  sectionKey: string;
  accountKeyPolicy?: ChannelAccountKeyPolicy;
  listAccountIds: (cfg: Config) => string[];
  resolveAccount: (cfg: Config, accountId?: string | null) => ResolvedAccount;
...
export declare function adaptScopedAccountAccessor<Result, Config extends TestclawConfig = TestclawConfig>(accessor: (params: {
  cfg: Config;
  accountId?: string | null;
...
export declare function createScopedAccountConfigAccessors<ResolvedAccount, Config extends TestclawConfig = TestclawConfig>(params: {
...
export declare function createScopedChannelConfigBase<ResolvedAccount, Config extends TestclawConfig = TestclawConfig>(params: NamedAccountChannelConfigBaseParams<ResolvedAccount, Config> & {
...
export declare function createScopedChannelConfigAdapter<ResolvedAccount, AccessorAccount = ResolvedAccount, Config extends TestclawConfig = TestclawConfig>(params: MultiAccountChannelConfigAdapterParams<ResolvedAccount, AccessorAccount, Config> & {
  allowTopLevel?: boolean;
}): ChannelConfigAdapterWithAccessors<ResolvedAccount>;
/** Build CRUD/config helpers for top-level single-account channels. */
export declare function createTopLevelChannelConfigBase<ResolvedAccount, Config extends TestclawConfig = TestclawConfig>(params: {
  sectionKey: string;
...
export declare function createTopLevelChannelConfigAdapter<ResolvedAccount, AccessorAccount = ResolvedAccount, Config extends TestclawConfig = TestclawConfig>(params: {
  sectionKey: string;
  resolveAccount: (cfg: Config) => ResolvedAccount;
...
export declare function createHybridChannelConfigBase<ResolvedAccount, Config extends TestclawConfig = TestclawConfig>(params: NamedAccountChannelConfigBaseParams<ResolvedAccount, Config> & {
...
export declare function createHybridChannelConfigAdapter<ResolvedAccount, AccessorAccount = ResolvedAccount, Config extends TestclawConfig = TestclawConfig>(params: MultiAccountChannelConfigAdapterParams<ResolvedAccount, AccessorAccount, Config> & {
  preserveSectionOnDefaultDelete?: boolean;
}): ChannelConfigAdapterWithAccessors<ResolvedAccount>;
