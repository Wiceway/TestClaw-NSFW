...
import { l as ChannelDirectoryEntry, u as ChannelDirectoryEntryKind } from "../types.core-DUehY8AL.js";
...
import { t as createRuntimeDirectoryLiveAdapter } from "../runtime-forwarders-CjG5FQQ_.js";
...
export declare function listInspectedDirectoryEntriesFromSources<InspectedAccount>(params: DirectoryConfigParams & {
  kind: "user" | "group";
  inspectAccount: (cfg: TestclawConfig, accountId?: string | null) => InspectedAccount | null | undefined;
