...
import { n as assertNoSymlinkParentsSync, r as sanitizeUntrustedFileName, t as assertNoSymlinkParents } from "../fs-safe-advanced-D9oba4eY.js";
...
import { i as shouldIncludeSupplementalContext, n as evaluateSupplementalContextVisibility, r as filterSupplementalContextItems, t as ContextVisibilityDecision } from "../context-visibility-CNXHuDNv.js";
import { i as expandAllowFromWithAccessGroups } from "../access-groups-bETJTOiZ.js";
import { s as resolvePinnedMainDmOwnerFromAllowlist } from "../dm-policy-shared-DXFX_qcV.js";
...
import "@testclaw/fs-safe/permissions";
import "@testclaw/fs-safe/durability";
import { FileStoreSync } from "@testclaw/fs-safe/store";
import { movePathWithCopyFallback, replaceFileAtomic as replaceFileAtomic$1 } from "@testclaw/fs-safe/atomic";
...
//#endregion
export { type ContextVisibilityDecision, FsSafeError, type LookupFn, type SafeRegexRejectReason, SsrFBlockedError, type SsrFPolicy, appendRegularFile, assertNoSymlinkParents, assertNoSymlinkParentsSync, canonicalPathFromExistingAncestor, evaluateSupplementalContextVisibility, expandAllowFromWithAccessGroups, extractErrorCode, filterSupplementalContextItems, findExistingAncestor, formatErrorMessage, hasProxyEnvConfigured, isPathInside, isPrivateNetworkAllowedByPolicy, matchesHostnameAllowlist, movePathWithCopyFallback, normalizeHostname, openLocalFileSafely, parseAccessGroupAllowFromEntry, pathExists, pathExistsSync, pathScope, readRegularFile, readRegularFileSync, redactSensitiveText, resolveAbsolutePathForRead, resolveAbsolutePathForWrite, resolveExistingPathsWithinRoot, resolveLocalPathFromRootsSync, resolvePinnedHostnameWithPolicy, resolvePinnedMainDmOwnerFromAllowlist, resolvePreferredTestclawTmpDir, resolveStrictExistingPathsWithinRoot, root, sanitizeUntrustedFileName, shouldIncludeSupplementalContext, statRegularFile, statRegularFileSync, withTimeout, writeExternalFileWithinRoot };