import { As as TestclawPluginApi, Ms as TestclawPluginToolContext, ni as definePluginEntry } from "../agent-harness-runtime-DNhAy8yX.js";
import { an as PluginManifestActivation } from "../types.testclaw-C-wX50Nb.js";
import { d as JsonSchemaObject } from "../zod-schema.implicit-mentions-Du1YLL_X.js";
...
export type ToolPluginExecutionContext = {
  /** Plugin runtime API for tool implementations that need Testclaw services. */
...
export type ToolPluginFactoryContext<TConfig> = {
  ...
  toolContext: TestclawPluginToolContext;
};
