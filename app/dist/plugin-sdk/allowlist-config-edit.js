...
function resolveAccountScopedWriteTarget(parsed, channelId, accountId) {
	...
	const accountKey = resolveChannelAccountKey(accounts, normalizedAccountId, channelId, (id) => id) ?? normalizedAccountId;
	const existingAccount = accounts[accountKey];
	if (!existingAccount || typeof existingAccount !== "object") accounts[accountKey] = {};
	return {
