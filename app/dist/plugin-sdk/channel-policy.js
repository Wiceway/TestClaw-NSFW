...
import { a as buildChannelGroupsScopeTree, c as resolveScopeKeyCaseInsensitive, d as scopeKey, f as resolveToolsBySender, i as resolveChannelGroupsConfigPath, l as resolveScopeRequireMention, n as resolveChannelGroupRequireMention, o as encodeScopeSegment, p as resolveChannelGroups, r as resolveChannelGroupToolsPolicy, s as resolveScopeIntroHint, t as resolveChannelGroupPolicy, u as resolveScopeToolsPolicy } from "../group-policy-DihBpxlM.mjs";
import { a as resolveOpenDmAllowlistAccess, i as resolveEffectiveAllowFromLists, n as readStoreAllowFromForDmPolicy, r as resolveDmGroupAccessWithLists, t as DM_GROUP_ACCESS_REASON } from "../dm-policy-shared-Ceyofg5t.mjs";
import { s as createScopedDmSecurityResolver } from "../channel-config-helpers-BnTo4fA6.mjs";
...
import { i as resolveOpenProviderRuntimeGroupPolicy, n as resolveAllowlistProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy } from "../runtime-group-policy-B2iaOIDT.mjs";
...
function buildMutableAllowEntryDetector(params) {
	...
	return (entry) => {
		...
		if (!text || text === "*" || parseAccessGroupAllowFromEntry(text) !== null) return false;
