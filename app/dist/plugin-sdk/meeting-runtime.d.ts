import { Am as TranscriptStopRequest, As as TestclawPluginApi, Bm as RealtimeVoiceCloseOptions, Bs as TestclawPluginNodeInvokePolicy, Fm as RealtimeVoiceAudioFormat, Gm as RealtimeVoiceRole, Hm as RealtimeVoiceProviderCapabilities, Im as RealtimeVoiceBargeInOptions, Jm as RealtimeVoiceToolResultOptions, Km as RealtimeVoiceTool, Lm as RealtimeVoiceBridge, Mm as TranscriptsStopResult, Nm as RealtimeVoiceAgentConsultRunner, Pa as TestclawPluginConfigSchema, Pm as RealtimeVoiceAudioClearReason, Rm as RealtimeVoiceBridgeCallbacks, Rs as TestclawPluginCliRootCommandDescriptor, Um as RealtimeVoiceProviderConfig, Vm as RealtimeVoiceCloseReason, Wm as RealtimeVoiceResponseOutcome, hm as RealtimeVoiceProviderPlugin, jm as TranscriptsStartResult, km as TranscriptStartRequest, mm as RealtimeTranscriptionProviderPlugin, qm as RealtimeVoiceToolCallEvent, ui as PluginRuntime, vo as RuntimeLogger, zm as RealtimeVoiceBridgeEvent } from "../agent-harness-runtime-DNhAy8yX.js";
import { r as TestclawConfig } from "../types.testclaw-C-wX50Nb.js";
import "../config-Q4A7ydl1.js";
import { Qt as TalkEventInput, Xt as TalkEvent, Zt as TalkEventContext } from "../diagnostic-events-B4BoRl9s.js";
import { n as callGatewayFromCli } from "../gateway-rpc-CBN_NHzi.js";
...
type MeetingPluginEntryOptions<Config extends MeetingPluginConfig, Request extends MeetingJoinRequest, Runtime extends MeetingPluginRuntime<Request>> = {
  ...
  createNodePolicy(config: Config): TestclawPluginNodeInvokePolicy;
  ...
  registerCli(api: TestclawPluginApi, config: Config): void;
  registerNodeWhen(config: Config): boolean;
  resolveGatewayTimeoutMs(config: Config): number;
  resolveToolRuntime(api: TestclawPluginApi, agentId: string | undefined): Promise<TestclawPluginApi["runtime"] | undefined>;
...
export declare function createMeetingBrowserNodeInvokePolicy(options: MeetingBrowserNodePolicyOptions): TestclawPluginNodeInvokePolicy;
//#endregion
...
declare function createMeetingPluginNodeInvokePolicy(config: {
  ...
  deniedCode: string;
  platform: MeetingPluginShellPlatform;
}): TestclawPluginNodeInvokePolicy;
...
type MeetingPluginShellEntryOptions<Config extends MeetingPluginConfig, Request extends MeetingJoinRequest, Runtime extends MeetingPluginRuntime<Request>> = Omit<MeetingPluginEntryOptions<Config, Request, Runtime>, "cap" | "createRuntime" | "description" | "disabledMessage" | "gatewayMethodPrefix" | "id" | "name" | "nodeCommand" | "normalizeUrl" | "registerCli" | "toolDescription" | "toolLabel" | "toolName" | "transcriptSource" | "unknownActionMessage"> & {
  cli: {
    descriptor: TestclawPluginCliRootCommandDescriptor;
    load(): Promise<(params: {
      program: Command;
      config: Config;
    }) => void>;
  ...
  runtime: new (params: {
    config: Config;
    fullConfig: TestclawPluginApi["config"];
    logger: TestclawPluginApi["logger"];
    runtime: TestclawPluginApi["runtime"];
  }) => Runtime;
  transcriptSource: {
    aliases?: readonly string[];
    id: string;
...
type MeetingRuntimeFacadeInstance<Transport extends "chrome" | "chrome-node", Mode extends string, Health extends MeetingPluginChromeHealth<string, string>, Results extends MeetingRuntimeProbeResults> = Pick<MeetingRuntimeOwner<Transport, Mode, Health>, "join" | "leave" | "reconcileTranscriptPolicy" | "speak" | "startTranscriptSource" | "status" | "stopTranscriptSource" | "transcript"> & {
