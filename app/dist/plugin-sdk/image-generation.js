...
import { m as readProviderJsonResponse, n as assertOkOrThrowHttpError } from "../provider-http-errors-BdTzR7WL.mjs";
...
import { h as resolveProviderOperationTimeoutMs, l as postJsonRequest, p as resolveProviderHttpRequestConfig, r as createProviderOperationDeadline, u as postMultipartRequest } from "../shared-CCOiNzJH.mjs";
...
const INLINE_IMAGE_JSON_RESPONSE_ENVELOPE_BYTES = 1048576;
...
function createOpenAiCompatibleImageGenerationProvider(options) {
	...
	return {
		...
		async generateImage(req) {
			...
			if (requestBody.kind === "multipart") requestOptions.headers.delete("Content-Type");
			else requestOptions.headers.set("Content-Type", "application/json");
