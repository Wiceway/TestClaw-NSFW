...
import { i as isPathRelativeEscape } from "./path-safety-D-qXHKZj.mjs";
...
import { s as readAgentDeletionJournalInDatabase } from "./agent-deletion-journal-DI5y0Fk0.mjs";
import "./installed-plugin-index-records-CTYgsrgw.mjs";
import { s as withAgentDeletion } from "./agent-lifecycle-registry-r7UAOGpY.mjs";
...
import { n as inspectBundlePluginArtifact, r as inspectNativePluginArtifact, t as PLUGIN_ARTIFACT_ADAPTER_IDENTITY } from "./install-artifact-inspection-CSM8OsZb.mjs";
...
import { f as CLAW_OUTPUT_STABILITY, t as parseClawMarkdown } from "./reader-BU9kgCOF.mjs";
import { t as listConfiguredMcpServers } from "./mcp-config-Dxi66ATE.mjs";
import { a as resolvePluginInstallRequestContext } from "./install-config-BPSnD_5V.mjs";
import { n as PluginRuntimeApplicationError } from "./lifecycle-kyMYqai_.mjs";
import { i as prepareAgentDeleteDatabases, n as assertAgentSessionStoreDeletionSafe } from "./agent-delete-databases-D0eCIrd2.mjs";
import { T as readClawCronRefs, a as ClawRemoveError, c as deletionEffects, h as synthesizeOrphanInstall, l as inspectClawBootstrap, u as inspectClawWorkspaceFile } from "./monitor-cleanup-contract-CbhVewFQ.mjs";
import { r as deleteAgentConfigEntry, t as AgentConfigPreconditionError } from "./agents-config-mutations-DrSGNRTi.mjs";
import { c as readClawPackageRefs, d as updateClawPackageRefStatus, o as readClawInstallRecordFromDatabase, s as readClawInstallRecords, u as updateClawInstallRecordStatus } from "./provenance-ksQfwli9.mjs";
import { a as digestClawMcpServer, c as readClawMcpServerRefs, u as reconcileClawMcpServerRefs } from "./mcp-CwJWD5at.mjs";
import { r as planClawHubSkillUninstall, t as applyClawHubSkillUninstall } from "./clawhub-uninstall-BnZ2wsJE.mjs";
	...
	for (const decision of decisions) {
		...
		try {
			...
			if (decision.packageRef.kind === "plugin") {
				...
				assertCurrent();
				const uninstallPlugin = deps.uninstallPlugin ?? (await import("./management-uninstall-mdq4osgA.mjs")).uninstallPluginWithPolicy;
				assertCurrent();
