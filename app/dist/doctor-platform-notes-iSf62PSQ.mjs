...
import { i as isLaunchAgentLoaded, r as isLaunchAgentEnabled, s as launchAgentPlistExists } from "./launchd-runtime-DRE7kYGq.mjs";
import { n as findStaleAssistantUpdateLaunchdJobs } from "./launchd-uwaEKgPK.mjs";
...
async function collectGatewayPlatformWarnings(cfg) {
	if (process.platform === "linux") {
		...
		const { auditGatewayServiceConfig, SERVICE_AUDIT_CODES } = await import("./service-audit-BFMoDDPR.mjs");
