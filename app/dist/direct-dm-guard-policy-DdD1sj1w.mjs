...
function createDirectDmPreCryptoGuardPolicy(overrides = {}) {
	return {
		...
		maxCiphertextBytes: resolveIntegerOption(overrides.maxCiphertextBytes, 16384, { min: 1 }),
		maxPlaintextBytes: resolveIntegerOption(overrides.maxPlaintextBytes, 8192, { min: 1 }),
		rateLimit: {
