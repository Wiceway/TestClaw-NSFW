...
import { C as ReplyToMode, S as MarkdownTableMode } from "./types.base-CA0_JvyZ.js";
...
import { M as ReplyPayloadDeliveryPin, f as MessagePresentation } from "./payload-WAL4rVqk.js";
import { t as OutboundMediaAccess } from "./load-options-BwtyeSvQ.js";
import { C as ChannelOutboundTargetMode, T as ChannelPollResult, w as ChannelPollContext } from "./types.core-DUehY8AL.js";
...
declare function resolveTextChunkLimit(cfg: TestclawConfig | undefined, provider?: TextChunkProvider, accountId?: string | null, opts?: {
  fallbackLimit?: number;
}): number;
declare function resolveChunkMode(cfg: TestclawConfig | undefined, provider?: TextChunkProvider, accountId?: string | null): ChunkMode;
/**
