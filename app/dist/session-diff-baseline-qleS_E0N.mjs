...
import { d as resolveSessionWorkStartError, i as SessionWorkStartInvalidatedError, l as isSessionWorkStartInvalidatedError, r as SessionWorkStartChangedError } from "./lifecycle-DX3moz6p.mjs";
...
async function settleCapture(params) {
	let baseline;
	try {
		const { captureSessionDiffBaseline } = await import("./session-diff-Dlq0gcVo.mjs");
