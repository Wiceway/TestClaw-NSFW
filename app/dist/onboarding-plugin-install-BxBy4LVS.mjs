...
import { o as clearLoadInstalledPluginIndexInstallRecordsCache } from "./installed-plugin-index-record-reader-BZDPDRhI.mjs";
...
import { n as isUnavailableNpmTarget } from "./install-types-DYuUiFfw.mjs";
...
import { s as buildNpmResolutionInstallFields, u as recordPluginInstall } from "./installed-plugin-index-records-CTYgsrgw.mjs";
import "./with-timeout-CEnLHVHe.mjs";
import { r as withPluginLifecycleLease } from "./plugin-lifecycle-lease-CkmD-Hkp.mjs";
import { i as installPluginFromNpmPackArchive, r as installPluginFromNpmSpec } from "./install-DmfIGJIq.mjs";
...
import { t as invalidatePluginRuntimeDiscoveryAfterConfigMutation } from "./registry-refresh-ggtO48iw.mjs";
...
import { n as resolveBundledInstallPlanForCatalogEntry } from "./install-source-plan-CCNJx6Gh.mjs";
...
async function installPluginFromClawHubSpecWithProgress(params) {
	...
	try {
		const { installPluginFromClawHub } = await import("./clawhub-fTkay-e7.mjs");
