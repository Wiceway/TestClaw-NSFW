...
import { i as registerSignalExitGate, n as registerSignalExitBarrier, o as waitForSignalExitBarriers } from "./signal-exit-barrier-B5EZbWu_.mjs";
import { c as isGatewayServiceEnv, d as resolveGatewayProfileSuffix } from "./constants-DJMIH2n2.mjs";
...
import { i as resolveManagedServiceNodeRunner, s as summarizeGatewayServiceLayout } from "./service-layout-Vt9OJt8Q.mjs";
import { u as resolveTaskName } from "./schtasks-layout-nzXkuZDw.mjs";
import "./update-control-plane-sentinel-D9E1Aa9B.mjs";
import { t as finishUpdateRun } from "./update-run-write-DLKbiRhE.mjs";
import { f as recordUpdateRunPhase, h as recordUpdateRunStep } from "./update-run-ledger-CWjgjkCi.mjs";
import { r as getUpdateRun } from "./update-run-reader-DcJAE2Qr.mjs";
import { n as probePortUsage } from "./ports-probe-kSPonTZ4.mjs";
import { _ as readWindowsStartupFallbackRuntimeForUpdate, d as suspendScheduledTaskAutoStartForUpdate, f as ScheduledTaskAutoStartRecoveryError, p as isScheduledTaskDefinitelyNotRunning, s as resumeScheduledTaskAutoStartAfterUpdate } from "./schtasks-DFavL5G2.mjs";
...
import { u as captureSystemdServiceIdentity } from "./systemd-C14FU_go.mjs";
import { l as isCurrentManagedServiceUpdateHandoffProcess } from "./update-managed-service-handoff-DcM1N6C8.mjs";
...
import { n as gatewayMaintenanceBlockMessage } from "./update-command-handoff-C-MQewiw.mjs";
import { c as observedSystemdManagerUid, i as assertGatewayServiceManagementAllowedForUpdate, n as GatewayServiceUpdateOwnershipError, o as inspectManagedGatewayServiceBeforeUpdate, p as resolveUpdatedGatewayRestartPort, r as assertGatewayServiceAdmissionUnchanged, t as GATEWAY_SERVICE_INSPECTION_WARNING, u as resolveGatewayServiceManagementBlockMessageForUpdate } from "./update-command-service-plan-BvweOT5A.mjs";
...
async function stopManagedServiceBeforeMutableUpdate(params, assertNative) {
	...
	if (params.phase === "refresh" || !params.shouldRestart || !serviceState.running && !supervisorMayRespawn) {
		if (process.platform === "linux" && serviceUpdateVerdict.kind === "owned") {
			const { prepareSystemdGatewayMaintenance } = await import("./systemd-maintenance-CearPq6q.mjs");
	...
	try {
		...
		if (process.platform === "linux") {
			const { withGatewayMaintenanceDrain } = await import("./update-command-service-drain-LNEoZZmv.mjs");
