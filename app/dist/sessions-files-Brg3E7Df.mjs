...
import { Ci as validateSessionsFilesListParams, Si as validateSessionsFilesGetParams, Ti as validateSessionsFilesSetParams, wi as validateSessionsFilesRevealParams, zg as isCloudWorkerPlacementState } from "./src-BNV0SJoP.mjs";
import { f as errorShape } from "./error-codes-WUvUxA6s.mjs";
import { n as resolveRequestedSessionAgentId } from "./session-request-agent-CmhrS9-1.mjs";
import { u as readSessionTranscriptVisibleMessageDeltaCore } from "./session-accessor.sqlite-active-events-CM5yNO6K.mjs";
...
import { t as WORKSPACE_PREVIEW_MAX_BYTES } from "./workspace-fs-C0S-KsR8.mjs";
import { a as setSessionWorkspaceFile, i as resolveFileRoot, n as listSessionWorkspaceFiles, t as getSessionWorkspaceFile } from "./workspace-files-Bsva_xCo.mjs";
...
import { n as getRepositoryArtifact, r as listRepositoryArtifacts, t as resolveRepositoryWorkspaceAccess } from "./session-repository-workspace-access-BuYPEDIq.mjs";
...
async function loadSessionFiles(params) {
	...
	if (entry.worktree?.id && loaded.root) {
		const { withSettledLocalWorkspacePath } = await import("./local-workspace-projection-BU86W998.mjs");
