...
import { c as resolveAgentModelTimeoutMsValue } from "./model-input-DKxKaZGG.mjs";
...
import { l as withVideoGenerationProviders, o as listVideoGenerationProviders, r as getVideoGenerationProvider } from "./registry-TDG6F0QJ.mjs";
import { c as resolveMediaProviderRequestTimeoutMs, i as resolveCapabilityModelCandidates, n as buildNoCapabilityModelConfiguredMessage, t as buildMediaGenerationNormalizationMetadata, u as runMediaGenerationCandidates } from "./runtime-shared-D3af9oCm.mjs";
import { t as parseGenerationModelRef } from "./model-ref-4WSJM5TU.mjs";
import { t as hasMediaNormalizationEntry } from "./normalization-CJ51nPmx.mjs";
import { t as resolveMediaGeometryOverrides } from "./geometry-normalization-DnjogKAs.mjs";
...
const SUPPORTED_DURATIONS_HINT = Symbol.for("testclaw.videoGeneration.supportedDurations");
/**
...
async function generateVideo(params, deps = {}) {
	if (deps.getProvider && deps.listProviders) return runVideoGeneration(params, deps);
...
async function runVideoGeneration(params, deps) {
