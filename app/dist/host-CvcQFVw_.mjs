...
import { a as SpawnBrokerError, i as restoreStdinPipe, n as holdPipe, r as restorePipePrefix, t as BrokerChild } from "./child-CEi2EQGz.mjs";
	...
	async closeInternal() {
		...
		try {
			...
			if (child && child.exitCode === null && child.signalCode === null) {
				...
				if (child.connected) child.disconnect();
				const timer = setTimeout(() => child.kill("SIGKILL"), GRACEFUL_CANCEL_TIMEOUT_MS + 2e3);
				try {
					await exited;
				} finally {
					clearTimeout(timer);
...
//#endregion
export { spawnBrokerEntryPath as i, brokerSpawnOptions as n, createSpawnBrokerHost as r, SpawnBrokerHost as t };
