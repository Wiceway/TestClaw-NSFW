...
import { a as createLazyRuntimeSurface, i as createLazyRuntimeNamedExport } from "./lazy-runtime-BPNHa36e.mjs";
...
import { F as createDiagnosticToolExecutionLiveness, I as markToolExecutionLivenessDiagnosticEvent, O as freezeDiagnosticTraceContext, _ as onTrustedInternalDiagnosticEvent, c as emitTrustedDiagnosticEventWithPrivateData, l as emitTrustedSecurityEvent, s as emitTrustedDiagnosticEvent, u as emitTrustedSkillUsedDiagnosticEvent, v as onTrustedToolExecutionEvent, w as createChildDiagnosticTraceContext } from "./diagnostic-events-C4sEV9aC.mjs";
import { t as createSubsystemLogger } from "./subsystem-Bmu9GF-b.mjs";
import { i as getNodeSqliteKysely, t as compileSqliteQueryBindings } from "./kysely-sync-DUH0XYlR.mjs";
import { A as unknown, E as string, _ as literal, b as number, d as array, l as _enum, v as looseObject } from "./schemas-qz0osXyE.mjs";
import "./automations-tool-name-DBMZPbPL.mjs";
...
import { A as pluginToolMatcherCoversTool, D as createPluginToolMatcherScope, k as normalizePluginToolMatcher, u as cloneHookIsolationValue } from "./hooks-D28cLPAG.mjs";
import { s as getGlobalHookRunnerRegistry, t as getGlobalHookRunner } from "./hook-runner-global-eA1aRrLi.mjs";
...
import { a as getCodeModeExecBeforeHookMetadata, d as reconcileCodeModeExecBeforeHookParams, o as getCodeModeExecBeforeHookMetadataForToolKind, s as isCodeModeControlTool, u as normalizeCodeModeExecBeforeHookParams } from "./code-mode-control-tools-DJ5t_-Dq.mjs";
...
import { p as resolveAgentRunAbortLifecycleFields } from "./run-termination-Cf8kcgMU.mjs";
import { n as extractResolvedApplyPatchTargetPaths } from "./apply-patch-paths-CRtevPZK.mjs";
import { t as isEmbeddedMode } from "./embedded-mode-wPlJkQN6.mjs";
import { r as getPluginToolMeta } from "./tool-metadata-CwykBqAo.mjs";
import { c as getChannelAgentToolMeta, d as clearBeforeToolCallWrappedMarker, f as getBeforeToolCallDiagnosticOptions, i as copyBeforeToolCallWrapperMetadata, m as getBeforeToolCallSourceTool, o as getToolTerminalPresentation, p as getBeforeToolCallHookContext, u as bindBeforeToolCallMetadata } from "./agent-tool-metadata-CyFqBZ5V.mjs";
import { a as attachInternalToolExecutionPreparer, n as appendToolLoopWarning } from "./internal-hooks-A8m3oGkR.mjs";
import { a as withGatewayToolApprovalOwner, i as getGatewayToolCallerIdentity } from "./gateway-caller-context-CxCRBFJ-.mjs";
import { i as diagnosticHttpStatusCode, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-DzKWXg1m.mjs";
import { n as resolveDiagnosticModelContentCapturePolicy, t as cloneDiagnosticContentValue } from "./diagnostic-llm-content-pAJxJAOh.mjs";
import { n as resolveSkillTelemetrySource, r as resolveSkillTelemetrySourceValue } from "./source-CZniHZj_.mjs";
import { n as recordGenericToolActionDecision, o as normalizeFileToolPathParam, r as runWithGenericToolActionDecision } from "./agent-tools.before-tool-call.decision-BLWhmguO.mjs";
import { a as protectNetworkToolExecutionError, c as registerTrustedToolNoStartError, i as isTrustedToolExecutionPreflightError, l as resolveToolExecutionErrorKind, n as formatToolExecutionErrorMessage, u as resolveToolResultFailureKind } from "./tool-result-error-Ce9ky0UT.mjs";
import { t as canonicalizePath } from "./paths-CIwQeLl6.mjs";
import { t as sanitizeApprovalScope } from "./approval-scope-Dmm8pWiA.mjs";
import { n as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS, r as MAX_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-CbE1CTiQ.mjs";
import { t as resolveCanonicalPluginApprovalRequestAllowedDecisions } from "./plugin-approval-canonical-decisions-C8CVYHsE.mjs";
import { i as resolveApprovalInitiatingSurfaceState, n as describeNativePluginApprovalClientSetup } from "./exec-approval-surface-FKkZmrLs.mjs";
import { t as resolveSkillWorkshopConfig } from "./config-CYRu5kQ6.mjs";
import { t as callGatewayTool } from "./gateway-DOSiCmYl.mjs";
import { r as getPluginSessionExtensionStateSync } from "./host-hook-state-B4X9zEPW.mjs";
...
import { i as copyAgentToolSourceExecutionGuard, n as captureAgentToolExecutionBudget, o as runAgentToolSourceExecutionGuard } from "./agent-tool-source-execution-guard-ci7yWtqg.mjs";
...
const loadPendingSkillProposalResolver = createLazyRuntimeNamedExport(() => import("./policy.runtime.js"), "resolvePendingSkillProposal");
...
async function deliverClientVoiceMutationDigest(record, config, signal) {
	...
	const { sendDurableMessageBatchCore } = await import("./runtime-B-6RcQ3t.mjs");
...
//#endregion
export { finalizeToolTerminalPresentation as $, ensureClientVoiceAgentSessionEntry as A, authorizeClientVoiceConfirmation as B, appendClientVoiceTranscript as C, closeRelayVoiceSessionRecord as D, closeClientVoiceSession as E, resolveClientVoiceSessionOrigin as F, observeClientVoiceConfirmationRun as G, bindAuthorizedClientVoiceConfirmation as H, resolveOpenClientVoiceSessionId as I, cancelDeferredPluginToolApproval as J, readClientVoiceConfirmationReadiness as K, VOICE_TRANSCRIPT_QUEUE_POLICY as L, registerClientVoiceConsultRun as M, resolveClientVoiceAgentSessionId as N, closeStaleClientVoiceSessions as O, resolveClientVoiceRunBinding as P, setEmbeddedPluginApprovalBroker as Q, normalizeVoiceTranscriptText as R, admitToolCallBatch as S, assertClientVoiceSessionOpen as T, captureClientVoiceConfirmationUtterance as U, authorizeObservedClientVoiceConfirmation as V, invalidateClientVoiceConfirmationUtterance as W, EmbeddedPluginApprovalBroker as X, requestDeferredPluginToolApproval as Y, clearEmbeddedPluginApprovalBroker as Z, hasRunWorkspaceSkillUsage as _, isPreExecutionBlockedToolResult as a, peekAdjustedParamsForToolCall as at, hasBeforeToolCallPolicy as b, recordStructuredReplayTrustForToolCall as c, captureAgentPluginRuntimeRefresh as d, clearBatchAdmittedToolCallsForRun as et, createAgentPluginRuntimeRefresh as f, consumeRunSkillUsage as g, readInternalExecutionControl as h, isBeforeToolCallBlockedError as i, consumeTrackedToolExecutionStarted as it, flushClientVoiceSessionWrites as j, createOrResumeClientVoiceSession as k, rewrapToolWithBeforeToolCallHook as l, createInternalExecutionPreparer as m, finalizeBeforeToolCallExecutionParams as n, consumePreExecutionBlockedToolCall as nt, prepareBeforeToolCallExecutionParams as o, peekPreExecutionBlockedToolCall as ot, runWithToolExecutionValidation as p, getTrustedToolPolicyMatcherScope as q, getBeforeToolCallFailureDisposition as r, consumeStructuredReplaySafeToolCall as rt, recordAdjustedParamsForToolCall as s, PluginApprovalResolutions as st, buildBlockedToolResult as t, consumeAdjustedParamsForToolCall as tt, wrapToolWithBeforeToolCallHook as u, consumeFinalClientVoiceToolConfirmation as v, appendRelayVoiceTranscript as w, runBeforeToolCallHook as x, getBeforeToolCallPolicyDiagnosticState as y, voiceTranscriptEventId as z };
