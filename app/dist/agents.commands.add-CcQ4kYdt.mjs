...
import { T as tryResolveLegacyCompatibilityAgentId, a as resolveAgentDir, d as resolveAgentWorkspaceDir } from "./agent-scope-config-Dm8T0OhW.mjs";
...
import { a as inspectPersistedAuthProfileStoreRaw, h as resolveAuthProfileDatabasePath } from "./sqlite-BFln1N56.mjs";
import { a as loadPersistedAuthProfileStore, f as AuthProfileStoreUnreadableError } from "./persisted-MKrH3nfz.mjs";
import { g as buildPortableAuthProfileStoreForAgentCopy } from "./store-_Ypv0hYn.mjs";
...
import { s as transformConfigWithPendingPluginInstalls, t as commitConfigWithPendingPluginInstalls } from "./install-record-commit-hNHPjMVi.mjs";
import { t as applyAgentConfig } from "./agents.config-8PkaGUZy.mjs";
import { n as loadAgentRole } from "./agent-roles-DNEmOwCN.mjs";
import { a as ensureOnboardingAgentWorkspace, c as resolveOnboardingAgentTarget, r as applyOnboardingUtilityModel } from "./onboard-agent-target--U5T7XvY.mjs";
import { t as describeBinding } from "./agents.binding-format-BRYI5aWJ.mjs";
import { n as buildChannelBindings, t as applyAgentBindings } from "./agents.bindings-BCFC1wmz.mjs";
import { n as createAgent, r as validateAgentIdInput, t as checkAgentCreationGate } from "./agent-create-CcPRCTLK.mjs";
import { n as WizardCancelledError } from "./prompts-DLsO8MlU.mjs";
import { r as stageProviderAuthProfileBatch } from "./provider-auth-persistence-DavudovL.mjs";
...
import { a as prepareAuthChoice, r as warnIfModelConfigLooksOff } from "./auth-choice-BFAd8NXq.mjs";
