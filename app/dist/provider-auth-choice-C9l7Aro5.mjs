...
import { r as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-BJVdLDpP.mjs";
...
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-KdOSa4Rd.mjs";
...
import { t as persistProviderAuthProfileBatch } from "./provider-auth-persistence-DavudovL.mjs";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const runtimePlugins = await import("./runtime-plugin-install-FomGYpcy.mjs");
