...
const loadSendMessage = createLazyRuntimeModule(() => import("./message-BgMRafFm.mjs").then((module) => module.sendMessage));
const loadGetChannelPlugin = createLazyRuntimeModule(() => import("./plugins-BVRem-z9.mjs").then((module) => module.getChannelPlugin));
