...
import { c as resolveAssistantReleaseCohortVersion, o as parseRegistryNpmSpec, r as isExactSemverVersion } from "./npm-registry-spec-B-fX1tYr.mjs";
import { t as parseClawHubPluginSpec } from "./clawhub-spec-r-Sm6wpn.mjs";
import { p as selectNpmChannelVersion } from "./update-channels-D-eqC5La.mjs";
...
async function resolveNpmInstallSpecsForUpdateChannel(params) {
	...
	const { resolveNpmSpecMetadata } = await import("./install-source-utils-BYJRqoPU.mjs");
...
async function loadConfiguredHostedOfficialExternalPluginCatalogEntries(params) {
	const { loadHostedOfficialExternalPluginCatalogEntries } = await import("./official-external-plugin-catalog-hosted-DcCLXctz.mjs");
