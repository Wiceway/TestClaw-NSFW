import { E as ToolResultMessage, S as TextContent, T as Tool, b as SimpleStreamOptions, d as AssistantMessage, f as AssistantMessageEvent, g as ImageContent, v as Message, x as StreamFn$1, y as Model } from "./types.testclaw-C-wX50Nb.js";
import "./index-TX1z6EwW.js";
...
interface InternalToolBatchCall {
  ...
  args: unknown;
  /** Resolved tool identity for Testclaw-owned argument canonicalization. */
  tool?: AgentTool;
}
...
/** Context for Testclaw-owned whole-batch tool admission. */
interface InternalBeforeToolBatchContext {
  assistantMessage: AssistantMessage;
  calls: InternalToolBatchCall[];
  context: AgentContext;
}
/** Result of Testclaw-owned whole-batch tool admission. */
type InternalBeforeToolBatchResult = {
...
interface AgentLoopConfig extends SimpleStreamOptions {
  ...
  /** @internal Testclaw-owned batch admission. Not a plugin or session SDK hook. */
 ...
 * from testclaw/plugin-sdk/llm to detect support for a concrete model.
 */
...
//#endregion
export { QueueMode as _, AgentLoopConfig as a, ToolExecutionMode as b, AgentState as c, AgentToolUpdateCallback as d, BashExecutionMessage as f, PrepareNextTurnContext as g, CustomMessage as h, AgentEvent as i, AgentTool as l, BeforeToolCallResult as m, AfterToolCallResult as n, AgentLoopTurnUpdate as o, BeforeToolCallContext as p, AfterToolOutcomeContext as r, AgentMessage as s, AfterToolCallContext as t, AgentToolResult as u, StreamFn as v, ToolLoopWarning as x, ThinkingLevel as y };