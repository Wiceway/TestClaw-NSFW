//#region src/skills/workshop/maintenance-prompt.ts
const SKILL_WORKSHOP_MAINTENANCE_TOOLS = [
	"ls",
	"read",
	"write",
	"edit",
...
const SKILL_WORKSHOP_MAINTENANCE_PROMPT = [
...
//#endregion
export { SKILL_WORKSHOP_MAINTENANCE_TOOLS as n, SKILL_WORKSHOP_MAINTENANCE_PROMPT as t };
