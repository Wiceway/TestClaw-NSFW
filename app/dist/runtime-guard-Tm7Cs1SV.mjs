...
import { a as classifyUnsupportedNodeCommand, c as isNodeVersionAtLeast, i as canRunAssistantNodeDiagnostics, l as isSupportedAssistantNodeVersion, o as formatUnsupportedNodeDiagnosticWarning, u as parseNodeReleaseVersion } from "./node-version-pLsxezYK.mjs";
import { a as nodeRuntimeNote, i as nodeRuntimeFailure, n as detectCurrentSqliteCapabilities, r as isSqliteWalResetSafeVersion } from "./node-sqlite-D5ZjhJXT.mjs";
...
async function assertSupportedRuntime(providedRuntime, providedDetails, argv, emitDiagnosticWarning = true, recoveryEnv) {
	...
	if (details.kind === "node" && argv && recoveryEnv) {
		const { recoverNodeRuntime } = await import("./node-runtime-recovery-bJc6R3hy.mjs");
