...
homepage: (документация продукта)/automation/hooks#session-memory
metadata:
  {
    "testclaw":
      {
...
- Uses your workspace directory (`~/.testclaw/workspace` by default)
...
```bash
testclaw hooks disable session-memory
```
