...
import { n as resolveNodeVersionManager } from "./version-manager-path-CORhhR2Q.mjs";
...
import { r as SUPPORTED_NODE_VERSION_RANGE } from "./node-version-pLsxezYK.mjs";
...
import { c as createRuntimeUpdateRecoverySteps, u as formatUpdateRecoverySteps } from "./update-outcome-Dj5_EBo1.mjs";
...
import { n as hasGatewayServiceDefinitionOverrides } from "./service-types-D9NIqD52.mjs";
import { i as resolveManagedServiceNodeRunner, r as resolveGatewayServiceInstallationRefreshRoot, s as summarizeGatewayServiceLayout, t as gatewayServiceCommandMatchesRoot } from "./service-layout-Vt9OJt8Q.mjs";
...
import { r as resolveServiceRecoveryContext } from "./update-command-service-env-DbNjnRg7.mjs";
import { A as createFreeBsdPkgOwnershipInspection } from "./update-runner-command-Dn-V6rM4.mjs";
import { t as resolveNodeRunner } from "./node-runner-Cua6MUxg.mjs";
import "./shared-hPUQ-y6A.mjs";
...
async function resolvePackageRuntimePreflight(params) {
	return await withCommandProcessScope(async () => {
		...
		if (params.runtimeRecovery && target.nodeEngine) {
			const { resolveTargetNodeRuntime } = await import("./update-command-node-runtime-resolution-DR3HHe35.mjs");
