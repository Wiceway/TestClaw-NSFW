...
import { i as runSqliteDeferredTransactionSync, n as logSlowSqliteCoordinatorWait, o as runSqliteImmediateTransactionSync, s as runSqlitePinnedReadSnapshotSync } from "./sqlite-transaction-Bar1ps-o.mjs";
...
import { a as tableHasColumns, i as tableHasColumn, r as tableExists, t as ensureColumn } from "./testclaw-state-db-schema-helpers-CQ_Xh1qa.mjs";
import { i as LAZY_ADDITIVE_STATE_TABLES, o as TESTCLAW_SQLITE_BUSY_TIMEOUT_MS } from "./testclaw-state-db-contract-CdyGtChZ.mjs";
import { n as StartupMaintenanceRequiredError } from "./startup-maintenance-required-C6kRvGBD.mjs";
import { a as readSqliteUserVersion, i as isSqliteSchemaVersionError } from "./sqlite-user-version-BboyngJR.mjs";
import { l as createSqliteWalReclamationResult, n as configureSqlitePreSchemaPragmas, t as configureSqliteConnectionPragmas } from "./sqlite-wal-36gEREe5.mjs";
import { E as StateSchemaMutationConflictError, s as acquireStateDatabaseCoordinator, v as resolveStateLifecycleRuntimeDirectory, w as withStateSchemaFence } from "./sqlite-source-handle-CDYF24uv.mjs";
...
import { n as hashFileDescriptorSync } from "./file-descriptor--ToewmB_.mjs";
import { a as isTerminalSqliteIntegrityError, c as sqliteIntegrityCheckSteps, n as assertSqliteIntegrity, r as assertSqliteTableIntegrity, s as runSqliteIntegrityOperationSync, t as SqliteRepairableForeignKeyError } from "./sqlite-integrity-BSZQ5Avg.mjs";
import { S as testClawStateDatabaseCache, c as closeAssistantStateDatabaseByPathAsync, h as recordAssistantStateDatabaseOpenFailure, i as clearAssistantStateDatabaseOpenFailure, w as openTrackedStateDatabase } from "./testclaw-state-db-cache-DLl9ibxh.mjs";
import { t as extractSqliteTableSchema } from "./sqlite-schema-sql-5Wa9sNMr.mjs";
import { c as readSqliteSchemaCookie, n as assertSqliteSchemaTablesPresent, o as getCanonicalSqliteNamedIndexContracts, r as collectSqliteNamedIndexContract, s as getCanonicalSqliteTableNames } from "./sqlite-schema-contract-BhQmGuZB.mjs";
import { n as migrateSqliteSchemaToStrictInTransaction } from "./sqlite-strict-7A3qfvsv.mjs";
import { c as warnAgentPathMigration, o as resolveAssistantStateSqliteDir, s as resolveAssistantStateSqlitePath, t as describeAgentPathMigration } from "./testclaw-state-db.paths-DStyAtQk.mjs";
import { i as clearAssistantDatabaseQuarantine } from "./testclaw-quarantine-store-BgTM1lrX.mjs";
import { i as readStateSchemaMigrationVersion, n as assertSupportedStateSchemaVersion, r as readStateSchemaContentVersion } from "./testclaw-state-db-schema-version-DOTBthQx.mjs";
import { a as recordExistingAssistantStateSchemaDatabase, i as isExistingAssistantStateSchema, n as assertAssistantStateSchemaRepairAllowed } from "./testclaw-state-db-schema-policy-BQ7bZxNb.mjs";
import { $ as repairLegacyTaskDeliveryStatuses, A as prepareStateDatabaseSchemaRepair, B as getAssistantStateRuntimeSchema, D as assertAssistantStateDatabaseOwner, Dt as migrateLegacyCronRunLogsToTaskRuns, E as assertAssistantStateDatabaseForMaintenance, Et as ORDERED_STARTUP_ADDITIVE_STATE_COLUMNS, F as writeCurrentStateSchemaMetadata, G as backfillCronRunLogEntryJson, J as repairLegacySubagentExecutionPayloads, K as backfillDeliveryQueueEntriesFromEntryJson, L as readStateSchemaPublicationBlocker, M as runStateSchemaMigrationTransaction, N as testClawStateMigrationAssertions, O as executeCanonicalStateSchema, P as versionedStateMigrations, Q as repairLegacyTaskAgentAttribution, T as repairAuditEventsSchema, Tt as CLAW_STARTUP_ADDITIVE_STATE_COLUMN_DEFINITIONS, U as backfillAcpReplayEstimatedBytes, W as backfillCronJobsFromJobJson, X as repairLegacySubagentSuspensionReasons, Y as repairLegacySubagentRetainedResults, Z as repairLegacySubagentTaskBindings, _ as repairLegacyGatewayRestartHandoffsForStrictMigration, b as migrateSessionWatchCursorProvenance, c as assertNoLegacyStateRuntimeRepair, d as assertCanonicalStateSchemaShape, et as repairOperatorApprovalSchema, g as repairAgentDatabasesCompositePrimaryKey, h as migrateWorkerPlacementExecutionModeSchema, j as resolveDatabasePath, k as markCurrentStateSchemaVersion, l as isAssistantStateSchemaFastPathEligible, m as migrateAgentDatabaseRelativePaths, o as assertExistingAssistantStateRuntimeSchema, p as dropLegacyStateTables, q as ensureOperatorApprovalResolutionRefs, r as openAssistantStateReadConnection, s as assertCurrentStateRuntimeSchema, tt as TESTCLAW_STATE_SCHEMA_SQL, u as needsAssistantStateDatabaseSchemaRepair, v as logRetiredStateTableMigration, w as migrateSingletonStateFoldInV12, wt as CLAW_FIRST_USE_ADDITIVE_STATE_COLUMN_DEFINITIONS, x as needsSessionWatchCursorProvenanceMigration, y as runRetiredStateTableMigrations } from "./testclaw-state-db-read-connection-BvrNnfuu.mjs";
...
import { a as assertAssistantStateWriteAllowed, f as runWithAssistantStateWriteAccess, l as isAssistantStateWriteContentionError, r as AssistantStateOwnershipError } from "./testclaw-state-ownership-Czk4lNwX.mjs";
...
import "./testclaw-state-db-schema-discovery-imcBGzRe.mjs";
...
function ensureMcpOAuthPendingSchema(database) {
	database.exec(extractSqliteTableSchema(TESTCLAW_STATE_SCHEMA_SQL, "mcp_oauth_pending_authorizations", { errorMessage: "Assistant MCP OAuth pending schema marker is missing." }));
}
...
function ensureDevicePairSetupCompletionSchema(database) {
	database.exec(extractSqliteTableSchema(TESTCLAW_STATE_SCHEMA_SQL, "device_pair_setup_completions"));
}
...
//#endregion
export { repairLegacyTaskIdentifiers as A, ensureRepositoryGitHubPublicationSchema as C, ensureTaskExecutionOwnerSchema as D, ensureSessionRepositoryWorkspaceSchema as E, runCoordinatedStateTransaction as F, withSharedStateWriteCoordinator as I, verifyAndRepairCanonicalSqliteIndexSteps as M, verifyAndRepairCanonicalSqliteIndexes as N, ensureWorkerEnvironmentNodeEnrollmentSchema as O, ensureAssistantStatePermissions as P, ensurePersonalGitHubPublicationSchema as S, ensureSecretStoreSchema as T, ensureDevicePairingJoinCodeSchema as _, reconcileAssistantStateSchemaPublication as a, ensureMcpOAuthPendingSchema as b, runAssistantStateWriteTransaction as c, recoverOrphanTaskDeliveryRows as d, ensureAgentDatabaseLeaseSchema as f, ensureDevicePairSetupCompletionSchema as g, ensureDevicePairSetupBootstrapSchema as h, prepareAssistantStateDatabaseSchema as i, repairCanonicalSqliteIndexes as j, hasRepositoryWorkspacePendingResultSchema as k, runWithAssistantStateBusyTimeout as l, ensureConfigRevisionKeySchema as m, openExistingAssistantStateDatabaseReadOnly as n, repairAssistantStateDatabaseReadabilityForDoctor as o, ensureAgentDeletionJournalSchema as p, openAssistantStateDatabase as r, repairAssistantStateDatabaseSchema as s, initializeNativeAssistantStateDatabase as t, withAssistantStateStartupMigrationCheckpointDatabase as u, ensureGitHubPublicationSchema as v, ensureRepositoryWorkspacePendingResultSchema as w, ensureNodeWorkerPreparedWorkspaceSchema as x, ensureGitHubPublicationSessionLifecycleSchema as y };
