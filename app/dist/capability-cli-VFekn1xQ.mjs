import { i as getCommandArgsWithRootOptions } from "./cli-root-options-vGuJ5JgW.mjs";
import { h as normalizeRootLogLevelArgv, n as getCommandPathWithRootOptions } from "./argv-Wc3zbgLD.mjs";
...
import { r as providerSummaryText, t as emitJsonOrText } from "./output-CB4SXVdl.mjs";
...
const capabilityCommandGroups = [
	["model", async () => (await import("./model-BGIuSwUi.mjs")).registerModelCapabilityCommands],
	["image", async () => (await import("./image-DbtyZJH6.mjs")).registerImageCapabilityCommands],
	["audio", async () => (await import("./audio-BRxNc0yR.mjs")).registerAudioCapabilityCommands],
	["tts", async () => (await import("./tts-hCfPS0eP.mjs")).registerTtsCapabilityCommands],
	["video", async () => (await import("./video-C888C2xt.mjs")).registerVideoCapabilityCommands],
	["web", async () => (await import("./web-CDU6R1Mm.mjs")).registerWebCapabilityCommands],
	["embedding", async () => (await import("./embedding-F9qI3eZ6.mjs")).registerEmbeddingCapabilityCommands]
];
...
async function registerCapabilityDomainCommands(capability, argv) {
	...
	const commandArgs = primary === "infer" || primary === "capability" ? getCommandArgsWithRootOptions(selectionArgv, {
		commandPath: [primary],
		mode: "command-path"
	}) : void 0;
	const selectedName = commandArgs?.[0] === "--" ? commandPath[1] : commandArgs?.[0];
