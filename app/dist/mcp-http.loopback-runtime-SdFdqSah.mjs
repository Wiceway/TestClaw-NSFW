...
const toolCallCaptures = resolveGlobalMap(Symbol.for("testclaw.mcpLoopbackToolCallCaptures"), (captures) => {
...
const MCP_AUTH_HEADERS = { Authorization: "Bearer ${TESTCLAW_MCP_TOKEN}" };
const MCP_CAPTURE_HEADERS = { "x-testclaw-cli-capture-key": "${TESTCLAW_MCP_CLI_CAPTURE_KEY}" };
