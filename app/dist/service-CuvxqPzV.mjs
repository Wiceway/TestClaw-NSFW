...
import { E as string, _ as literal, x as object } from "./schemas-qz0osXyE.mjs";
...
import { c as normalizeGitPathForFilesystem, d as startGitOperationTiming, u as requireGitCommandOutput } from "./git-exec-0cc0Upnj.mjs";
import { n as formatDiskSpaceBytes, r as tryReadDiskSpace } from "./disk-space-CtKhSv74.mjs";
import { c as requireGit, d as runGit, l as requireGitBuffer, m as worktreePathExists, n as commandError, s as listGitWorktrees, t as WORKTREE_CHECKOUT_TIMEOUT_MS, u as resolveGitRepositoryPaths } from "./git-C-rUSsb0.mjs";
...
import { n as runGitReadOperation } from "./git-read-cache-DhEz18Db.mjs";
...
import { S as retireMissingRegistryWorktree, T as WorktreeRemovalContentionError, _ as insertRegistryWorktreeProvisionedChunk, a as clearRegistryWorktreeProvisionedChunks, d as getRegistryWorktree, f as getRegistryWorktreeProvisionedChunk, g as insertRegistryWorktree, l as findLiveRegistryWorktreeByOwner, m as getRegistryWorktreeProvisionedState, o as deleteRegistryWorktree, p as getRegistryWorktreeProvisionedPaths, r as assertWorktreeRemovalClaim, u as findLiveRegistryWorktreeByPath, w as updateRegistryWorktree, y as listRegistryWorktrees } from "./registry-BYEaQrMy.mjs";
import { a as hasLiveWorktreeRunLease, c as lockState, i as finalizeWorktreeRemoval, l as lockWorktreeForProcess, r as claimWorktreeRemoval, s as createWorktreeLockPrefilter, t as abortWorktreeRemoval, u as unlockWorktree } from "./run-lease-MweG9Y43.mjs";
import { c as splitNullBuffer, i as gitPathspecBatches } from "./git-path-inventory-sE4y6-Mm.mjs";
import { c as inspectProvisionedFiles, d as resolveGitPath, i as restoreExactStateMetadata, l as lstatIfExists, o as hasSafeParentDirectories, r as readExactStateSnapshot, u as normalizeProvisionedRelativePath } from "./snapshot-exact-state-CRPdMwS6.mjs";
import { t as resolveCheckoutRootFromRealPath } from "./repository-paths-DNmvTE-8.mjs";
import { t as exactStateRetirementSchema } from "./snapshot-exact-state-contract-BvujAn51.mjs";
	...
	const prepare = async () => {
		...
		try {
			...
			if (template.backend.id === "apfs") {
				const { copyApfsCloneIndex } = await import("./checkout-apfs-BNIwMChf.mjs");
...
async function retireManagedWorktreeSnapshot(params) {
	...
	try {
		const { expireLocalWorkspaceProjection } = await import("./local-workspace-projection-BU86W998.mjs");
