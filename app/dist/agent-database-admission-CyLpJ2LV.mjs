...
import { C as tryResolveAmbientOwnerAgentId, T as tryResolveLegacyCompatibilityAgentId } from "./agent-scope-config-Dm8T0OhW.mjs";
...
async function evaluateAgentDatabaseAdmissions(config, options = {}) {
	...
	const { resolveConfiguredAgentDatabaseCandidatePaths } = await import("./targets-DMHkZnmA.mjs");
