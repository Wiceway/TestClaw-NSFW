...
import { A as parseAgentSessionKey, E as parseThreadSessionSuffix, O as normalizeSessionKeyPreservingOpaquePeerIds } from "./session-key-C_bfgyCp.mjs";
...
import { Rr as validateSendParams, gn as validateMessageActionParams, ur as validatePollParams } from "./src-BNV0SJoP.mjs";
...
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-BfhYDbXQ.mjs";
...
import { c as selectMessageActionRequesterIdentity, i as resolveMessageActionTurnAuthorization, r as readMessageActionInvocationConfig } from "./message-action-turn-capability-qbePp5iP.mjs";
import { t as buildOutboundSessionContext } from "./session-context-DaL_V0d6.mjs";
import { a as maybeResolveIdLikeTarget } from "./target-resolver-hKhv_7cs.mjs";
...
import { d as createChannelPartialDeliveryError, f as isChannelPartialDeliveryError } from "./live-B6WuRF4e.mjs";
...
import { c as isScheduledMessageWriteAction, n as resolveImplicitMessageActionTarget, o as dispatchChannelMessageAction, p as hydrateAttachmentParamsForAction, r as actionHasTarget, s as isFencedProviderReadAction, v as resolveAttachmentMediaPolicy } from "./message-action-normalization-B-y-OGvM.mjs";
import { a as mirrorDeliveredSourceReplyToTranscript, n as cancelTerminalSourceReplyDelivery, o as reconcileTerminalSourceReplyDelivery, t as beginTerminalSourceReplyDelivery } from "./source-reply-mirror-BG8rs5m2.mjs";
...
import { n as resolveGatewayInflightRequest$1, r as runGatewayInflightWork } from "./inflight-C7tVF6RA.mjs";
					...
					return await withChannelReadAuthority(request.action === "download-file" || messageAuthority.assertReadCurrent ? assertDirectAdapterHandoff : void 0, async () => {
						...
						try {
							if (canonicalAction || messageAuthority.assertScheduledWriteCurrent) {
								const { runMessageAction } = await import("./message-action-runner-Pi9P5I_x.mjs");
