...
import { p as resolvePluginNpmProjectsDir, s as resolveDefaultPluginNpmDir } from "./install-paths-Cd1lenii.mjs";
...
import { a as resolveRetainedManagedNpmInstallMarkerPath, i as markRetainedManagedNpmInstall, n as clearRetainedManagedNpmInstallMarker, o as resolveRetainedManagedNpmInstallPackageInfo, s as restoreRetainedManagedNpmInstallMarkers } from "./managed-npm-retention-BaNHLLDn.mjs";
import { n as readPersistedInstalledPluginIndex } from "./installed-plugin-index-store-8IghgXkj.mjs";
import { C as resolveConfigWriteAfterWrite } from "./runtime-snapshot-Dti8jFIP.mjs";
import { S as copyRuntimeConfigWriteApplication, c as readConfigFileSnapshot } from "./io.runtime-DIHH_X2V.mjs";
import { o as transformConfigFileWithRetry, r as replaceConfigFile } from "./mutate-p35y2dNu.mjs";
import "./config-DqAgdhnz.mjs";
import { r as restorePersistedInstalledPluginIndexIfCurrent } from "./installed-plugin-index-store-write-P0EApttv.mjs";
import { a as withoutPluginInstallRecords, o as writePersistedInstalledPluginIndexInstallRecordsWithLease, t as PLUGIN_INSTALLS_CONFIG_PATH } from "./installed-plugin-index-records-CTYgsrgw.mjs";
import { r as withPluginLifecycleLease } from "./plugin-lifecycle-lease-CkmD-Hkp.mjs";
import { o as recordPluginPackageUninstallPlan, r as planPluginUninstall } from "./uninstall-BL-87M1Q.mjs";
...
async function assertPluginConfigActivationConsent(params) {
	...
	const { resolvePluginControlPlaneWorkspace } = await import("./control-plane-workspace-_VsKNJMG.mjs");
