...
import { i as buildModelAliasIndex, o as dedupeModelCatalogEntries, p as resolveBareModelDefaultProvider, v as resolveModelRefFromString } from "./model-selection-shared-DIVgwazZ.mjs";
...
import { o as isRetiredModelPickerProvider } from "./model-runtime-aliases-BoGMxzI3.mjs";
...
import { c as loadPublishedPreparedModelCatalogOwnerSnapshot } from "./prepared-model-catalog-iMxpdaVw.mjs";
import { t as getChannelPlugin } from "./registry-DcRiLbUb.mjs";
import "./plugins-DXMl0Sbq.mjs";
import { s as rejectUnauthorizedCommand } from "./command-gates-DBQdi4sc.mjs";
...
import { i as normalizeRuntimeChoiceId, s as resolveRuntimeNormalization } from "./model-runtime-normalization-BYLTBNsO.mjs";
...
import { a as resolveProviderChannelLoginChoice } from "./provider-login-options-CP2OUWBZ.mjs";
...
function getModelsRuntimeChoices(data, provider, model) {
	if (data.isCurrent?.() === false) return;
	return model ? data.runtimeChoicesByModel?.get(`${normalizeProviderId(provider)}/${model}`) : data.runtimeChoicesByProvider?.get(normalizeProviderId(provider));
}
function buildPreparedModelsProviderData(cfg, agentId, options = {}) {
...
//#endregion
export { buildPreparedModelsProviderData as a, resolveModelsCommandReply as i, formatModelsAvailableHeader as n, getModelsRuntimeChoices as o, handleModelsCommand as r, MODEL_PICKER_CHANGED_MESSAGE as t };
