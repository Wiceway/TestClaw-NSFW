...
import { a as isCurrentPluginMetadataSnapshotRuntimeGeneration, i as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CuzkxMsN.mjs";
...
import { n as OAuthProviderRegistry, t as OAuthProviderConfiguredUnavailableError } from "./provider-runtime.errors-Cx4Tc0bx.mjs";
import { c as resolveProviderOAuthRefreshCapabilityWithPlugin, i as loginProviderOAuthWithPlugin, s as resolveProviderOAuthCredentialWithPlugin } from "./provider-runtime.runtime.js";
import { _ as runAuthProfileWriteTransaction, a as inspectPersistedAuthProfileStoreRaw, h as resolveAuthProfileDatabasePath, i as inspectPersistedAuthProfileStateRaw } from "./sqlite-BFln1N56.mjs";
import { t as normalizeOptionalSecretInput } from "./normalize-secret-input-Df_qhWv_.mjs";
import { E as OAUTH_REFRESH_LOCK_OPTIONS, T as OAUTH_REFRESH_CALL_TIMEOUT_MS, a as loadPersistedAuthProfileStore, f as AuthProfileStoreUnreadableError, h as loadPersistedAuthProfileState } from "./persisted-MKrH3nfz.mjs";
import { l as isOAuthRefreshFence, u as isPendingOAuthRefreshFence } from "./credential-state-B72qRadL.mjs";
import { V as normalizeOAuthRefreshCredential, W as refreshSerializedOAuthCredential } from "./runtime-snapshots-BVrxpeKm.mjs";
import { i as assertAuthProfileMigrationReady, t as AuthProfileMigrationRequiredError } from "./legacy-source-diagnostic-C3oR-sYo.mjs";
import { o as hasUsableCustomProviderApiKey } from "./model-auth-provider-config-BtBizCzx.mjs";
import { f as saveAuthProfileStoreWithPreparedOwner, t as createAuthProfileStoreReadScope } from "./store-runtime-CZ_l0ERR.mjs";
...
import { a as getBashShellEnv, i as getBashShellConfig, t as buildShellCommandInvocation } from "./shell-utils-DoC1Sfpw.mjs";
import { a as sanitizeModelHeaders } from "./model.inline-provider-DJBripyM.mjs";
import { t as parseModelCatalogJson } from "./model-catalog-json-CxUsDrkg.mjs";
import { a as normalizeProviderMapKeys, n as mergeProviderModels, t as buildSourceModelFields } from "./models-config.merge-CSxLqS8X.mjs";
import { t as materializeConfiguredProviderCatalogModels } from "./models-config.providers.catalog-BJudNZ1x.mjs";
import { a as loadPersistedPluginModelCatalogsReadOnly, d as isGeneratedPluginModelCatalog, i as inspectLegacyPluginModelCatalogs, r as filterGeneratedPluginModelCatalogProviders } from "./plugin-model-catalog-D6osTooo.mjs";
