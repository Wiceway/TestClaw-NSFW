...
import { n as formatIcaclsResetCommand, t as createIcaclsResetCommand } from "./permissions-BpoR0No3.mjs";
...
import { p as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-BAu4G4zB.mjs";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-DTK8SxCJ.mjs");
