...
import { a as iterateSqliteQuerySync, i as getNodeSqliteKysely, l as sqliteStringSet, n as executeSqliteQuerySync, o as prepareSqliteQueryIterator, r as executeSqliteQueryTakeFirstSync, s as prepareSqliteQuerySync, u as sql } from "./kysely-sync-DUH0XYlR.mjs";
...
import { i as tableHasColumn, r as tableExists, t as ensureColumn } from "./testclaw-state-db-schema-helpers-CQ_Xh1qa.mjs";
import { T as LEGACY_ACP_MIGRATION_COLUMN_DEFINITION, h as ensureSessionPendingInputsSchema, m as ensureSessionInputCompletionsSchema, v as hasSessionPendingInputsSchema } from "./testclaw-agent-db-identity-B2JyZwuj.mjs";
...
import { E as string, b as number, d as array, x as object } from "./schemas-qz0osXyE.mjs";
...
import { E as ensureSessionRepositoryWorkspaceSchema, c as runAssistantStateWriteTransaction, r as openAssistantStateDatabase } from "./testclaw-state-db-BXFT1fUC.mjs";
...
import { a as mergeDeliveryContext, c as normalizeSessionDeliveryState, s as normalizeDeliveryContext, t as deliveryContextFromChannelRoute } from "./delivery-context.shared-C0r2NKUR.mjs";
...
import { g as ensureSessionParticipantsSchema } from "./testclaw-agent-db-schema-helpers-CYxrGCCh.mjs";
...
import { a as getSessionKysely, g as toDatabaseOptions, h as runExclusiveSqliteSessionWrite, o as normalizeSqliteSessionKey, u as resolveSqliteScope } from "./session-accessor.sqlite-scope-kTo4D2H6.mjs";
import { d as readSessionEntryTargetRow, l as readSessionEntryRow, o as readExactSessionEntryRow, s as readExactSessionEntryRowValidated, u as readSessionEntryRowScan, v as mergeParticipantAggregate } from "./session-accessor.sqlite-entry-read-Cah7Q8q_.mjs";
import { c as hasSqliteSessionOwnerColumns, n as normalizeStatus, r as parseSessionEntryJson, s as sessionEntryMetadataJson } from "./session-accessor.sqlite-status-DgteG5a_.mjs";
...
import { m as canonicalSessionKeyMigrationRequiredError, n as assertCanonicalSessionKeyWrite, s as hasCanonicalSessionValidationProjection, t as assertCanonicalSessionEntryLineageWrite } from "./session-canonical-key-D8rnGIu3.mjs";
import { a as preserveCreationStamp } from "./session-entry-provenance-DsjUFk5O.mjs";
import "./session-accessor.sqlite-entry-inventory-BKBM7n1O.mjs";
...
import { r as resolveGroupSessionKey, t as buildGroupDisplayName } from "./group-D5IZTzr7.mjs";
...
import { a as getSessionMaintenanceActivityAt, p as shouldPreserveMaintenanceEntry } from "./store-maintenance-BULqjr93.mjs";
...
import { c as readTranscriptMutationStateInTransaction } from "./session-accessor.sqlite-transcript-state-DELnx7YZ.mjs";
		...
		handle: Object.freeze({
			...
			prepareNativeToolPolicy: async (model) => {
				...
				const [{ resolvePluginHarnessToolPolicies }, { resolveSandboxRuntimeStatus }, { resolveWebSearchToolPolicy }] = await Promise.all([
					import("./execution-environment-BcIsvhhS.mjs"),
					import("./runtime-status-rN5Gq2-x.mjs"),
					import("./web-search-tool-policy-D1We0-Mi.mjs")
				]);
				owner.handle.assertCurrent();
				const child = {
