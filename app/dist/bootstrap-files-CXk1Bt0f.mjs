...
import { i as DEFAULT_MEMORY_FILENAME, n as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_USER_FILENAME } from "./workspace-bootstrap-policy-DhM0WSIj.mjs";
import { a as isWorkspaceSetupCompleted, d as getWorkspaceFileSourceRelativePath, f as readWorkspaceFileWithGuards, h as workspaceFilesShareSourceIdentity, n as filterBootstrapFilesForSession, p as setWorkspaceFileSourceIdentity, s as loadWorkspaceBootstrapFiles } from "./workspace-CQbT0L2J.mjs";
import { r as isMemoryOriginEligibleForAutomaticInjection } from "./types-DQpgwdiP.mjs";
import "./session-accessor-CtBBLApI.mjs";
import { r as readRecentSessionTranscriptActiveEvents } from "./session-accessor.sqlite-active-events-CM5yNO6K.mjs";
import { n as createInternalHookEvent, u as triggerInternalHook } from "./internal-hooks-Mpc90vI4.mjs";
import { i as resolveBootstrapTotalMaxChars, n as buildBootstrapContextFiles, r as resolveBootstrapMaxChars } from "./bootstrap-CdWcuyvw.mjs";
import "./embedded-agent-helpers-C4UbmZwd.mjs";
import { i as getOrLoadBootstrapFiles } from "./bootstrap-cache-C5Rt25pf.mjs";
import { n as classifyActiveMemoryWorkspacePaths } from "./memory-runtime-DYVgPuA7.mjs";
