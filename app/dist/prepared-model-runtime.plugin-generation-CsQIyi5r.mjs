...
import { E as waitForPluginCacheRetirement, c as getPluginCacheRetirementSignal, d as getPluginMetadataSnapshotCache, x as retainPluginCache } from "./plugin-cache-CTGtP6hf.mjs";
import { a as asOptionalRecord, c as isRecord } from "./record-coerce-DItp3I4t.mjs";
import { l as normalizeOptionalString, o as normalizeLowercaseStringOrEmpty } from "./string-coerce-CIXf7egm.mjs";
import { n as hasRetainedPluginRuntimeCloseError, t as PluginRuntimeCloseRetainedError } from "./runtime-close-error-CPdmUycd.mjs";
...
import { n as resolveCatalogOwnedModelCompat, t as modelTransportRoutesMatch } from "./model-compat-catalog-DU9GPmr_.mjs";
...
import { a as createModelVisibilityPolicyWithFallbacks, u as listModelAliasCandidates } from "./model-selection-shared-DIVgwazZ.mjs";
import { t as findNormalizedProviderValue$1 } from "./model-selection-normalize-BgF-TcTd.mjs";
import { t as resolveDefaultModelForAgent } from "./model-selection-config-Djxkz5Qa.mjs";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, r as canonicalizeOpenAIModelId } from "./openai-routing-BjbLRc1p.mjs";
import { b as materializeConfiguredProviderModelRows } from "./validation-core-tZ7JDiKd.mjs";
import { t as mergeModelCost } from "./model-cost-BNQWuFdo.mjs";
import { _ as markPluginRegistryActive, a as capturePluginRegistryLifecycleEpoch, h as isPluginRegistryRetired, i as capturePluginLifecycleAuthority, l as getPluginRegistryLifetime, n as bindPluginRegistryLifetime, o as capturePluginRegistryLifecycleSignal, u as getPluginRegistryResourceOwner } from "./registry-lifecycle-7UsSBpcC.mjs";
import { o as disposePluginRegistryInstances } from "./runtime-D1tHq7F4.mjs";
import { l as isOAuthRefreshFence } from "./credential-state-B72qRadL.mjs";
import { C as isAmbientCredentialAllowedByProviderAuthPin } from "./store-_Ypv0hYn.mjs";
import { k as AuthProfileRuntimeReadStaleError } from "./runtime-snapshots-BVrxpeKm.mjs";
import { r as resolveProviderEndpoint } from "./provider-attribution-BL9inzbS.mjs";
import { n as attachModelProviderRequestRouteFacts, p as sanitizeConfiguredModelProviderRequest, r as attachModelProviderRequestTransport, s as inheritModelProviderRequestRouteFacts, u as resolveProviderRequestConfig } from "./provider-request-config-B-Uo_fI2.mjs";
import { o as registryContainsRuntimePluginIds } from "./active-runtime-registry-CFUp_yLA.mjs";
import { f as getPluginRegistryInspectionResources, m as collectRegistryInvocationInstances } from "./registry-BPMvk3sV.mjs";
...
import { m as resolveProviderEnvAuthLookupMaps, p as listProviderEnvAuthLookupKeys } from "./model-auth-markers-Bml4Y1AZ.mjs";
import { t as resolveEnvApiKey } from "./model-auth-env-8aEZOe8n.mjs";
import { i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore, s as loadAuthProfileStoreForRuntimeAsync } from "./store-runtime-CZ_l0ERR.mjs";
...
import { t as buildPreparedModelCatalogSnapshot } from "./model-catalog-C8yXMb21.mjs";
import { a as resolveLoadedProviderRuntimePlugin } from "./provider-hook-runtime-VNdazVeu.mjs";
import { F as runProviderDynamicModel, R as shouldPreferProviderRuntimeResolvedModel, a as buildProviderUnknownModelHintWithPlugin, f as normalizeProviderResolvedModelWithPlugin, h as prepareProviderDynamicModel, k as resolveProviderSyntheticAuthWithPlugin, m as normalizeProviderTransportWithPlugin, t as applyProviderResolvedTransportWithPlugin, v as prepareProviderSyntheticAuthWithPlugin } from "./provider-runtime-v9pi62W8.mjs";
import { i as resolveRuntimeSyntheticAuthProviderRefs } from "./synthetic-auth.runtime.js";
import { c as resolveModelPluginMetadataSnapshot, i as AuthStorage, t as ModelRegistry } from "./model-registry-BdggoGOS.mjs";
import { i as normalizeModelCompat } from "./provider-model-compat-y7hNxHn9.mjs";
import { t as attachModelProviderLocalService } from "./provider-local-service-BsLhaaNb.mjs";
import { a as sanitizeModelHeaders, i as resolveProviderModelInput, r as normalizeResolvedTransportApi, t as buildInlineProviderModels } from "./model.inline-provider-DJBripyM.mjs";
import { i as shouldUnconditionallySuppress, n as buildSuppressedBuiltInModelError, r as resolveBuiltInModelSuppressionFromManifest } from "./model-suppression-uEcwkN2_.mjs";
import { a as resolveBundledStaticCatalogModel, l as resolveProviderTransport, o as resolveManifestModelCatalogProviderAliasMetadata } from "./model.static-catalog-DD7Z3lG3.mjs";
...
import { n as augmentPreparedModelCatalogWithAgentHarness } from "./model-catalog-Bh_u_ILI.mjs";
import { i as resolveAgentRuntimePluginLoadPlan } from "./runtime-plugin-load-plan-VA_wFpYQ.mjs";
import { n as capturePreparedModelRuntimeLifetime, o as registerPreparedPluginRetirement, s as retirePreparedModelRuntimeGeneration } from "./prepared-model-runtime.lifecycle-Ca9ROCyG.mjs";
import { a as releaseRuntimePluginWork, o as retainRuntimePluginWork, t as acquireAgentRuntimePluginRegistry } from "./runtime-plugins-DCyOf92x.mjs";
...
//#endregion
export { mergeModelMediaInput as A, resolveRuntimePreferredSuppressedModel as C, resolveConfiguredProviderConfig as D, applyConfiguredProviderOverrides as E, resolveAmbientAgentCredentialsForDiscovery as F, resolveAgentCredentialMapFromStore as I, resolveUsableAgentCredentialModes as L, discoverModels as M, discoverModelsFromCapturedSources as N, normalizeResolvedModel as O, prepareAmbientAgentCredentialsForDiscovery as P, resolveModelWithRegistry as S, buildConfiguredFallbackModel as T, prepareConfiguredModelAliases as _, preparedPluginGenerationSupportsSelections as a, resolveExplicitModelWithRegistry as b, publishPreparedPluginGeneration as c, retainPreparedPluginGeneration as d, retainPreparedPluginRegistry as f, completeConfiguredRuntimeModels as g, retainPreparedModelRuntimeSnapshotResources as h, preparedPluginGenerationReusesBase as i, discoverAuthStorageFacts as j, resolveRuntimeHooks as k, registerPreparedPluginLifetime as l, closeEphemeralPreparedModelRuntimeResources as m, buildPreparedPluginModelCatalog as n, discardPreparedPluginGeneration as o, PreparedModelRuntimeBuildResources as p, createPreparedPluginGeneration as r, ownPreparedPluginGeneration as s, acquirePreparedMediaCapabilityProviders as t, releasePreparedPluginPublication as u, normalizeProviderModelRef as v, shouldCompareProviderRuntimeResolvedModel as w, resolveModelWithPreparedRegistry as x, resolveDynamicModelAuthProfile as y };
