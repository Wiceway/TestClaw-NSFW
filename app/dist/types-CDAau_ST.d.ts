...
type ChannelMessageSendTextContext<TConfig = TestclawConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
type ChannelMessageSendMediaContext<TConfig = TestclawConfig> = ChannelMessageSendTextContext<TConfig> & {
  mediaUrl: string;
...
type ChannelMessageSendPayloadContext<TConfig = TestclawConfig> = ChannelMessageSendTextContext<TConfig> & {
...
type ChannelMessageSendPollContext<TConfig = TestclawConfig> = Omit<ChannelMessageSendTextContext<TConfig>, "text" | "threadId"> & {
  poll: PollInput;
...
type ChannelMessageSendAttemptContext<TConfig = TestclawConfig> = (ChannelMessageSendTextContext<TConfig> & {
  kind: "text";
...
type ChannelMessageSendSuccessContext<TConfig = TestclawConfig, TSendResult extends ChannelMessageSendResult = ChannelMessageSendResult> = ChannelMessageSendAttemptContext<TConfig> & {
  result: TSendResult;
  attemptToken?: unknown;
};
/** Lifecycle context emitted after an adapter send throws or rejects. */
type ChannelMessageSendFailureContext<TConfig = TestclawConfig> = ChannelMessageSendAttemptContext<TConfig> & {
  error: unknown;
  attemptToken?: unknown;
};
/** Lifecycle context emitted when a successful send is being durably committed. */
type ChannelMessageSendCommitContext<TConfig = TestclawConfig, TSendResult extends ChannelMessageSendResult = ChannelMessageSendResult> = ChannelMessageSendSuccessContext<TConfig, TSendResult>;
/** Durable queue context used to reconcile a send whose platform state is unknown. */
type ChannelMessageUnknownSendContext<TConfig = TestclawConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
...
type ChannelMessageDeferredDeliveryAdmissionContext<TConfig = TestclawConfig> = {
  cfg: TConfig;
  channel: string;
  to: string;
  accountId?: string | null;
...
type ChannelMessageSendLifecycleAdapter<TConfig = TestclawConfig, TSendResult extends ChannelMessageSendResult = ChannelMessageSendResult> = {
...
type ChannelMessageSendAdapter<TConfig = TestclawConfig, TSendResult extends ChannelMessageSendResult = ChannelMessageSendResult> = {
...
type ChannelMessageAdapterShape<TConfig = TestclawConfig, TSendResult extends ChannelMessageSendResult = ChannelMessageSendResult> = {
  id?: string;
