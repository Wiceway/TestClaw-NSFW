...
import { E as createDiagnosticTraceContextFromActiveScope, I as markToolExecutionLivenessDiagnosticEvent, O as freezeDiagnosticTraceContext, c as emitTrustedDiagnosticEventWithPrivateData, q as hasInternalDiagnosticEventListeners, s as emitTrustedDiagnosticEvent, t as areDiagnosticsEnabledForProcess } from "./diagnostic-events-C4sEV9aC.mjs";
import { s as sanitizeHostExecEnv } from "./host-env-security-zCuqI0tD.mjs";
...
import { c as createCapturedOutputBuffers, s as appendCapturedOutput } from "./exec-BddaUUYf.mjs";
...
import { t as NODE_AGENT_CLI_CLAUDE_RUN_COMMAND } from "./node-commands-BLhGKTZa.mjs";
...
import { i as emitAgentEvent, t as assertAgentRunLifecycleGenerationCurrent } from "./agent-events-WwqMA2rD.mjs";
import { i as resolveWindowsExecutablePath, o as resolveWindowsSpawnProgramCandidate } from "./windows-spawn-CR3vyrK9.mjs";
import { s as recordAdjustedParamsForToolCall, x as runBeforeToolCallHook } from "./agent-tools.before-tool-call-CN-tk8aM.mjs";
...
import { a as isFailoverError, o as isSignalTimeoutReason, t as FailoverError } from "./error-ON38hPhx.mjs";
...
import { i as resolveExecApprovalsFromFile, l as recordAllowlistMatchesUse } from "./exec-approvals-BBEWVrGM.mjs";
import { l as loadSessionEntryReadOnly } from "./session-accessor.sqlite-entry-BgjD5zI-.mjs";
import "./session-accessor-CtBBLApI.mjs";
import { f as resolveAdmittedRunActiveAssertion, o as getAdmittedRunDelegatedAuthority } from "./admitted-run-context-Dr03O97V.mjs";
import { h as resolveCliToolTerminalReason } from "./run-termination-Cf8kcgMU.mjs";
...
import { c as resolveFastModeForElapsed } from "./fast-mode-CF9HctjM.mjs";
import { _ as BLOCKED_TOOL_CALL_ABORT_FLOOR_MS, h as beginDiagnosticBackendActivity } from "./diagnostic-run-activity-CdSzto1l.mjs";
import { i as getGatewayToolCallerIdentity, n as createAdmittedGatewayToolCallerIdentity, o as withGatewayToolCallerIdentity } from "./gateway-caller-context-CxCRBFJ-.mjs";
...
import { p as resolveFailoverStatus } from "./failover-error-CLjp2PNc.mjs";
...
import { a as sanitizeExecApprovalWarningTextWithStatus, t as exceedsApprovalTextLimit } from "./exec-approval-text-sanitize-C4VbUkOU.mjs";
import { n as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS, p as truncatePluginApprovalDetail } from "./plugin-approvals-CbE1CTiQ.mjs";
import { t as callGatewayTool } from "./gateway-DOSiCmYl.mjs";
import { a as isMessagingToolSendAction, i as isMessagingToolDeliveryAction, o as isMessagingToolTargetEvidenceAction, r as isMessagingTool } from "./embedded-agent-messaging-sOK_beTq.mjs";
...
import { n as applySkillEnvOverridesFromSnapshot } from "./env-overrides-DWO642wD.mjs";
import { n as hasHydratableMediaImages } from "./images.media-refs-BlC6rrCj.mjs";
import { r as detectImageReferences } from "./images-KqHMkdLQ.mjs";
import { r as projectAgentToolActivity } from "./agent-activity-events-Cd9GpIU8.mjs";
import { i as extractToolErrorMessage, l as sanitizeToolArgs, u as sanitizeToolResult } from "./embedded-agent-tool-results-DiQscj2f.mjs";
import { i as filterToolResultMediaUrls, n as collectMessagingMediaUrlsFromToolResult, r as extractToolResultMediaArtifact, t as collectMessagingMediaUrlsFromRecord } from "./embedded-agent-tool-media-C8HBVcYh.mjs";
...
import { i as resolveMessageToolSourceReplyFinal, n as isDeliveredMessagingToolResult, t as isDeliveredMessageToolOnlySourceReplyResult } from "./embedded-agent-message-tool-source-reply-B5Y-eLZ7.mjs";
import { t as createModelCallStreamProgressReporter } from "./diagnostic-model-stream-progress-DQQlefQJ.mjs";
...
import { r as stripAssistantMcpToolPrefix, t as normalizeCliToolName } from "./tool-policy-C-S-D_rA.mjs";
import { t as createPluginToolsMcpHandlers } from "./plugin-tools-handlers-BBHmOxOW.mjs";
import { a as resolveCliRuntimeOwnerFingerprint, o as resolveCliExecutableIdentity, t as fingerprintCliRuntimeArtifact } from "./cli-auth-epoch-C149Le8e.mjs";
import { c as encodeNodeClaudeSkillMessage, i as NODE_CLAUDE_WORKSHOP_RESULT_BYTES, n as NODE_CLAUDE_SKILLS_MESSAGE_BYTES, o as NodeClaudeSkillUpstreamSchema } from "./node-claude-skill-protocol-vz147HUx.mjs";
...
import { n as hashCliImageTurnEntryId } from "./cli-image-turn-correlation-ZHLeWi9y.mjs";
import { n as cliBackendLog, r as formatCliBackendOutputDigest, t as CLI_BACKEND_LOG_OUTPUT_ENV } from "./log-C3-BcQUI.mjs";
import { c as resolvePromptInput, d as writeCliSystemPromptFile, f as buildCliSupervisorScopeKey, i as isClaudeCliBackendId, l as resolveSessionIdToSend, m as resolveCliRunTimeoutOverrideMs, n as buildCliArgs, o as prepareCliPromptImagePayload, p as resolveCliNoOutputTimeoutMs, r as enqueueCliRun, s as resolveCliRunQueueKey, u as resolveSystemPromptUsage } from "./helpers-YjNe3cPt.mjs";
import { r as compileStructuredInputQuestions, t as runStructuredInput } from "./structured-input-execution-D5Z7YIrX.mjs";
import { i as prepareCliBundleMcpCaptureAttempt, n as composeCliPromptContext } from "./prompt-context-D3jifoVd.mjs";
import { a as getCliLiveSessionApprovalGrants, c as restartCliLiveSession, d as resolveCliResumeAtError, f as formatCliOutputError, g as createCliRunCurrentAssertion, h as transformCliResultText, i as createCliLiveSessionCapability, l as createCliExitFailoverError, m as createCliJsonlStreamingParser, n as buildCliLiveOwnerKey, p as parseCliOutput, r as closeCliLiveSession, t as acceptsCliLiveSession, u as createCliFailoverError, y as runCliCleanup } from "./cli-live-session-registry-Bwa570V5.mjs";
import { t as buildMcpToolSchema } from "./mcp-http.schema-BVJ9N5yn.mjs";
import { g as waitForMcpLoopbackToolCallCaptureIdle, r as clearMcpLoopbackToolCallCapture, t as beginMcpLoopbackToolCallCapture } from "./mcp-http.loopback-runtime-SdFdqSah.mjs";
import { r as projectCliMessagingDeliveryEvidence, t as attachCliMessagingDeliveryEvidence } from "./delivery-evidence-DH2y_idP.mjs";
