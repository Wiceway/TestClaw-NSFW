...
import { D as withAgentRosterFactsBatch, d as resolveAgentWorkspaceDir } from "./agent-scope-config-Dm8T0OhW.mjs";
...
import { l as getRuntimeAuthProfileStoreMetadataRevision } from "./runtime-snapshots-BVrxpeKm.mjs";
import { a as listUserProfileAuthLinks } from "./user-model-accounts-D4lUc8aG.mjs";
import { r as getPreparedModelFullCatalogAuth } from "./prepared-model-runtime-auth-Cnc45sWs.mjs";
import "./auth-profiles-3zYAJqiZ.mjs";
import { y as withPreparedModelRuntimeReadBatch } from "./prepared-model-runtime-DkA7Mb_L.mjs";
import { t as getPreparedModelRuntimeStartupStatus } from "./prepared-model-runtime.startup-status-Da154XRr.mjs";
import { r as getPublishedPreparedModelCatalogOwnerSnapshot } from "./prepared-model-catalog-iMxpdaVw.mjs";
import { t as resolveSwarmConfig } from "./swarm-config-CB3czZI3.mjs";
import { r as getSkillsSnapshotVersion } from "./refresh-state-CK1eR8r9.mjs";
import { a as resolveSessionCatalogProfiles, n as prepareChatMetadataModelProjection, o as sessionProjectionKey, r as projectChatSessionMetadata, s as resolveChatAccountSelection, t as hasSessionCatalogContext } from "./chat-metadata-session-projection-CbibKRj9.mjs";
...
function createGatewayChatMetadataRuntime(params) {
	const deps = {
		...
		buildCommands: async ({ cfg, agentId }) => {
			const { buildCommandsListResult } = await import("./commands-list-result-FLSrobGm.mjs");
