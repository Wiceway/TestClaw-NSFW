...
import { t as getActiveManagedProxyLoopbackMode } from "./active-proxy-state-Cv_uMpbF.mjs";
import { c as resolveUndiciAutoSelectFamilyConnectOptions, n as createHttp1EnvHttpProxyAgent, r as createHttp1ProxyAgent, t as createHttp1Agent } from "./undici-runtime-BH85nU3O.mjs";
import { o as globalUndiciStreamTimeoutMs } from "./undici-global-dispatcher-2MZ9W_E1.mjs";
...
import { _ as resolvePinnedHostnameWithPolicy, a as createPinnedDispatcher, i as closeDispatcher, n as assertHostnameAllowedWithPolicy, p as matchesHostnameAllowlist, t as SsrFBlockedError, v as resolveSsrFPolicyForUrl } from "./ssrf-CA4JQHU2.mjs";
import "./pinned-dispatcher-pool-CTuP5JxC.mjs";
import { i as isMockedFetch, n as fetchWithRuntimeDispatcher } from "./runtime-fetch-C89VZBot.mjs";
...
function responseWithRelease(response, release) {
	...
	return new Response(wrapBodyStream({
		body: response.body,
		cleanup: release
	}, "release"), {
		status: response.status,
...
async function prepareGuardedFetchCapture(params, fetchImpl) {
	...
	const { prepareHttpCapture, resolveDebugProxyFetchTransport } = await import("./runtime-B7B4uRBP.mjs");
	return {
...
//#endregion
export { isManagedProxyActive as a, withTrustedEnvProxyGuardedFetchMode as c, responseWithRelease as d, wrapGuardedBodyStream as f, fetchWithSsrFGuard as i, withTrustedExplicitProxyGuardedFetchMode as l, GuardedFetchRedirectError as n, retainSafeHeadersForCrossOriginRedirectHeaders as o, withGuardedFetchRequestAuthority as p, fetchConfiguredLocalOriginWithSsrFGuard as r, withStrictGuardedFetchMode as s, GUARDED_FETCH_MODE as t, retainSafeHeadersForCrossOriginRedirect$1 as u };
