...
import { m as scopeLegacySessionKeyToAgent } from "./session-key-C_bfgyCp.mjs";
...
import { J as validateChatStartupParams, U as validateChatHistoryParams } from "./src-BNV0SJoP.mjs";
...
import { $ as listSessionPendingInputReceipts, et as listSessionPendingInputs } from "./session-accessor-CtBBLApI.mjs";
...
import { S as resolveActiveEmbeddedRunHandleSessionId, w as resolveActiveEmbeddedRunOwner } from "./runs-CgiowlON.mjs";
import { n as resolveSessionModelRef } from "./session-model-ref-Bzh8G0AG.mjs";
import { d as resolveInFlightRunSnapshot, o as projectInFlightRunSnapshot, r as boundInFlightRunSnapshotForChatHistory } from "./chat-abort-CNLBLnF-.mjs";
...
import { i as resolveGatewayModelThinkingProfile, t as getSessionDefaults } from "./session-utils-model-B-id1HFF.mjs";
import { B as buildGatewaySessionRow, n as withReadySessionRows } from "./session-row-prepared-read-B632AuGn.mjs";
import { p as resolveCurrentUserProfileDisplay } from "./session-identity-projection-Bs5BuY8x.mjs";
import { d as hiddenSessionNotFound, f as isGatewayAdmin, y as resolveSessionVisibility } from "./session-sharing-policy-gt4OMoUR.mjs";
import { i as resolveVisibleActiveSessionRunState } from "./session-active-runs-B7nF2tZH.mjs";
import { o as resolveGatewayModelSelectionPolicy } from "./session-utils-list-C8xRKZPC.mjs";
...
import { i as readTranscriptDisplayDelta } from "./session-accessor.sqlite-history-events-BdEPy7lb.mjs";
...
import { a as isAssistantTtsSupplementMessage } from "./chat-display-projection.history-lS6Jhi42.mjs";
import { i as projectChatDisplayMessage, n as createCurrentUserProfileMessageProjector } from "./chat-display-projection.core-Obp7lmhd.mjs";
import { i as composeTranscriptDisplay } from "./transcript-image-artifacts-CmHodhVD.mjs";
import "./chat-display-projection-CAY6Nifi.mjs";
import { l as resolveClaudeCliBindingSessionId } from "./cli-session-history.claude-C6SSRmUs.mjs";
import "./cli-session-history-C6ZUtuI_.mjs";
import { a as createChatHistoryByteCounter, c as trimChatHistoryActivity, i as createChatHistoryActivityProjection, n as CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES, o as replaceOversizedChatHistoryMessages, r as chatHistoryActivityBytes, s as reportOmittedChatHistory, t as readChatHistoryPage } from "./chat-history-pages-C1x4VlOq.mjs";
import { i as resolveChatHistoryNextOffset, n as enrichChatHistoryCompactionMarkers, t as capChatHistoryAroundMessage } from "./chat-history-page-kernel-B1XmmEuC.mjs";
...
import { a as prepareSessionWorkspaceIcon } from "./workspace-icon-http-BSSOU0Ap.mjs";
import { n as isAppendOnlySessionHistoryDelta, t as createPreparedSessionHistorySubagentProjection } from "./session-history-delta-visibility-Dgy-2QpD.mjs";
import { t as projectSessionMessagePayload } from "./session-transcript-message-BZ_G_NHc.mjs";
import { n as prepareSessionMutationFacts, t as SessionMutationFactsUnavailableError } from "./session-sharing-preparation-_ZdagR8P.mjs";
import { t as handleChatMetadataRequest } from "./chat-metadata-handler-ri64sVv6.mjs";
...
async function prepareChatStartupRequester(client) {
	...
	if (!profileId && email) {
		const { ensureProfileIdForEmail } = await import("./user-profile-email-DX1R8c6G.mjs");
