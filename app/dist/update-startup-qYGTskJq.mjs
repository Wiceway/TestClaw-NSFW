...
import { a as channelToNpmTag, c as normalizeUpdateChannel, u as resolveEffectiveUpdateChannel } from "./update-channels-D-eqC5La.mjs";
import { a as writeConfigMachineState } from "./config-machine-state-write-B5HfY1po.mjs";
import { n as sanitizeTerminalText } from "./safe-text-CBmKtmbt.mjs";
import { r as checkRemoteModelCatalogUpdate, s as resolveRemoteCatalogUrl } from "./model-catalog-h3BsH2qo.mjs";
...
import { l as resolveDevGitCommits, n as compareSemverStrings, o as resolveNpmChannelTag } from "./update-check-iRYMjMOk.mjs";
...
import { n as refreshRemoteModelCatalog, t as REMOTE_MODEL_CATALOG_TTL_MS } from "./remote-refresh-B0EWw1JR.mjs";
...
import { n as currentUpdateCheckLifecycle, t as createGatewayUpdateLifecycle } from "./update-check-lifecycle-CXkZRgsW.mjs";
import { t as resolveStartupInstallStatus } from "./update-install-status-cZLAI7WE.mjs";
import { n as runCampaignUpdate } from "./update-startup-auto-run-C4ho3llx.mjs";
...
async function runGatewayUpdateCheckOwned(params, lifecycle) {
	...
	const runAuto = params.runAutoUpdate ?? (async (runParams) => {
		const { runAutoUpdateCommand } = await import("./update-startup-auto-run-DmXhjSk5.mjs");
