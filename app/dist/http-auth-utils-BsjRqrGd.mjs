...
import { r as isLocalDirectRequest, s as isLoopbackHost, y as resolveHostName } from "./net-D6MXMoHn.mjs";
import { c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN } from "./auth-rate-limit-Dk5g5GeL.mjs";
import { a as prepareGatewayIngressAttribution } from "./ingress-attribution-DuobesAh.mjs";
import { a as resolveBrowserOriginPolicy } from "./origin-check-Dp7U-gwA.mjs";
import { t as withSerializedCredentialFallbackAttempt } from "./rate-limit-attempt-serialization-Dn9Ln-33.mjs";
import { n as authorizeControlUiReadHttpGatewayConnect, r as authorizeHttpGatewayConnect } from "./auth-BiBrp8U7.mjs";
import { a as roleScopesAllow, t as intersectOperatorScopes } from "./operator-scope-compat-Ci6GBcmU.mjs";
import { n as authorizeOperatorScopesForMethod, t as CLI_DEFAULT_OPERATOR_SCOPES } from "./method-scopes-Cn-bBRCy.mjs";
import { R as readUserProfileAliasRevision } from "./user-profiles-internal-BfnkNaNn.mjs";
...
import { c as readOperatorRolePolicyRevision, f as resolveOperatorRolePolicyForAssignment, p as resolveOperatorRolePolicyForProfile } from "./operator-role-policy-BqKjnbl9.mjs";
...
import { c as CONTROL_UI_PLUGIN_AUTH_GRANT_TTL_MS, d as CONTROL_UI_PLUGIN_AUTH_PROBE_QUERY, l as CONTROL_UI_PLUGIN_AUTH_PROBE_MESSAGE, r as listControlUiPluginTabAuthGrants, u as CONTROL_UI_PLUGIN_AUTH_PROBE_ORIGIN_QUERY } from "./control-ui-plugin-tabs-ch8JF3VP.mjs";
...
import { c as sendJson, f as sendUnauthorized, o as sendGatewayAuthFailure, u as sendMissingScopeForbidden } from "./http-common-BRkymMwR.mjs";
