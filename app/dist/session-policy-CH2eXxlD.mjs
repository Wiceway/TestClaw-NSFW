...
import { A as parseAgentSessionKey, E as parseThreadSessionSuffix } from "./session-key-C_bfgyCp.mjs";
...
import { p as DEFAULT_AGENT_ID } from "./types-DgEaE0BK.mjs";
import { i as resolveCanonicalSessionKeyFromSessionId } from "./session-CHEQ6kuk.mjs";
...
function isEligibleInteractiveSession(ctx) {
	...
	if (ctx.inputProvenance?.kind === "inter_session") return false;
