...
import { i as supportsDecorativeEmoji, t as decorativeEmoji } from "./decorative-emoji-Dgii7osH.mjs";
...
function plainTitleLine() {
	...
	return supportsDecorativeEmoji() && icon ? `${icon} TESTCLAW ${icon}` : "TESTCLAW";
}
...
/**
* Prints the Assistant banner: animated on rich interactive terminals, static
