import { Jt as ExecApprovalForwardingMode, r as TestclawConfig } from "./types.testclaw-C-wX50Nb.js";
import { A as ExecApprovalRequest, a as SystemAgentApprovalRequest, h as PluginApprovalRequest, n as ChannelApprovalKind } from "./approval-types-DIxuby8L.js";
import { r as ChannelApprovalCapability } from "./types.adapters-8WMF_p63.js";
import { i as ChannelOutboundPayloadHint } from "./outbound.types-BEE1v82E.js";
...
import "./config-runtime-BM83mYxW.js";
import { i as ExecApprovalReplyMetadata } from "./exec-approval-reply-DQhWvgmb.js";
import { n as ExecApprovalSessionTarget } from "./exec-approval-session-target-CPjbhYt_.js";
...
type NativeApprovalChannelRouteGateParams<TTarget extends NativeApprovalTarget> = {
  ...
  listAccountIds: (cfg: TestclawConfig) => readonly string[];
  resolveDefaultAccountId: (cfg: TestclawConfig) => string;
  normalizeForwardTarget: (target: NativeApprovalForwardTarget) => TTarget | null;
