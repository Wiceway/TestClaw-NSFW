...
import { a as writeRuntimeJson, r as defaultRuntime, t as ExitError } from "./runtime-Dg6PE4Mj.mjs";
...
import { s as isDefaultStateDir, v as resolveGatewayPort } from "./paths-DvpAEtA8.mjs";
import "./session-key-C_bfgyCp.mjs";
import { n as listAgentEntries } from "./agent-roster-Cl9s4QHb.mjs";
import { a as createGatewayEnvSecretRef, l as isValidEnvSecretRefId } from "./ref-contract-BVi3ykLT.mjs";
...
import { n as applyWizardMetadata, o as handleReset, p as waitForGatewayReachable, s as normalizeGatewayTokenInput, t as DEFAULT_WORKSPACE } from "./onboard-helpers-BRZVRRpx.mjs";
import { a as ensureOnboardingAgentWorkspace, c as resolveOnboardingAgentTarget, l as resolveOnboardingSetupTarget } from "./onboard-agent-target--U5T7XvY.mjs";
...
import { t as hasInteractiveOnboardingTty } from "./onboard-interactive-runner-B244PLt1.mjs";
...
import { o as normalizeTokenProviderInput } from "./provider-auth-input-DrwOvWSv.mjs";
import { a as GENERIC_PROVIDER_AUTH_CHOICES, r as formatAuthChoiceChoicesForCli } from "./auth-choice-options-B1fpmjKx.mjs";
...
import { n as validateGatewayWebSocketUrl } from "./onboard-remote-DclSREaS.mjs";
import { n as applySkipBootstrapConfig, r as resolveOnboardingWorkspaceConflict, t as applyLocalSetupWorkspaceConfig } from "./onboard-config-5sl-05yZ.mjs";
import { u as withSetupMigrationTargetLock } from "./setup.migration-snapshot-BMlM_Iud.mjs";
import { n as runInteractiveSetup } from "./onboard-interactive-CgCnF6P9.mjs";
import { t as inferAuthChoiceFromFlags } from "./auth-choice-inference-DfW6g2yq.mjs";
import { n as validateOnboardingChoiceOptions, t as rejectOnboardingOption } from "./onboard-options-BZfpPeqd.mjs";
import { t as resolveNonInteractiveApiKey } from "./api-keys-prGb9T6G.mjs";
import { t as provisionGatewayTokenStoreRef } from "./auth-token-store-ref-CDQ6c7Oy.mjs";
...
async function collectGatewayHealthFailureDiagnostics() {
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-C77RIgLm.mjs");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-9Wpnv_O7.mjs")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-B7Zr5_7S.mjs");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-D1LrN80g.mjs");
	...
	if (!opts.skipHealth) {
		const { healthCommandNonExiting } = await import("./health-rSp49rDE.mjs");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-oL9JY5hg.mjs");
...
async function setupWizardCommand(opts, runtime = defaultRuntime) {
	...
	if (normalizedOpts.agentName !== void 0) {
		const { validateFirstOnboardingAgentName } = await import("./onboard-agent-CZQyK_XR.mjs");
