...
import { A as parseAgentSessionKey, r as agentSessionKeysMatchByRequestKey } from "./session-key-C_bfgyCp.mjs";
import { _ as resolveSessionAgentId } from "./agent-scope-_30Scclc.mjs";
import { r as getRuntimeConfig, y as registerConfigWriteListener } from "./io.runtime-DIHH_X2V.mjs";
...
import { Q as setEmbeddedPluginApprovalBroker, X as EmbeddedPluginApprovalBroker, Z as clearEmbeddedPluginApprovalBroker } from "./agent-tools.before-tool-call-CN-tk8aM.mjs";
import { a as getPreparedModelRuntimeAuthMaterializations } from "./prepared-model-runtime-auth-Cnc45sWs.mjs";
import { r as resolvePublishedModelCatalogOwner } from "./prepared-model-catalog-owner-C_fKUO2k.mjs";
...
import { g as refreshPreparedModelRuntimeSnapshots } from "./prepared-model-runtime-DkA7Mb_L.mjs";
import { a as loadPreparedModelCatalogSnapshot, d as readPreparedModelCatalog, f as withPreparedModelCatalogOwner } from "./prepared-model-catalog-iMxpdaVw.mjs";
...
import { E as getSubagentSessionListReadSnapshotIdentity, M as prepareOptionalSubagentSessionListReadCache } from "./subagent-registry-read-PBgGP-fW.mjs";
import { i as resolveTextCommand } from "./commands-registry-normalize-D_t-v1PZ.mjs";
import { n as setEmbeddedMode } from "./embedded-mode-wPlJkQN6.mjs";
import { n as QuestionAnswerUnconfirmedError } from "./gateway-question-dispatch-BN3u82se.mjs";
import { b as queueEmbeddedAgentMessageWithOutcomeAsync, r as claimPendingEmbeddedAgentQuestionAnswer } from "./runs-CgiowlON.mjs";
...
import { i as parseGoalCommand, t as executeSessionGoalCommand } from "./commands-goal-B0DKEphh.mjs";
...
import { a as isChatStopCommandText } from "./chat-abort-CNLBLnF-.mjs";
import { m as resolveEffectiveChatHistoryMaxChars } from "./chat-display-projection.helpers-BDrSlf-A.mjs";
import { c as normalizeLiveAssistantBufferedText, l as projectLiveAssistantBufferedText, s as capLiveAssistantText, u as shouldSuppressAssistantEventForLiveChat } from "./server-chat-state-s6eZWEwx.mjs";
...
import { t as ensureContextWindowCacheLoaded } from "./context-CkigEvA0.mjs";
import { n as projectSessionPatchResult, t as getSessionDefaults } from "./session-utils-model-B-id1HFF.mjs";
import { i as loadGatewaySessionEntryReadOnly, n as listAgentsForGateway, o as resolveCanonicalGatewaySessionStoreKey, r as loadGatewaySessionEntry } from "./session-utils-store-BVoy_pJn.mjs";
import { t as resolveQueueSettingsCore } from "./settings-Jm2gqlWz.mjs";
import { g as buildCollectPrompt, m as applyQueueDropPolicy, w as waitForQueueDebounce, x as previewQueueSummaryPrompt } from "./state-BiFUkrFk.mjs";
...
import { s as bindEmbeddedSessionRowProjection } from "./testclaw-tools-CMkAHLll.mjs";
...
import { a as createChatHistoryByteCounter, i as createChatHistoryActivityProjection, n as CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES, o as replaceOversizedChatHistoryMessages, t as readChatHistoryPage } from "./chat-history-pages-C1x4VlOq.mjs";
import { n as enrichChatHistoryCompactionMarkers } from "./chat-history-page-kernel-B1XmmEuC.mjs";
import { o as performGatewaySessionReset } from "./session-reset-service-BFelyREE.mjs";
import { a as isAgentLifecycleYieldedWaiting } from "./session-event-payload-C6MsfOsM.mjs";
import { a as resolveAssistantTextInput, t as mergeAssistantText } from "./agent-event-assistant-text-DvsC02YI.mjs";
import "./chat-PSTUo_NL.mjs";
...
import { t as createSessionRowProjection } from "./session-row-projection-Be1GgM6V.mjs";
import { i as setEmbeddedQuestionBroker, n as clearEmbeddedQuestionBroker, t as EmbeddedQuestionBroker } from "./embedded-question-broker-TNaM-i_X.mjs";
import { t as resolveLocalRunShutdownGraceMs } from "./local-run-shutdown-yLlv630S.mjs";
import { l as formatTuiErrorMessage } from "./tui-formatters-CosafF0A.mjs";
...
var EmbeddedTuiBackend = class {
	...
	start() {
		...
		this.sessionProjection = (async () => {
			const { runSessionStartupMigration } = await import("./startup-migration-Dffno6Li.mjs");
	...
	async loadImage(opts) {
		const { loadEmbeddedImage } = await import("./embedded-image-loader-_k-1F_bT.mjs");
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw-DacC0yLI.mjs");
